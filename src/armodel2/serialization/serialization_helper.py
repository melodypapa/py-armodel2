...
class SerializationHelper:
    ...
    def import_class_by_name(class_name: str):  # type: ignore[no-untyped-def]
        ...
        search_paths = [
            ...
            f'armodel2.models.M2.MSR.AsamHdo.ComputationMethod.{compu_method_filename}',
        ]
    ...
    def unwrap_primitive(result: Any) -> Any:
        ...
        """
        from armodel2.models.M2.AUTOSARTemplates.GenericStructure.GeneralTemplateClasses.PrimitiveTypes.ar_primitive import (
            ARPrimitive,
        )
    ...
    def serialize_item(value: Any, expected_type: str) -> Optional[ET.Element]:  # type: ignore[no-any-return]
        ...
        from armodel2.models.M2.AUTOSARTemplates.GenericStructure.GeneralTemplateClasses.PrimitiveTypes.ar_enum import (
            AREnum,
        )
