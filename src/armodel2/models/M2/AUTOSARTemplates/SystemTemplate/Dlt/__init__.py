...
from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.Dlt.dlt_default_trace_state_enum import (
    DltDefaultTraceStateEnum,
)
from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.Dlt.log_trace_default_log_level_enum import (
