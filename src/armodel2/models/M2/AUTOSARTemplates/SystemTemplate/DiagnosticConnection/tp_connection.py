...
class TpConnectionBuilder(BuilderBase, ABC):
    """Builder for TpConnection with fluent API."""
    ...
    def with_ident(self, value: Optional[TpConnectionIdent]) -> "TpConnectionBuilder":
        """Set ident attribute.
    ...
    def build(self) -> TpConnection:
        """Build and return the TpConnection instance (abstract)."""
