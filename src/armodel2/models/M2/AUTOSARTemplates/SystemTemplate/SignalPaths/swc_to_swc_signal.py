...
class SwcToSwcSignalBuilder(BuilderBase):
    """Builder for SwcToSwcSignal with fluent API."""
    ...
    def with_data_elements(self, items: list[VariableDataPrototype]) -> "SwcToSwcSignalBuilder":
    ...
    def add_data_element(self, item: VariableDataPrototype) -> "SwcToSwcSignalBuilder":
    ...
    def clear_data_elements(self) -> "SwcToSwcSignalBuilder":
    ...
    def build(self) -> SwcToSwcSignal:
        """Build and return the SwcToSwcSignal instance with validation."""
