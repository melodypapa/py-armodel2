...
class TlsPskIdentityBuilder(BuilderBase):
    """Builder for TlsPskIdentity with fluent API."""
    ...
    def with_pre_shared_key(self, value: Optional[CryptoServiceKey]) -> "TlsPskIdentityBuilder":
    ...
    def with_psk_identity(self, value: Optional[String]) -> "TlsPskIdentityBuilder":
    ...
    def with_psk_identity_hint(self, value: Optional[String]) -> "TlsPskIdentityBuilder":
        """Set psk_identity_hint attribute.
    ...
    def build(self) -> TlsPskIdentity:
        """Build and return the TlsPskIdentity instance with validation."""
