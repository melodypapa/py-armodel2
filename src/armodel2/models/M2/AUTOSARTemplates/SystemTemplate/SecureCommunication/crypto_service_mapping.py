...
class CryptoServiceMapping(Identifiable, ABC):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(CryptoServiceMapping, self).serialize()
...
class CryptoServiceMappingBuilder(IdentifiableBuilder):
    """Builder for CryptoServiceMapping with fluent API."""
    ...
    def build(self) -> CryptoServiceMapping:
        """Build and return the CryptoServiceMapping instance (abstract)."""
