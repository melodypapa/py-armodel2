...
class NetworkSegmentIdentification(ARObject):
    ...
    _XML_TAG = "NETWORK-SEGMENT-IDENTIFICATION"
...
class NetworkSegmentIdentificationBuilder(BuilderBase):
    """Builder for NetworkSegmentIdentification with fluent API."""
    ...
    def with_network(self, value: Optional[PositiveInteger]) -> "NetworkSegmentIdentificationBuilder":
    ...
    def build(self) -> NetworkSegmentIdentification:
        """Build and return the NetworkSegmentIdentification instance with validation."""
