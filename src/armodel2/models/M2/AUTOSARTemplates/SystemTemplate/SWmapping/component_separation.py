...
from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.SWmapping.mapping_constraint import MappingConstraintBuilder
from armodel2.models.M2.AUTOSARTemplates.GenericStructure.GeneralTemplateClasses.ArObject.ar_ref import ARRef
from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.SWmapping import (
    MappingScopeEnum,
)
...
class ComponentSeparationBuilder(MappingConstraintBuilder):
    """Builder for ComponentSeparation with fluent API."""
    ...
    def with_mapping_scope_enum(self, value: Optional[MappingScopeEnum]) -> "ComponentSeparationBuilder":
    ...
    def build(self) -> ComponentSeparation:
        """Build and return the ComponentSeparation instance with validation."""
