...
class MappingConstraintBuilder(BuilderBase, ABC):
    """Builder for MappingConstraint with fluent API."""
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "MappingConstraintBuilder":
    ...
    def build(self) -> MappingConstraint:
        """Build and return the MappingConstraint instance (abstract)."""
