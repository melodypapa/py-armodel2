    ...
    def deserialize(cls, element: ET.Element) -> "LinTpConfig":
        ...
        for child in element:
            ...
            if tag == "TP-ADDRESSES":
                ...
                obj.tp_connections.append(SerializationHelper.deserialize_by_tag(child, "LinTpConnection"))
            elif tag == "TP-NODES":
                obj.tp_nodes.append(SerializationHelper.deserialize_by_tag(child, "LinTpNode"))
