...
if TYPE_CHECKING:
    ...
    from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.TransportProtocols.flexray_tp_config import (
        FlexrayTpConfig,
    )
    from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.TransportProtocols.flexray_tp_connection_control import (
    ...
    from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.TransportProtocols.flexray_ar_tp_config import (
        FlexrayArTpConfig,
    )
    from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.TransportProtocols.flexray_ar_tp_channel import (
        FlexrayArTpChannel,
    )
    ...
    from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.TransportProtocols.can_tp_config import (
        CanTpConfig,
    )
    ...
    from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.TransportProtocols.lin_tp_config import (
        LinTpConfig,
    )
    ...
    from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.TransportProtocols.eth_tp_config import (
        EthTpConfig,
    )
    from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.TransportProtocols.eth_tp_connection import (
        EthTpConnection,
    )
    from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.TransportProtocols.someip_tp_config import (
        SomeipTpConfig,
    )
    from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.TransportProtocols.someip_tp_connection import (
        SomeipTpConnection,
    )
    from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.TransportProtocols.someip_tp_channel import (
        SomeipTpChannel,
    )
    from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.TransportProtocols.j1939_tp_config import (
        J1939TpConfig,
    )
    from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.TransportProtocols.j1939_tp_connection import (
        J1939TpConnection,
    )
    from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.TransportProtocols.j1939_tp_pg import (
        J1939TpPg,
    )
...
from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.TransportProtocols.fr_ar_tp_ack_type import (
    FrArTpAckType,
)
from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.TransportProtocols.maximum_message_length_type import (
    MaximumMessageLengthType,
)
from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.TransportProtocols.can_tp_addressing_format_type import (
    CanTpAddressingFormatType,
)
from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.TransportProtocols.network_target_address_type import (
