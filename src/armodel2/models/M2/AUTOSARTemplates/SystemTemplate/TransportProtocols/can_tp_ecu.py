...
class CanTpEcuBuilder(BuilderBase):
    """Builder for CanTpEcu with fluent API."""
    ...
    def with_cycle_time_main(self, value: Optional[TimeValue]) -> "CanTpEcuBuilder":
    ...
    def with_ecu_instance(self, value: Optional[EcuInstance]) -> "CanTpEcuBuilder":
    ...
    def build(self) -> CanTpEcu:
        """Build and return the CanTpEcu instance with validation."""
