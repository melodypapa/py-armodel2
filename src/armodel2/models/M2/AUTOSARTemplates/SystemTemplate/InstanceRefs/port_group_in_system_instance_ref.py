...
class PortGroupInSystemInstanceRef(ARObject):
    ...
    _XML_TAG = "PORT-GROUP-IN-SYSTEM-INSTANCE-REF"
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(PortGroupInSystemInstanceRef, self).serialize()
    ...
    def deserialize(cls, element: ET.Element) -> "PortGroupInSystemInstanceRef":
        ...
        obj = super(PortGroupInSystemInstanceRef, cls).deserialize(element)
...
class PortGroupInSystemInstanceRefBuilder(BuilderBase):
    """Builder for PortGroupInSystemInstanceRef with fluent API."""
    ...
    def with_base(self, value: Optional[System]) -> "PortGroupInSystemInstanceRefBuilder":
        """Set base attribute.
    ...
    def with_context(self, value: Optional[RootSwCompositionPrototype]) -> "PortGroupInSystemInstanceRefBuilder":
    ...
    def with_target(self, value: PortGroup) -> "PortGroupInSystemInstanceRefBuilder":
    ...
    def _validate_instance(self) -> None:
        ...
        if getattr(self._obj, "target", None) is None:
            if mode == BuilderValidationMode.STRICT:
                raise ValueError(f"Required attribute 'target' is None")
            elif mode == BuilderValidationMode.LENIENT:
                import warnings
                warnings.warn(f"Required attribute 'target' is None", UserWarning)


    def build(self) -> PortGroupInSystemInstanceRef:
        """Build and return the PortGroupInSystemInstanceRef instance with validation."""
