...
class BinaryManifestMetaDataField(BinaryManifestAddressableObject):
    ...
    _XML_TAG = "BINARY-MANIFEST-META-DATA-FIELD"
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(BinaryManifestMetaDataField, self).serialize()
...
class BinaryManifestMetaDataFieldBuilder(BinaryManifestAddressableObjectBuilder):
    """Builder for BinaryManifestMetaDataField with fluent API."""
    ...
    def with_size(self, value: Optional[PositiveInteger]) -> "BinaryManifestMetaDataFieldBuilder":
        """Set size attribute.
    ...
    def with_value(self, value: Optional[VerbatimString]) -> "BinaryManifestMetaDataFieldBuilder":
        """Set value attribute.
    ...
    def build(self) -> BinaryManifestMetaDataField:
        """Build and return the BinaryManifestMetaDataField instance with validation."""
