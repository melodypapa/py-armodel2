...
class AbstractDoIpLogicAddressPropsBuilder(IdentifiableBuilder):
    """Builder for AbstractDoIpLogicAddressProps with fluent API."""
    ...
    def build(self) -> AbstractDoIpLogicAddressProps:
        """Build and return the AbstractDoIpLogicAddressProps instance (abstract)."""
