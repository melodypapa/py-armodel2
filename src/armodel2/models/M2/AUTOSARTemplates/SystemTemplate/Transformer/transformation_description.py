...
class TransformationDescriptionBuilder(DescribableBuilder):
    """Builder for TransformationDescription with fluent API."""
    ...
    def build(self) -> TransformationDescription:
        """Build and return the TransformationDescription instance (abstract)."""
