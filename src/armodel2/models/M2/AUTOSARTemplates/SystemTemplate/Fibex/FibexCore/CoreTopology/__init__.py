...
if TYPE_CHECKING:
    ...
    from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.Fibex.FibexCore.CoreTopology.cycle_counter import (
        CycleCounter,
    )
    from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.Fibex.FibexCore.CoreTopology.cycle_repetition import (
        CycleRepetition,
    )

from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.Fibex.FibexCore.CoreTopology.pnc_gateway_type_enum import (
    PncGatewayTypeEnum,
)
from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.Fibex.FibexCore.CoreTopology.cycle_repetition_type import (
    CycleRepetitionType,
)
