...
class CommunicationCluster(ARElement, ABC):
    ...
    _DESERIALIZE_DISPATCH = {
        ...
        "PHYSICAL-CHANNELS": ("_POLYMORPHIC_LIST", "physical_channels", ["AbstractCanPhysicalChannel", "CanPhysicalChannel", "EthernetPhysicalChannel", "FlexrayPhysicalChannel", "LinPhysicalChannel", "TtcanPhysicalChannel"]),
