...
class RelativeToleranceBuilder(BuilderBase):
    """Builder for RelativeTolerance with fluent API."""
    ...
    def with_relative(self, value: Optional[Integer]) -> "RelativeToleranceBuilder":
    ...
    def build(self) -> RelativeTolerance:
        """Build and return the RelativeTolerance instance with validation."""
