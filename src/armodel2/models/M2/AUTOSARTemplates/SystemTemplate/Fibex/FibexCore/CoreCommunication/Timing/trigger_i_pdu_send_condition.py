...
class TriggerIPduSendCondition(ARObject):
    ...
    _XML_TAG = "TRIGGER-I-PDU-SEND-CONDITION"
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(TriggerIPduSendCondition, self).serialize()
...
class TriggerIPduSendConditionBuilder(BuilderBase):
    """Builder for TriggerIPduSendCondition with fluent API."""
    ...
    def with_modes(self, items: list[ModeDeclaration]) -> "TriggerIPduSendConditionBuilder":
    ...
    def add_mode(self, item: ModeDeclaration) -> "TriggerIPduSendConditionBuilder":
    ...
    def clear_modes(self) -> "TriggerIPduSendConditionBuilder":
    ...
    def build(self) -> TriggerIPduSendCondition:
        """Build and return the TriggerIPduSendCondition instance with validation."""
