...
class CommunicationConnector(Identifiable, ABC):
    ...
    _DESERIALIZE_DISPATCH = {
        "COMM-CONTROLLER-REF": ("_POLYMORPHIC", "comm_controller_ref", ["AbstractCanCommunicationController", "CanCommunicationController", "EthernetCommunicationController", "FlexrayCommunicationController", "LinCommunicationController", "LinMaster", "LinSlave", "TtcanCommunicationController", "UserDefinedCommunicationController"]),
