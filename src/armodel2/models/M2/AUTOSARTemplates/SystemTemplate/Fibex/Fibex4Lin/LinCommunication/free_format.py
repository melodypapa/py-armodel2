...
from armodel2.models.M2.AUTOSARTemplates.SystemTemplate.Fibex.Fibex4Lin.LinCommunication.free_format_entry import FreeFormatEntryBuilder
...
class FreeFormatBuilder(FreeFormatEntryBuilder):
    """Builder for FreeFormat with fluent API."""
    ...
    def with_byte_values(self, items: list[Integer]) -> "FreeFormatBuilder":
    ...
    def add_byte_value(self, item: Integer) -> "FreeFormatBuilder":
    ...
    def clear_byte_values(self) -> "FreeFormatBuilder":
    ...
    def build(self) -> FreeFormat:
        """Build and return the FreeFormat instance with validation."""
