...
class LinConfigurationEntryBuilder(ScheduleTableEntryBuilder):
    """Builder for LinConfigurationEntry with fluent API."""
    ...
    def with_assigned(self, value: Optional[LinSlave]) -> "LinConfigurationEntryBuilder":
    ...
    def with_assigned_lin(self, value: Optional[LinSlaveConfigIdent]) -> "LinConfigurationEntryBuilder":
    ...
    def build(self) -> LinConfigurationEntry:
        """Build and return the LinConfigurationEntry instance (abstract)."""
