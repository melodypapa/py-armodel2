...
class FreeFormatEntry(ScheduleTableEntry, ABC):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(FreeFormatEntry, self).serialize()
...
class FreeFormatEntryBuilder(ScheduleTableEntryBuilder):
    """Builder for FreeFormatEntry with fluent API."""
    ...
    def build(self) -> FreeFormatEntry:
        """Build and return the FreeFormatEntry instance (abstract)."""
