...
class CanCommunicationController(AbstractCanCommunicationController):
    ...
    def serialize(self) -> ET.Element:
        """Serialize CanCommunicationController to XML element with atp_variant wrapper.
        ...
        parent_elem = super(CanCommunicationController, self).serialize()
        ...
        wrapped = SerializationHelper.serialize_with_atp_variant(inner_elem, "CanCommunicationController")
        elem.append(wrapped)
    ...
    def deserialize(cls, element: ET.Element) -> "CanCommunicationController":
        """Deserialize XML element to CanCommunicationController object with atp_variant unwrapping.
        ...
        inner_elem = SerializationHelper.deserialize_from_atp_variant(element, "CanCommunicationController")
        ...
        obj = super(CanCommunicationController, cls).deserialize(element)
...
class CanCommunicationControllerBuilder(BuilderBase):
    """Builder for CanCommunicationController with fluent API."""
    ...
    def build(self) -> CanCommunicationController:
        """Build and return the CanCommunicationController instance with validation."""
