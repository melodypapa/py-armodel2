...
class FlexrayFrameTriggering(FrameTriggering):
    ...
    def deserialize(cls, element: ET.Element) -> "FlexrayFrameTriggering":
        ...
        for child in element:
            ...
            if tag == "ABSOLUTELIES":
                obj.absolutelies.append(SerializationHelper.deserialize_by_tag(child, "FlexrayAbsolutelyScheduledTiming"))
...
class FlexrayFrameTriggeringBuilder(FrameTriggeringBuilder):
    ...
    def add_absolutely(self, item: FlexrayAbsolutelyScheduledTiming) -> "FlexrayFrameTriggeringBuilder":
