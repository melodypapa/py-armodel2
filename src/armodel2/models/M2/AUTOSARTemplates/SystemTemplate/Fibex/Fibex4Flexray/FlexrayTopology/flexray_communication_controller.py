...
class FlexrayCommunicationController(ARObject):
    ...
    _DESERIALIZE_DISPATCH = {
        "ACCEPTED": lambda obj, elem: setattr(obj, "accepted", SerializationHelper.deserialize_by_tag(elem, "Integer")),
        "ALLOW-HALT-DUE-TO": lambda obj, elem: setattr(obj, "allow_halt_due_to", SerializationHelper.deserialize_by_tag(elem, "Boolean")),
        "ALLOW-PASSIVE-TO": lambda obj, elem: setattr(obj, "allow_passive_to", SerializationHelper.deserialize_by_tag(elem, "Integer")),
        "CLUSTER-DRIFT": lambda obj, elem: setattr(obj, "cluster_drift", SerializationHelper.deserialize_by_tag(elem, "Integer")),
        "DECODING": lambda obj, elem: setattr(obj, "decoding", SerializationHelper.deserialize_by_tag(elem, "Integer")),
        "DELAY": lambda obj, elem: setattr(obj, "delay", SerializationHelper.deserialize_by_tag(elem, "Integer")),
        "EXTERNAL-SYNC": lambda obj, elem: setattr(obj, "external_sync", SerializationHelper.deserialize_by_tag(elem, "Boolean")),
        ...
        "LATEST-TX": lambda obj, elem: setattr(obj, "latest_tx", SerializationHelper.deserialize_by_tag(elem, "Integer")),
        "LISTEN-TIMEOUT": lambda obj, elem: setattr(obj, "listen_timeout", SerializationHelper.deserialize_by_tag(elem, "Integer")),
        "MACRO-INITIAL": lambda obj, elem: setattr(obj, "macro_initial", SerializationHelper.deserialize_by_tag(elem, "Integer")),
        "MAXIMUM": lambda obj, elem: setattr(obj, "maximum", SerializationHelper.deserialize_by_tag(elem, "Integer")),
        "MICRO-INITIAL": lambda obj, elem: setattr(obj, "micro_initial", SerializationHelper.deserialize_by_tag(elem, "Integer")),
        "MICRO-PER-CYCLE": lambda obj, elem: setattr(obj, "micro_per_cycle", SerializationHelper.deserialize_by_tag(elem, "Integer")),
        "MICROTICK": lambda obj, elem: setattr(obj, "microtick", SerializationHelper.deserialize_by_tag(elem, "TimeValue")),
        "NM-VECTOR-EARLY": lambda obj, elem: setattr(obj, "nm_vector_early", SerializationHelper.deserialize_by_tag(elem, "Boolean")),
        "OFFSET-CORRECTION": lambda obj, elem: setattr(obj, "offset_correction", SerializationHelper.deserialize_by_tag(elem, "Integer")),
        "RATE-CORRECTION": lambda obj, elem: setattr(obj, "rate_correction", SerializationHelper.deserialize_by_tag(elem, "Integer")),
        "SAMPLES-PER-MICROTICK": lambda obj, elem: setattr(obj, "samples_per_microtick", SerializationHelper.deserialize_by_tag(elem, "Integer")),
        "SECOND-KEY-SLOT": lambda obj, elem: setattr(obj, "second_key_slot", SerializationHelper.deserialize_by_tag(elem, "PositiveInteger")),
        "TWO-KEY-SLOT": lambda obj, elem: setattr(obj, "two_key_slot", SerializationHelper.deserialize_by_tag(elem, "Boolean")),
        "WAKE-UP-PATTERN": lambda obj, elem: setattr(obj, "wake_up_pattern", SerializationHelper.deserialize_by_tag(elem, "Integer")),
    }
