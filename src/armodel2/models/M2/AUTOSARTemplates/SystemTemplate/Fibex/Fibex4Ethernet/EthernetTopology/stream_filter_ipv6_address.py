...
class StreamFilterIpv6Address(ARObject):
    ...
    _XML_TAG = "STREAM-FILTER-IPV6-ADDRESS"
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(StreamFilterIpv6Address, self).serialize()
    ...
    def deserialize(cls, element: ET.Element) -> "StreamFilterIpv6Address":
        ...
        obj = super(StreamFilterIpv6Address, cls).deserialize(element)
...
class StreamFilterIpv6AddressBuilder(BuilderBase):
    """Builder for StreamFilterIpv6Address with fluent API."""
    ...
    def with_ipv6_address(self, value: Optional[Ip6AddressString]) -> "StreamFilterIpv6AddressBuilder":
    ...
    def build(self) -> StreamFilterIpv6Address:
        """Build and return the StreamFilterIpv6Address instance with validation."""
