...
class DdsDurabilityService(ARObject):
    ...
    def serialize(self) -> ET.Element:
        ...
        if self.durability is not None:
            serialized = SerializationHelper.serialize_item(self.durability, "PositiveInteger")
...
class DdsDurabilityServiceBuilder(BuilderBase):
    """Builder for DdsDurabilityService with fluent API."""
    ...
    def with_durability(self, value: Optional[PositiveInteger]) -> "DdsDurabilityServiceBuilder":
    ...
    def build(self) -> DdsDurabilityService:
        """Build and return the DdsDurabilityService instance with validation."""
