...
class SomeipServiceVersionBuilder(BuilderBase):
    """Builder for SomeipServiceVersion with fluent API."""
    ...
    def with_major_version(self, value: Optional[PositiveInteger]) -> "SomeipServiceVersionBuilder":
    ...
    def with_minor_version(self, value: Optional[PositiveInteger]) -> "SomeipServiceVersionBuilder":
    ...
    def build(self) -> SomeipServiceVersion:
        """Build and return the SomeipServiceVersion instance with validation."""
