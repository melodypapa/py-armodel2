...
class RtpTpBuilder(TransportProtocolConfigurationBuilder):
    """Builder for RtpTp with fluent API."""
    ...
    def with_ssrc(self, value: Optional[PositiveInteger]) -> "RtpTpBuilder":
        """Set ssrc attribute.
    ...
    def with_tcp_udp_config(self, value: Optional[TcpUdpConfig]) -> "RtpTpBuilder":
        """Set tcp_udp_config attribute.
    ...
    def build(self) -> RtpTp:
        """Build and return the RtpTp instance with validation."""
