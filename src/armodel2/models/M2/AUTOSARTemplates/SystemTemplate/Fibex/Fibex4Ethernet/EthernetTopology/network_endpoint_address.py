...
class NetworkEndpointAddressBuilder(BuilderBase, ABC):
    """Builder for NetworkEndpointAddress with fluent API."""
    ...
    def build(self) -> NetworkEndpointAddress:
        """Build and return the NetworkEndpointAddress instance (abstract)."""
