...
class NmClusterBuilder(IdentifiableBuilder):
    ...
    def with_nm_channel(self, value: Optional[Boolean]) -> "NmClusterBuilder":
        ...
        """
        if value is None and not True:
            raise ValueError("Attribute 'nm_channel' is required and cannot be None")
    ...
    def with_nm_node_id_enabled(self, value: Optional[Boolean]) -> "NmClusterBuilder":
        ...
        """
        if value is None and not True:
            raise ValueError("Attribute 'nm_node_id_enabled' is required and cannot be None")
    ...
    def with_nm_pnc(self, value: Optional[Boolean]) -> "NmClusterBuilder":
        ...
        """
        if value is None and not True:
            raise ValueError("Attribute 'nm_pnc' is required and cannot be None")
    ...
    def with_nm_repeat_msg_ind_enabled(self, value: Optional[Boolean]) -> "NmClusterBuilder":
        ...
        """
        if value is None and not True:
            raise ValueError("Attribute 'nm_repeat_msg_ind_enabled' is required and cannot be None")
    ...
    def with_nm(self, value: Optional[Boolean]) -> "NmClusterBuilder":
        ...
        """
        if value is None and not True:
            raise ValueError("Attribute 'nm' is required and cannot be None")
        self._obj.nm = value
        return self
    ...
    def with_pnc_cluster(self, value: Optional[PositiveInteger]) -> "NmClusterBuilder":
        ...
        """
        if value is None and not True:
            raise ValueError("Attribute 'pnc_cluster' is required and cannot be None")
