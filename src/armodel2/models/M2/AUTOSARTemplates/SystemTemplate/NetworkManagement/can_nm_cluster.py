...
class CanNmCluster(NmCluster):
    ...
    _DESERIALIZE_DISPATCH = {
        "NM-BUSLOAD": lambda obj, elem: setattr(obj, "nm_busload", SerializationHelper.deserialize_by_tag(elem, "Boolean")),
        "NM-CAR-WAKE-UP": lambda obj, elem: setattr(obj, "nm_car_wake_up", SerializationHelper.deserialize_by_tag(elem, "PositiveInteger")),
        "NM-CAR-WAKE-UP-FILTER-NODE-ID": lambda obj, elem: setattr(obj, "nm_car_wake_up_filter_node_id", SerializationHelper.deserialize_by_tag(elem, "PositiveInteger")),
    ...
    def deserialize(cls, element: ET.Element) -> "CanNmCluster":
        ...
        for child in element:
            ...
            if tag == "NM-BUSLOAD":
                ...
                setattr(obj, "nm_car_wake_up", SerializationHelper.deserialize_by_tag(child, "PositiveInteger"))
            elif tag == "NM-CAR-WAKE-UP-FILTER-NODE-ID":
                setattr(obj, "nm_car_wake_up_filter_node_id", SerializationHelper.deserialize_by_tag(child, "PositiveInteger"))
            elif tag == "NM-CBV-POSITION":
...
class CanNmClusterBuilder(NmClusterBuilder):
