...
if TYPE_CHECKING:
    ...
    from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.PortInterface.sender_receiver_interface import (
        SenderReceiverInterface,
    )
    from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.PortInterface.data_interface import (
        DataInterface,
    )
    from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.PortInterface.nv_data_interface import (
        NvDataInterface,
    )
    from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.PortInterface.port_interface import (
        PortInterface,
    )
    from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.PortInterface.parameter_interface import (
        ParameterInterface,
    )
    ...
    from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.PortInterface.trigger_interface import (
        TriggerInterface,
    )
    from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.PortInterface.mode_switch_interface import (
        ModeSwitchInterface,
    )
    from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.PortInterface.port_interface_mapping_set import (
        PortInterfaceMappingSet,
    )
    from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.PortInterface.port_interface_mapping import (
        PortInterfaceMapping,
    )
    from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.PortInterface.variable_and_parameter_interface_mapping import (
        VariableAndParameterInterfaceMapping,
    )
    from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.PortInterface.data_prototype_mapping import (
        DataPrototypeMapping,
    )
    from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.PortInterface.client_server_interface_mapping import (
        ClientServerInterfaceMapping,
    )
    from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.PortInterface.client_server_operation_mapping import (
    ...
    from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.PortInterface.mode_interface_mapping import (
        ModeInterfaceMapping,
    )
    from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.PortInterface.mode_declaration_mapping_set import (
        ModeDeclarationMappingSet,
    )
    from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.PortInterface.mode_declaration_mapping import (
        ModeDeclarationMapping,
    )
    from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.PortInterface.trigger_interface_mapping import (
    ...
    from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.PortInterface.implementation_data_type_sub_element_ref import (
        ImplementationDataTypeSubElementRef,
    )
    from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.PortInterface.application_composite_data_type_sub_element_ref import (
...
from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.PortInterface.server_argument_impl_policy_enum import (
    ServerArgumentImplPolicyEnum,
)
from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.PortInterface.mapping_direction_enum import (
