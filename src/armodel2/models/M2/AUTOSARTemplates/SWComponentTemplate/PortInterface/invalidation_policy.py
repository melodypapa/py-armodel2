...
class InvalidationPolicyBuilder(BuilderBase):
    """Builder for InvalidationPolicy with fluent API."""
    ...
    def with_data_element(self, value: Optional[VariableDataPrototype]) -> "InvalidationPolicyBuilder":
    ...
    def with_handle_invalid_enum(self, value: Optional[HandleInvalidEnum]) -> "InvalidationPolicyBuilder":
    ...
    def build(self) -> InvalidationPolicy:
        """Build and return the InvalidationPolicy instance with validation."""
