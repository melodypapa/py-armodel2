...
class PortInterfaceMappingBuilder(IdentifiableBuilder):
    """Builder for PortInterfaceMapping with fluent API."""
    ...
    def build(self) -> PortInterfaceMapping:
        """Build and return the PortInterfaceMapping instance (abstract)."""
