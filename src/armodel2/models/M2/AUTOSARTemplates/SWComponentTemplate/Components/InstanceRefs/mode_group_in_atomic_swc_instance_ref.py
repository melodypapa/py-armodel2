...
class ModeGroupInAtomicSwcInstanceRef(ARObject, ABC):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(ModeGroupInAtomicSwcInstanceRef, self).serialize()
        ...
        if self.target_ref is not None:
            serialized = SerializationHelper.serialize_item(self.target_ref, "ModeDeclarationGroup")
            if serialized is not None:
                # Wrap with correct tag
    ...
    def deserialize(cls, element: ET.Element) -> "ModeGroupInAtomicSwcInstanceRef":
        ...
        obj = super(ModeGroupInAtomicSwcInstanceRef, cls).deserialize(element)
...
class ModeGroupInAtomicSwcInstanceRefBuilder(BuilderBase, ABC):
    """Builder for ModeGroupInAtomicSwcInstanceRef with fluent API."""
    ...
    def with_base(self, value: Optional[AtomicSwComponentType]) -> "ModeGroupInAtomicSwcInstanceRefBuilder":
        """Set base attribute.
    ...
    def with_context_port(self, value: Optional[PortPrototype]) -> "ModeGroupInAtomicSwcInstanceRefBuilder":
    ...
    def with_target(self, value: Optional[ModeDeclarationGroup]) -> "ModeGroupInAtomicSwcInstanceRefBuilder":
    ...
    def build(self) -> ModeGroupInAtomicSwcInstanceRef:
        """Build and return the ModeGroupInAtomicSwcInstanceRef instance (abstract)."""
