...
from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.Components.InstanceRefs.trigger_in_atomic_swc_instance_ref import TriggerInAtomicSwcInstanceRefBuilder
...
class PTriggerInAtomicSwcTypeInstanceRef(TriggerInAtomicSwcInstanceRef):
    ...
    _XML_TAG = "P-TRIGGER-IN-ATOMIC-SWC-TYPE-INSTANCE-REF"
...
class PTriggerInAtomicSwcTypeInstanceRefBuilder(TriggerInAtomicSwcInstanceRefBuilder):
    """Builder for PTriggerInAtomicSwcTypeInstanceRef with fluent API."""
    ...
    def with_context_p_port(self, value: Optional[AbstractProvidedPortPrototype]) -> "PTriggerInAtomicSwcTypeInstanceRefBuilder":
    ...
    def with_target_trigger(self, value: Optional[Trigger]) -> "PTriggerInAtomicSwcTypeInstanceRefBuilder":
    ...
    def build(self) -> PTriggerInAtomicSwcTypeInstanceRef:
        """Build and return the PTriggerInAtomicSwcTypeInstanceRef instance with validation."""
