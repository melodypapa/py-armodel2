...
class RTriggerInAtomicSwcInstanceRef(TriggerInAtomicSwcInstanceRef):
    ...
    _XML_TAG = "R-TRIGGER-IN-ATOMIC-SWC-INSTANCE-REF"
...
class RTriggerInAtomicSwcInstanceRefBuilder(TriggerInAtomicSwcInstanceRefBuilder):
    """Builder for RTriggerInAtomicSwcInstanceRef with fluent API."""
    ...
    def with_context_r_port(self, value: Optional[AbstractRequiredPortPrototype]) -> "RTriggerInAtomicSwcInstanceRefBuilder":
    ...
    def with_target_trigger(self, value: Optional[Trigger]) -> "RTriggerInAtomicSwcInstanceRefBuilder":
    ...
    def build(self) -> RTriggerInAtomicSwcInstanceRef:
        """Build and return the RTriggerInAtomicSwcInstanceRef instance with validation."""
