...
class RModeGroupInAtomicSWCInstanceRef(ModeGroupInAtomicSwcInstanceRef):
    ...
    _XML_TAG = "R-MODE-GROUP-IN-ATOMIC-SWC-INSTANCE-REF"
...
class RModeGroupInAtomicSWCInstanceRefBuilder(ModeGroupInAtomicSwcInstanceRefBuilder):
    ...
    def with_context_r_port(self, value: Optional[AbstractRequiredPortPrototype]) -> "RModeGroupInAtomicSWCInstanceRefBuilder":
