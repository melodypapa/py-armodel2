...
class InnerDataPrototypeGroupInCompositionInstanceRefBuilder(BuilderBase):
    """Builder for InnerDataPrototypeGroupInCompositionInstanceRef with fluent API."""
    ...
    def with_base(self, value: Optional[CompositionSwComponentType]) -> "InnerDataPrototypeGroupInCompositionInstanceRefBuilder":
        """Set base attribute.
    ...
    def with_target_data(self, value: Optional[DataPrototypeGroup]) -> "InnerDataPrototypeGroupInCompositionInstanceRefBuilder":
    ...
    def clear_context_sws(self) -> "InnerDataPrototypeGroupInCompositionInstanceRefBuilder":
    ...
    def build(self) -> InnerDataPrototypeGroupInCompositionInstanceRef:
        """Build and return the InnerDataPrototypeGroupInCompositionInstanceRef instance with validation."""
