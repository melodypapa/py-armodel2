...
class AutosarDataTypeBuilder(ARElementBuilder):
    """Builder for AutosarDataType with fluent API."""
    ...
    def with_sw_data_def_props(self, value: Optional[SwDataDefProps]) -> "AutosarDataTypeBuilder":
    ...
    def build(self) -> AutosarDataType:
        """Build and return the AutosarDataType instance (abstract)."""
