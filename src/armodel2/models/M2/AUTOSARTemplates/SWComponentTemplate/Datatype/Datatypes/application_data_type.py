...
class ApplicationDataTypeBuilder(AutosarDataTypeBuilder):
    """Builder for ApplicationDataType with fluent API."""
    ...
    def build(self) -> ApplicationDataType:
        """Build and return the ApplicationDataType instance (abstract)."""
