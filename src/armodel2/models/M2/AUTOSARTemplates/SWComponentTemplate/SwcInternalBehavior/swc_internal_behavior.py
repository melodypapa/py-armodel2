...
class SwcInternalBehavior(InternalBehavior):
    ...
    supports_multiple_instantiation: Optional[Boolean]
    ...
    _DESERIALIZE_DISPATCH = {
        ...
        "SUPPORTS-MULTIPLE-INSTANTIATION": lambda obj, elem: setattr(obj, "supports_multiple_instantiation", SerializationHelper.deserialize_by_tag(elem, "Boolean")),
    ...
    def __init__(self) -> None:
        ...
        self.supports_multiple_instantiation: Optional[Boolean] = None
    ...
    def serialize(self) -> ET.Element:
        ...
        # Serialize supports_multiple_instantiation
        if self.supports_multiple_instantiation is not None:
            serialized = SerializationHelper.serialize_item(self.supports_multiple_instantiation, "Boolean")
            if serialized is not None:
                # Wrap with correct tag
                wrapped = ET.Element("SUPPORTS-MULTIPLE-INSTANTIATION")
                if hasattr(serialized, 'attrib'):
                    wrapped.attrib.update(serialized.attrib)
                if serialized.text:
                    wrapped.text = serialized.text
    ...
    def deserialize(cls, element: ET.Element) -> "SwcInternalBehavior":
        ...
        for child in element:
            ...
            elif tag == "SUPPORTS-MULTIPLE-INSTANTIATION":
                setattr(obj, "supports_multiple_instantiation", SerializationHelper.deserialize_by_tag(child, "Boolean"))
...
class SwcInternalBehaviorBuilder(InternalBehaviorBuilder):
    ...
    def with_supports_multiple_instantiation(self, value: Optional[Boolean]) -> "SwcInternalBehaviorBuilder":
        """Set supports_multiple_instantiation attribute.
