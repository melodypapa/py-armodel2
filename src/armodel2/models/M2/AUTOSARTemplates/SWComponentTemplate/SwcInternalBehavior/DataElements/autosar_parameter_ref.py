...
class AutosarParameterRef(ARObject):
    ...
    def serialize(self) -> ET.Element:
        ...
        if self.local_parameter_ref is not None:
            serialized = SerializationHelper.serialize_item(self.local_parameter_ref, "DataPrototype")
            if serialized is not None:
                # Wrap with correct tag
...
class AutosarParameterRefBuilder(BuilderBase):
    """Builder for AutosarParameterRef with fluent API."""
    ...
    def build(self) -> AutosarParameterRef:
        """Build and return the AutosarParameterRef instance with validation."""
