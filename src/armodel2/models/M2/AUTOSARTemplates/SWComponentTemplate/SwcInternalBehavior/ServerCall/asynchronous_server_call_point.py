...
from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.SwcInternalBehavior.ServerCall.server_call_point import ServerCallPointBuilder
...
class AsynchronousServerCallPoint(ServerCallPoint):
    ...
    _XML_TAG = "ASYNCHRONOUS-SERVER-CALL-POINT"
...
class AsynchronousServerCallPointBuilder(ServerCallPointBuilder):
