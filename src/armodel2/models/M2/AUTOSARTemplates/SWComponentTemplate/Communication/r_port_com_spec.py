...
class RPortComSpec(ARObject, ABC):
    ...
    def serialize(self) -> ET.Element:
        """Serialize RPortComSpec to XML element.
        ...
        parent_elem = super(RPortComSpec, self).serialize()
    ...
    def deserialize(cls, element: ET.Element) -> "RPortComSpec":
        ...
        return super(RPortComSpec, cls).deserialize(element)



class RPortComSpecBuilder(BuilderBase, ABC):
    """Builder for RPortComSpec with fluent API."""
    ...
    def build(self) -> RPortComSpec:
        """Build and return the RPortComSpec instance (abstract)."""
