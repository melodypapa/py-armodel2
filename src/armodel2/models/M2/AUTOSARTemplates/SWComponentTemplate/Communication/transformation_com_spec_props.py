...
class TransformationComSpecProps(Describable, ABC):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(TransformationComSpecProps, self).serialize()
    ...
    def deserialize(cls, element: ET.Element) -> "TransformationComSpecProps":
        """Deserialize XML element to TransformationComSpecProps object.
...
class TransformationComSpecPropsBuilder(DescribableBuilder):
    """Builder for TransformationComSpecProps with fluent API."""
    ...
    def build(self) -> TransformationComSpecProps:
        """Build and return the TransformationComSpecProps instance (abstract)."""
