...
from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.Composition.instantiation_rte_event_props import InstantiationRTEEventPropsBuilder
...
class InstantiationTimingEventPropsBuilder(InstantiationRTEEventPropsBuilder):
    """Builder for InstantiationTimingEventProps with fluent API."""
    ...
    def with_period(self, value: Optional[TimeValue]) -> "InstantiationTimingEventPropsBuilder":
    ...
    def build(self) -> InstantiationTimingEventProps:
        """Build and return the InstantiationTimingEventProps instance with validation."""
