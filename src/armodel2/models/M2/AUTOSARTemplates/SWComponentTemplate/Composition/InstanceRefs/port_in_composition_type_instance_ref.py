...
class PortInCompositionTypeInstanceRef(ARObject, ABC):
    ...
    _DESERIALIZE_DISPATCH = {
        ...
        "TARGET-PORT-REF": ("_POLYMORPHIC", "target_port_ref", ["AbstractProvidedPortPrototype", "AbstractRequiredPortPrototype", "PPortPrototype", "PRPortPrototype", "RPortPrototype"]),
    }
    ...
    def serialize(self) -> ET.Element:
        ...
        if self.target_port_ref is not None:
            serialized = SerializationHelper.serialize_item(self.target_port_ref, "PortPrototype")
            if serialized is not None:
                # Wrap with correct tag
    ...
    def deserialize(cls, element: ET.Element) -> "PortInCompositionTypeInstanceRef":
        ...
        for child in element:
            ...
            if tag == "ABSTRACT-CONTEXT-COMPONENT-REF":
                ...
                setattr(obj, "target_port_ref", ARRef.deserialize(child))

        return obj



class PortInCompositionTypeInstanceRefBuilder(BuilderBase, ABC):
    """Builder for PortInCompositionTypeInstanceRef with fluent API."""
    ...
    def with_abstract_context_component(self, value: Optional[SwComponentPrototype]) -> "PortInCompositionTypeInstanceRefBuilder":
        ...
        if value is None and not True:
            raise ValueError("Attribute 'abstract_context_component' is required and cannot be None")
        self._obj.abstract_context_component = value
        return self

    def with_base(self, value: Optional[CompositionSwComponentType]) -> "PortInCompositionTypeInstanceRefBuilder":
        """Set base attribute.
    ...
    def with_target_port(self, value: Optional[PortPrototype]) -> "PortInCompositionTypeInstanceRefBuilder":
        ...
        """
        if value is None and not True:
            raise ValueError("Attribute 'target_port' is required and cannot be None")
    ...
    def build(self) -> PortInCompositionTypeInstanceRef:
        """Build and return the PortInCompositionTypeInstanceRef instance (abstract)."""
