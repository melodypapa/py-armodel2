...
class InstanceEventInCompositionInstanceRef(ARObject):
    ...
    _DESERIALIZE_DISPATCH = {
        ...
        "CONTEXT-PROTOTYPE-REFS": lambda obj, elem: obj.context_prototype_refs.append(ARRef.deserialize(elem)),
        ...
        for child in element:
            ...
            if tag == "BASE-REF":
                ...
                for item_elem in child:
                    obj.context_prototype_refs.append(SerializationHelper.deserialize_by_tag(item_elem, "any (SwComponent)"))
