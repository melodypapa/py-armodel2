...
from armodel2.models.M2.MSR.Documentation.BlockElements.RequirementsTracing.traceable import TraceableBuilder
...
class TimingConstraintBuilder(TraceableBuilder):
    """Builder for TimingConstraint with fluent API."""
    ...
    def with_timing_condition(self, value: Optional[TimingCondition]) -> "TimingConstraintBuilder":
    ...
    def build(self) -> TimingConstraint:
        """Build and return the TimingConstraint instance (abstract)."""
