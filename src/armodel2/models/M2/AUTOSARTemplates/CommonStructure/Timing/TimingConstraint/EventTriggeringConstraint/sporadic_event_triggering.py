...
class SporadicEventTriggering(EventTriggeringConstraint):
    ...
    _DESERIALIZE_DISPATCH = {
        ...
        "MAXIMUM-INTER": lambda obj, elem: setattr(obj, "maximum_inter", MultidimensionalTime.deserialize(elem)),
...
class SporadicEventTriggeringBuilder(EventTriggeringConstraintBuilder):
