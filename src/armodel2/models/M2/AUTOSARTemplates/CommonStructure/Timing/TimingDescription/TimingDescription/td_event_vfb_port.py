...
from armodel2.models.M2.AUTOSARTemplates.CommonStructure.Timing.TimingDescription.TimingDescription.td_event_vfb import TDEventVfbBuilder
...
class TDEventVfbPortBuilder(TDEventVfbBuilder):
    """Builder for TDEventVfbPort with fluent API."""
    ...
    def with_is_external(self, value: Optional[Boolean]) -> "TDEventVfbPortBuilder":
    ...
    def with_port(self, value: Optional[PortPrototype]) -> "TDEventVfbPortBuilder":
        """Set port attribute.
    ...
    def with_port_prototype(self, value: Optional[PortPrototypeBlueprint]) -> "TDEventVfbPortBuilder":
    ...
    def build(self) -> TDEventVfbPort:
        """Build and return the TDEventVfbPort instance (abstract)."""
