...
from armodel2.models.M2.AUTOSARTemplates.SWComponentTemplate.Datatype.Datatypes.autosar_data_type import AutosarDataTypeBuilder
...
class AbstractImplementationDataTypeBuilder(AutosarDataTypeBuilder):
    """Builder for AbstractImplementationDataType with fluent API."""
    ...
    def build(self) -> AbstractImplementationDataType:
        """Build and return the AbstractImplementationDataType instance (abstract)."""
