...
class TextValueSpecification(ValueSpecification):
    ...
    _XML_TAG = "TEXT-VALUE-SPECIFICATION"
...
class TextValueSpecificationBuilder(ValueSpecificationBuilder):
    """Builder for TextValueSpecification with fluent API."""
    ...
    def with_value(self, value: Optional[VerbatimString]) -> "TextValueSpecificationBuilder":
        """Set value attribute.
    ...
    def build(self) -> TextValueSpecification:
        """Build and return the TextValueSpecification instance with validation."""
