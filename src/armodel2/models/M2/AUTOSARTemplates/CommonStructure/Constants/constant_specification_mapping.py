...
class ConstantSpecificationMappingBuilder(BuilderBase):
    """Builder for ConstantSpecificationMapping with fluent API."""
    ...
    def with_appl_constant(self, value: Optional[ConstantSpecification]) -> "ConstantSpecificationMappingBuilder":
        """Set appl_constant attribute.
    ...
    def with_impl_constant(self, value: Optional[ConstantSpecification]) -> "ConstantSpecificationMappingBuilder":
        """Set impl_constant attribute.
    ...
    def build(self) -> ConstantSpecificationMapping:
        """Build and return the ConstantSpecificationMapping instance with validation."""
