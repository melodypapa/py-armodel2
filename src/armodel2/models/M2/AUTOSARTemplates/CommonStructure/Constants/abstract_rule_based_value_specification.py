...
class AbstractRuleBasedValueSpecificationBuilder(ValueSpecificationBuilder):
    """Builder for AbstractRuleBasedValueSpecification with fluent API."""
    ...
    def build(self) -> AbstractRuleBasedValueSpecification:
        """Build and return the AbstractRuleBasedValueSpecification instance (abstract)."""
