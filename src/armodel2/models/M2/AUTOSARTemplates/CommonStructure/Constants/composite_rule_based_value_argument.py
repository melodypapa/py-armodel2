...
class CompositeRuleBasedValueArgument(ARObject, ABC):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(CompositeRuleBasedValueArgument, self).serialize()
    ...
    def deserialize(cls, element: ET.Element) -> "CompositeRuleBasedValueArgument":
        ...
        return super(CompositeRuleBasedValueArgument, cls).deserialize(element)



class CompositeRuleBasedValueArgumentBuilder(BuilderBase, ABC):
    """Builder for CompositeRuleBasedValueArgument with fluent API."""
    ...
    def build(self) -> CompositeRuleBasedValueArgument:
        """Build and return the CompositeRuleBasedValueArgument instance (abstract)."""
