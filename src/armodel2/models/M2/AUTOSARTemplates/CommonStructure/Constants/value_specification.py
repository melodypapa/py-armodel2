...
class ValueSpecificationBuilder(BuilderBase, ABC):
    """Builder for ValueSpecification with fluent API."""
    ...
    def with_short_label(self, value: Optional[Identifier]) -> "ValueSpecificationBuilder":
    ...
    def build(self) -> ValueSpecification:
        """Build and return the ValueSpecification instance (abstract)."""
