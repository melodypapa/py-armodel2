...
class SwcBswSynchronizedTriggerBuilder(BuilderBase):
    """Builder for SwcBswSynchronizedTrigger with fluent API."""
    ...
    def with_bsw_trigger(self, value: Optional[Trigger]) -> "SwcBswSynchronizedTriggerBuilder":
        """Set bsw_trigger attribute.
    ...
    def with_swc_trigger(self, value: Optional[Trigger]) -> "SwcBswSynchronizedTriggerBuilder":
        """Set swc_trigger attribute.
    ...
    def build(self) -> SwcBswSynchronizedTrigger:
        """Build and return the SwcBswSynchronizedTrigger instance with validation."""
