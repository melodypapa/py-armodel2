...
class DiagnosticStorageConditionNeedsBuilder(DiagnosticCapabilityElementBuilder):
    ...
    def with_initial_status(self, value: Optional[StorageConditionStatusEnum]) -> "DiagnosticStorageConditionNeedsBuilder":
        ...
        if value is None and not True:
            raise ValueError("Attribute 'initial_status' is required and cannot be None")
