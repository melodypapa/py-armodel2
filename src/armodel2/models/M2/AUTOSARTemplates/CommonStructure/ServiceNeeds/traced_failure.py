...
class TracedFailureBuilder(IdentifiableBuilder):
    """Builder for TracedFailure with fluent API."""
    ...
    def with_id(self, value: Optional[PositiveInteger]) -> "TracedFailureBuilder":
        """Set id attribute.
    ...
    def build(self) -> TracedFailure:
        """Build and return the TracedFailure instance (abstract)."""
