...
class BlueprintMapping(ARObject):
    ...
    _DESERIALIZE_DISPATCH = {
        "BLUEPRINT-REF": lambda obj, elem: setattr(obj, "blueprint_ref", ARRef.deserialize(elem)),
        "DERIVED-OBJECT-REF": lambda obj, elem: setattr(obj, "derived_object_ref", ARRef.deserialize(elem)),
    }
