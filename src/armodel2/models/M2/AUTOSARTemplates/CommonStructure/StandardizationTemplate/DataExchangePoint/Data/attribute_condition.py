...
from armodel2.models.M2.AUTOSARTemplates.GenericStructure.GeneralTemplateClasses.ModelRestrictionTypes.abstract_multiplicity_restriction import AbstractMultiplicityRestrictionBuilder
...
class AttributeConditionBuilder(AbstractMultiplicityRestrictionBuilder):
    """Builder for AttributeCondition with fluent API."""
    ...
    def build(self) -> AttributeCondition:
        """Build and return the AttributeCondition instance (abstract)."""
