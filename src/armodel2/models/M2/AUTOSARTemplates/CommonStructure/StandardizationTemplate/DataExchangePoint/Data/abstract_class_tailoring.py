...
from armodel2.models.M2.AUTOSARTemplates.CommonStructure.StandardizationTemplate.DataExchangePoint.Common.data_format_element_reference import DataFormatElementReferenceBuilder
...
class AbstractClassTailoringBuilder(DataFormatElementReferenceBuilder):
    """Builder for AbstractClassTailoring with fluent API."""
    ...
    def build(self) -> AbstractClassTailoring:
        """Build and return the AbstractClassTailoring instance (abstract)."""
