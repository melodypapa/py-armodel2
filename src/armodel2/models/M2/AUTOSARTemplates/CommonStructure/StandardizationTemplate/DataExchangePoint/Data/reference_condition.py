...
class ReferenceCondition(AttributeCondition):
    ...
    _XML_TAG = "REFERENCE-CONDITION"


    reference_ref: ARRef
    _DESERIALIZE_DISPATCH = {
        "REFERENCE-REF": lambda obj, elem: setattr(obj, "reference_ref", ARRef.deserialize(elem)),
    }
    ...
    def serialize(self) -> ET.Element:
        ...
        if self.reference_ref is not None:
            serialized = SerializationHelper.serialize_item(self.reference_ref, "ReferenceTailoring")
...
class ReferenceConditionBuilder(AttributeConditionBuilder):
    """Builder for ReferenceCondition with fluent API."""
    ...
    def with_reference(self, value: ReferenceTailoring) -> "ReferenceConditionBuilder":
        ...
        if value is None and not False:
            raise ValueError("Attribute 'reference' is required and cannot be None")
        self._obj.reference = value
        return self
    ...
    def build(self) -> ReferenceCondition:
        """Build and return the ReferenceCondition instance with validation."""
