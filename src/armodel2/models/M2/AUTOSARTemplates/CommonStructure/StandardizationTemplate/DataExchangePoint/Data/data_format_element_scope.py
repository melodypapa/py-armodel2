...
from armodel2.models.M2.AUTOSARTemplates.CommonStructure.StandardizationTemplate.DataExchangePoint.Common.spec_element_scope import SpecElementScopeBuilder
...
class DataFormatElementScope(SpecElementScope, ABC):
    ...
    def serialize(self) -> ET.Element:
        """Serialize DataFormatElementScope to XML element.
        ...
        parent_elem = super(DataFormatElementScope, self).serialize()
    ...
    def deserialize(cls, element: ET.Element) -> "DataFormatElementScope":
        ...
        return super(DataFormatElementScope, cls).deserialize(element)



class DataFormatElementScopeBuilder(SpecElementScopeBuilder):
    """Builder for DataFormatElementScope with fluent API."""
    ...
    def build(self) -> DataFormatElementScope:
        """Build and return the DataFormatElementScope instance (abstract)."""
