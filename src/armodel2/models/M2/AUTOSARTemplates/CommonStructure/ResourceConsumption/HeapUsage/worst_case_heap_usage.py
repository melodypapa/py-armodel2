...
class WorstCaseHeapUsage(HeapUsage):
    ...
    _XML_TAG = "WORST-CASE-HEAP-USAGE"
...
class WorstCaseHeapUsageBuilder(HeapUsageBuilder):
    ...
    def with_memory_consumption(self, value: Optional[PositiveInteger]) -> "WorstCaseHeapUsageBuilder":
        ...
        if value is None and not True:
            raise ValueError("Attribute 'memory_consumption' is required and cannot be None")
