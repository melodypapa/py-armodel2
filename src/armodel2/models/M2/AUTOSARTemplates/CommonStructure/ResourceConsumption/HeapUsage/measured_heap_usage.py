...
from armodel2.models.M2.AUTOSARTemplates.CommonStructure.ResourceConsumption.HeapUsage.heap_usage import HeapUsageBuilder
...
class MeasuredHeapUsageBuilder(HeapUsageBuilder):
