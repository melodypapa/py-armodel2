...
class AbstractEventBuilder(IdentifiableBuilder):
    """Builder for AbstractEvent with fluent API."""
    ...
    def with_activation(self, value: Optional[ExecutableEntity]) -> "AbstractEventBuilder":
        ...
        if value is None and not True:
            raise ValueError("Attribute 'activation' is required and cannot be None")
    ...
    def build(self) -> AbstractEvent:
        """Build and return the AbstractEvent instance (abstract)."""
