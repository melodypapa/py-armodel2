...
class ModeDeclarationGroupPrototypeMappingBuilder(BuilderBase):
    """Builder for ModeDeclarationGroupPrototypeMapping with fluent API."""
    ...
    def with_first_mode_group_prototype(self, value: Optional[ModeDeclarationGroup]) -> "ModeDeclarationGroupPrototypeMappingBuilder":
        """Set first_mode_group_prototype attribute.
    ...
    def with_mode(self, value: Optional[ModeDeclaration]) -> "ModeDeclarationGroupPrototypeMappingBuilder":
        """Set mode attribute.
    ...
    def with_second_mode(self, value: Optional[ModeDeclarationGroup]) -> "ModeDeclarationGroupPrototypeMappingBuilder":
    ...
    def build(self) -> ModeDeclarationGroupPrototypeMapping:
        """Build and return the ModeDeclarationGroupPrototypeMapping instance with validation."""
