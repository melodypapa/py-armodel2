...
class RtePluginProps(ARObject):
    ...
    _XML_TAG = "RTE-PLUGIN-PROPS"


    associated_ref: Optional[ARRef]
    associated_rte_ref: Optional[ARRef]
    _DESERIALIZE_DISPATCH = {
        "ASSOCIATED-REF": lambda obj, elem: setattr(obj, "associated_ref", ARRef.deserialize(elem)),
        "ASSOCIATED-RTE-REF": lambda obj, elem: setattr(obj, "associated_rte_ref", ARRef.deserialize(elem)),
    }
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(RtePluginProps, self).serialize()
...
class RtePluginPropsBuilder(BuilderBase):
    """Builder for RtePluginProps with fluent API."""
    ...
    def with_associated(self, value: Optional[EcucContainerValue]) -> "RtePluginPropsBuilder":
    ...
    def with_associated_rte(self, value: Optional[EcucContainerValue]) -> "RtePluginPropsBuilder":
        """Set associated_rte attribute.
    ...
    def build(self) -> RtePluginProps:
        """Build and return the RtePluginProps instance with validation."""
