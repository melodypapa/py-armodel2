...
class SecurityEventContextData(ARObject):
    ...
    _XML_TAG = "SECURITY-EVENT-CONTEXT-DATA"
...
class SecurityEventContextDataBuilder(BuilderBase):
    """Builder for SecurityEventContextData with fluent API."""
    ...
    def build(self) -> SecurityEventContextData:
        """Build and return the SecurityEventContextData instance with validation."""
