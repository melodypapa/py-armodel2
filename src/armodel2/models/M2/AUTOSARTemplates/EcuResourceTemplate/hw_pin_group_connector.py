...
class HwPinGroupConnector(Describable):
    ...
    _XML_TAG = "HW-PIN-GROUP-CONNECTOR"
    ...
    def deserialize(cls, element: ET.Element) -> "HwPinGroupConnector":
        ...
        for child in element:
            ...
            if tag == "HW-PINS":
                obj.hw_pins.append(SerializationHelper.deserialize_by_tag(child, "HwPinConnector"))
            elif tag == "HW-PIN-GROUPS":
                obj.hw_pin_group_refs.append(ARRef.deserialize(child))

        return obj



class HwPinGroupConnectorBuilder(DescribableBuilder):
