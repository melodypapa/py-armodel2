    ...
    def deserialize(cls, element: ET.Element) -> "HwElement":
        ...
        for child in element:
            ...
            if tag == "HW-ELEMENT-CONNECTIONS":
                obj.hw_element_connections.append(SerializationHelper.deserialize_by_tag(child, "HwElementConnector"))
            elif tag == "HW-PIN-GROUPS":
                obj.hw_pin_groups.append(SerializationHelper.deserialize_by_tag(child, "HwPinGroup"))
