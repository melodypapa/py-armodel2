...
class BswModeSwitchAckRequest(ARObject):
    ...
    _XML_TAG = "BSW-MODE-SWITCH-ACK-REQUEST"
...
class BswModeSwitchAckRequestBuilder(BuilderBase):
    """Builder for BswModeSwitchAckRequest with fluent API."""
    ...
    def with_timeout(self, value: Optional[TimeValue]) -> "BswModeSwitchAckRequestBuilder":
    ...
    def build(self) -> BswModeSwitchAckRequest:
        """Build and return the BswModeSwitchAckRequest instance with validation."""
