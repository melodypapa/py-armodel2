...
class BswModeManagerErrorEvent(BswScheduleEvent):
    ...
    _XML_TAG = "BSW-MODE-MANAGER-ERROR-EVENT"
...
class BswModeManagerErrorEventBuilder(BswScheduleEventBuilder):
    ...
    def with_mode_group(self, value: Optional[ModeDeclarationGroupPrototype]) -> "BswModeManagerErrorEventBuilder":
