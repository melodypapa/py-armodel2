...
class BswDataReceptionPolicyBuilder(BuilderBase, ABC):
    """Builder for BswDataReceptionPolicy with fluent API."""
    ...
    def build(self) -> BswDataReceptionPolicy:
        """Build and return the BswDataReceptionPolicy instance (abstract)."""
