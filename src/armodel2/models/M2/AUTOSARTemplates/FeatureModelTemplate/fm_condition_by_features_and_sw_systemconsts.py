...
class FMConditionByFeaturesAndSwSystemconsts(ARObject):
    ...
    _XML_TAG = "F-M-CONDITION-BY-FEATURES-AND-SW-SYSTEMCONSTS"
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(FMConditionByFeaturesAndSwSystemconsts, self).serialize()
    ...
    def deserialize(cls, element: ET.Element) -> "FMConditionByFeaturesAndSwSystemconsts":
        ...
        return super(FMConditionByFeaturesAndSwSystemconsts, cls).deserialize(element)



class FMConditionByFeaturesAndSwSystemconstsBuilder(BuilderBase):
    """Builder for FMConditionByFeaturesAndSwSystemconsts with fluent API."""
    ...
    def build(self) -> FMConditionByFeaturesAndSwSystemconsts:
        """Build and return the FMConditionByFeaturesAndSwSystemconsts instance with validation."""
