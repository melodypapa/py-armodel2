...
class FMConditionByFeaturesAndAttributes(ARObject):
    ...
    _XML_TAG = "F-M-CONDITION-BY-FEATURES-AND-ATTRIBUTES"
...
class FMConditionByFeaturesAndAttributesBuilder(BuilderBase):
    """Builder for FMConditionByFeaturesAndAttributes with fluent API."""
    ...
    def build(self) -> FMConditionByFeaturesAndAttributes:
        """Build and return the FMConditionByFeaturesAndAttributes instance with validation."""
