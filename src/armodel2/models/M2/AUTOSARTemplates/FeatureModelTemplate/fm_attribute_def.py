...
class FMAttributeDef(Identifiable):
    ...
    _DESERIALIZE_DISPATCH = {
        "DEFAULT-VALUE": lambda obj, elem: setattr(obj, "default_value", SerializationHelper.deserialize_by_tag(elem, "Numerical")),
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(FMAttributeDef, self).serialize()
    ...
    def deserialize(cls, element: ET.Element) -> "FMAttributeDef":
        ...
        for child in element:
            ...
            if tag == "DEFAULT-VALUE":
                setattr(obj, "default_value", SerializationHelper.deserialize_by_tag(child, "Numerical"))
            elif tag == "MAX":
...
class FMAttributeDefBuilder(IdentifiableBuilder):
    """Builder for FMAttributeDef with fluent API."""
    ...
    def with_default_value(self, value: Optional[Numerical]) -> "FMAttributeDefBuilder":
    ...
    def with_max(self, value: Optional[Limit]) -> "FMAttributeDefBuilder":
        """Set max attribute.
    ...
    def with_min(self, value: Optional[Limit]) -> "FMAttributeDefBuilder":
        """Set min attribute.
    ...
    def build(self) -> FMAttributeDef:
        """Build and return the FMAttributeDef instance with validation."""
