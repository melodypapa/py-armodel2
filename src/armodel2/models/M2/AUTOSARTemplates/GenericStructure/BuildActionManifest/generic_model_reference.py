...
class GenericModelReference(ARObject):
    ...
    _DESERIALIZE_DISPATCH = {
        "BASE": lambda obj, elem: setattr(obj, "base", SerializationHelper.deserialize_by_tag(elem, "NameToken")),
        "DEST": lambda obj, elem: setattr(obj, "dest", SerializationHelper.deserialize_by_tag(elem, "NameToken")),
    ...
    def deserialize(cls, element: ET.Element) -> "GenericModelReference":
        ...
        for child in element:
            ...
            if tag == "BASE":
                setattr(obj, "base", SerializationHelper.deserialize_by_tag(child, "NameToken"))
            elif tag == "DEST":
                setattr(obj, "dest", SerializationHelper.deserialize_by_tag(child, "NameToken"))
            elif tag == "REF-REF":
...
class GenericModelReferenceBuilder(BuilderBase):
    """Builder for GenericModelReference with fluent API."""
    ...
    def with_base(self, value: NameToken) -> "GenericModelReferenceBuilder":
        """Set base attribute.
    ...
    def with_dest(self, value: NameToken) -> "GenericModelReferenceBuilder":
        """Set dest attribute.
    ...
    def with_ref(self, value: Ref) -> "GenericModelReferenceBuilder":
        """Set ref attribute.
    ...
    def build(self) -> GenericModelReference:
        """Build and return the GenericModelReference instance with validation."""
