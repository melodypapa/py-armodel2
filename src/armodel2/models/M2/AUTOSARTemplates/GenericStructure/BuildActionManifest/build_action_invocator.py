...
class BuildActionInvocatorBuilder(BuilderBase):
    """Builder for BuildActionInvocator with fluent API."""
    ...
    def with_command(self, value: Optional[VerbatimString]) -> "BuildActionInvocatorBuilder":
        ...
        if value is None and not True:
            raise ValueError("Attribute 'command' is required and cannot be None")
        self._obj.command = value
        return self
    ...
    def build(self) -> BuildActionInvocator:
        """Build and return the BuildActionInvocator instance with validation."""
