...
class SwSystemconstValue(ARObject):
    ...
    def serialize(self) -> ET.Element:
        ...
        if self.sw_systemconst_ref is not None:
            serialized = SerializationHelper.serialize_item(self.sw_systemconst_ref, "SwSystemconst")
            if serialized is not None:
...
class SwSystemconstValueBuilder(BuilderBase):
    """Builder for SwSystemconstValue with fluent API."""
    ...
    def with_annotations(self, items: list[Annotation]) -> "SwSystemconstValueBuilder":
    ...
    def with_sw_systemconst(self, value: SwSystemconst) -> "SwSystemconstValueBuilder":
        """Set sw_systemconst attribute.
    ...
    def with_value(self, value: Numerical) -> "SwSystemconstValueBuilder":
        """Set value attribute.
    ...
    def add_annotation(self, item: Annotation) -> "SwSystemconstValueBuilder":
    ...
    def clear_annotations(self) -> "SwSystemconstValueBuilder":
    ...
    def _validate_instance(self) -> None:
        ...
        if getattr(self._obj, "swSystemconst", None) is None:
            if mode == BuilderValidationMode.STRICT:
                raise ValueError(f"Required attribute 'swSystemconst' is None")
            elif mode == BuilderValidationMode.LENIENT:
                import warnings
                warnings.warn(f"Required attribute 'swSystemconst' is None", UserWarning)
    ...
    def build(self) -> SwSystemconstValue:
        """Build and return the SwSystemconstValue instance with validation."""
