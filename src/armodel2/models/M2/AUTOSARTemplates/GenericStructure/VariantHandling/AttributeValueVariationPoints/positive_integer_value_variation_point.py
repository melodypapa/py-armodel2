...
class PositiveIntegerValueVariationPoint(ARObject):
    ...
    _XML_TAG = "POSITIVE-INTEGER-VALUE-VARIATION-POINT"
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(PositiveIntegerValueVariationPoint, self).serialize()
    ...
    def deserialize(cls, element: ET.Element) -> "PositiveIntegerValueVariationPoint":
        ...
        return super(PositiveIntegerValueVariationPoint, cls).deserialize(element)



class PositiveIntegerValueVariationPointBuilder(BuilderBase):
    """Builder for PositiveIntegerValueVariationPoint with fluent API."""
    ...
    def build(self) -> PositiveIntegerValueVariationPoint:
        """Build and return the PositiveIntegerValueVariationPoint instance with validation."""
