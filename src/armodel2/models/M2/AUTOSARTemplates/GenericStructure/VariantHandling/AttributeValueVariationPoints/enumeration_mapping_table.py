...
from armodel2.models.M2.AUTOSARTemplates.GenericStructure.GeneralTemplateClasses.ARPackage.packageable_element import PackageableElementBuilder
...
class EnumerationMappingTable(PackageableElement):
    ...
    _XML_TAG = "ENUMERATION-MAPPING-TABLE"


    entry_refs: list[Any]
    _DESERIALIZE_DISPATCH = {
        "ENTRIES": lambda obj, elem: obj.entry_refs.append(ARRef.deserialize(elem)),
    }
    ...
    def deserialize(cls, element: ET.Element) -> "EnumerationMappingTable":
        ...
        for child in element:
            ...
            if tag == "ENTRIES":
                obj.entry_refs.append(ARRef.deserialize(child))

        return obj



class EnumerationMappingTableBuilder(PackageableElementBuilder):
