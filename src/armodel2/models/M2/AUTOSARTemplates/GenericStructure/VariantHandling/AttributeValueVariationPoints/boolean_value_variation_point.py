...
class BooleanValueVariationPoint(ARObject):
    ...
    _XML_TAG = "BOOLEAN-VALUE-VARIATION-POINT"
...
class BooleanValueVariationPointBuilder(BuilderBase):
    """Builder for BooleanValueVariationPoint with fluent API."""
    ...
    def build(self) -> BooleanValueVariationPoint:
        """Build and return the BooleanValueVariationPoint instance with validation."""
