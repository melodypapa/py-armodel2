...
class TimeValueValueVariationPoint(ARObject):
    ...
    _XML_TAG = "TIME-VALUE-VALUE-VARIATION-POINT"
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(TimeValueValueVariationPoint, self).serialize()
    ...
    def deserialize(cls, element: ET.Element) -> "TimeValueValueVariationPoint":
        ...
        return super(TimeValueValueVariationPoint, cls).deserialize(element)



class TimeValueValueVariationPointBuilder(BuilderBase):
    """Builder for TimeValueValueVariationPoint with fluent API."""
    ...
    def build(self) -> TimeValueValueVariationPoint:
        """Build and return the TimeValueValueVariationPoint instance with validation."""
