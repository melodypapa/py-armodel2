...
class FloatValueVariationPoint(ARObject):
    ...
    _XML_TAG = "FLOAT-VALUE-VARIATION-POINT"
...
class FloatValueVariationPointBuilder(BuilderBase):
    """Builder for FloatValueVariationPoint with fluent API."""
    ...
    def build(self) -> FloatValueVariationPoint:
        """Build and return the FloatValueVariationPoint instance with validation."""
