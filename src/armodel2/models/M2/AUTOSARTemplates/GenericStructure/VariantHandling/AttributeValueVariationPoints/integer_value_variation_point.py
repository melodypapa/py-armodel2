...
class IntegerValueVariationPoint(ARObject):
    ...
    _XML_TAG = "INTEGER-VALUE-VARIATION-POINT"
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(IntegerValueVariationPoint, self).serialize()
    ...
    def deserialize(cls, element: ET.Element) -> "IntegerValueVariationPoint":
        ...
        return super(IntegerValueVariationPoint, cls).deserialize(element)



class IntegerValueVariationPointBuilder(BuilderBase):
    """Builder for IntegerValueVariationPoint with fluent API."""
    ...
    def build(self) -> IntegerValueVariationPoint:
        """Build and return the IntegerValueVariationPoint instance with validation."""
