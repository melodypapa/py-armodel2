...
class PostBuildVariantCriterionValue(ARObject):
    ...
    _XML_TAG = "POST-BUILD-VARIANT-CRITERION-VALUE"
...
class PostBuildVariantCriterionValueBuilder(BuilderBase):
    """Builder for PostBuildVariantCriterionValue with fluent API."""
    ...
    def with_annotations(self, items: list[Annotation]) -> "PostBuildVariantCriterionValueBuilder":
    ...
    def with_value(self, value: Integer) -> "PostBuildVariantCriterionValueBuilder":
        """Set value attribute.
    ...
    def add_annotation(self, item: Annotation) -> "PostBuildVariantCriterionValueBuilder":
    ...
    def clear_annotations(self) -> "PostBuildVariantCriterionValueBuilder":
    ...
    def build(self) -> PostBuildVariantCriterionValue:
        """Build and return the PostBuildVariantCriterionValue instance with validation."""
