...
class AtpStructureElementBuilder(IdentifiableBuilder):
    """Builder for AtpStructureElement with fluent API."""
    ...
    def build(self) -> AtpStructureElement:
        """Build and return the AtpStructureElement instance (abstract)."""
