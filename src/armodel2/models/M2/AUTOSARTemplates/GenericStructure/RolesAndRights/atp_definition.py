...
class AtpDefinition(Referrable, ABC):
    ...
    def serialize(self) -> ET.Element:
        """Serialize AtpDefinition to XML element.
        ...
        parent_elem = super(AtpDefinition, self).serialize()
    ...
    def deserialize(cls, element: ET.Element) -> "AtpDefinition":
        ...
        return super(AtpDefinition, cls).deserialize(element)



class AtpDefinitionBuilder(ReferrableBuilder):
    """Builder for AtpDefinition with fluent API."""
    ...
    def build(self) -> AtpDefinition:
        """Build and return the AtpDefinition instance (abstract)."""
