...
from armodel2.models.M2.AUTOSARTemplates.GenericStructure.GeneralTemplateClasses.ElementCollection.collectable_element import CollectableElementBuilder
...
class PackageableElementBuilder(CollectableElementBuilder):
    """Builder for PackageableElement with fluent API."""
    ...
    def build(self) -> PackageableElement:
        """Build and return the PackageableElement instance (abstract)."""
