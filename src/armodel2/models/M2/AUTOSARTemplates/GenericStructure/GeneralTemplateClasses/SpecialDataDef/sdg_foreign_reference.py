...
class SdgForeignReference(SdgAbstractForeignReference):
    ...
    _XML_TAG = "SDG-FOREIGN-REFERENCE"
...
class SdgForeignReferenceBuilder(SdgAbstractForeignReferenceBuilder):
    """Builder for SdgForeignReference with fluent API."""
    ...
    def build(self) -> SdgForeignReference:
        """Build and return the SdgForeignReference instance with validation."""
