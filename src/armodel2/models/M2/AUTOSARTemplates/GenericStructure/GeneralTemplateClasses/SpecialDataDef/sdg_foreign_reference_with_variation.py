...
from armodel2.models.M2.AUTOSARTemplates.GenericStructure.GeneralTemplateClasses.SpecialDataDef.sdg_abstract_foreign_reference import SdgAbstractForeignReferenceBuilder
...
class SdgForeignReferenceWithVariation(SdgAbstractForeignReference):
    ...
    _XML_TAG = "SDG-FOREIGN-REFERENCE-WITH-VARIATION"
...
class SdgForeignReferenceWithVariationBuilder(SdgAbstractForeignReferenceBuilder):
    """Builder for SdgForeignReferenceWithVariation with fluent API."""
    ...
    def build(self) -> SdgForeignReferenceWithVariation:
        """Build and return the SdgForeignReferenceWithVariation instance with validation."""
