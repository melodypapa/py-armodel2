...
from armodel2.models.M2.AUTOSARTemplates.DiagnosticExtract.DiagnosticContribution import (
...
class DiagnosticEcuInstanceProps(DiagnosticCommonElement):
    ...
    _DESERIALIZE_DISPATCH = {
        "ECU-INSTANCE-REFS": lambda obj, elem: [obj.ecu_instance_refs.append(ARRef.deserialize(item_elem)) for item_elem in elem],
        ...
        for child in element:
            ...
            if tag == "ECU-INSTANCE-REFS":
                ...
                for item_elem in child:
                    obj.ecu_instance_refs.append(ARRef.deserialize(item_elem))
...
class DiagnosticEcuInstancePropsBuilder(DiagnosticCommonElementBuilder):
    ...
    def with_obd_support(self, value: Optional[DiagnosticObdSupportEnum]) -> "DiagnosticEcuInstancePropsBuilder":
        ...
        if value is None and not True:
            raise ValueError("Attribute 'obd_support' is required and cannot be None")
