...
class DiagnosticRequestOnBoardMonitoringTestResultsClass(DiagnosticServiceClass):
    ...
    _XML_TAG = "DIAGNOSTIC-REQUEST-ON-BOARD-MONITORING-TEST-RESULTS-CLASS"
...
class DiagnosticRequestOnBoardMonitoringTestResultsClassBuilder(DiagnosticServiceClassBuilder):
