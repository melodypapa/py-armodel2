...
class DiagnosticRequestEmissionRelatedDTCPermanentStatusClass(DiagnosticServiceClass):
    ...
    _XML_TAG = "DIAGNOSTIC-REQUEST-EMISSION-RELATED-D-T-C-PERMANENT-STATUS-CLASS"
...
class DiagnosticRequestEmissionRelatedDTCPermanentStatusClassBuilder(DiagnosticServiceClassBuilder):
