...
class DiagnosticRequestEmissionRelatedDTCPermanentStatus(DiagnosticServiceInstance):
    ...
    _XML_TAG = "DIAGNOSTIC-REQUEST-EMISSION-RELATED-D-T-C-PERMANENT-STATUS"
...
class DiagnosticRequestEmissionRelatedDTCPermanentStatusBuilder(DiagnosticServiceInstanceBuilder):
