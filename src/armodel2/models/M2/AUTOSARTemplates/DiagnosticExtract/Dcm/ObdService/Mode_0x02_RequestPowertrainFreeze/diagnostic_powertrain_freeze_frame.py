...
class DiagnosticPowertrainFreezeFrame(DiagnosticCommonElement):
    ...
    _XML_TAG = "DIAGNOSTIC-POWERTRAIN-FREEZE-FRAME"


    pid_refs: list[ARRef]
    _DESERIALIZE_DISPATCH = {
        "PID-REFS": lambda obj, elem: obj.pid_refs.append(ARRef.deserialize(elem)),
    }
        ...
        for child in element:
            ...
            if tag == "PID-REFS":
                ...
                for item_elem in child:
                    obj.pid_refs.append(SerializationHelper.deserialize_by_tag(item_elem, "DiagnosticParameter"))

        return obj



class DiagnosticPowertrainFreezeFrameBuilder(DiagnosticCommonElementBuilder):
