...
class DiagnosticEnvModeElementBuilder(ReferrableBuilder):
    """Builder for DiagnosticEnvModeElement with fluent API."""
    ...
    def build(self) -> DiagnosticEnvModeElement:
        """Build and return the DiagnosticEnvModeElement instance (abstract)."""
