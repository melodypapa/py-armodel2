...
from armodel2.models.M2.AUTOSARTemplates.DiagnosticExtract.Dcm.EnvironmentalCondition.diagnostic_env_mode_element import DiagnosticEnvModeElementBuilder
...
class DiagnosticEnvSwcModeElement(DiagnosticEnvModeElement):
    ...
    _XML_TAG = "DIAGNOSTIC-ENV-SWC-MODE-ELEMENT"
    ...
    def serialize(self) -> ET.Element:
        """Serialize DiagnosticEnvSwcModeElement to XML element.
        ...
        parent_elem = super(DiagnosticEnvSwcModeElement, self).serialize()
        ...
        if self.mode is not None:
            serialized = SerializationHelper.serialize_item(self.mode, "ModeDeclaration")
    ...
    def deserialize(cls, element: ET.Element) -> "DiagnosticEnvSwcModeElement":
        """Deserialize XML element to DiagnosticEnvSwcModeElement object.

        Args:
            element: XML element to deserialize from

        Returns:
            Deserialized DiagnosticEnvSwcModeElement object
        """
...
class DiagnosticEnvSwcModeElementBuilder(DiagnosticEnvModeElementBuilder):
    """Builder for DiagnosticEnvSwcModeElement with fluent API."""
    ...
    def with_mode(self, value: Optional[ModeDeclaration]) -> "DiagnosticEnvSwcModeElementBuilder":
        """Set mode attribute.
    ...
    def build(self) -> DiagnosticEnvSwcModeElement:
        """Build and return the DiagnosticEnvSwcModeElement instance with validation."""
