...
class DiagnosticEnvBswModeElement(DiagnosticEnvModeElement):
    ...
    _XML_TAG = "DIAGNOSTIC-ENV-BSW-MODE-ELEMENT"
...
class DiagnosticEnvBswModeElementBuilder(DiagnosticEnvModeElementBuilder):
    """Builder for DiagnosticEnvBswModeElement with fluent API."""
    ...
    def with_mode(self, value: Optional[ModeDeclaration]) -> "DiagnosticEnvBswModeElementBuilder":
        """Set mode attribute.
    ...
    def build(self) -> DiagnosticEnvBswModeElement:
        """Build and return the DiagnosticEnvBswModeElement instance with validation."""
