...
class DiagnosticServiceClassBuilder(DiagnosticCommonElementBuilder):
    """Builder for DiagnosticServiceClass with fluent API."""
    ...
    def build(self) -> DiagnosticServiceClass:
        """Build and return the DiagnosticServiceClass instance (abstract)."""
