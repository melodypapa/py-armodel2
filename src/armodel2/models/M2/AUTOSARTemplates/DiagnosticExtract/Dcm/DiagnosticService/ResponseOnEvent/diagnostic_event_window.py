...
class DiagnosticEventWindowBuilder(BuilderBase):
    """Builder for DiagnosticEventWindow with fluent API."""
    ...
    def with_event_window(self, value: Optional[DiagnosticEventWindow]) -> "DiagnosticEventWindowBuilder":
        """Set event_window attribute.
    ...
    def build(self) -> DiagnosticEventWindow:
        """Build and return the DiagnosticEventWindow instance with validation."""
