...
class DiagnosticRequestFileTransfer(DiagnosticServiceInstance):
    ...
    _XML_TAG = "DIAGNOSTIC-REQUEST-FILE-TRANSFER"


    request_file_ref: Optional[Any]
    _DESERIALIZE_DISPATCH = {
        "REQUEST-FILE-REF": lambda obj, elem: setattr(obj, "request_file_ref", ARRef.deserialize(elem)),
    }
    ...
    def deserialize(cls, element: ET.Element) -> "DiagnosticRequestFileTransfer":
        ...
        for child in element:
            ...
            if tag == "REQUEST-FILE-REF":
                setattr(obj, "request_file_ref", ARRef.deserialize(child))

        return obj



class DiagnosticRequestFileTransferBuilder(DiagnosticServiceInstanceBuilder):
