...
class DiagnosticRoutineControl(DiagnosticServiceInstance):
    ...
    _XML_TAG = "DIAGNOSTIC-ROUTINE-CONTROL"
    ...
    _DESERIALIZE_DISPATCH = {
        ...
        "ROUTINE-CONTROL-REF": lambda obj, elem: setattr(obj, "routine_control_ref", ARRef.deserialize(elem)),
    }
...
class DiagnosticRoutineControlBuilder(DiagnosticServiceInstanceBuilder):
    ...
    def with_routine_control(self, value: Optional[DiagnosticRoutine]) -> "DiagnosticRoutineControlBuilder":
        ...
        """
        if value is None and not True:
            raise ValueError("Attribute 'routine_control' is required and cannot be None")
