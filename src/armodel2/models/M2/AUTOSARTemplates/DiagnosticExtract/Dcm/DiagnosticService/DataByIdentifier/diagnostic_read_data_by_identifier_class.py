...
class DiagnosticReadDataByIdentifierClassBuilder(DiagnosticServiceClassBuilder):
    ...
    def with_max_did_to_read(self, value: Optional[PositiveInteger]) -> "DiagnosticReadDataByIdentifierClassBuilder":
        ...
        if value is None and not True:
            raise ValueError("Attribute 'max_did_to_read' is required and cannot be None")
