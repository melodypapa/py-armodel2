...
class DiagnosticPeriodicRateBuilder(BuilderBase):
    """Builder for DiagnosticPeriodicRate with fluent API."""
    ...
    def with_period(self, value: Optional[TimeValue]) -> "DiagnosticPeriodicRateBuilder":
    ...
    def with_periodic_rate(self, value: Optional[DiagnosticPeriodicRate]) -> "DiagnosticPeriodicRateBuilder":
        """Set periodic_rate attribute.
    ...
    def build(self) -> DiagnosticPeriodicRate:
        """Build and return the DiagnosticPeriodicRate instance with validation."""
