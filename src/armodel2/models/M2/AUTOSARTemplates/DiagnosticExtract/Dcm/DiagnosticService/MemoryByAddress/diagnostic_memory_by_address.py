...
class DiagnosticMemoryByAddressBuilder(DiagnosticServiceInstanceBuilder):
    """Builder for DiagnosticMemoryByAddress with fluent API."""
    ...
    def build(self) -> DiagnosticMemoryByAddress:
        """Build and return the DiagnosticMemoryByAddress instance (abstract)."""
