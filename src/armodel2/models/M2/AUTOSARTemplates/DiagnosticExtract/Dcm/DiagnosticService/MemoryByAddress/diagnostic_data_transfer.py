...
class DiagnosticDataTransfer(DiagnosticMemoryByAddress):
    ...
    _XML_TAG = "DIAGNOSTIC-DATA-TRANSFER"


    data_transfer_ref: Optional[ARRef]
    _DESERIALIZE_DISPATCH = {
        "DATA-TRANSFER-REF": lambda obj, elem: setattr(obj, "data_transfer_ref", ARRef.deserialize(elem)),
    }
...
class DiagnosticDataTransferBuilder(DiagnosticMemoryByAddressBuilder):
    ...
    def with_data_transfer(self, value: Optional[DiagnosticDataTransfer]) -> "DiagnosticDataTransferBuilder":
        ...
        if value is None and not True:
            raise ValueError("Attribute 'data_transfer' is required and cannot be None")
