...
class DiagnosticFimAliasEventMappingBuilder(DiagnosticMappingBuilder):
    ...
    def with_alias_event_event(self, value: Optional[Any]) -> "DiagnosticFimAliasEventMappingBuilder":
        ...
        """
        if value is None and not True:
            raise ValueError("Attribute 'alias_event_event' is required and cannot be None")
