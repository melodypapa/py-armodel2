...
class DiagnosticIumprGroupIdentifierBuilder(BuilderBase):
    """Builder for DiagnosticIumprGroupIdentifier with fluent API."""
    ...
    def with_group_id(self, value: Optional[NameToken]) -> "DiagnosticIumprGroupIdentifierBuilder":
        """Set group_id attribute.
        ...
        if value is None and not True:
            raise ValueError("Attribute 'group_id' is required and cannot be None")
        self._obj.group_id = value
        return self
    ...
    def build(self) -> DiagnosticIumprGroupIdentifier:
        """Build and return the DiagnosticIumprGroupIdentifier instance with validation."""
