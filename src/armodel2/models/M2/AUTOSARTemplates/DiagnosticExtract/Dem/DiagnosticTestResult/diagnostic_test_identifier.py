...
class DiagnosticTestIdentifierBuilder(BuilderBase):
    """Builder for DiagnosticTestIdentifier with fluent API."""
    ...
    def with_id(self, value: Optional[PositiveInteger]) -> "DiagnosticTestIdentifierBuilder":
        """Set id attribute.
    ...
    def with_uas_id(self, value: Optional[PositiveInteger]) -> "DiagnosticTestIdentifierBuilder":
        """Set uas_id attribute.
    ...
    def build(self) -> DiagnosticTestIdentifier:
        """Build and return the DiagnosticTestIdentifier instance with validation."""
