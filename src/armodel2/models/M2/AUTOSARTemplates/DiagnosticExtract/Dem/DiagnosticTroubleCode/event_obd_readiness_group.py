...
class EventObdReadinessGroupBuilder(BuilderBase):
    """Builder for EventObdReadinessGroup with fluent API."""
    ...
    def with_event_obd(self, value: Optional[NameToken]) -> "EventObdReadinessGroupBuilder":
        """Set event_obd attribute.
    ...
    def build(self) -> EventObdReadinessGroup:
        """Build and return the EventObdReadinessGroup instance with validation."""
