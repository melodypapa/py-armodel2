...
class DiagnosticServiceSwMappingBuilder(DiagnosticSwMappingBuilder):
    ...
    def with_accessed_data(self, value: Optional[DataPrototype]) -> "DiagnosticServiceSwMappingBuilder":
        ...
        if value is None and not True:
            raise ValueError("Attribute 'accessed_data' is required and cannot be None")
    ...
    def with_mapped_bsw(self, value: Optional[Any]) -> "DiagnosticServiceSwMappingBuilder":
        ...
        """
        if value is None and not True:
            raise ValueError("Attribute 'mapped_bsw' is required and cannot be None")
        self._obj.mapped_bsw = value
        return self

    def with_mapped_flat_swc(self, value: Optional[Any]) -> "DiagnosticServiceSwMappingBuilder":
        ...
        """
        if value is None and not True:
            raise ValueError("Attribute 'mapped_flat_swc' is required and cannot be None")
        self._obj.mapped_flat_swc = value
        return self

    def with_mapped_swc(self, value: Optional[Any]) -> "DiagnosticServiceSwMappingBuilder":
        ...
        """
        if value is None and not True:
            raise ValueError("Attribute 'mapped_swc' is required and cannot be None")
    ...
    def with_service_instance(self, value: Optional[Any]) -> "DiagnosticServiceSwMappingBuilder":
