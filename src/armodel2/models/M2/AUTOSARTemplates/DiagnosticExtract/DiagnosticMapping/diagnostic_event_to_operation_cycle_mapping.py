...
class DiagnosticEventToOperationCycleMapping(DiagnosticMapping):
    ...
    _XML_TAG = "DIAGNOSTIC-EVENT-TO-OPERATION-CYCLE-MAPPING"
...
class DiagnosticEventToOperationCycleMappingBuilder(DiagnosticMappingBuilder):
