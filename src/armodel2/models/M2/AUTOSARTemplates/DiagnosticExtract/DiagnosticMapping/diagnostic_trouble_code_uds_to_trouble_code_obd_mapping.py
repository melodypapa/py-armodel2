...
class DiagnosticTroubleCodeUdsToTroubleCodeObdMapping(DiagnosticMapping):
    ...
    _XML_TAG = "DIAGNOSTIC-TROUBLE-CODE-UDS-TO-TROUBLE-CODE-OBD-MAPPING"
    ...
    _DESERIALIZE_DISPATCH = {
        ...
        "TROUBLE-CODE-UDS-REF": ("_POLYMORPHIC", "trouble_code_uds_ref", ["DiagnosticTroubleCodeJ1939", "DiagnosticTroubleCodeObd", "DiagnosticTroubleCodeUds"]),
    }
...
class DiagnosticTroubleCodeUdsToTroubleCodeObdMappingBuilder(DiagnosticMappingBuilder):
    ...
    def with_trouble_code(self, value: Optional[DiagnosticTroubleCode]) -> "DiagnosticTroubleCodeUdsToTroubleCodeObdMappingBuilder":
        ...
        if value is None and not True:
            raise ValueError("Attribute 'trouble_code' is required and cannot be None")
