...
class DiagnosticJ1939SpnMapping(DiagnosticMapping):
    ...
    _DESERIALIZE_DISPATCH = {
        "SENDING-NODE-REFS": lambda obj, elem: [obj.sending_node_refs.append(ARRef.deserialize(item_elem)) for item_elem in elem],
        ...
        for child in element:
            ...
            if tag == "SENDING-NODE-REFS":
                ...
                for item_elem in child:
                    obj.sending_node_refs.append(ARRef.deserialize(item_elem))
            elif tag == "SPN-REF":
