...
class DiagnosticRoutineSubfunctionBuilder(IdentifiableBuilder):
    """Builder for DiagnosticRoutineSubfunction with fluent API."""
    ...
    def with_access(self, value: Optional[DiagnosticAccessPermission]) -> "DiagnosticRoutineSubfunctionBuilder":
    ...
    def build(self) -> DiagnosticRoutineSubfunction:
        """Build and return the DiagnosticRoutineSubfunction instance (abstract)."""
