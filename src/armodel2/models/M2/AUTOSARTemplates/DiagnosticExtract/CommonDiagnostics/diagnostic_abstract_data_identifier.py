...
class DiagnosticAbstractDataIdentifier(DiagnosticCommonElement, ABC):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(DiagnosticAbstractDataIdentifier, self).serialize()
...
class DiagnosticAbstractDataIdentifierBuilder(DiagnosticCommonElementBuilder):
    """Builder for DiagnosticAbstractDataIdentifier with fluent API."""
    ...
    def with_id(self, value: Optional[PositiveInteger]) -> "DiagnosticAbstractDataIdentifierBuilder":
        """Set id attribute.
    ...
    def build(self) -> DiagnosticAbstractDataIdentifier:
        """Build and return the DiagnosticAbstractDataIdentifier instance (abstract)."""
