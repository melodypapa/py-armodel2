...
class EcucParameterDerivationFormula(ARObject):
    ...
    def deserialize(cls, element: ET.Element) -> "EcucParameterDerivationFormula":
        ...
        obj = super(EcucParameterDerivationFormula, cls).deserialize(element)
...
class EcucParameterDerivationFormulaBuilder(BuilderBase):
    """Builder for EcucParameterDerivationFormula with fluent API."""
    ...
    def with_ecuc_query(self, value: Optional[EcucQuery]) -> "EcucParameterDerivationFormulaBuilder":
        ...
        if value is None and not True:
            raise ValueError("Attribute 'ecuc_query' is required and cannot be None")
    ...
    def build(self) -> EcucParameterDerivationFormula:
        """Build and return the EcucParameterDerivationFormula instance with validation."""
