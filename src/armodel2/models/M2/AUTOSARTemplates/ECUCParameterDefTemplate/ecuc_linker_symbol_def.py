...
class EcucLinkerSymbolDef(ARObject):
    ...
    def serialize(self) -> ET.Element:
        """Serialize EcucLinkerSymbolDef to XML element with atp_variant wrapper.
        ...
        parent_elem = super(EcucLinkerSymbolDef, self).serialize()
        ...
        wrapped = SerializationHelper.serialize_with_atp_variant(inner_elem, "EcucLinkerSymbolDef")
        elem.append(wrapped)
    ...
    def deserialize(cls, element: ET.Element) -> "EcucLinkerSymbolDef":
        """Deserialize XML element to EcucLinkerSymbolDef object with atp_variant unwrapping.
        ...
        inner_elem = SerializationHelper.deserialize_from_atp_variant(element, "EcucLinkerSymbolDef")
        ...
        obj = super(EcucLinkerSymbolDef, cls).deserialize(element)
...
class EcucLinkerSymbolDefBuilder(BuilderBase):
    """Builder for EcucLinkerSymbolDef with fluent API."""
    ...
    def build(self) -> EcucLinkerSymbolDef:
        """Build and return the EcucLinkerSymbolDef instance with validation."""
