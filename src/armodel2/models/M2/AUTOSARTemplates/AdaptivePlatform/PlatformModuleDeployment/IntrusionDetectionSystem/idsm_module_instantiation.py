...
from armodel2.models.M2.AUTOSARTemplates.AdaptivePlatform.PlatformModuleDeployment.IntrusionDetectionSystem.ids_platform_instantiation import IdsPlatformInstantiationBuilder
...
class IdsmModuleInstantiation(IdsPlatformInstantiation):
    ...
    _XML_TAG = "IDSM-MODULE-INSTANTIATION"
...
class IdsmModuleInstantiationBuilder(IdsPlatformInstantiationBuilder):
