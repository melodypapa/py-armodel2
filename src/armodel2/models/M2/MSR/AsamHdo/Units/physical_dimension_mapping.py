...
class PhysicalDimensionMapping(ARObject):
    ...
    _XML_TAG = "PHYSICAL-DIMENSION-MAPPING"


    first_physical_ref: Optional[ARRef]
    second_physical_ref: Optional[ARRef]
    _DESERIALIZE_DISPATCH = {
        "FIRST-PHYSICAL-REF": lambda obj, elem: setattr(obj, "first_physical_ref", ARRef.deserialize(elem)),
        "SECOND-PHYSICAL-REF": lambda obj, elem: setattr(obj, "second_physical_ref", ARRef.deserialize(elem)),
    }
...
class PhysicalDimensionMappingBuilder(BuilderBase):
    ...
    def with_first_physical(self, value: Optional[PhysicalDimension]) -> "PhysicalDimensionMappingBuilder":
        ...
        if value is None and not True:
            raise ValueError("Attribute 'first_physical' is required and cannot be None")
    ...
    def with_second_physical(self, value: Optional[PhysicalDimension]) -> "PhysicalDimensionMappingBuilder":
        ...
        """
        if value is None and not True:
            raise ValueError("Attribute 'second_physical' is required and cannot be None")
