...
class CompuGenericMathBuilder(BuilderBase):
    """Builder for CompuGenericMath with fluent API."""
    ...
    def with_level(self, value: Optional[PrimitiveIdentifier]) -> "CompuGenericMathBuilder":
        """Set level attribute.
        ...
        if value is None and not True:
            raise ValueError("Attribute 'level' is required and cannot be None")
        self._obj.level = value
        return self
    ...
    def build(self) -> CompuGenericMath:
        """Build and return the CompuGenericMath instance with validation."""
