...
class CompuScaleContents(ARObject, ABC):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(CompuScaleContents, self).serialize()
    ...
    def deserialize(cls, element: ET.Element) -> "CompuScaleContents":
        ...
        return super(CompuScaleContents, cls).deserialize(element)



class CompuScaleContentsBuilder(BuilderBase, ABC):
    """Builder for CompuScaleContents with fluent API."""
    ...
    def build(self) -> CompuScaleContents:
        """Build and return the CompuScaleContents instance (abstract)."""
