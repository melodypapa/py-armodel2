...
class SwCalprmAxisTypePropsBuilder(BuilderBase, ABC):
    """Builder for SwCalprmAxisTypeProps with fluent API."""
    ...
    def with_max_gradient(self, value: Optional[Float]) -> "SwCalprmAxisTypePropsBuilder":
    ...
    def with_monotony(self, value: Optional[MonotonyEnum]) -> "SwCalprmAxisTypePropsBuilder":
    ...
    def build(self) -> SwCalprmAxisTypeProps:
        """Build and return the SwCalprmAxisTypeProps instance (abstract)."""
