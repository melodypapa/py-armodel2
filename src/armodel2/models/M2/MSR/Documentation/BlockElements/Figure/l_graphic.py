...
from armodel2.models.M2.MSR.Documentation.TextModel.LanguageDataModel.language_specific import LanguageSpecificBuilder
...
class LGraphicBuilder(LanguageSpecificBuilder):
    """Builder for LGraphic with fluent API."""
    ...
    def with_graphic(self, value: Graphic) -> "LGraphicBuilder":
    ...
    def with_map(self, value: Optional[Map]) -> "LGraphicBuilder":
        """Set map attribute.
    ...
    def build(self) -> LGraphic:
        """Build and return the LGraphic instance with validation."""
