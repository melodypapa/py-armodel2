...
class GraphicFitEnum(AREnum):
    ...
    ROTATE180_ROTATE180_LIMIT_TO = "ROTATE-180-ROTATE-180-LIMIT-TO"
    TEXT = "TEXT"
    ROTATE90CCW = "ROTATE-90CCW"
    ROTATE90_CCW_FIT_TO_TEXT_ROTATE90_CCW_LIMIT = "ROTATE-90-CCW-FIT-TO-TEXT-ROTATE-90-CCW-LIMIT"
    TO_TEXT = "TO-TEXT"
    ROTATE90_CW = "ROTATE-90-CW"
    ROTATE90_CW_FIT_TO_TEXT_ROTATE90_CW_LIMIT_TO = "ROTATE-90-CW-FIT-TO-TEXT-ROTATE-90-CW-LIMIT-TO"
