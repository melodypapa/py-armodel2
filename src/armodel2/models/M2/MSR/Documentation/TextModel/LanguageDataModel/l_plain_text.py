...
class LPlainTextBuilder(BuilderBase):
    """Builder for LPlainText with fluent API."""
    ...
    def build(self) -> LPlainText:
        """Build and return the LPlainText instance with validation."""
