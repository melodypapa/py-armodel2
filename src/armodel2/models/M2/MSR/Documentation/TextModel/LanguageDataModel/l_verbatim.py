...
class LVerbatim(LanguageSpecific):
    ...
    def serialize(self) -> ET.Element:
        """Serialize LVerbatim to XML element.
...
class LVerbatimBuilder(BuilderBase):
    """Builder for LVerbatim with fluent API."""
    ...
    def build(self) -> LVerbatim:
        """Build and return the LVerbatim instance with validation."""
