...
class SlParagraphBuilder(BuilderBase):
    """Builder for SlParagraph with fluent API."""
    ...
    def build(self) -> SlParagraph:
        """Build and return the SlParagraph instance with validation."""
