...
class SlOverviewParagraph(ARObject):
    ...
    _XML_TAG = "SL-OVERVIEW-PARAGRAPH"
...
class SlOverviewParagraphBuilder(BuilderBase):
    """Builder for SlOverviewParagraph with fluent API."""
    ...
    def build(self) -> SlOverviewParagraph:
        """Build and return the SlOverviewParagraph instance with validation."""
