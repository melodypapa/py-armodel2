...
class MixedContentForParagraph(ARObject, ABC):
    ...
    def deserialize(cls, element: ET.Element) -> "MixedContentForParagraph":
        ...
        if child is not None:
            ft_value = SerializationHelper.deserialize_by_tag(child, "SlParagraph")
            obj.ft = ft_value
        ...
        # Parse std
        child = SerializationHelper.find_child_element(element, "STD")
        if child is not None:
            std_value = SerializationHelper.deserialize_by_tag(child, "Std")
            obj.std = std_value
        ...
        # Parse xdoc
        child = SerializationHelper.find_child_element(element, "XDOC")
        if child is not None:
            xdoc_value = SerializationHelper.deserialize_by_tag(child, "Xdoc")
            obj.xdoc = xdoc_value

        # Parse xfile
        child = SerializationHelper.find_child_element(element, "XFILE")
        if child is not None:
            xfile_value = SerializationHelper.deserialize_by_tag(child, "Xfile")
