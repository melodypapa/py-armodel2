...
class CaptionBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "CaptionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "CaptionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "CaptionBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "CaptionBuilder":
    ...
    def clear_short_name_fragments(self) -> "CaptionBuilder":
