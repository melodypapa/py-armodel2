...
class NoteBuilder:
    ...
    def with_si(self, value: NameTokens) -> "NoteBuilder":
        """Set si attribute.
    ...
    def with_view(self, value: Optional[ViewTokens]) -> "NoteBuilder":
        """Set view attribute.
    ...
    def with_break(self, value: Optional[ChapterEnumBreak]) -> "NoteBuilder":
        """Set break attribute.
    ...
    def with_keep_with(self, value: Optional[KeepWithPreviousEnum]) -> "NoteBuilder":
