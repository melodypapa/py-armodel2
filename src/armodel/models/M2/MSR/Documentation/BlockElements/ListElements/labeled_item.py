...
class LabeledItemBuilder:
    ...
    def with_si(self, value: NameTokens) -> "LabeledItemBuilder":
        """Set si attribute.
    ...
    def with_view(self, value: Optional[ViewTokens]) -> "LabeledItemBuilder":
        """Set view attribute.
    ...
    def with_break(self, value: Optional[ChapterEnumBreak]) -> "LabeledItemBuilder":
        """Set break attribute.
    ...
    def with_keep_with(self, value: Optional[KeepWithPreviousEnum]) -> "LabeledItemBuilder":
