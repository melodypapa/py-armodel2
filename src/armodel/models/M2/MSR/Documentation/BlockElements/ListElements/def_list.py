...
class DefListBuilder:
    ...
    def with_si(self, value: NameTokens) -> "DefListBuilder":
        """Set si attribute.
    ...
    def with_view(self, value: Optional[ViewTokens]) -> "DefListBuilder":
        """Set view attribute.
    ...
    def with_break(self, value: Optional[ChapterEnumBreak]) -> "DefListBuilder":
        """Set break attribute.
    ...
    def with_keep_with(self, value: Optional[KeepWithPreviousEnum]) -> "DefListBuilder":
