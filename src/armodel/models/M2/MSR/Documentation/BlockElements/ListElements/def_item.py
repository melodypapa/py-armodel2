...
class DefItem(Paginateable):
    ...
    def deserialize(cls, element: ET.Element) -> "DefItem":
        ...
        # Parse def_
        child = SerializationHelper.find_child_element(element, "DEF")
        if child is not None:
            def__value = SerializationHelper.deserialize_by_tag(child, "DocumentationBlock")
            obj.def_ = def__value
...
class DefItemBuilder:
    ...
    def with_si(self, value: NameTokens) -> "DefItemBuilder":
        """Set si attribute.
    ...
    def with_view(self, value: Optional[ViewTokens]) -> "DefItemBuilder":
        """Set view attribute.
    ...
    def with_break(self, value: Optional[ChapterEnumBreak]) -> "DefItemBuilder":
        """Set break attribute.
    ...
    def with_keep_with(self, value: Optional[KeepWithPreviousEnum]) -> "DefItemBuilder":
