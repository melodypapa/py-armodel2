...
class LabeledListBuilder:
    ...
    def with_si(self, value: NameTokens) -> "LabeledListBuilder":
        """Set si attribute.
    ...
    def with_view(self, value: Optional[ViewTokens]) -> "LabeledListBuilder":
        """Set view attribute.
    ...
    def with_break(self, value: Optional[ChapterEnumBreak]) -> "LabeledListBuilder":
        """Set break attribute.
    ...
    def with_keep_with(self, value: Optional[KeepWithPreviousEnum]) -> "LabeledListBuilder":
