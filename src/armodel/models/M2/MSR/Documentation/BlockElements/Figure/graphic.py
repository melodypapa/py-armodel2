...
class GraphicBuilder:
    ...
    def with_revision_label_strings(self, items: list[RevisionLabelString]) -> "GraphicBuilder":
    ...
    def add_revision_label_string(self, item: RevisionLabelString) -> "GraphicBuilder":
    ...
    def clear_revision_label_strings(self) -> "GraphicBuilder":
