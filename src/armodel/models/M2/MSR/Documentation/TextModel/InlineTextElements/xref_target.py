...
from armodel.models.M2.AUTOSARTemplates.GenericStructure.GeneralTemplateClasses.Identifiable.single_language_referrable import SingleLanguageReferrableBuilder
...
class XrefTargetBuilder(SingleLanguageReferrableBuilder):
