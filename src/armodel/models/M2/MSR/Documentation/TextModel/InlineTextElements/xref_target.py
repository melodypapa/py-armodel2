...
class XrefTarget(SingleLanguageReferrable):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(XrefTarget, self).serialize()
...
class XrefTargetBuilder:
    """Builder for XrefTarget with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "XrefTargetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "XrefTargetBuilder":
    ...
    def with_long_name1(self, value: Optional[SingleLanguageLongName]) -> "XrefTargetBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "XrefTargetBuilder":
    ...
    def clear_short_name_fragments(self) -> "XrefTargetBuilder":
    ...
    def build(self) -> XrefTarget:
        """Build and return the XrefTarget instance with validation."""
