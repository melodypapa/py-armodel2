...
class StdBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "StdBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "StdBuilder":
    ...
    def with_long_name1(self, value: Optional[SingleLanguageLongName]) -> "StdBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "StdBuilder":
    ...
    def clear_short_name_fragments(self) -> "StdBuilder":
