...
class XfileBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "XfileBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "XfileBuilder":
    ...
    def with_long_name1(self, value: Optional[SingleLanguageLongName]) -> "XfileBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "XfileBuilder":
    ...
    def clear_short_name_fragments(self) -> "XfileBuilder":
