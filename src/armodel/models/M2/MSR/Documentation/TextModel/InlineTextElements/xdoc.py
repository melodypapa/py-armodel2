...
class XdocBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "XdocBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "XdocBuilder":
    ...
    def with_long_name1(self, value: Optional[SingleLanguageLongName]) -> "XdocBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "XdocBuilder":
    ...
    def clear_short_name_fragments(self) -> "XdocBuilder":
