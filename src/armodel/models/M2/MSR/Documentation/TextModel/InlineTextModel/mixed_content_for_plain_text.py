...
class MixedContentForPlainText(ARObject, ABC):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(MixedContentForPlainText, self).serialize()
    ...
    def deserialize(cls, element: ET.Element) -> "MixedContentForPlainText":
        ...
        return super(MixedContentForPlainText, cls).deserialize(element)



class MixedContentForPlainTextBuilder(BuilderBase, ABC):
    """Builder for MixedContentForPlainText with fluent API."""
    ...
    def build(self) -> MixedContentForPlainText:
        """Build and return the MixedContentForPlainText instance (abstract)."""
