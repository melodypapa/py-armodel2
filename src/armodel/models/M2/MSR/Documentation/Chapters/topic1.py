...
class Topic1Builder:
    ...
    def with_si(self, value: NameTokens) -> "Topic1Builder":
        """Set si attribute.
    ...
    def with_view(self, value: Optional[ViewTokens]) -> "Topic1Builder":
        """Set view attribute.
    ...
    def with_break(self, value: Optional[ChapterEnumBreak]) -> "Topic1Builder":
        """Set break attribute.
    ...
    def with_keep_with(self, value: Optional[KeepWithPreviousEnum]) -> "Topic1Builder":
