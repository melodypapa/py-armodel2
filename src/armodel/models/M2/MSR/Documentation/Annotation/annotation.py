...
class AnnotationBuilder:
    """Builder for Annotation with fluent API."""
    ...
    def with_annotation(self, value: String) -> "AnnotationBuilder":
    ...
    def with_annotation_text(self, value: DocumentationBlock) -> "AnnotationBuilder":
    ...
    def with_label(self, value: Optional[MultilanguageLongName]) -> "AnnotationBuilder":
        """Set label attribute.
    ...
    def build(self) -> Annotation:
        """Build and return the Annotation instance with validation."""
