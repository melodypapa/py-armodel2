...
class MsrQueryChapterBuilder:
    ...
    def with_si(self, value: NameTokens) -> "MsrQueryChapterBuilder":
        """Set si attribute.
    ...
    def with_view(self, value: Optional[ViewTokens]) -> "MsrQueryChapterBuilder":
        """Set view attribute.
    ...
    def with_break(self, value: Optional[ChapterEnumBreak]) -> "MsrQueryChapterBuilder":
        """Set break attribute.
    ...
    def with_keep_with(self, value: Optional[KeepWithPreviousEnum]) -> "MsrQueryChapterBuilder":
