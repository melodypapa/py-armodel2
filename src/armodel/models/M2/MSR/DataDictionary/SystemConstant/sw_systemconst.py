...
class SwSystemconstBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SwSystemconstBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SwSystemconstBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SwSystemconstBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SwSystemconstBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SwSystemconstBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SwSystemconstBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SwSystemconstBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SwSystemconstBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SwSystemconstBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SwSystemconstBuilder":
    ...
    def clear_short_name_fragments(self) -> "SwSystemconstBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SwSystemconstBuilder":
    ...
    def clear_annotations(self) -> "SwSystemconstBuilder":
