...
class SwServiceArgBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SwServiceArgBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SwServiceArgBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SwServiceArgBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SwServiceArgBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SwServiceArgBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SwServiceArgBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SwServiceArgBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SwServiceArgBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SwServiceArgBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SwServiceArgBuilder":
    ...
    def clear_short_name_fragments(self) -> "SwServiceArgBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SwServiceArgBuilder":
    ...
    def clear_annotations(self) -> "SwServiceArgBuilder":
