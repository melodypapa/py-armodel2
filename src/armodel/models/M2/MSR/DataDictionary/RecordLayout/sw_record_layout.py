...
class SwRecordLayoutBuilder:
    """Builder for SwRecordLayout with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "SwRecordLayoutBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SwRecordLayoutBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SwRecordLayoutBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SwRecordLayoutBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SwRecordLayoutBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SwRecordLayoutBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SwRecordLayoutBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SwRecordLayoutBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SwRecordLayoutBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SwRecordLayoutBuilder":
    ...
    def clear_short_name_fragments(self) -> "SwRecordLayoutBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SwRecordLayoutBuilder":
    ...
    def clear_annotations(self) -> "SwRecordLayoutBuilder":
    ...
    def build(self) -> SwRecordLayout:
        """Build and return the SwRecordLayout instance with validation."""
