...
class SwAxisTypeBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SwAxisTypeBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SwAxisTypeBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SwAxisTypeBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SwAxisTypeBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SwAxisTypeBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SwAxisTypeBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SwAxisTypeBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SwAxisTypeBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SwAxisTypeBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SwAxisTypeBuilder":
    ...
    def clear_short_name_fragments(self) -> "SwAxisTypeBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SwAxisTypeBuilder":
    ...
    def clear_annotations(self) -> "SwAxisTypeBuilder":
