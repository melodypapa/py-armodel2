...
class SwGenericAxisParamTypeBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SwGenericAxisParamTypeBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SwGenericAxisParamTypeBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SwGenericAxisParamTypeBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SwGenericAxisParamTypeBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SwGenericAxisParamTypeBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SwGenericAxisParamTypeBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SwGenericAxisParamTypeBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SwGenericAxisParamTypeBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SwGenericAxisParamTypeBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SwGenericAxisParamTypeBuilder":
    ...
    def clear_short_name_fragments(self) -> "SwGenericAxisParamTypeBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SwGenericAxisParamTypeBuilder":
    ...
    def clear_annotations(self) -> "SwGenericAxisParamTypeBuilder":
