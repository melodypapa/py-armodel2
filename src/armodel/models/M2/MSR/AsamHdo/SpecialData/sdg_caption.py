...
class SdgCaptionBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SdgCaptionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SdgCaptionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SdgCaptionBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SdgCaptionBuilder":
    ...
    def clear_short_name_fragments(self) -> "SdgCaptionBuilder":
