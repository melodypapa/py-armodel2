...
class ModificationBuilder(BuilderBase):
    """Builder for Modification with fluent API."""
    ...
    def with_change(self, value: MultiLanguageOverviewParagraph) -> "ModificationBuilder":
    ...
    def with_reason(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ModificationBuilder":
    ...
    def build(self) -> Modification:
        """Build and return the Modification instance with validation."""
