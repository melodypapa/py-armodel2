...
class UnitGroupBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "UnitGroupBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "UnitGroupBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "UnitGroupBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "UnitGroupBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "UnitGroupBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "UnitGroupBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "UnitGroupBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "UnitGroupBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "UnitGroupBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "UnitGroupBuilder":
    ...
    def clear_short_name_fragments(self) -> "UnitGroupBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "UnitGroupBuilder":
    ...
    def clear_annotations(self) -> "UnitGroupBuilder":
