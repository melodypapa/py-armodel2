...
class PhysicalDimensionMappingSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "PhysicalDimensionMappingSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "PhysicalDimensionMappingSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "PhysicalDimensionMappingSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "PhysicalDimensionMappingSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "PhysicalDimensionMappingSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "PhysicalDimensionMappingSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "PhysicalDimensionMappingSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "PhysicalDimensionMappingSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "PhysicalDimensionMappingSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "PhysicalDimensionMappingSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "PhysicalDimensionMappingSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "PhysicalDimensionMappingSetBuilder":
    ...
    def clear_annotations(self) -> "PhysicalDimensionMappingSetBuilder":
