...
class CompuConstContent(ARObject, ABC):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(CompuConstContent, self).serialize()
    ...
    def deserialize(cls, element: ET.Element) -> "CompuConstContent":
        ...
        return super(CompuConstContent, cls).deserialize(element)



class CompuConstContentBuilder(BuilderBase, ABC):
    """Builder for CompuConstContent with fluent API."""
    ...
    def build(self) -> CompuConstContent:
        """Build and return the CompuConstContent instance (abstract)."""
