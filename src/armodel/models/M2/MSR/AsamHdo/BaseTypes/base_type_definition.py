...
class BaseTypeDefinition(ARObject, ABC):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(BaseTypeDefinition, self).serialize()
    ...
    def deserialize(cls, element: ET.Element) -> "BaseTypeDefinition":
        ...
        return super(BaseTypeDefinition, cls).deserialize(element)



class BaseTypeDefinitionBuilder(BuilderBase, ABC):
    """Builder for BaseTypeDefinition with fluent API."""
    ...
    def build(self) -> BaseTypeDefinition:
        """Build and return the BaseTypeDefinition instance (abstract)."""
