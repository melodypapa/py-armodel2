...
class DataConstrBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DataConstrBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DataConstrBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DataConstrBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DataConstrBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DataConstrBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DataConstrBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DataConstrBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DataConstrBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DataConstrBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DataConstrBuilder":
    ...
    def clear_short_name_fragments(self) -> "DataConstrBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DataConstrBuilder":
    ...
    def clear_annotations(self) -> "DataConstrBuilder":
