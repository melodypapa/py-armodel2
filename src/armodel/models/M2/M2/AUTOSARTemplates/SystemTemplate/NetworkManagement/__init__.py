...
from armodel.models.M2.AUTOSARTemplates.SystemTemplate.NetworkManagement.nm_coordinator_role_enum import (
    NmCoordinatorRoleEnum,
)
from armodel.models.M2.AUTOSARTemplates.SystemTemplate.NetworkManagement.flexray_nm_schedule_variant import (
    FlexrayNmScheduleVariant,
)
from armodel.models.M2.AUTOSARTemplates.SystemTemplate.NetworkManagement.j1939_nm_address_configuration_capability_enum import (
