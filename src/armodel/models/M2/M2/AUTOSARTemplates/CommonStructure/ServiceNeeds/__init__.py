...
from armodel.models.M2.AUTOSARTemplates.CommonStructure.ServiceNeeds.nv_block_needs_reliability_enum import (
    NvBlockNeedsReliabilityEnum,
)
from armodel.models.M2.AUTOSARTemplates.CommonStructure.ServiceNeeds.nv_block_needs_writing_priority_enum import (
    NvBlockNeedsWritingPriorityEnum,
)
from armodel.models.M2.AUTOSARTemplates.CommonStructure.ServiceNeeds.max_comm_mode_enum import (
    MaxCommModeEnum,
)
from armodel.models.M2.AUTOSARTemplates.CommonStructure.ServiceNeeds.diagnostic_value_access_enum import (
    DiagnosticValueAccessEnum,
)
from armodel.models.M2.AUTOSARTemplates.CommonStructure.ServiceNeeds.diagnostic_processing_style_enum import (
    DiagnosticProcessingStyleEnum,
)
from armodel.models.M2.AUTOSARTemplates.CommonStructure.ServiceNeeds.diagnostic_routine_type_enum import (
    DiagnosticRoutineTypeEnum,
)
from armodel.models.M2.AUTOSARTemplates.CommonStructure.ServiceNeeds.service_provider_enum import (
    ServiceProviderEnum,
)
from armodel.models.M2.AUTOSARTemplates.CommonStructure.ServiceNeeds.service_diagnostic_relevance_enum import (
    ServiceDiagnosticRelevanceEnum,
)
from armodel.models.M2.AUTOSARTemplates.CommonStructure.ServiceNeeds.diagnostic_audience_enum import (
    DiagnosticAudienceEnum,
)
from armodel.models.M2.AUTOSARTemplates.CommonStructure.ServiceNeeds.operation_cycle_type_enum import (
    OperationCycleTypeEnum,
)
from armodel.models.M2.AUTOSARTemplates.CommonStructure.ServiceNeeds.event_acceptance_status_enum import (
    EventAcceptanceStatusEnum,
)
from armodel.models.M2.AUTOSARTemplates.CommonStructure.ServiceNeeds.storage_condition_status_enum import (
    StorageConditionStatusEnum,
)
from armodel.models.M2.AUTOSARTemplates.CommonStructure.ServiceNeeds.diagnostic_clear_dtc_notification_enum import (
    DiagnosticClearDtcNotificationEnum,
)
from armodel.models.M2.AUTOSARTemplates.CommonStructure.ServiceNeeds.diagnostic_service_request_callback_type_enum import (
    DiagnosticServiceRequestCallbackTypeEnum,
)
from armodel.models.M2.AUTOSARTemplates.CommonStructure.ServiceNeeds.obd_ratio_connection_kind_enum import (
    ObdRatioConnectionKindEnum,
)
from armodel.models.M2.AUTOSARTemplates.CommonStructure.ServiceNeeds.diagnostic_monitor_update_kind_enum import (
    DiagnosticMonitorUpdateKindEnum,
)
from armodel.models.M2.AUTOSARTemplates.CommonStructure.ServiceNeeds.diagnostic_denominator_condition_enum import (
    DiagnosticDenominatorConditionEnum,
)
from armodel.models.M2.AUTOSARTemplates.CommonStructure.ServiceNeeds.verification_status_indication_mode_enum import (
