...
if TYPE_CHECKING:
    ...
    from armodel.models.M2.AUTOSARTemplates.DiagnosticExtract.CommonDiagnostics.diagnostic_parameter_element import (
        DiagnosticParameterElement,
    )
    from armodel.models.M2.AUTOSARTemplates.DiagnosticExtract.CommonDiagnostics.diagnostic_parameter_ident import (
    ...
    from armodel.models.M2.AUTOSARTemplates.DiagnosticExtract.CommonDiagnostics.diagnostic_request_routine_results import (
        DiagnosticRequestRoutineResults,
    )
    from armodel.models.M2.AUTOSARTemplates.DiagnosticExtract.CommonDiagnostics.diagnostic_parameter_identifier import (
        DiagnosticParameterIdentifier,
    )
    from armodel.models.M2.AUTOSARTemplates.DiagnosticExtract.CommonDiagnostics.diagnostic_parameter_support_info import (
