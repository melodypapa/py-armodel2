...
class FieldBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "FieldBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "FieldBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "FieldBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "FieldBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "FieldBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "FieldBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "FieldBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "FieldBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "FieldBuilder":
        """Set uuid attribute.
    ...
    def with_sw_data_def(self, value: Optional[SwDataDefProps]) -> "FieldBuilder":
    ...
    def with_type(self, value: Optional[AutosarDataType]) -> "FieldBuilder":
        """Set type attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "FieldBuilder":
    ...
    def clear_short_name_fragments(self) -> "FieldBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "FieldBuilder":
    ...
    def clear_annotations(self) -> "FieldBuilder":
