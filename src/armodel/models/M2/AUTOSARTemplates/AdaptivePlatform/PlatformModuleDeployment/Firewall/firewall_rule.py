...
class FirewallRuleBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "FirewallRuleBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "FirewallRuleBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "FirewallRuleBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "FirewallRuleBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "FirewallRuleBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "FirewallRuleBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "FirewallRuleBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "FirewallRuleBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "FirewallRuleBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "FirewallRuleBuilder":
    ...
    def clear_short_name_fragments(self) -> "FirewallRuleBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "FirewallRuleBuilder":
    ...
    def clear_annotations(self) -> "FirewallRuleBuilder":
