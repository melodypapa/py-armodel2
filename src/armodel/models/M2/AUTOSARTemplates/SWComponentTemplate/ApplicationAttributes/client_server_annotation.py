...
class ClientServerAnnotationBuilder:
    ...
    def with_annotation(self, value: String) -> "ClientServerAnnotationBuilder":
    ...
    def with_annotation_text(self, value: DocumentationBlock) -> "ClientServerAnnotationBuilder":
    ...
    def with_label(self, value: Optional[MultilanguageLongName]) -> "ClientServerAnnotationBuilder":
        """Set label attribute.
