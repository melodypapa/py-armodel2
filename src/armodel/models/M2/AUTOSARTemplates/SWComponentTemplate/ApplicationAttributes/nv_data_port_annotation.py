...
class NvDataPortAnnotationBuilder:
    """Builder for NvDataPortAnnotation with fluent API."""
    ...
    def with_annotation(self, value: String) -> "NvDataPortAnnotationBuilder":
    ...
    def with_annotation_text(self, value: DocumentationBlock) -> "NvDataPortAnnotationBuilder":
    ...
    def with_label(self, value: Optional[MultilanguageLongName]) -> "NvDataPortAnnotationBuilder":
        """Set label attribute.
    ...
    def with_variable(self, value: Optional[VariableDataPrototype]) -> "NvDataPortAnnotationBuilder":
    ...
    def build(self) -> NvDataPortAnnotation:
        """Build and return the NvDataPortAnnotation instance with validation."""
