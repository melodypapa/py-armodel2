...
class IoHwAbstractionServerAnnotationBuilder:
    ...
    def with_annotation(self, value: String) -> "IoHwAbstractionServerAnnotationBuilder":
    ...
    def with_annotation_text(self, value: DocumentationBlock) -> "IoHwAbstractionServerAnnotationBuilder":
    ...
    def with_label(self, value: Optional[MultilanguageLongName]) -> "IoHwAbstractionServerAnnotationBuilder":
        """Set label attribute.
