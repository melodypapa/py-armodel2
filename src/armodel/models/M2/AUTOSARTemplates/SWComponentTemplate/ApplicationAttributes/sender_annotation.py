...
class SenderAnnotationBuilder:
    """Builder for SenderAnnotation with fluent API."""
    ...
    def with_annotation(self, value: String) -> "SenderAnnotationBuilder":
    ...
    def with_annotation_text(self, value: DocumentationBlock) -> "SenderAnnotationBuilder":
    ...
    def with_label(self, value: Optional[MultilanguageLongName]) -> "SenderAnnotationBuilder":
        """Set label attribute.
    ...
    def with_computed(self, value: Optional[Boolean]) -> "SenderAnnotationBuilder":
    ...
    def with_data_element(self, value: Optional[VariableDataPrototype]) -> "SenderAnnotationBuilder":
    ...
    def with_limit_kind(self, value: Optional[DataLimitKindEnum]) -> "SenderAnnotationBuilder":
    ...
    def with_processing_kind_enum(self, value: Optional[ProcessingKindEnum]) -> "SenderAnnotationBuilder":
    ...
    def build(self) -> SenderAnnotation:
        """Build and return the SenderAnnotation instance with validation."""
