...
class ParameterPortAnnotationBuilder:
    """Builder for ParameterPortAnnotation with fluent API."""
    ...
    def with_annotation(self, value: String) -> "ParameterPortAnnotationBuilder":
    ...
    def with_annotation_text(self, value: DocumentationBlock) -> "ParameterPortAnnotationBuilder":
    ...
    def with_label(self, value: Optional[MultilanguageLongName]) -> "ParameterPortAnnotationBuilder":
        """Set label attribute.
    ...
    def with_parameter(self, value: Optional[ParameterDataPrototype]) -> "ParameterPortAnnotationBuilder":
    ...
    def build(self) -> ParameterPortAnnotation:
        """Build and return the ParameterPortAnnotation instance with validation."""
