...
class TriggerPortAnnotationBuilder:
    """Builder for TriggerPortAnnotation with fluent API."""
    ...
    def with_annotation(self, value: String) -> "TriggerPortAnnotationBuilder":
    ...
    def with_annotation_text(self, value: DocumentationBlock) -> "TriggerPortAnnotationBuilder":
    ...
    def with_label(self, value: Optional[MultilanguageLongName]) -> "TriggerPortAnnotationBuilder":
        """Set label attribute.
    ...
    def with_trigger(self, value: Optional[Trigger]) -> "TriggerPortAnnotationBuilder":
    ...
    def build(self) -> TriggerPortAnnotation:
        """Build and return the TriggerPortAnnotation instance with validation."""
