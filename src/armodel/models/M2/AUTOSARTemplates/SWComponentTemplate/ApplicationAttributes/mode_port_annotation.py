...
class ModePortAnnotationBuilder:
    ...
    def with_annotation(self, value: String) -> "ModePortAnnotationBuilder":
    ...
    def with_annotation_text(self, value: DocumentationBlock) -> "ModePortAnnotationBuilder":
    ...
    def with_label(self, value: Optional[MultilanguageLongName]) -> "ModePortAnnotationBuilder":
        """Set label attribute.
