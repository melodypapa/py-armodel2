...
class DelegatedPortAnnotationBuilder:
    ...
    def with_annotation(self, value: String) -> "DelegatedPortAnnotationBuilder":
    ...
    def with_annotation_text(self, value: DocumentationBlock) -> "DelegatedPortAnnotationBuilder":
    ...
    def with_label(self, value: Optional[MultilanguageLongName]) -> "DelegatedPortAnnotationBuilder":
        """Set label attribute.
