...
class InterpolationRoutineMappingSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "InterpolationRoutineMappingSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "InterpolationRoutineMappingSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "InterpolationRoutineMappingSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "InterpolationRoutineMappingSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "InterpolationRoutineMappingSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "InterpolationRoutineMappingSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "InterpolationRoutineMappingSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "InterpolationRoutineMappingSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "InterpolationRoutineMappingSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "InterpolationRoutineMappingSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "InterpolationRoutineMappingSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "InterpolationRoutineMappingSetBuilder":
    ...
    def clear_annotations(self) -> "InterpolationRoutineMappingSetBuilder":
