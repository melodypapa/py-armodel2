...
class CalibrationParameterValueSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "CalibrationParameterValueSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "CalibrationParameterValueSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "CalibrationParameterValueSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "CalibrationParameterValueSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "CalibrationParameterValueSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "CalibrationParameterValueSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "CalibrationParameterValueSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "CalibrationParameterValueSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "CalibrationParameterValueSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "CalibrationParameterValueSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "CalibrationParameterValueSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "CalibrationParameterValueSetBuilder":
    ...
    def clear_annotations(self) -> "CalibrationParameterValueSetBuilder":
