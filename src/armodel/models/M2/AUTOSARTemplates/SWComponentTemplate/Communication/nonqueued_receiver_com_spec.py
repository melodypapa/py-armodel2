...
class NonqueuedReceiverComSpecBuilder:
    ...
    def with_composite_networks(self, items: list[CompositeNetworkRepresentation]) -> "NonqueuedReceiverComSpecBuilder":
    ...
    def with_data_element(self, value: Optional[AutosarDataPrototype]) -> "NonqueuedReceiverComSpecBuilder":
    ...
    def with_handle_out_of_range(self, value: Optional[any (HandleOutOfRange)]) -> "NonqueuedReceiverComSpecBuilder":
    ...
    def with_max_delta(self, value: Optional[PositiveInteger]) -> "NonqueuedReceiverComSpecBuilder":
    ...
    def with_sync_counter_init(self, value: Optional[PositiveInteger]) -> "NonqueuedReceiverComSpecBuilder":
    ...
    def with_transformation_coms(self, items: list[any (TransformationCom)]) -> "NonqueuedReceiverComSpecBuilder":
    ...
    def with_uses_end_to_end(self, value: Optional[Boolean]) -> "NonqueuedReceiverComSpecBuilder":
    ...
    def add_composite_network(self, item: CompositeNetworkRepresentation) -> "NonqueuedReceiverComSpecBuilder":
    ...
    def clear_composite_networks(self) -> "NonqueuedReceiverComSpecBuilder":
    ...
    def add_transformation_com(self, item: any (TransformationCom)) -> "NonqueuedReceiverComSpecBuilder":
    ...
    def clear_transformation_coms(self) -> "NonqueuedReceiverComSpecBuilder":
