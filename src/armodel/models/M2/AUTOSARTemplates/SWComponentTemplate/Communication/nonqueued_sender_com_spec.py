...
class NonqueuedSenderComSpecBuilder:
    ...
    def with_composite_networks(self, items: list[CompositeNetworkRepresentation]) -> "NonqueuedSenderComSpecBuilder":
    ...
    def with_data_element(self, value: Optional[AutosarDataPrototype]) -> "NonqueuedSenderComSpecBuilder":
    ...
    def with_handle_out_of_range(self, value: Optional[any (HandleOutOfRange)]) -> "NonqueuedSenderComSpecBuilder":
    ...
    def with_network(self, value: Optional[SwDataDefProps]) -> "NonqueuedSenderComSpecBuilder":
    ...
    def with_transmission(self, value: Optional[any (Transmission)]) -> "NonqueuedSenderComSpecBuilder":
    ...
    def with_transmission_com_spec(self, value: Optional[TransmissionComSpecProps]) -> "NonqueuedSenderComSpecBuilder":
    ...
    def with_uses_end_to_end(self, value: Optional[Boolean]) -> "NonqueuedSenderComSpecBuilder":
    ...
    def add_composite_network(self, item: CompositeNetworkRepresentation) -> "NonqueuedSenderComSpecBuilder":
    ...
    def clear_composite_networks(self) -> "NonqueuedSenderComSpecBuilder":
