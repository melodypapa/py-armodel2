...
class NvRequireComSpecBuilder(RPortComSpecBuilder):
    """Builder for NvRequireComSpec with fluent API."""
    ...
    def with_init_value(self, value: Optional[ValueSpecification]) -> "NvRequireComSpecBuilder":
    ...
    def with_variable(self, value: Optional[VariableDataPrototype]) -> "NvRequireComSpecBuilder":
    ...
    def build(self) -> NvRequireComSpec:
        """Build and return the NvRequireComSpec instance with validation."""
