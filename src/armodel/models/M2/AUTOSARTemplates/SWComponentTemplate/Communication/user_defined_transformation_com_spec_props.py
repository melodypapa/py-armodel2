...
class UserDefinedTransformationComSpecPropsBuilder:
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "UserDefinedTransformationComSpecPropsBuilder":
    ...
    def with_category(self, value: Optional[CategoryString]) -> "UserDefinedTransformationComSpecPropsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "UserDefinedTransformationComSpecPropsBuilder":
        """Set desc attribute.
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "UserDefinedTransformationComSpecPropsBuilder":
