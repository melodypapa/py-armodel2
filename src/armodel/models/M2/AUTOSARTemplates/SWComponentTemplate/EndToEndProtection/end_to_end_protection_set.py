...
class EndToEndProtectionSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "EndToEndProtectionSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "EndToEndProtectionSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "EndToEndProtectionSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "EndToEndProtectionSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "EndToEndProtectionSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "EndToEndProtectionSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "EndToEndProtectionSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "EndToEndProtectionSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "EndToEndProtectionSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "EndToEndProtectionSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "EndToEndProtectionSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "EndToEndProtectionSetBuilder":
    ...
    def clear_annotations(self) -> "EndToEndProtectionSetBuilder":
