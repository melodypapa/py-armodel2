...
class EndToEndProtectionBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "EndToEndProtectionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "EndToEndProtectionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "EndToEndProtectionBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "EndToEndProtectionBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "EndToEndProtectionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "EndToEndProtectionBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "EndToEndProtectionBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "EndToEndProtectionBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "EndToEndProtectionBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "EndToEndProtectionBuilder":
    ...
    def clear_short_name_fragments(self) -> "EndToEndProtectionBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "EndToEndProtectionBuilder":
    ...
    def clear_annotations(self) -> "EndToEndProtectionBuilder":
