...
class RunnableEntityGroupBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "RunnableEntityGroupBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "RunnableEntityGroupBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "RunnableEntityGroupBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "RunnableEntityGroupBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "RunnableEntityGroupBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "RunnableEntityGroupBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "RunnableEntityGroupBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "RunnableEntityGroupBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "RunnableEntityGroupBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "RunnableEntityGroupBuilder":
    ...
    def clear_short_name_fragments(self) -> "RunnableEntityGroupBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "RunnableEntityGroupBuilder":
    ...
    def clear_annotations(self) -> "RunnableEntityGroupBuilder":
