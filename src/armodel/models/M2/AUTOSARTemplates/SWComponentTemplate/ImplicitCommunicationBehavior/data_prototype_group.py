...
class DataPrototypeGroupBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DataPrototypeGroupBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DataPrototypeGroupBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DataPrototypeGroupBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DataPrototypeGroupBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DataPrototypeGroupBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DataPrototypeGroupBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DataPrototypeGroupBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DataPrototypeGroupBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DataPrototypeGroupBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DataPrototypeGroupBuilder":
    ...
    def clear_short_name_fragments(self) -> "DataPrototypeGroupBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DataPrototypeGroupBuilder":
    ...
    def clear_annotations(self) -> "DataPrototypeGroupBuilder":
