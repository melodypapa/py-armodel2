...
class RptContainerBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "RptContainerBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "RptContainerBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "RptContainerBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "RptContainerBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "RptContainerBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "RptContainerBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "RptContainerBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "RptContainerBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "RptContainerBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "RptContainerBuilder":
    ...
    def clear_short_name_fragments(self) -> "RptContainerBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "RptContainerBuilder":
    ...
    def clear_annotations(self) -> "RptContainerBuilder":
