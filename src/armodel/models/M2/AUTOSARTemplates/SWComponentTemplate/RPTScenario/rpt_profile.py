...
class RptProfileBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "RptProfileBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "RptProfileBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "RptProfileBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "RptProfileBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "RptProfileBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "RptProfileBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "RptProfileBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "RptProfileBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "RptProfileBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "RptProfileBuilder":
    ...
    def clear_short_name_fragments(self) -> "RptProfileBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "RptProfileBuilder":
    ...
    def clear_annotations(self) -> "RptProfileBuilder":
