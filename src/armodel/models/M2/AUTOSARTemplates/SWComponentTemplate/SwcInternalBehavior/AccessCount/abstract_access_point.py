...
class AbstractAccessPointBuilder(IdentifiableBuilder):
    """Builder for AbstractAccessPoint with fluent API."""
    ...
    def build(self) -> AbstractAccessPoint:
        """Build and return the AbstractAccessPoint instance (abstract)."""
