...
class SwcModeManagerErrorEventBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SwcModeManagerErrorEventBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SwcModeManagerErrorEventBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SwcModeManagerErrorEventBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SwcModeManagerErrorEventBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SwcModeManagerErrorEventBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SwcModeManagerErrorEventBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SwcModeManagerErrorEventBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SwcModeManagerErrorEventBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SwcModeManagerErrorEventBuilder":
        """Set uuid attribute.
    ...
    def with_activation(self, value: Optional[ExecutableEntity]) -> "SwcModeManagerErrorEventBuilder":
    ...
    def with_disabled_mode_instance_refs(self, items: list[ModeDeclaration]) -> "SwcModeManagerErrorEventBuilder":
    ...
    def with_start_on_event(self, value: Optional[RunnableEntity]) -> "SwcModeManagerErrorEventBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SwcModeManagerErrorEventBuilder":
    ...
    def clear_short_name_fragments(self) -> "SwcModeManagerErrorEventBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SwcModeManagerErrorEventBuilder":
    ...
    def clear_annotations(self) -> "SwcModeManagerErrorEventBuilder":
    ...
    def add_disabled_mode_instance_ref(self, item: ModeDeclaration) -> "SwcModeManagerErrorEventBuilder":
    ...
    def clear_disabled_mode_instance_refs(self) -> "SwcModeManagerErrorEventBuilder":
