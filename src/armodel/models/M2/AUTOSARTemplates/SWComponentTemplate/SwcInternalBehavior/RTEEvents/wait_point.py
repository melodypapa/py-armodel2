...
class WaitPointBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "WaitPointBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "WaitPointBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "WaitPointBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "WaitPointBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "WaitPointBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "WaitPointBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "WaitPointBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "WaitPointBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "WaitPointBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "WaitPointBuilder":
    ...
    def clear_short_name_fragments(self) -> "WaitPointBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "WaitPointBuilder":
    ...
    def clear_annotations(self) -> "WaitPointBuilder":
