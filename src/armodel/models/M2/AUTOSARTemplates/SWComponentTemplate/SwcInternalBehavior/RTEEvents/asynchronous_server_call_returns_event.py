...
class AsynchronousServerCallReturnsEvent(RTEEvent):
    ...
    _xml_members = [
        ("event_source", None, False, False, any (AsynchronousServer)),  # eventSource
    ]
    ...
    def deserialize(cls, element: ET.Element) -> "AsynchronousServerCallReturnsEvent":
        ...
        # Cast to AsynchronousServerCallReturnsEvent since parent returns ARObject
        return cast("AsynchronousServerCallReturnsEvent", obj)
