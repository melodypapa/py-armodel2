...
class TimingEventBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "TimingEventBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TimingEventBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "TimingEventBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "TimingEventBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "TimingEventBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "TimingEventBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "TimingEventBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "TimingEventBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "TimingEventBuilder":
        """Set uuid attribute.
    ...
    def with_activation(self, value: Optional[ExecutableEntity]) -> "TimingEventBuilder":
    ...
    def with_disabled_mode_instance_refs(self, items: list[ModeDeclaration]) -> "TimingEventBuilder":
    ...
    def with_start_on_event(self, value: Optional[RunnableEntity]) -> "TimingEventBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TimingEventBuilder":
    ...
    def clear_short_name_fragments(self) -> "TimingEventBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "TimingEventBuilder":
    ...
    def clear_annotations(self) -> "TimingEventBuilder":
    ...
    def add_disabled_mode_instance_ref(self, item: ModeDeclaration) -> "TimingEventBuilder":
    ...
    def clear_disabled_mode_instance_refs(self) -> "TimingEventBuilder":
