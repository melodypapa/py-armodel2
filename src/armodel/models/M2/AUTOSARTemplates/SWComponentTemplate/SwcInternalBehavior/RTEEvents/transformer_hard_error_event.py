...
class TransformerHardErrorEventBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "TransformerHardErrorEventBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TransformerHardErrorEventBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "TransformerHardErrorEventBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "TransformerHardErrorEventBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "TransformerHardErrorEventBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "TransformerHardErrorEventBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "TransformerHardErrorEventBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "TransformerHardErrorEventBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "TransformerHardErrorEventBuilder":
        """Set uuid attribute.
    ...
    def with_activation(self, value: Optional[ExecutableEntity]) -> "TransformerHardErrorEventBuilder":
    ...
    def with_disabled_mode_instance_refs(self, items: list[ModeDeclaration]) -> "TransformerHardErrorEventBuilder":
    ...
    def with_start_on_event(self, value: Optional[RunnableEntity]) -> "TransformerHardErrorEventBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TransformerHardErrorEventBuilder":
    ...
    def clear_short_name_fragments(self) -> "TransformerHardErrorEventBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "TransformerHardErrorEventBuilder":
    ...
    def clear_annotations(self) -> "TransformerHardErrorEventBuilder":
    ...
    def add_disabled_mode_instance_ref(self, item: ModeDeclaration) -> "TransformerHardErrorEventBuilder":
    ...
    def clear_disabled_mode_instance_refs(self) -> "TransformerHardErrorEventBuilder":
