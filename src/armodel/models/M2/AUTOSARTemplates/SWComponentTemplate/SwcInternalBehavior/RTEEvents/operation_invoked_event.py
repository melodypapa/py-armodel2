...
class OperationInvokedEventBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "OperationInvokedEventBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "OperationInvokedEventBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "OperationInvokedEventBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "OperationInvokedEventBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "OperationInvokedEventBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "OperationInvokedEventBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "OperationInvokedEventBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "OperationInvokedEventBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "OperationInvokedEventBuilder":
        """Set uuid attribute.
    ...
    def with_activation(self, value: Optional[ExecutableEntity]) -> "OperationInvokedEventBuilder":
    ...
    def with_disabled_mode_instance_refs(self, items: list[ModeDeclaration]) -> "OperationInvokedEventBuilder":
    ...
    def with_start_on_event(self, value: Optional[RunnableEntity]) -> "OperationInvokedEventBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "OperationInvokedEventBuilder":
    ...
    def clear_short_name_fragments(self) -> "OperationInvokedEventBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "OperationInvokedEventBuilder":
    ...
    def clear_annotations(self) -> "OperationInvokedEventBuilder":
    ...
    def add_disabled_mode_instance_ref(self, item: ModeDeclaration) -> "OperationInvokedEventBuilder":
    ...
    def clear_disabled_mode_instance_refs(self) -> "OperationInvokedEventBuilder":
