...
class SwcModeSwitchEventBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SwcModeSwitchEventBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SwcModeSwitchEventBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SwcModeSwitchEventBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SwcModeSwitchEventBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SwcModeSwitchEventBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SwcModeSwitchEventBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SwcModeSwitchEventBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SwcModeSwitchEventBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SwcModeSwitchEventBuilder":
        """Set uuid attribute.
    ...
    def with_activation(self, value: Optional[ExecutableEntity]) -> "SwcModeSwitchEventBuilder":
    ...
    def with_disabled_mode_instance_refs(self, items: list[ModeDeclaration]) -> "SwcModeSwitchEventBuilder":
    ...
    def with_start_on_event(self, value: Optional[RunnableEntity]) -> "SwcModeSwitchEventBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SwcModeSwitchEventBuilder":
    ...
    def clear_short_name_fragments(self) -> "SwcModeSwitchEventBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SwcModeSwitchEventBuilder":
    ...
    def clear_annotations(self) -> "SwcModeSwitchEventBuilder":
    ...
    def add_disabled_mode_instance_ref(self, item: ModeDeclaration) -> "SwcModeSwitchEventBuilder":
    ...
    def clear_disabled_mode_instance_refs(self) -> "SwcModeSwitchEventBuilder":
