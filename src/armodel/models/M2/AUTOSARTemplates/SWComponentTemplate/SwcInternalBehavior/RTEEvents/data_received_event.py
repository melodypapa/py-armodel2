...
class DataReceivedEventBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DataReceivedEventBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DataReceivedEventBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DataReceivedEventBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DataReceivedEventBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DataReceivedEventBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DataReceivedEventBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DataReceivedEventBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DataReceivedEventBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DataReceivedEventBuilder":
        """Set uuid attribute.
    ...
    def with_activation(self, value: Optional[ExecutableEntity]) -> "DataReceivedEventBuilder":
    ...
    def with_disabled_mode_instance_refs(self, items: list[ModeDeclaration]) -> "DataReceivedEventBuilder":
    ...
    def with_start_on_event(self, value: Optional[RunnableEntity]) -> "DataReceivedEventBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DataReceivedEventBuilder":
    ...
    def clear_short_name_fragments(self) -> "DataReceivedEventBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DataReceivedEventBuilder":
    ...
    def clear_annotations(self) -> "DataReceivedEventBuilder":
    ...
    def add_disabled_mode_instance_ref(self, item: ModeDeclaration) -> "DataReceivedEventBuilder":
    ...
    def clear_disabled_mode_instance_refs(self) -> "DataReceivedEventBuilder":
