...
class ModeSwitchPointBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ModeSwitchPointBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ModeSwitchPointBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ModeSwitchPointBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ModeSwitchPointBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ModeSwitchPointBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ModeSwitchPointBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ModeSwitchPointBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ModeSwitchPointBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ModeSwitchPointBuilder":
        """Set uuid attribute.
    ...
    def with_return_value(self, value: Optional[RteApiReturnValueProvisionEnum]) -> "ModeSwitchPointBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ModeSwitchPointBuilder":
    ...
    def clear_short_name_fragments(self) -> "ModeSwitchPointBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ModeSwitchPointBuilder":
    ...
    def clear_annotations(self) -> "ModeSwitchPointBuilder":
