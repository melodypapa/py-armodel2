...
class VariationPointProxyBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "VariationPointProxyBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "VariationPointProxyBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "VariationPointProxyBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "VariationPointProxyBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "VariationPointProxyBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "VariationPointProxyBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "VariationPointProxyBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "VariationPointProxyBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "VariationPointProxyBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "VariationPointProxyBuilder":
    ...
    def clear_short_name_fragments(self) -> "VariationPointProxyBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "VariationPointProxyBuilder":
    ...
    def clear_annotations(self) -> "VariationPointProxyBuilder":
