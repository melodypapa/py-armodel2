...
class SynchronousServerCallPointBuilder:
    """Builder for SynchronousServerCallPoint with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "SynchronousServerCallPointBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SynchronousServerCallPointBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SynchronousServerCallPointBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SynchronousServerCallPointBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SynchronousServerCallPointBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SynchronousServerCallPointBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SynchronousServerCallPointBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SynchronousServerCallPointBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SynchronousServerCallPointBuilder":
        """Set uuid attribute.
    ...
    def with_return_value(self, value: Optional[RteApiReturnValueProvisionEnum]) -> "SynchronousServerCallPointBuilder":
    ...
    def with_operation_instance_ref(self, value: Optional[ClientServerOperation]) -> "SynchronousServerCallPointBuilder":
    ...
    def with_timeout(self, value: Optional[TimeValue]) -> "SynchronousServerCallPointBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SynchronousServerCallPointBuilder":
    ...
    def clear_short_name_fragments(self) -> "SynchronousServerCallPointBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SynchronousServerCallPointBuilder":
    ...
    def clear_annotations(self) -> "SynchronousServerCallPointBuilder":
    ...
    def build(self) -> SynchronousServerCallPoint:
        """Build and return the SynchronousServerCallPoint instance with validation."""
