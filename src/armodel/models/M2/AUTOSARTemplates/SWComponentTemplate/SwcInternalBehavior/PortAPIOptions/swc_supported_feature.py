...
class SwcSupportedFeature(ARObject, ABC):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(SwcSupportedFeature, self).serialize()
    ...
    def deserialize(cls, element: ET.Element) -> "SwcSupportedFeature":
        ...
        return super(SwcSupportedFeature, cls).deserialize(element)



class SwcSupportedFeatureBuilder(BuilderBase, ABC):
    """Builder for SwcSupportedFeature with fluent API."""
    ...
    def build(self) -> SwcSupportedFeature:
        """Build and return the SwcSupportedFeature instance (abstract)."""
