...
class InternalTriggeringPointBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "InternalTriggeringPointBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "InternalTriggeringPointBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "InternalTriggeringPointBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "InternalTriggeringPointBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "InternalTriggeringPointBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "InternalTriggeringPointBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "InternalTriggeringPointBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "InternalTriggeringPointBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "InternalTriggeringPointBuilder":
        """Set uuid attribute.
    ...
    def with_return_value(self, value: Optional[RteApiReturnValueProvisionEnum]) -> "InternalTriggeringPointBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "InternalTriggeringPointBuilder":
    ...
    def clear_short_name_fragments(self) -> "InternalTriggeringPointBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "InternalTriggeringPointBuilder":
    ...
    def clear_annotations(self) -> "InternalTriggeringPointBuilder":
