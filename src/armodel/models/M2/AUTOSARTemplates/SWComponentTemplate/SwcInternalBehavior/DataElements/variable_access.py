...
class VariableAccessBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "VariableAccessBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "VariableAccessBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "VariableAccessBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "VariableAccessBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "VariableAccessBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "VariableAccessBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "VariableAccessBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "VariableAccessBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "VariableAccessBuilder":
        """Set uuid attribute.
    ...
    def with_return_value(self, value: Optional[RteApiReturnValueProvisionEnum]) -> "VariableAccessBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "VariableAccessBuilder":
    ...
    def clear_short_name_fragments(self) -> "VariableAccessBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "VariableAccessBuilder":
    ...
    def clear_annotations(self) -> "VariableAccessBuilder":
