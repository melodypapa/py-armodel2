...
class ParameterAccessBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ParameterAccessBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ParameterAccessBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ParameterAccessBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ParameterAccessBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ParameterAccessBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ParameterAccessBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ParameterAccessBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ParameterAccessBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ParameterAccessBuilder":
        """Set uuid attribute.
    ...
    def with_return_value(self, value: Optional[RteApiReturnValueProvisionEnum]) -> "ParameterAccessBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ParameterAccessBuilder":
    ...
    def clear_short_name_fragments(self) -> "ParameterAccessBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ParameterAccessBuilder":
    ...
    def clear_annotations(self) -> "ParameterAccessBuilder":
