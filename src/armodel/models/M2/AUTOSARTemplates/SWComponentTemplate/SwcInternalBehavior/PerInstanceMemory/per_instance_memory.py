...
class PerInstanceMemoryBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "PerInstanceMemoryBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "PerInstanceMemoryBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "PerInstanceMemoryBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "PerInstanceMemoryBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "PerInstanceMemoryBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "PerInstanceMemoryBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "PerInstanceMemoryBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "PerInstanceMemoryBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "PerInstanceMemoryBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "PerInstanceMemoryBuilder":
    ...
    def clear_short_name_fragments(self) -> "PerInstanceMemoryBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "PerInstanceMemoryBuilder":
    ...
    def clear_annotations(self) -> "PerInstanceMemoryBuilder":
