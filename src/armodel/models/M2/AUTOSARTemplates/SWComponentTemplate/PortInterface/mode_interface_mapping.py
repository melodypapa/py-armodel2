...
class ModeInterfaceMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ModeInterfaceMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ModeInterfaceMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ModeInterfaceMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ModeInterfaceMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ModeInterfaceMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ModeInterfaceMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ModeInterfaceMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ModeInterfaceMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ModeInterfaceMappingBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ModeInterfaceMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "ModeInterfaceMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ModeInterfaceMappingBuilder":
    ...
    def clear_annotations(self) -> "ModeInterfaceMappingBuilder":
