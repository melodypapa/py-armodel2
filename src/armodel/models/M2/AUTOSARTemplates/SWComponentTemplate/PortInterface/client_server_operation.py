...
class ClientServerOperation(Identifiable):
    ...
    def deserialize(cls, element: ET.Element) -> "ClientServerOperation":
        ...
        child = SerializationHelper.find_child_element(element, "DIAG-ARG-INTEGRITY")
...
class ClientServerOperationBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ClientServerOperationBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ClientServerOperationBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ClientServerOperationBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ClientServerOperationBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ClientServerOperationBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ClientServerOperationBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ClientServerOperationBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ClientServerOperationBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ClientServerOperationBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ClientServerOperationBuilder":
    ...
    def clear_short_name_fragments(self) -> "ClientServerOperationBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ClientServerOperationBuilder":
    ...
    def clear_annotations(self) -> "ClientServerOperationBuilder":
