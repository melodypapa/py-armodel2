...
class ClientServerInterfaceMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ClientServerInterfaceMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ClientServerInterfaceMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ClientServerInterfaceMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ClientServerInterfaceMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ClientServerInterfaceMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ClientServerInterfaceMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ClientServerInterfaceMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ClientServerInterfaceMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ClientServerInterfaceMappingBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ClientServerInterfaceMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "ClientServerInterfaceMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ClientServerInterfaceMappingBuilder":
    ...
    def clear_annotations(self) -> "ClientServerInterfaceMappingBuilder":
