...
class SenderReceiverInterfaceBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SenderReceiverInterfaceBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SenderReceiverInterfaceBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SenderReceiverInterfaceBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SenderReceiverInterfaceBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SenderReceiverInterfaceBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SenderReceiverInterfaceBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SenderReceiverInterfaceBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SenderReceiverInterfaceBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SenderReceiverInterfaceBuilder":
        """Set uuid attribute.
    ...
    def with_is_service(self, value: Optional[Boolean]) -> "SenderReceiverInterfaceBuilder":
    ...
    def with_service_kind(self, value: Optional[ServiceProviderEnum]) -> "SenderReceiverInterfaceBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SenderReceiverInterfaceBuilder":
    ...
    def clear_short_name_fragments(self) -> "SenderReceiverInterfaceBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SenderReceiverInterfaceBuilder":
    ...
    def clear_annotations(self) -> "SenderReceiverInterfaceBuilder":
