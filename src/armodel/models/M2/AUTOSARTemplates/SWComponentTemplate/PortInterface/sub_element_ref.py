...
class SubElementRef(ARObject, ABC):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(SubElementRef, self).serialize()
    ...
    def deserialize(cls, element: ET.Element) -> "SubElementRef":
        ...
        return super(SubElementRef, cls).deserialize(element)



class SubElementRefBuilder(BuilderBase, ABC):
    """Builder for SubElementRef with fluent API."""
    ...
    def build(self) -> SubElementRef:
        """Build and return the SubElementRef instance (abstract)."""
