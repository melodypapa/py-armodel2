...
class ModeSwitchInterfaceBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ModeSwitchInterfaceBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ModeSwitchInterfaceBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ModeSwitchInterfaceBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ModeSwitchInterfaceBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ModeSwitchInterfaceBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ModeSwitchInterfaceBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ModeSwitchInterfaceBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ModeSwitchInterfaceBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ModeSwitchInterfaceBuilder":
        """Set uuid attribute.
    ...
    def with_is_service(self, value: Optional[Boolean]) -> "ModeSwitchInterfaceBuilder":
    ...
    def with_service_kind(self, value: Optional[ServiceProviderEnum]) -> "ModeSwitchInterfaceBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ModeSwitchInterfaceBuilder":
    ...
    def clear_short_name_fragments(self) -> "ModeSwitchInterfaceBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ModeSwitchInterfaceBuilder":
    ...
    def clear_annotations(self) -> "ModeSwitchInterfaceBuilder":
