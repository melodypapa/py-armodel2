...
class TriggerInterfaceMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "TriggerInterfaceMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TriggerInterfaceMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "TriggerInterfaceMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "TriggerInterfaceMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "TriggerInterfaceMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "TriggerInterfaceMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "TriggerInterfaceMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "TriggerInterfaceMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "TriggerInterfaceMappingBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TriggerInterfaceMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "TriggerInterfaceMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "TriggerInterfaceMappingBuilder":
    ...
    def clear_annotations(self) -> "TriggerInterfaceMappingBuilder":
