...
class TriggerInterfaceBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "TriggerInterfaceBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TriggerInterfaceBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "TriggerInterfaceBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "TriggerInterfaceBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "TriggerInterfaceBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "TriggerInterfaceBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "TriggerInterfaceBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "TriggerInterfaceBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "TriggerInterfaceBuilder":
        """Set uuid attribute.
    ...
    def with_is_service(self, value: Optional[Boolean]) -> "TriggerInterfaceBuilder":
    ...
    def with_service_kind(self, value: Optional[ServiceProviderEnum]) -> "TriggerInterfaceBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TriggerInterfaceBuilder":
    ...
    def clear_short_name_fragments(self) -> "TriggerInterfaceBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "TriggerInterfaceBuilder":
    ...
    def clear_annotations(self) -> "TriggerInterfaceBuilder":
