...
class PortInterfaceMappingSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "PortInterfaceMappingSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "PortInterfaceMappingSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "PortInterfaceMappingSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "PortInterfaceMappingSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "PortInterfaceMappingSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "PortInterfaceMappingSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "PortInterfaceMappingSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "PortInterfaceMappingSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "PortInterfaceMappingSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "PortInterfaceMappingSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "PortInterfaceMappingSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "PortInterfaceMappingSetBuilder":
    ...
    def clear_annotations(self) -> "PortInterfaceMappingSetBuilder":
