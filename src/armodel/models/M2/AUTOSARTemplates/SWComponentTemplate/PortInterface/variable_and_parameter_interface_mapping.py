...
class VariableAndParameterInterfaceMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "VariableAndParameterInterfaceMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "VariableAndParameterInterfaceMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "VariableAndParameterInterfaceMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "VariableAndParameterInterfaceMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "VariableAndParameterInterfaceMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "VariableAndParameterInterfaceMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "VariableAndParameterInterfaceMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "VariableAndParameterInterfaceMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "VariableAndParameterInterfaceMappingBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "VariableAndParameterInterfaceMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "VariableAndParameterInterfaceMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "VariableAndParameterInterfaceMappingBuilder":
    ...
    def clear_annotations(self) -> "VariableAndParameterInterfaceMappingBuilder":
