...
class ModeDeclarationMappingSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ModeDeclarationMappingSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ModeDeclarationMappingSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ModeDeclarationMappingSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ModeDeclarationMappingSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ModeDeclarationMappingSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ModeDeclarationMappingSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ModeDeclarationMappingSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ModeDeclarationMappingSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ModeDeclarationMappingSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ModeDeclarationMappingSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "ModeDeclarationMappingSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ModeDeclarationMappingSetBuilder":
    ...
    def clear_annotations(self) -> "ModeDeclarationMappingSetBuilder":
