...
class SymbolProps(ImplementationProps):
    ...
    def deserialize(cls, element: ET.Element) -> "SymbolProps":
        ...
        return super(SymbolProps, cls).deserialize(element)



class SymbolPropsBuilder:
    """Builder for SymbolProps with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "SymbolPropsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SymbolPropsBuilder":
    ...
    def with_symbol(self, value: Optional[CIdentifier]) -> "SymbolPropsBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SymbolPropsBuilder":
    ...
    def clear_short_name_fragments(self) -> "SymbolPropsBuilder":
    ...
    def build(self) -> SymbolProps:
        """Build and return the SymbolProps instance with validation."""
