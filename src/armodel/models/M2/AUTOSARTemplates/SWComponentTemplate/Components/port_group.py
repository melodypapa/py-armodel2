...
class PortGroupBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "PortGroupBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "PortGroupBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "PortGroupBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "PortGroupBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "PortGroupBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "PortGroupBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "PortGroupBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "PortGroupBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "PortGroupBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "PortGroupBuilder":
    ...
    def clear_short_name_fragments(self) -> "PortGroupBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "PortGroupBuilder":
    ...
    def clear_annotations(self) -> "PortGroupBuilder":
