...
class RTriggerInAtomicSwcInstanceRefBuilder:
    ...
    def with_base(self, value: Optional[AtomicSwComponentType]) -> "RTriggerInAtomicSwcInstanceRefBuilder":
        """Set base attribute.
    ...
    def with_context_port(self, value: Optional[PortPrototype]) -> "RTriggerInAtomicSwcInstanceRefBuilder":
    ...
    def with_target(self, value: Optional[Trigger]) -> "RTriggerInAtomicSwcInstanceRefBuilder":
    ...
    def with_context_r_port_prototype(self, value: Optional[AbstractRequiredPortPrototype]) -> "RTriggerInAtomicSwcInstanceRefBuilder":
