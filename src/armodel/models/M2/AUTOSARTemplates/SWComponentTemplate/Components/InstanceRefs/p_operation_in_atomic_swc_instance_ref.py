...
class POperationInAtomicSwcInstanceRefBuilder:
    ...
    def with_base(self, value: Optional[AtomicSwComponentType]) -> "POperationInAtomicSwcInstanceRefBuilder":
        """Set base attribute.
    ...
    def with_context_port(self, value: Optional[PortPrototype]) -> "POperationInAtomicSwcInstanceRefBuilder":
    ...
    def with_target_operation(self, value: Optional[ClientServerOperation]) -> "POperationInAtomicSwcInstanceRefBuilder":
    ...
    def with_context_p_port_prototype(self, value: Optional[AbstractProvidedPortPrototype]) -> "POperationInAtomicSwcInstanceRefBuilder":
