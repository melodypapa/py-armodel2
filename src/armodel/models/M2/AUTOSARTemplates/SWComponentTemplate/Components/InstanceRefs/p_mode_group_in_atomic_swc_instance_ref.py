...
class PModeGroupInAtomicSwcInstanceRefBuilder:
    ...
    def with_base(self, value: Optional[AtomicSwComponentType]) -> "PModeGroupInAtomicSwcInstanceRefBuilder":
        """Set base attribute.
    ...
    def with_context_port(self, value: Optional[PortPrototype]) -> "PModeGroupInAtomicSwcInstanceRefBuilder":
    ...
    def with_target(self, value: Optional[ModeDeclarationGroup]) -> "PModeGroupInAtomicSwcInstanceRefBuilder":
