...
class ROperationInAtomicSwcInstanceRef(OperationInAtomicSwcInstanceRef):
    ...
    _xml_members = [
        ...
        ("target_required_operation", None, False, False, ClientServerOperation),  # targetRequiredOperation
    ]
    ...
    def deserialize(cls, element: ET.Element) -> "ROperationInAtomicSwcInstanceRef":
        ...
        # Cast to ROperationInAtomicSwcInstanceRef since parent returns ARObject
        return cast("ROperationInAtomicSwcInstanceRef", obj)
