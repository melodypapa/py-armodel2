...
class ROperationInAtomicSwcInstanceRefBuilder:
    ...
    def with_base(self, value: Optional[AtomicSwComponentType]) -> "ROperationInAtomicSwcInstanceRefBuilder":
        """Set base attribute.
    ...
    def with_context_port(self, value: Optional[PortPrototype]) -> "ROperationInAtomicSwcInstanceRefBuilder":
    ...
    def with_target_operation(self, value: Optional[ClientServerOperation]) -> "ROperationInAtomicSwcInstanceRefBuilder":
