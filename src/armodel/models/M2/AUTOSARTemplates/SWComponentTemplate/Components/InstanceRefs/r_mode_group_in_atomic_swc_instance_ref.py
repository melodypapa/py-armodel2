...
from armodel.models.M2.AUTOSARTemplates.SWComponentTemplate.Components.InstanceRefs.mode_group_in_atomic_swc_instance_ref import ModeGroupInAtomicSwcInstanceRefBuilder
...
class RModeGroupInAtomicSWCInstanceRefBuilder(ModeGroupInAtomicSwcInstanceRefBuilder):
