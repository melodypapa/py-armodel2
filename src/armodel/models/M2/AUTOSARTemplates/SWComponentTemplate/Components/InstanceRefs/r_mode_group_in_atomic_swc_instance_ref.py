...
class RModeGroupInAtomicSWCInstanceRefBuilder:
    """Builder for RModeGroupInAtomicSWCInstanceRef with fluent API."""
    ...
    def with_base(self, value: Optional[AtomicSwComponentType]) -> "RModeGroupInAtomicSWCInstanceRefBuilder":
        """Set base attribute.
    ...
    def with_context_port(self, value: Optional[PortPrototype]) -> "RModeGroupInAtomicSWCInstanceRefBuilder":
    ...
    def with_target(self, value: Optional[ModeDeclarationGroup]) -> "RModeGroupInAtomicSWCInstanceRefBuilder":
    ...
    def with_context_r_port_prototype(self, value: Optional[AbstractRequiredPortPrototype]) -> "RModeGroupInAtomicSWCInstanceRefBuilder":
    ...
    def build(self) -> RModeGroupInAtomicSWCInstanceRef:
        """Build and return the RModeGroupInAtomicSWCInstanceRef instance with validation."""
