...
class PTriggerInAtomicSwcTypeInstanceRefBuilder:
    ...
    def with_base(self, value: Optional[AtomicSwComponentType]) -> "PTriggerInAtomicSwcTypeInstanceRefBuilder":
        """Set base attribute.
    ...
    def with_context_port(self, value: Optional[PortPrototype]) -> "PTriggerInAtomicSwcTypeInstanceRefBuilder":
    ...
    def with_target(self, value: Optional[Trigger]) -> "PTriggerInAtomicSwcTypeInstanceRefBuilder":
    ...
    def with_context_p_port_prototype(self, value: Optional[AbstractProvidedPortPrototype]) -> "PTriggerInAtomicSwcTypeInstanceRefBuilder":
