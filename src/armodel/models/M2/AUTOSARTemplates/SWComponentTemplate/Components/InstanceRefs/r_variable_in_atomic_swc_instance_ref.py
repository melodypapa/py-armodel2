...
class RVariableInAtomicSwcInstanceRefBuilder:
    ...
    def with_abstract_target(self, value: Optional[VariableDataPrototype]) -> "RVariableInAtomicSwcInstanceRefBuilder":
    ...
    def with_base(self, value: Optional[AtomicSwComponentType]) -> "RVariableInAtomicSwcInstanceRefBuilder":
        """Set base attribute.
    ...
    def with_context_port(self, value: Optional[PortPrototype]) -> "RVariableInAtomicSwcInstanceRefBuilder":
