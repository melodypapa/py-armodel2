...
class ParameterDataPrototypeBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ParameterDataPrototypeBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ParameterDataPrototypeBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ParameterDataPrototypeBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ParameterDataPrototypeBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ParameterDataPrototypeBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ParameterDataPrototypeBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ParameterDataPrototypeBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ParameterDataPrototypeBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ParameterDataPrototypeBuilder":
        """Set uuid attribute.
    ...
    def with_sw_data_def(self, value: Optional[SwDataDefProps]) -> "ParameterDataPrototypeBuilder":
    ...
    def with_type(self, value: Optional[AutosarDataType]) -> "ParameterDataPrototypeBuilder":
        """Set type attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ParameterDataPrototypeBuilder":
    ...
    def clear_short_name_fragments(self) -> "ParameterDataPrototypeBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ParameterDataPrototypeBuilder":
    ...
    def clear_annotations(self) -> "ParameterDataPrototypeBuilder":
