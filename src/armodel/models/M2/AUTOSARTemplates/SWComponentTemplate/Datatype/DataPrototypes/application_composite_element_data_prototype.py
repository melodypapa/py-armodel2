...
from armodel.models.M2.AUTOSARTemplates.SWComponentTemplate.Datatype.DataPrototypes.data_prototype import DataPrototypeBuilder
...
class ApplicationCompositeElementDataPrototypeBuilder(DataPrototypeBuilder):
    """Builder for ApplicationCompositeElementDataPrototype with fluent API."""
    ...
    def with_type(self, value: Optional[ApplicationDataType]) -> "ApplicationCompositeElementDataPrototypeBuilder":
        """Set type attribute.
    ...
    def build(self) -> ApplicationCompositeElementDataPrototype:
        """Build and return the ApplicationCompositeElementDataPrototype instance (abstract)."""
