...
class VariableDataPrototypeBuilder:
    """Builder for VariableDataPrototype with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "VariableDataPrototypeBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "VariableDataPrototypeBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "VariableDataPrototypeBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "VariableDataPrototypeBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "VariableDataPrototypeBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "VariableDataPrototypeBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "VariableDataPrototypeBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "VariableDataPrototypeBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "VariableDataPrototypeBuilder":
        """Set uuid attribute.
    ...
    def with_sw_data_def(self, value: Optional[SwDataDefProps]) -> "VariableDataPrototypeBuilder":
    ...
    def with_type(self, value: Optional[AutosarDataType]) -> "VariableDataPrototypeBuilder":
        """Set type attribute.
    ...
    def with_init_value(self, value: Optional[ValueSpecification]) -> "VariableDataPrototypeBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "VariableDataPrototypeBuilder":
    ...
    def clear_short_name_fragments(self) -> "VariableDataPrototypeBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "VariableDataPrototypeBuilder":
    ...
    def clear_annotations(self) -> "VariableDataPrototypeBuilder":
    ...
    def build(self) -> VariableDataPrototype:
        """Build and return the VariableDataPrototype instance with validation."""
