...
class DataTypeMappingSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DataTypeMappingSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DataTypeMappingSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DataTypeMappingSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DataTypeMappingSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DataTypeMappingSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DataTypeMappingSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DataTypeMappingSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DataTypeMappingSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DataTypeMappingSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DataTypeMappingSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "DataTypeMappingSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DataTypeMappingSetBuilder":
    ...
    def clear_annotations(self) -> "DataTypeMappingSetBuilder":
