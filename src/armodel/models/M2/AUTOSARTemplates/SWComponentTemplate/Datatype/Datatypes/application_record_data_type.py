...
class ApplicationRecordDataTypeBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ApplicationRecordDataTypeBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ApplicationRecordDataTypeBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ApplicationRecordDataTypeBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ApplicationRecordDataTypeBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ApplicationRecordDataTypeBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ApplicationRecordDataTypeBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ApplicationRecordDataTypeBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ApplicationRecordDataTypeBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ApplicationRecordDataTypeBuilder":
        """Set uuid attribute.
    ...
    def with_sw_data_def_props(self, value: Optional[SwDataDefProps]) -> "ApplicationRecordDataTypeBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ApplicationRecordDataTypeBuilder":
    ...
    def clear_short_name_fragments(self) -> "ApplicationRecordDataTypeBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ApplicationRecordDataTypeBuilder":
    ...
    def clear_annotations(self) -> "ApplicationRecordDataTypeBuilder":
