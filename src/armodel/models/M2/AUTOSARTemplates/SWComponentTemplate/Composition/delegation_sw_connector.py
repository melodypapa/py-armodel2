...
class DelegationSwConnectorBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DelegationSwConnectorBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DelegationSwConnectorBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DelegationSwConnectorBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DelegationSwConnectorBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DelegationSwConnectorBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DelegationSwConnectorBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DelegationSwConnectorBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DelegationSwConnectorBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DelegationSwConnectorBuilder":
        """Set uuid attribute.
    ...
    def with_mapping(self, value: Optional[PortInterfaceMapping]) -> "DelegationSwConnectorBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DelegationSwConnectorBuilder":
    ...
    def clear_short_name_fragments(self) -> "DelegationSwConnectorBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DelegationSwConnectorBuilder":
    ...
    def clear_annotations(self) -> "DelegationSwConnectorBuilder":
