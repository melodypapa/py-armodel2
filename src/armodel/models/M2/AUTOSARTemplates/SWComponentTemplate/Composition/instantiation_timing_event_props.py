...
class InstantiationTimingEventPropsBuilder:
    ...
    def with_refined_event(self, value: Optional[RTEEvent]) -> "InstantiationTimingEventPropsBuilder":
    ...
    def with_short_label(self, value: Optional[Identifier]) -> "InstantiationTimingEventPropsBuilder":
