...
class SwComponentPrototypeBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SwComponentPrototypeBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SwComponentPrototypeBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SwComponentPrototypeBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SwComponentPrototypeBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SwComponentPrototypeBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SwComponentPrototypeBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SwComponentPrototypeBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SwComponentPrototypeBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SwComponentPrototypeBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SwComponentPrototypeBuilder":
    ...
    def clear_short_name_fragments(self) -> "SwComponentPrototypeBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SwComponentPrototypeBuilder":
    ...
    def clear_annotations(self) -> "SwComponentPrototypeBuilder":
