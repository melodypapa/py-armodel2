...
class PassThroughSwConnectorBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "PassThroughSwConnectorBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "PassThroughSwConnectorBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "PassThroughSwConnectorBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "PassThroughSwConnectorBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "PassThroughSwConnectorBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "PassThroughSwConnectorBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "PassThroughSwConnectorBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "PassThroughSwConnectorBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "PassThroughSwConnectorBuilder":
        """Set uuid attribute.
    ...
    def with_mapping(self, value: Optional[PortInterfaceMapping]) -> "PassThroughSwConnectorBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "PassThroughSwConnectorBuilder":
    ...
    def clear_short_name_fragments(self) -> "PassThroughSwConnectorBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "PassThroughSwConnectorBuilder":
    ...
    def clear_annotations(self) -> "PassThroughSwConnectorBuilder":
