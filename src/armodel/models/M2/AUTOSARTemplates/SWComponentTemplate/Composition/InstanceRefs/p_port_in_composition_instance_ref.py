...
class PPortInCompositionInstanceRefBuilder:
    ...
    def with_abstract_context_component(self, value: Optional[SwComponentPrototype]) -> "PPortInCompositionInstanceRefBuilder":
    ...
    def with_base(self, value: Optional[CompositionSwComponentType]) -> "PPortInCompositionInstanceRefBuilder":
        """Set base attribute.
    ...
    def with_target_port(self, value: Optional[PortPrototype]) -> "PPortInCompositionInstanceRefBuilder":
