...
class BulkNvDataDescriptorBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "BulkNvDataDescriptorBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "BulkNvDataDescriptorBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "BulkNvDataDescriptorBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "BulkNvDataDescriptorBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "BulkNvDataDescriptorBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "BulkNvDataDescriptorBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "BulkNvDataDescriptorBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "BulkNvDataDescriptorBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "BulkNvDataDescriptorBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "BulkNvDataDescriptorBuilder":
    ...
    def clear_short_name_fragments(self) -> "BulkNvDataDescriptorBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "BulkNvDataDescriptorBuilder":
    ...
    def clear_annotations(self) -> "BulkNvDataDescriptorBuilder":
