...
class EcucStringParamDef(ARObject):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(EcucStringParamDef, self).serialize()
    ...
    def deserialize(cls, element: ET.Element) -> "EcucStringParamDef":
        ...
        obj = super(EcucStringParamDef, cls).deserialize(element)
...
class EcucStringParamDefBuilder(BuilderBase):
    """Builder for EcucStringParamDef with fluent API."""
    ...
    def build(self) -> EcucStringParamDef:
        """Build and return the EcucStringParamDef instance with validation."""
