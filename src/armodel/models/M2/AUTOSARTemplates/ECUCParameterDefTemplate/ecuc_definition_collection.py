...
class EcucDefinitionCollectionBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "EcucDefinitionCollectionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "EcucDefinitionCollectionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "EcucDefinitionCollectionBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "EcucDefinitionCollectionBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "EcucDefinitionCollectionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "EcucDefinitionCollectionBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "EcucDefinitionCollectionBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "EcucDefinitionCollectionBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "EcucDefinitionCollectionBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "EcucDefinitionCollectionBuilder":
    ...
    def clear_short_name_fragments(self) -> "EcucDefinitionCollectionBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "EcucDefinitionCollectionBuilder":
    ...
    def clear_annotations(self) -> "EcucDefinitionCollectionBuilder":
