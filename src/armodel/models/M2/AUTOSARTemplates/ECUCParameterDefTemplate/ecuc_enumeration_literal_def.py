...
class EcucEnumerationLiteralDefBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "EcucEnumerationLiteralDefBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "EcucEnumerationLiteralDefBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "EcucEnumerationLiteralDefBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "EcucEnumerationLiteralDefBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "EcucEnumerationLiteralDefBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "EcucEnumerationLiteralDefBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "EcucEnumerationLiteralDefBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "EcucEnumerationLiteralDefBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "EcucEnumerationLiteralDefBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "EcucEnumerationLiteralDefBuilder":
    ...
    def clear_short_name_fragments(self) -> "EcucEnumerationLiteralDefBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "EcucEnumerationLiteralDefBuilder":
    ...
    def clear_annotations(self) -> "EcucEnumerationLiteralDefBuilder":
