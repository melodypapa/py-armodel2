...
class EcucMultiplicityConfigurationClassBuilder:
    ...
    def with_config_class(self, value: Optional[EcucConfigurationClassEnum]) -> "EcucMultiplicityConfigurationClassBuilder":
    ...
    def with_config_variant(self, value: Optional[any (EcucConfiguration)]) -> "EcucMultiplicityConfigurationClassBuilder":
