...
class EcucValidationConditionBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "EcucValidationConditionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "EcucValidationConditionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "EcucValidationConditionBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "EcucValidationConditionBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "EcucValidationConditionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "EcucValidationConditionBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "EcucValidationConditionBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "EcucValidationConditionBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "EcucValidationConditionBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "EcucValidationConditionBuilder":
    ...
    def clear_short_name_fragments(self) -> "EcucValidationConditionBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "EcucValidationConditionBuilder":
    ...
    def clear_annotations(self) -> "EcucValidationConditionBuilder":
    ...
    def add_ecuc_querie(self, item: EcucQuery) -> "EcucValidationConditionBuilder":
