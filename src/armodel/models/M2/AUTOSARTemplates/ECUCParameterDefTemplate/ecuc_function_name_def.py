...
class EcucFunctionNameDefBuilder(BuilderBase):
    """Builder for EcucFunctionNameDef with fluent API."""
    ...
    def build(self) -> EcucFunctionNameDef:
        """Build and return the EcucFunctionNameDef instance with validation."""
