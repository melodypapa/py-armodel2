...
from armodel.models.M2.AUTOSARTemplates.ECUCParameterDefTemplate.ecuc_abstract_internal_reference_def import EcucAbstractInternalReferenceDefBuilder
...
class EcucUriReferenceDefBuilder(EcucAbstractInternalReferenceDefBuilder):
