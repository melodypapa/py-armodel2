...
class EcucDestinationUriDefBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "EcucDestinationUriDefBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "EcucDestinationUriDefBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "EcucDestinationUriDefBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "EcucDestinationUriDefBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "EcucDestinationUriDefBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "EcucDestinationUriDefBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "EcucDestinationUriDefBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "EcucDestinationUriDefBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "EcucDestinationUriDefBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "EcucDestinationUriDefBuilder":
    ...
    def clear_short_name_fragments(self) -> "EcucDestinationUriDefBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "EcucDestinationUriDefBuilder":
    ...
    def clear_annotations(self) -> "EcucDestinationUriDefBuilder":
