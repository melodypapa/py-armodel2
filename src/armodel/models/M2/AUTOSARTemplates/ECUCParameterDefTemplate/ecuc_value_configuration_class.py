...
class EcucValueConfigurationClassBuilder:
    ...
    def with_config_class(self, value: Optional[EcucConfigurationClassEnum]) -> "EcucValueConfigurationClassBuilder":
    ...
    def with_config_variant(self, value: Optional[any (EcucConfiguration)]) -> "EcucValueConfigurationClassBuilder":
