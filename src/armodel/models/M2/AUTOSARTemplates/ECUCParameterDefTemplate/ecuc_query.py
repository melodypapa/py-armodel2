...
class EcucQueryBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "EcucQueryBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "EcucQueryBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "EcucQueryBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "EcucQueryBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "EcucQueryBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "EcucQueryBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "EcucQueryBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "EcucQueryBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "EcucQueryBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "EcucQueryBuilder":
    ...
    def clear_short_name_fragments(self) -> "EcucQueryBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "EcucQueryBuilder":
    ...
    def clear_annotations(self) -> "EcucQueryBuilder":
