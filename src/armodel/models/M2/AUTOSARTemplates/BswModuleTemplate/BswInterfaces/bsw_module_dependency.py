...
class BswModuleDependencyBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "BswModuleDependencyBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "BswModuleDependencyBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "BswModuleDependencyBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "BswModuleDependencyBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "BswModuleDependencyBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "BswModuleDependencyBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "BswModuleDependencyBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "BswModuleDependencyBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "BswModuleDependencyBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "BswModuleDependencyBuilder":
    ...
    def clear_short_name_fragments(self) -> "BswModuleDependencyBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "BswModuleDependencyBuilder":
    ...
    def clear_annotations(self) -> "BswModuleDependencyBuilder":
