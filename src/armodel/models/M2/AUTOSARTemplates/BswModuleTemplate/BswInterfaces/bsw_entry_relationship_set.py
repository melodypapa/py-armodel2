...
class BswEntryRelationshipSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "BswEntryRelationshipSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "BswEntryRelationshipSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "BswEntryRelationshipSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "BswEntryRelationshipSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "BswEntryRelationshipSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "BswEntryRelationshipSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "BswEntryRelationshipSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "BswEntryRelationshipSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "BswEntryRelationshipSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "BswEntryRelationshipSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "BswEntryRelationshipSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "BswEntryRelationshipSetBuilder":
    ...
    def clear_annotations(self) -> "BswEntryRelationshipSetBuilder":
