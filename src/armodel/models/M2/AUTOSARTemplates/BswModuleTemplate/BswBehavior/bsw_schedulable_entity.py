...
class BswSchedulableEntityBuilder:
    ...
    def with_activations(self, items: list[ExecutableEntity]) -> "BswSchedulableEntityBuilder":
    ...
    def with_exclusive_area_nestings(self, items: list[ExclusiveAreaNestingOrder]) -> "BswSchedulableEntityBuilder":
    ...
    def with_minimum_start(self, value: Optional[TimeValue]) -> "BswSchedulableEntityBuilder":
    ...
    def with_reentrancy_level_enum(self, value: Optional[ReentrancyLevelEnum]) -> "BswSchedulableEntityBuilder":
    ...
    def with_accessed_modes(self, items: list[ModeDeclarationGroup]) -> "BswSchedulableEntityBuilder":
    ...
    def with_data_receives(self, items: list[BswVariableAccess]) -> "BswSchedulableEntityBuilder":
    ...
    def with_implemented(self, value: Optional[BswModuleEntry]) -> "BswSchedulableEntityBuilder":
    ...
    def with_managed_modes(self, items: list[ModeDeclarationGroup]) -> "BswSchedulableEntityBuilder":
    ...
    def with_scheduler_name(self, value: Optional[BswSchedulerNamePrefix]) -> "BswSchedulableEntityBuilder":
    ...
    def add_activation(self, item: ExecutableEntity) -> "BswSchedulableEntityBuilder":
    ...
    def clear_activations(self) -> "BswSchedulableEntityBuilder":
    ...
    def add_exclusive_area_nesting(self, item: ExclusiveAreaNestingOrder) -> "BswSchedulableEntityBuilder":
    ...
    def clear_exclusive_area_nestings(self) -> "BswSchedulableEntityBuilder":
    ...
    def add_accessed_mode(self, item: ModeDeclarationGroup) -> "BswSchedulableEntityBuilder":
    ...
    def clear_accessed_modes(self) -> "BswSchedulableEntityBuilder":
    ...
    def add_data_receive(self, item: BswVariableAccess) -> "BswSchedulableEntityBuilder":
    ...
    def clear_data_receives(self) -> "BswSchedulableEntityBuilder":
    ...
    def add_managed_mode(self, item: ModeDeclarationGroup) -> "BswSchedulableEntityBuilder":
    ...
    def clear_managed_modes(self) -> "BswSchedulableEntityBuilder":
