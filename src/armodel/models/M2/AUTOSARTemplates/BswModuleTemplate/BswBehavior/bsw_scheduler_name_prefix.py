...
class BswSchedulerNamePrefixBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "BswSchedulerNamePrefixBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "BswSchedulerNamePrefixBuilder":
    ...
    def with_symbol(self, value: Optional[CIdentifier]) -> "BswSchedulerNamePrefixBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "BswSchedulerNamePrefixBuilder":
    ...
    def clear_short_name_fragments(self) -> "BswSchedulerNamePrefixBuilder":
