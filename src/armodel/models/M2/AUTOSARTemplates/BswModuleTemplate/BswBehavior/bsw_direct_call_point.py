...
class BswDirectCallPoint(BswModuleCallPoint):
    ...
    def serialize(self) -> ET.Element:
        ...
        if self.called_entry_ref is not None:
            serialized = SerializationHelper.serialize_item(self.called_entry_ref, "BswModuleEntry")
    ...
    def deserialize(cls, element: ET.Element) -> "BswDirectCallPoint":
        ...
        child = SerializationHelper.find_child_element(element, "CALLED-ENTRY-REF")
...
class BswDirectCallPointBuilder:
    """Builder for BswDirectCallPoint with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "BswDirectCallPointBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "BswDirectCallPointBuilder":
    ...
    def with_contexts(self, items: list[BswDistinguishedPartition]) -> "BswDirectCallPointBuilder":
    ...
    def with_called_entry(self, value: Optional[BswModuleEntry]) -> "BswDirectCallPointBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "BswDirectCallPointBuilder":
    ...
    def clear_short_name_fragments(self) -> "BswDirectCallPointBuilder":
    ...
    def add_context(self, item: BswDistinguishedPartition) -> "BswDirectCallPointBuilder":
    ...
    def clear_contexts(self) -> "BswDirectCallPointBuilder":
    ...
    def build(self) -> BswDirectCallPoint:
        """Build and return the BswDirectCallPoint instance with validation."""
