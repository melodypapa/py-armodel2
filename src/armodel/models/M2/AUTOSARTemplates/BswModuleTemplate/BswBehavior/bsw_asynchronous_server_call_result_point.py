...
class BswAsynchronousServerCallResultPointBuilder:
    """Builder for BswAsynchronousServerCallResultPoint with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "BswAsynchronousServerCallResultPointBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "BswAsynchronousServerCallResultPointBuilder":
    ...
    def with_contexts(self, items: list[BswDistinguishedPartition]) -> "BswAsynchronousServerCallResultPointBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "BswAsynchronousServerCallResultPointBuilder":
    ...
    def clear_short_name_fragments(self) -> "BswAsynchronousServerCallResultPointBuilder":
    ...
    def add_context(self, item: BswDistinguishedPartition) -> "BswAsynchronousServerCallResultPointBuilder":
    ...
    def clear_contexts(self) -> "BswAsynchronousServerCallResultPointBuilder":
    ...
    def build(self) -> BswAsynchronousServerCallResultPoint:
        """Build and return the BswAsynchronousServerCallResultPoint instance with validation."""
