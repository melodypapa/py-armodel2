...
class BswSynchronousServerCallPointBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "BswSynchronousServerCallPointBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "BswSynchronousServerCallPointBuilder":
    ...
    def with_contexts(self, items: list[BswDistinguishedPartition]) -> "BswSynchronousServerCallPointBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "BswSynchronousServerCallPointBuilder":
    ...
    def clear_short_name_fragments(self) -> "BswSynchronousServerCallPointBuilder":
    ...
    def add_context(self, item: BswDistinguishedPartition) -> "BswSynchronousServerCallPointBuilder":
    ...
    def clear_contexts(self) -> "BswSynchronousServerCallPointBuilder":
