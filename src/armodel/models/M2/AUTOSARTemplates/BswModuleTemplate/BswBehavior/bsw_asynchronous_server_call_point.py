...
class BswAsynchronousServerCallPointBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "BswAsynchronousServerCallPointBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "BswAsynchronousServerCallPointBuilder":
    ...
    def with_contexts(self, items: list[BswDistinguishedPartition]) -> "BswAsynchronousServerCallPointBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "BswAsynchronousServerCallPointBuilder":
    ...
    def clear_short_name_fragments(self) -> "BswAsynchronousServerCallPointBuilder":
    ...
    def add_context(self, item: BswDistinguishedPartition) -> "BswAsynchronousServerCallPointBuilder":
    ...
    def clear_contexts(self) -> "BswAsynchronousServerCallPointBuilder":
