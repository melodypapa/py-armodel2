...
class BswVariableAccessBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "BswVariableAccessBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "BswVariableAccessBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "BswVariableAccessBuilder":
    ...
    def clear_short_name_fragments(self) -> "BswVariableAccessBuilder":
