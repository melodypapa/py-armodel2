...
class BswCalledEntityBuilder:
    ...
    def with_activations(self, items: list[ExecutableEntity]) -> "BswCalledEntityBuilder":
    ...
    def with_exclusive_area_nestings(self, items: list[ExclusiveAreaNestingOrder]) -> "BswCalledEntityBuilder":
    ...
    def with_minimum_start(self, value: Optional[TimeValue]) -> "BswCalledEntityBuilder":
    ...
    def with_reentrancy_level_enum(self, value: Optional[ReentrancyLevelEnum]) -> "BswCalledEntityBuilder":
    ...
    def add_activation(self, item: ExecutableEntity) -> "BswCalledEntityBuilder":
    ...
    def clear_activations(self) -> "BswCalledEntityBuilder":
    ...
    def add_exclusive_area_nesting(self, item: ExclusiveAreaNestingOrder) -> "BswCalledEntityBuilder":
    ...
    def clear_exclusive_area_nestings(self) -> "BswCalledEntityBuilder":
