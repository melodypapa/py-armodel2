...
class BswInternalTriggeringPointBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "BswInternalTriggeringPointBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "BswInternalTriggeringPointBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "BswInternalTriggeringPointBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "BswInternalTriggeringPointBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "BswInternalTriggeringPointBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "BswInternalTriggeringPointBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "BswInternalTriggeringPointBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "BswInternalTriggeringPointBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "BswInternalTriggeringPointBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "BswInternalTriggeringPointBuilder":
    ...
    def clear_short_name_fragments(self) -> "BswInternalTriggeringPointBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "BswInternalTriggeringPointBuilder":
    ...
    def clear_annotations(self) -> "BswInternalTriggeringPointBuilder":
