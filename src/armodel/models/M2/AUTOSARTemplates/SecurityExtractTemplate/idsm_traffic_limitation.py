...
class IdsmTrafficLimitationBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "IdsmTrafficLimitationBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "IdsmTrafficLimitationBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "IdsmTrafficLimitationBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "IdsmTrafficLimitationBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "IdsmTrafficLimitationBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "IdsmTrafficLimitationBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "IdsmTrafficLimitationBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "IdsmTrafficLimitationBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "IdsmTrafficLimitationBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "IdsmTrafficLimitationBuilder":
    ...
    def clear_short_name_fragments(self) -> "IdsmTrafficLimitationBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "IdsmTrafficLimitationBuilder":
    ...
    def clear_annotations(self) -> "IdsmTrafficLimitationBuilder":
