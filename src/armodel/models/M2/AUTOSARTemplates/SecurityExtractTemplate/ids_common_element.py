...
class IdsCommonElement(ARElement, ABC):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(IdsCommonElement, self).serialize()
...
class IdsCommonElementBuilder(ARElementBuilder):
    """Builder for IdsCommonElement with fluent API."""
    ...
    def build(self) -> IdsCommonElement:
        """Build and return the IdsCommonElement instance (abstract)."""
