...
class SecurityEventThresholdFilter(AbstractSecurityEventFilter):
    ...
    _xml_members = [
        ("interval_length", None, True, False, None),  # intervalLength
    ...
    def deserialize(cls, element: ET.Element) -> "SecurityEventThresholdFilter":
        ...
        # Cast to SecurityEventThresholdFilter since parent returns ARObject
        return cast("SecurityEventThresholdFilter", obj)
