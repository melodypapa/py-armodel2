...
class SecurityEventStateFilterBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SecurityEventStateFilterBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SecurityEventStateFilterBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SecurityEventStateFilterBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SecurityEventStateFilterBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SecurityEventStateFilterBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SecurityEventStateFilterBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SecurityEventStateFilterBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SecurityEventStateFilterBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SecurityEventStateFilterBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SecurityEventStateFilterBuilder":
    ...
    def clear_short_name_fragments(self) -> "SecurityEventStateFilterBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SecurityEventStateFilterBuilder":
    ...
    def clear_annotations(self) -> "SecurityEventStateFilterBuilder":
