...
class IdsDesignBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "IdsDesignBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "IdsDesignBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "IdsDesignBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "IdsDesignBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "IdsDesignBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "IdsDesignBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "IdsDesignBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "IdsDesignBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "IdsDesignBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "IdsDesignBuilder":
    ...
    def clear_short_name_fragments(self) -> "IdsDesignBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "IdsDesignBuilder":
    ...
    def clear_annotations(self) -> "IdsDesignBuilder":
