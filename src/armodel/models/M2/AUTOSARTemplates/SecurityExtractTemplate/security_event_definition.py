...
class SecurityEventDefinitionBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SecurityEventDefinitionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SecurityEventDefinitionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SecurityEventDefinitionBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SecurityEventDefinitionBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SecurityEventDefinitionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SecurityEventDefinitionBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SecurityEventDefinitionBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SecurityEventDefinitionBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SecurityEventDefinitionBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SecurityEventDefinitionBuilder":
    ...
    def clear_short_name_fragments(self) -> "SecurityEventDefinitionBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SecurityEventDefinitionBuilder":
    ...
    def clear_annotations(self) -> "SecurityEventDefinitionBuilder":
