...
class SecurityEventFilterChainBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SecurityEventFilterChainBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SecurityEventFilterChainBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SecurityEventFilterChainBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SecurityEventFilterChainBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SecurityEventFilterChainBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SecurityEventFilterChainBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SecurityEventFilterChainBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SecurityEventFilterChainBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SecurityEventFilterChainBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SecurityEventFilterChainBuilder":
    ...
    def clear_short_name_fragments(self) -> "SecurityEventFilterChainBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SecurityEventFilterChainBuilder":
    ...
    def clear_annotations(self) -> "SecurityEventFilterChainBuilder":
