...
class AbstractSecurityEventFilterBuilder(IdentifiableBuilder):
    """Builder for AbstractSecurityEventFilter with fluent API."""
    ...
    def build(self) -> AbstractSecurityEventFilter:
        """Build and return the AbstractSecurityEventFilter instance (abstract)."""
