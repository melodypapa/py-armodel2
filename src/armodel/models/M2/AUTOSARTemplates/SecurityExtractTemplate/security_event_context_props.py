...
class SecurityEventContextPropsBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SecurityEventContextPropsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SecurityEventContextPropsBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SecurityEventContextPropsBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SecurityEventContextPropsBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SecurityEventContextPropsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SecurityEventContextPropsBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SecurityEventContextPropsBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SecurityEventContextPropsBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SecurityEventContextPropsBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SecurityEventContextPropsBuilder":
    ...
    def clear_short_name_fragments(self) -> "SecurityEventContextPropsBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SecurityEventContextPropsBuilder":
    ...
    def clear_annotations(self) -> "SecurityEventContextPropsBuilder":
