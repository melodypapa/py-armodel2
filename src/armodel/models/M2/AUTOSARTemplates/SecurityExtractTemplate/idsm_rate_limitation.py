...
class IdsmRateLimitationBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "IdsmRateLimitationBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "IdsmRateLimitationBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "IdsmRateLimitationBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "IdsmRateLimitationBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "IdsmRateLimitationBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "IdsmRateLimitationBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "IdsmRateLimitationBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "IdsmRateLimitationBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "IdsmRateLimitationBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "IdsmRateLimitationBuilder":
    ...
    def clear_short_name_fragments(self) -> "IdsmRateLimitationBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "IdsmRateLimitationBuilder":
    ...
    def clear_annotations(self) -> "IdsmRateLimitationBuilder":
