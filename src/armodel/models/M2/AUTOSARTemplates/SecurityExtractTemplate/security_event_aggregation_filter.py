...
class SecurityEventAggregationFilterBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SecurityEventAggregationFilterBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SecurityEventAggregationFilterBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SecurityEventAggregationFilterBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SecurityEventAggregationFilterBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SecurityEventAggregationFilterBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SecurityEventAggregationFilterBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SecurityEventAggregationFilterBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SecurityEventAggregationFilterBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SecurityEventAggregationFilterBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SecurityEventAggregationFilterBuilder":
    ...
    def clear_short_name_fragments(self) -> "SecurityEventAggregationFilterBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SecurityEventAggregationFilterBuilder":
    ...
    def clear_annotations(self) -> "SecurityEventAggregationFilterBuilder":
