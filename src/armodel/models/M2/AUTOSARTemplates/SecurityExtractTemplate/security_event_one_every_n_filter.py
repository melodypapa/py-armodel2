...
class SecurityEventOneEveryNFilterBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SecurityEventOneEveryNFilterBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SecurityEventOneEveryNFilterBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SecurityEventOneEveryNFilterBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SecurityEventOneEveryNFilterBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SecurityEventOneEveryNFilterBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SecurityEventOneEveryNFilterBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SecurityEventOneEveryNFilterBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SecurityEventOneEveryNFilterBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SecurityEventOneEveryNFilterBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SecurityEventOneEveryNFilterBuilder":
    ...
    def clear_short_name_fragments(self) -> "SecurityEventOneEveryNFilterBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SecurityEventOneEveryNFilterBuilder":
    ...
    def clear_annotations(self) -> "SecurityEventOneEveryNFilterBuilder":
