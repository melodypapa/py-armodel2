...
class DiagnosticProtocolBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticProtocolBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticProtocolBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticProtocolBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticProtocolBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticProtocolBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticProtocolBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticProtocolBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticProtocolBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticProtocolBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticProtocolBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticProtocolBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticProtocolBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticProtocolBuilder":
