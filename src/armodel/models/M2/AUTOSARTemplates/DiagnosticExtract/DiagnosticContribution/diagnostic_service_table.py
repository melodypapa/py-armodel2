...
class DiagnosticServiceTableBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticServiceTableBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticServiceTableBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticServiceTableBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticServiceTableBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticServiceTableBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticServiceTableBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticServiceTableBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticServiceTableBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticServiceTableBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticServiceTableBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticServiceTableBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticServiceTableBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticServiceTableBuilder":
