...
class DiagnosticFimAliasEventGroupBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticFimAliasEventGroupBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticFimAliasEventGroupBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticFimAliasEventGroupBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticFimAliasEventGroupBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticFimAliasEventGroupBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticFimAliasEventGroupBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticFimAliasEventGroupBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticFimAliasEventGroupBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticFimAliasEventGroupBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticFimAliasEventGroupBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticFimAliasEventGroupBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticFimAliasEventGroupBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticFimAliasEventGroupBuilder":
