...
class DiagnosticFimEventGroupBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticFimEventGroupBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticFimEventGroupBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticFimEventGroupBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticFimEventGroupBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticFimEventGroupBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticFimEventGroupBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticFimEventGroupBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticFimEventGroupBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticFimEventGroupBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticFimEventGroupBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticFimEventGroupBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticFimEventGroupBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticFimEventGroupBuilder":
