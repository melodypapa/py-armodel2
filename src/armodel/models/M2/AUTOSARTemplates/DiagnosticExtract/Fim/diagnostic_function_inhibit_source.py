...
class DiagnosticFunctionInhibitSource(Identifiable):
    ...
    def serialize(self) -> ET.Element:
        ...
        if self.event_ref is not None:
            serialized = SerializationHelper.serialize_item(self.event_ref, "Any")
        ...
        if self.event_group_ref is not None:
            serialized = SerializationHelper.serialize_item(self.event_group_ref, "Any")
            if serialized is not None:
                # Wrap with correct tag
...
class DiagnosticFunctionInhibitSourceBuilder:
    """Builder for DiagnosticFunctionInhibitSource with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticFunctionInhibitSourceBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticFunctionInhibitSourceBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticFunctionInhibitSourceBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticFunctionInhibitSourceBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticFunctionInhibitSourceBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticFunctionInhibitSourceBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticFunctionInhibitSourceBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticFunctionInhibitSourceBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticFunctionInhibitSourceBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticFunctionInhibitSourceBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticFunctionInhibitSourceBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticFunctionInhibitSourceBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticFunctionInhibitSourceBuilder":
    ...
    def build(self) -> DiagnosticFunctionInhibitSource:
        """Build and return the DiagnosticFunctionInhibitSource instance with validation."""
