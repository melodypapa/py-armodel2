...
class DiagnosticIndicatorBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticIndicatorBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticIndicatorBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticIndicatorBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticIndicatorBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticIndicatorBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticIndicatorBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticIndicatorBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticIndicatorBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticIndicatorBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticIndicatorBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticIndicatorBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticIndicatorBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticIndicatorBuilder":
