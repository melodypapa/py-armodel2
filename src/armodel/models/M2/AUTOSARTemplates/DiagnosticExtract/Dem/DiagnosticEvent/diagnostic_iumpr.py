...
class DiagnosticIumprBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticIumprBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticIumprBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticIumprBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticIumprBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticIumprBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticIumprBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticIumprBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticIumprBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticIumprBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticIumprBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticIumprBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticIumprBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticIumprBuilder":
