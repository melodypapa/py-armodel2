...
class DiagnosticIumprGroupBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticIumprGroupBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticIumprGroupBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticIumprGroupBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticIumprGroupBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticIumprGroupBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticIumprGroupBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticIumprGroupBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticIumprGroupBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticIumprGroupBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticIumprGroupBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticIumprGroupBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticIumprGroupBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticIumprGroupBuilder":
