...
class DiagnosticAbstractAliasEvent(DiagnosticCommonElement, ABC):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(DiagnosticAbstractAliasEvent, self).serialize()
...
class DiagnosticAbstractAliasEventBuilder(DiagnosticCommonElementBuilder):
    """Builder for DiagnosticAbstractAliasEvent with fluent API."""
    ...
    def build(self) -> DiagnosticAbstractAliasEvent:
        """Build and return the DiagnosticAbstractAliasEvent instance (abstract)."""
