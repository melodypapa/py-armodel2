...
class DiagnosticEventBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticEventBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticEventBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticEventBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticEventBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticEventBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticEventBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticEventBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticEventBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticEventBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticEventBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticEventBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticEventBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticEventBuilder":
