...
from armodel.models.M2.AUTOSARTemplates.DiagnosticExtract.Dem.DiagnosticEvent.diagnostic_clear_event_allowed_behavior_enum import (
    DiagnosticClearEventAllowedBehaviorEnum,
)
from armodel.models.M2.AUTOSARTemplates.DiagnosticExtract.Dem.DiagnosticEvent.diagnostic_event_clear_allowed_enum import (
    DiagnosticEventClearAllowedEnum,
)
from armodel.models.M2.AUTOSARTemplates.DiagnosticExtract.Dem.DiagnosticEvent.diagnostic_event_kind_enum import (
    DiagnosticEventKindEnum,
)
from armodel.models.M2.AUTOSARTemplates.DiagnosticExtract.Dem.DiagnosticEvent.diagnostic_connected_indicator_behavior_enum import (
    DiagnosticConnectedIndicatorBehaviorEnum,
)
from armodel.models.M2.AUTOSARTemplates.DiagnosticExtract.Dem.DiagnosticEvent.diagnostic_iumpr_kind_enum import (
