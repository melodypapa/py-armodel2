...
class DiagnosticIumprGroupIdentifier(ARObject):
    ...
    _xml_members = [
        ("group_id", None, True, False, None),  # groupId
    ]
    ...
    def deserialize(cls, element: ET.Element) -> "DiagnosticIumprGroupIdentifier":
        ...
        # Cast to DiagnosticIumprGroupIdentifier since parent returns ARObject
        return cast("DiagnosticIumprGroupIdentifier", obj)
