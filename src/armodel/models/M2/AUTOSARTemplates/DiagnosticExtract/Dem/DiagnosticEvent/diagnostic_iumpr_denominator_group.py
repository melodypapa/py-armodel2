...
class DiagnosticIumprDenominatorGroupBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticIumprDenominatorGroupBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticIumprDenominatorGroupBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticIumprDenominatorGroupBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticIumprDenominatorGroupBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticIumprDenominatorGroupBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticIumprDenominatorGroupBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticIumprDenominatorGroupBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticIumprDenominatorGroupBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticIumprDenominatorGroupBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticIumprDenominatorGroupBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticIumprDenominatorGroupBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticIumprDenominatorGroupBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticIumprDenominatorGroupBuilder":
