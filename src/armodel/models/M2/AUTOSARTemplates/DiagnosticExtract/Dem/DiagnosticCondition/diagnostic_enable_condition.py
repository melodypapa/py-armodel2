...
from armodel.models.M2.AUTOSARTemplates.DiagnosticExtract.Dem.DiagnosticCondition.diagnostic_condition import DiagnosticConditionBuilder
...
class DiagnosticEnableConditionBuilder(DiagnosticConditionBuilder):
