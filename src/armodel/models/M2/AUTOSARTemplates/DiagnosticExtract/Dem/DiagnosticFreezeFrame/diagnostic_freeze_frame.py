...
class DiagnosticFreezeFrameBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticFreezeFrameBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticFreezeFrameBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticFreezeFrameBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticFreezeFrameBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticFreezeFrameBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticFreezeFrameBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticFreezeFrameBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticFreezeFrameBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticFreezeFrameBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticFreezeFrameBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticFreezeFrameBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticFreezeFrameBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticFreezeFrameBuilder":
