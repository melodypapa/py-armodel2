...
class DiagnosticTroubleCodeBuilder(DiagnosticCommonElementBuilder):
    """Builder for DiagnosticTroubleCode with fluent API."""
    ...
    def build(self) -> DiagnosticTroubleCode:
        """Build and return the DiagnosticTroubleCode instance (abstract)."""
