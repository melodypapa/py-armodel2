...
class DiagnosticTroubleCodeGroupBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticTroubleCodeGroupBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticTroubleCodeGroupBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticTroubleCodeGroupBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticTroubleCodeGroupBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticTroubleCodeGroupBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticTroubleCodeGroupBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticTroubleCodeGroupBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticTroubleCodeGroupBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticTroubleCodeGroupBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticTroubleCodeGroupBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticTroubleCodeGroupBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticTroubleCodeGroupBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticTroubleCodeGroupBuilder":
