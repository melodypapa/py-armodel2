...
class DiagnosticTroubleCodeUdsBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticTroubleCodeUdsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticTroubleCodeUdsBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticTroubleCodeUdsBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticTroubleCodeUdsBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticTroubleCodeUdsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticTroubleCodeUdsBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticTroubleCodeUdsBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticTroubleCodeUdsBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticTroubleCodeUdsBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticTroubleCodeUdsBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticTroubleCodeUdsBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticTroubleCodeUdsBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticTroubleCodeUdsBuilder":
