...
class DiagnosticTroubleCodePropsBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticTroubleCodePropsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticTroubleCodePropsBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticTroubleCodePropsBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticTroubleCodePropsBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticTroubleCodePropsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticTroubleCodePropsBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticTroubleCodePropsBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticTroubleCodePropsBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticTroubleCodePropsBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticTroubleCodePropsBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticTroubleCodePropsBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticTroubleCodePropsBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticTroubleCodePropsBuilder":
