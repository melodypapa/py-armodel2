...
class DiagnosticTroubleCodeObdBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticTroubleCodeObdBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticTroubleCodeObdBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticTroubleCodeObdBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticTroubleCodeObdBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticTroubleCodeObdBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticTroubleCodeObdBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticTroubleCodeObdBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticTroubleCodeObdBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticTroubleCodeObdBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticTroubleCodeObdBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticTroubleCodeObdBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticTroubleCodeObdBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticTroubleCodeObdBuilder":
