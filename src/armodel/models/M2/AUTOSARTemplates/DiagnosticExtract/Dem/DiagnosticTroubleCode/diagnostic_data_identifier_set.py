...
class DiagnosticDataIdentifierSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticDataIdentifierSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticDataIdentifierSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticDataIdentifierSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticDataIdentifierSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticDataIdentifierSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticDataIdentifierSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticDataIdentifierSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticDataIdentifierSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticDataIdentifierSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticDataIdentifierSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticDataIdentifierSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticDataIdentifierSetBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticDataIdentifierSetBuilder":
