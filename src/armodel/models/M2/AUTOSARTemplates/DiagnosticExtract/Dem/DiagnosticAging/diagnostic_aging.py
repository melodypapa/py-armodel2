...
class DiagnosticAging(DiagnosticCommonElement):
    ...
    def serialize(self) -> ET.Element:
        ...
        if self.aging_cycle_ref is not None:
            serialized = SerializationHelper.serialize_item(self.aging_cycle_ref, "Any")
...
class DiagnosticAgingBuilder:
    """Builder for DiagnosticAging with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticAgingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticAgingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticAgingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticAgingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticAgingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticAgingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticAgingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticAgingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticAgingBuilder":
        """Set uuid attribute.
    ...
    def with_threshold(self, value: Optional[PositiveInteger]) -> "DiagnosticAgingBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticAgingBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticAgingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticAgingBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticAgingBuilder":
    ...
    def build(self) -> DiagnosticAging:
        """Build and return the DiagnosticAging instance with validation."""
