...
class DiagnosticEnableConditionGroupBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticEnableConditionGroupBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticEnableConditionGroupBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticEnableConditionGroupBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticEnableConditionGroupBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticEnableConditionGroupBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticEnableConditionGroupBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticEnableConditionGroupBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticEnableConditionGroupBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticEnableConditionGroupBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticEnableConditionGroupBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticEnableConditionGroupBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticEnableConditionGroupBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticEnableConditionGroupBuilder":
