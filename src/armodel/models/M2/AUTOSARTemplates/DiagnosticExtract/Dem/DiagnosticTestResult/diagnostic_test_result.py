...
class DiagnosticTestResultBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticTestResultBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticTestResultBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticTestResultBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticTestResultBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticTestResultBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticTestResultBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticTestResultBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticTestResultBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticTestResultBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticTestResultBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticTestResultBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticTestResultBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticTestResultBuilder":
