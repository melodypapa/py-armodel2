...
class DiagnosticMeasurementIdentifierBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticMeasurementIdentifierBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticMeasurementIdentifierBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticMeasurementIdentifierBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticMeasurementIdentifierBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticMeasurementIdentifierBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticMeasurementIdentifierBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticMeasurementIdentifierBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticMeasurementIdentifierBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticMeasurementIdentifierBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticMeasurementIdentifierBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticMeasurementIdentifierBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticMeasurementIdentifierBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticMeasurementIdentifierBuilder":
