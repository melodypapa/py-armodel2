...
class DiagnosticOperationCycleBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticOperationCycleBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticOperationCycleBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticOperationCycleBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticOperationCycleBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticOperationCycleBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticOperationCycleBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticOperationCycleBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticOperationCycleBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticOperationCycleBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticOperationCycleBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticOperationCycleBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticOperationCycleBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticOperationCycleBuilder":
