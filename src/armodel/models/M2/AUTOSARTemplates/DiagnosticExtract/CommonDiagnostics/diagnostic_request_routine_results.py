...
class DiagnosticRequestRoutineResultsBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticRequestRoutineResultsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticRequestRoutineResultsBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticRequestRoutineResultsBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticRequestRoutineResultsBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticRequestRoutineResultsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticRequestRoutineResultsBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticRequestRoutineResultsBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticRequestRoutineResultsBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticRequestRoutineResultsBuilder":
        """Set uuid attribute.
    ...
    def with_access(self, value: Optional[DiagnosticAccessPermission]) -> "DiagnosticRequestRoutineResultsBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticRequestRoutineResultsBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticRequestRoutineResultsBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticRequestRoutineResultsBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticRequestRoutineResultsBuilder":
