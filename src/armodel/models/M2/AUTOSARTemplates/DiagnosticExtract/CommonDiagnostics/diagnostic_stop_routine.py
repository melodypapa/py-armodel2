...
class DiagnosticStopRoutineBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticStopRoutineBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticStopRoutineBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticStopRoutineBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticStopRoutineBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticStopRoutineBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticStopRoutineBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticStopRoutineBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticStopRoutineBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticStopRoutineBuilder":
        """Set uuid attribute.
    ...
    def with_access(self, value: Optional[DiagnosticAccessPermission]) -> "DiagnosticStopRoutineBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticStopRoutineBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticStopRoutineBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticStopRoutineBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticStopRoutineBuilder":
    ...
    def add_response(self, item: DiagnosticParameter) -> "DiagnosticStopRoutineBuilder":
