...
class DiagnosticParameterIdentBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticParameterIdentBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticParameterIdentBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticParameterIdentBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticParameterIdentBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticParameterIdentBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticParameterIdentBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticParameterIdentBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticParameterIdentBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticParameterIdentBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticParameterIdentBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticParameterIdentBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticParameterIdentBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticParameterIdentBuilder":
