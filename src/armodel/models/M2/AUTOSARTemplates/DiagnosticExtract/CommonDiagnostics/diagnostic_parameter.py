...
class DiagnosticParameterBuilder:
    ...
    def with_bit_offset(self, value: Optional[PositiveInteger]) -> "DiagnosticParameterBuilder":
    ...
    def with_data_element(self, value: Optional[DiagnosticDataElement]) -> "DiagnosticParameterBuilder":
    ...
    def with_parameter_size(self, value: Optional[PositiveInteger]) -> "DiagnosticParameterBuilder":
