...
class DiagnosticCommonElementBuilder(ARElementBuilder):
    """Builder for DiagnosticCommonElement with fluent API."""
    ...
    def build(self) -> DiagnosticCommonElement:
        """Build and return the DiagnosticCommonElement instance (abstract)."""
