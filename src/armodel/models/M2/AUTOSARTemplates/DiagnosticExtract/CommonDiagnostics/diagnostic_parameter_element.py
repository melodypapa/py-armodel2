...
class DiagnosticParameterElementBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticParameterElementBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticParameterElementBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticParameterElementBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticParameterElementBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticParameterElementBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticParameterElementBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticParameterElementBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticParameterElementBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticParameterElementBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticParameterElementBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticParameterElementBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticParameterElementBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticParameterElementBuilder":
