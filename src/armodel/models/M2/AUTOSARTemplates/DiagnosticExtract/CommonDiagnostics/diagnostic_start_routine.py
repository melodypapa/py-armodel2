...
class DiagnosticStartRoutineBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticStartRoutineBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticStartRoutineBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticStartRoutineBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticStartRoutineBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticStartRoutineBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticStartRoutineBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticStartRoutineBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticStartRoutineBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticStartRoutineBuilder":
        """Set uuid attribute.
    ...
    def with_access(self, value: Optional[DiagnosticAccessPermission]) -> "DiagnosticStartRoutineBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticStartRoutineBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticStartRoutineBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticStartRoutineBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticStartRoutineBuilder":
    ...
    def add_response(self, item: DiagnosticParameter) -> "DiagnosticStartRoutineBuilder":
