...
class DiagnosticInfoTypeBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticInfoTypeBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticInfoTypeBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticInfoTypeBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticInfoTypeBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticInfoTypeBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticInfoTypeBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticInfoTypeBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticInfoTypeBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticInfoTypeBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticInfoTypeBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticInfoTypeBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticInfoTypeBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticInfoTypeBuilder":
