...
class DiagnosticRoutineBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticRoutineBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticRoutineBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticRoutineBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticRoutineBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticRoutineBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticRoutineBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticRoutineBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticRoutineBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticRoutineBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticRoutineBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticRoutineBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticRoutineBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticRoutineBuilder":
