...
class DiagnosticStorageConditionPortMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticStorageConditionPortMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticStorageConditionPortMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticStorageConditionPortMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticStorageConditionPortMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticStorageConditionPortMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticStorageConditionPortMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticStorageConditionPortMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticStorageConditionPortMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticStorageConditionPortMappingBuilder":
        """Set uuid attribute.
    ...
    def with_provider(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticStorageConditionPortMappingBuilder":
    ...
    def with_requester(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticStorageConditionPortMappingBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticStorageConditionPortMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticStorageConditionPortMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticStorageConditionPortMappingBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticStorageConditionPortMappingBuilder":
