...
class DiagnosticTroubleCodeUdsToTroubleCodeObdMappingBuilder:
    """Builder for DiagnosticTroubleCodeUdsToTroubleCodeObdMapping with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticTroubleCodeUdsToTroubleCodeObdMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticTroubleCodeUdsToTroubleCodeObdMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticTroubleCodeUdsToTroubleCodeObdMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticTroubleCodeUdsToTroubleCodeObdMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticTroubleCodeUdsToTroubleCodeObdMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticTroubleCodeUdsToTroubleCodeObdMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticTroubleCodeUdsToTroubleCodeObdMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticTroubleCodeUdsToTroubleCodeObdMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticTroubleCodeUdsToTroubleCodeObdMappingBuilder":
        """Set uuid attribute.
    ...
    def with_provider(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticTroubleCodeUdsToTroubleCodeObdMappingBuilder":
    ...
    def with_requester(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticTroubleCodeUdsToTroubleCodeObdMappingBuilder":
    ...
    def with_trouble_code(self, value: Optional[DiagnosticTroubleCode]) -> "DiagnosticTroubleCodeUdsToTroubleCodeObdMappingBuilder":
        """Set trouble_code attribute.
        ...
        if value is None and not True:
            raise ValueError("Attribute '" + snake_attr_name + "' is required and cannot be None")
        self._obj.trouble_code = value
        return self

    def with_trouble_code_uds(self, value: Optional[DiagnosticTroubleCode]) -> "DiagnosticTroubleCodeUdsToTroubleCodeObdMappingBuilder":
        """Set trouble_code_uds attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticTroubleCodeUdsToTroubleCodeObdMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticTroubleCodeUdsToTroubleCodeObdMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticTroubleCodeUdsToTroubleCodeObdMappingBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticTroubleCodeUdsToTroubleCodeObdMappingBuilder":
    ...
    def build(self) -> DiagnosticTroubleCodeUdsToTroubleCodeObdMapping:
        """Build and return the DiagnosticTroubleCodeUdsToTroubleCodeObdMapping instance with validation."""
