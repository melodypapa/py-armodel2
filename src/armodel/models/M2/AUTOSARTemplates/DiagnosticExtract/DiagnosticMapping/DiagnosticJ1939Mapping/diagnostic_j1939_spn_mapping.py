...
class DiagnosticJ1939SpnMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticJ1939SpnMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticJ1939SpnMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticJ1939SpnMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticJ1939SpnMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticJ1939SpnMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticJ1939SpnMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticJ1939SpnMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticJ1939SpnMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticJ1939SpnMappingBuilder":
        """Set uuid attribute.
    ...
    def with_provider(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticJ1939SpnMappingBuilder":
    ...
    def with_requester(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticJ1939SpnMappingBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticJ1939SpnMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticJ1939SpnMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticJ1939SpnMappingBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticJ1939SpnMappingBuilder":
