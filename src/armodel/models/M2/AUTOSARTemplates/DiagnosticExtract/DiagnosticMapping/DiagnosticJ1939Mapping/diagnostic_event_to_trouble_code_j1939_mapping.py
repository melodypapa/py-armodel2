...
class DiagnosticEventToTroubleCodeJ1939MappingBuilder:
    """Builder for DiagnosticEventToTroubleCodeJ1939Mapping with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticEventToTroubleCodeJ1939MappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticEventToTroubleCodeJ1939MappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticEventToTroubleCodeJ1939MappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticEventToTroubleCodeJ1939MappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticEventToTroubleCodeJ1939MappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticEventToTroubleCodeJ1939MappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticEventToTroubleCodeJ1939MappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticEventToTroubleCodeJ1939MappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticEventToTroubleCodeJ1939MappingBuilder":
        """Set uuid attribute.
    ...
    def with_provider(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticEventToTroubleCodeJ1939MappingBuilder":
    ...
    def with_requester(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticEventToTroubleCodeJ1939MappingBuilder":
    ...
    def with_diagnostic_event(self, value: Optional[DiagnosticEvent]) -> "DiagnosticEventToTroubleCodeJ1939MappingBuilder":
    ...
    def with_trouble_code(self, value: Optional[DiagnosticTroubleCode]) -> "DiagnosticEventToTroubleCodeJ1939MappingBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticEventToTroubleCodeJ1939MappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticEventToTroubleCodeJ1939MappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticEventToTroubleCodeJ1939MappingBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticEventToTroubleCodeJ1939MappingBuilder":
    ...
    def build(self) -> DiagnosticEventToTroubleCodeJ1939Mapping:
        """Build and return the DiagnosticEventToTroubleCodeJ1939Mapping instance with validation."""
