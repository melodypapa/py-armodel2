...
class DiagnosticJ1939SwMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticJ1939SwMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticJ1939SwMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticJ1939SwMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticJ1939SwMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticJ1939SwMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticJ1939SwMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticJ1939SwMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticJ1939SwMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticJ1939SwMappingBuilder":
        """Set uuid attribute.
    ...
    def with_provider(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticJ1939SwMappingBuilder":
    ...
    def with_requester(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticJ1939SwMappingBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticJ1939SwMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticJ1939SwMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticJ1939SwMappingBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticJ1939SwMappingBuilder":
