...
class CpSwClusterToDiagRoutineSubfunctionMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "CpSwClusterToDiagRoutineSubfunctionMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "CpSwClusterToDiagRoutineSubfunctionMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "CpSwClusterToDiagRoutineSubfunctionMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "CpSwClusterToDiagRoutineSubfunctionMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "CpSwClusterToDiagRoutineSubfunctionMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "CpSwClusterToDiagRoutineSubfunctionMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "CpSwClusterToDiagRoutineSubfunctionMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "CpSwClusterToDiagRoutineSubfunctionMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "CpSwClusterToDiagRoutineSubfunctionMappingBuilder":
        """Set uuid attribute.
    ...
    def with_provider(self, value: Optional[CpSoftwareCluster]) -> "CpSwClusterToDiagRoutineSubfunctionMappingBuilder":
    ...
    def with_requester(self, value: Optional[CpSoftwareCluster]) -> "CpSwClusterToDiagRoutineSubfunctionMappingBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "CpSwClusterToDiagRoutineSubfunctionMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "CpSwClusterToDiagRoutineSubfunctionMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "CpSwClusterToDiagRoutineSubfunctionMappingBuilder":
    ...
    def clear_annotations(self) -> "CpSwClusterToDiagRoutineSubfunctionMappingBuilder":
