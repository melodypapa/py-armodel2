...
class CpSwClusterResourceToDiagFunctionIdMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "CpSwClusterResourceToDiagFunctionIdMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "CpSwClusterResourceToDiagFunctionIdMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "CpSwClusterResourceToDiagFunctionIdMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "CpSwClusterResourceToDiagFunctionIdMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "CpSwClusterResourceToDiagFunctionIdMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "CpSwClusterResourceToDiagFunctionIdMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "CpSwClusterResourceToDiagFunctionIdMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "CpSwClusterResourceToDiagFunctionIdMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "CpSwClusterResourceToDiagFunctionIdMappingBuilder":
        """Set uuid attribute.
    ...
    def with_provider(self, value: Optional[CpSoftwareCluster]) -> "CpSwClusterResourceToDiagFunctionIdMappingBuilder":
    ...
    def with_requester(self, value: Optional[CpSoftwareCluster]) -> "CpSwClusterResourceToDiagFunctionIdMappingBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "CpSwClusterResourceToDiagFunctionIdMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "CpSwClusterResourceToDiagFunctionIdMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "CpSwClusterResourceToDiagFunctionIdMappingBuilder":
    ...
    def clear_annotations(self) -> "CpSwClusterResourceToDiagFunctionIdMappingBuilder":
