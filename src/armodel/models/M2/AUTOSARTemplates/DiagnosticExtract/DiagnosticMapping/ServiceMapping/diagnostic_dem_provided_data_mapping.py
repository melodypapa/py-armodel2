...
class DiagnosticDemProvidedDataMapping(DiagnosticMapping):
    ...
    _xml_members = [
        ...
        ("data_provider", None, True, False, None),  # dataProvider
    ]
    ...
    def deserialize(cls, element: ET.Element) -> "DiagnosticDemProvidedDataMapping":
        ...
        # Cast to DiagnosticDemProvidedDataMapping since parent returns ARObject
        return cast("DiagnosticDemProvidedDataMapping", obj)
