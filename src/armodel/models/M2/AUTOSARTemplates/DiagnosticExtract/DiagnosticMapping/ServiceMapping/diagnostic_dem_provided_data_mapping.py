...
class DiagnosticDemProvidedDataMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticDemProvidedDataMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticDemProvidedDataMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticDemProvidedDataMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticDemProvidedDataMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticDemProvidedDataMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticDemProvidedDataMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticDemProvidedDataMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticDemProvidedDataMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticDemProvidedDataMappingBuilder":
        """Set uuid attribute.
    ...
    def with_provider(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticDemProvidedDataMappingBuilder":
    ...
    def with_requester(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticDemProvidedDataMappingBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticDemProvidedDataMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticDemProvidedDataMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticDemProvidedDataMappingBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticDemProvidedDataMappingBuilder":
