...
class DiagnosticSecurityEventReportingModeMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticSecurityEventReportingModeMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticSecurityEventReportingModeMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticSecurityEventReportingModeMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticSecurityEventReportingModeMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticSecurityEventReportingModeMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticSecurityEventReportingModeMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticSecurityEventReportingModeMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticSecurityEventReportingModeMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticSecurityEventReportingModeMappingBuilder":
        """Set uuid attribute.
    ...
    def with_provider(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticSecurityEventReportingModeMappingBuilder":
    ...
    def with_requester(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticSecurityEventReportingModeMappingBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticSecurityEventReportingModeMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticSecurityEventReportingModeMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticSecurityEventReportingModeMappingBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticSecurityEventReportingModeMappingBuilder":
