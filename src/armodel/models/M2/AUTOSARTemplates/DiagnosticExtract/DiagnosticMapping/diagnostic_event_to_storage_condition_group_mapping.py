...
class DiagnosticEventToStorageConditionGroupMapping(DiagnosticMapping):
    ...
    _xml_members = [
        ...
        ("storage", None, False, False, any (DiagnosticStorage)),  # storage
    ]
    ...
    def deserialize(cls, element: ET.Element) -> "DiagnosticEventToStorageConditionGroupMapping":
        ...
        # Cast to DiagnosticEventToStorageConditionGroupMapping since parent returns ARObject
        return cast("DiagnosticEventToStorageConditionGroupMapping", obj)
