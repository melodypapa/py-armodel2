...
class DiagnosticEventPortMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticEventPortMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticEventPortMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticEventPortMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticEventPortMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticEventPortMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticEventPortMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticEventPortMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticEventPortMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticEventPortMappingBuilder":
        """Set uuid attribute.
    ...
    def with_provider(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticEventPortMappingBuilder":
    ...
    def with_requester(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticEventPortMappingBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticEventPortMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticEventPortMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticEventPortMappingBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticEventPortMappingBuilder":
