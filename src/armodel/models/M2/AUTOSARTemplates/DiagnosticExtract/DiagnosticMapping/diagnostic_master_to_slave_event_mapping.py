...
class DiagnosticMasterToSlaveEventMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticMasterToSlaveEventMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticMasterToSlaveEventMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticMasterToSlaveEventMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticMasterToSlaveEventMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticMasterToSlaveEventMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticMasterToSlaveEventMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticMasterToSlaveEventMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticMasterToSlaveEventMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticMasterToSlaveEventMappingBuilder":
        """Set uuid attribute.
    ...
    def with_provider(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticMasterToSlaveEventMappingBuilder":
    ...
    def with_requester(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticMasterToSlaveEventMappingBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticMasterToSlaveEventMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticMasterToSlaveEventMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticMasterToSlaveEventMappingBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticMasterToSlaveEventMappingBuilder":
