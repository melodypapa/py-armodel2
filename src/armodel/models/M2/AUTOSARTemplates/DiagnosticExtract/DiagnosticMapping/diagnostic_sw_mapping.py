...
class DiagnosticSwMappingBuilder(DiagnosticMappingBuilder):
    """Builder for DiagnosticSwMapping with fluent API."""
    ...
    def build(self) -> DiagnosticSwMapping:
        """Build and return the DiagnosticSwMapping instance (abstract)."""
