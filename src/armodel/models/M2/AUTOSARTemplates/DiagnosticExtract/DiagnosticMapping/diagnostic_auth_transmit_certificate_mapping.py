...
class DiagnosticAuthTransmitCertificateMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticAuthTransmitCertificateMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticAuthTransmitCertificateMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticAuthTransmitCertificateMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticAuthTransmitCertificateMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticAuthTransmitCertificateMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticAuthTransmitCertificateMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticAuthTransmitCertificateMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticAuthTransmitCertificateMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticAuthTransmitCertificateMappingBuilder":
        """Set uuid attribute.
    ...
    def with_provider(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticAuthTransmitCertificateMappingBuilder":
    ...
    def with_requester(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticAuthTransmitCertificateMappingBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticAuthTransmitCertificateMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticAuthTransmitCertificateMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticAuthTransmitCertificateMappingBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticAuthTransmitCertificateMappingBuilder":
