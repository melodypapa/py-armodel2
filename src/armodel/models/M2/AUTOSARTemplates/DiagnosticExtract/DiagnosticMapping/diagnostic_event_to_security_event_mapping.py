...
class DiagnosticEventToSecurityEventMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticEventToSecurityEventMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticEventToSecurityEventMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticEventToSecurityEventMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticEventToSecurityEventMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticEventToSecurityEventMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticEventToSecurityEventMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticEventToSecurityEventMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticEventToSecurityEventMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticEventToSecurityEventMappingBuilder":
        """Set uuid attribute.
    ...
    def with_provider(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticEventToSecurityEventMappingBuilder":
    ...
    def with_requester(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticEventToSecurityEventMappingBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticEventToSecurityEventMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticEventToSecurityEventMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticEventToSecurityEventMappingBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticEventToSecurityEventMappingBuilder":
