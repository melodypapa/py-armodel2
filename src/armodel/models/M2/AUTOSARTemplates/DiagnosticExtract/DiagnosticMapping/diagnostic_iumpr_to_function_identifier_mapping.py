...
class DiagnosticIumprToFunctionIdentifierMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticIumprToFunctionIdentifierMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticIumprToFunctionIdentifierMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticIumprToFunctionIdentifierMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticIumprToFunctionIdentifierMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticIumprToFunctionIdentifierMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticIumprToFunctionIdentifierMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticIumprToFunctionIdentifierMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticIumprToFunctionIdentifierMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticIumprToFunctionIdentifierMappingBuilder":
        """Set uuid attribute.
    ...
    def with_provider(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticIumprToFunctionIdentifierMappingBuilder":
    ...
    def with_requester(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticIumprToFunctionIdentifierMappingBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticIumprToFunctionIdentifierMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticIumprToFunctionIdentifierMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticIumprToFunctionIdentifierMappingBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticIumprToFunctionIdentifierMappingBuilder":
