...
class DiagnosticInhibitSourceEventMapping(DiagnosticMapping):
    ...
    def serialize(self) -> ET.Element:
        ...
        if self.event_group_group_ref is not None:
            serialized = SerializationHelper.serialize_item(self.event_group_group_ref, "DiagnosticFimEventGroup")
            if serialized is not None:
                # Wrap with correct tag
        ...
        if self.inhibition_source_ref is not None:
            serialized = SerializationHelper.serialize_item(self.inhibition_source_ref, "Any")
            if serialized is not None:
                # Wrap with correct tag
...
class DiagnosticInhibitSourceEventMappingBuilder:
    """Builder for DiagnosticInhibitSourceEventMapping with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticInhibitSourceEventMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticInhibitSourceEventMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticInhibitSourceEventMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticInhibitSourceEventMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticInhibitSourceEventMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticInhibitSourceEventMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticInhibitSourceEventMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticInhibitSourceEventMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticInhibitSourceEventMappingBuilder":
        """Set uuid attribute.
    ...
    def with_provider(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticInhibitSourceEventMappingBuilder":
    ...
    def with_requester(self, value: Optional[CpSoftwareCluster]) -> "DiagnosticInhibitSourceEventMappingBuilder":
    ...
    def with_diagnostic_event(self, value: Optional[DiagnosticEvent]) -> "DiagnosticInhibitSourceEventMappingBuilder":
    ...
    def with_event_group_group(self, value: Optional[DiagnosticFimEventGroup]) -> "DiagnosticInhibitSourceEventMappingBuilder":
        """Set event_group_group attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticInhibitSourceEventMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticInhibitSourceEventMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticInhibitSourceEventMappingBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticInhibitSourceEventMappingBuilder":
    ...
    def build(self) -> DiagnosticInhibitSourceEventMapping:
        """Build and return the DiagnosticInhibitSourceEventMapping instance with validation."""
