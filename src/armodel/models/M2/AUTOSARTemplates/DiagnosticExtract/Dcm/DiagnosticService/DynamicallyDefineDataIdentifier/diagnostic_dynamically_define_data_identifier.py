...
class DiagnosticDynamicallyDefineDataIdentifierBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticDynamicallyDefineDataIdentifierBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticDynamicallyDefineDataIdentifierBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticDynamicallyDefineDataIdentifierBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticDynamicallyDefineDataIdentifierBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticDynamicallyDefineDataIdentifierBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticDynamicallyDefineDataIdentifierBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticDynamicallyDefineDataIdentifierBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticDynamicallyDefineDataIdentifierBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticDynamicallyDefineDataIdentifierBuilder":
        """Set uuid attribute.
    ...
    def with_access(self, value: Optional[DiagnosticAccessPermission]) -> "DiagnosticDynamicallyDefineDataIdentifierBuilder":
    ...
    def with_service_class(self, value: Optional[DiagnosticServiceClass]) -> "DiagnosticDynamicallyDefineDataIdentifierBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticDynamicallyDefineDataIdentifierBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticDynamicallyDefineDataIdentifierBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticDynamicallyDefineDataIdentifierBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticDynamicallyDefineDataIdentifierBuilder":
