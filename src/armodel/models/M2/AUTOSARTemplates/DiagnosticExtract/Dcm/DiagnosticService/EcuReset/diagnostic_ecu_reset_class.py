...
class DiagnosticEcuResetClassBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticEcuResetClassBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticEcuResetClassBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticEcuResetClassBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticEcuResetClassBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticEcuResetClassBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticEcuResetClassBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticEcuResetClassBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticEcuResetClassBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticEcuResetClassBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticEcuResetClassBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticEcuResetClassBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticEcuResetClassBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticEcuResetClassBuilder":
