...
class DiagnosticMemoryIdentifierBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticMemoryIdentifierBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticMemoryIdentifierBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticMemoryIdentifierBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticMemoryIdentifierBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticMemoryIdentifierBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticMemoryIdentifierBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticMemoryIdentifierBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticMemoryIdentifierBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticMemoryIdentifierBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticMemoryIdentifierBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticMemoryIdentifierBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticMemoryIdentifierBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticMemoryIdentifierBuilder":
