...
class DiagnosticSessionControlBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticSessionControlBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticSessionControlBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticSessionControlBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticSessionControlBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticSessionControlBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticSessionControlBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticSessionControlBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticSessionControlBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticSessionControlBuilder":
        """Set uuid attribute.
    ...
    def with_access(self, value: Optional[DiagnosticAccessPermission]) -> "DiagnosticSessionControlBuilder":
    ...
    def with_service_class(self, value: Optional[DiagnosticServiceClass]) -> "DiagnosticSessionControlBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticSessionControlBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticSessionControlBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticSessionControlBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticSessionControlBuilder":
