...
class DiagnosticSessionControlClassBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticSessionControlClassBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticSessionControlClassBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticSessionControlClassBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticSessionControlClassBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticSessionControlClassBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticSessionControlClassBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticSessionControlClassBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticSessionControlClassBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticSessionControlClassBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticSessionControlClassBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticSessionControlClassBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticSessionControlClassBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticSessionControlClassBuilder":
