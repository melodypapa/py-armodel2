...
class DiagnosticRoutineControlBuilder:
    """Builder for DiagnosticRoutineControl with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticRoutineControlBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticRoutineControlBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticRoutineControlBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticRoutineControlBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticRoutineControlBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticRoutineControlBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticRoutineControlBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticRoutineControlBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticRoutineControlBuilder":
        """Set uuid attribute.
    ...
    def with_access(self, value: Optional[DiagnosticAccessPermission]) -> "DiagnosticRoutineControlBuilder":
    ...
    def with_service_class(self, value: Optional[DiagnosticServiceClass]) -> "DiagnosticRoutineControlBuilder":
    ...
    def with_routine(self, value: Optional[DiagnosticRoutine]) -> "DiagnosticRoutineControlBuilder":
    ...
    def with_routine_control(self, value: Optional[DiagnosticRoutine]) -> "DiagnosticRoutineControlBuilder":
        """Set routine_control attribute.
        ...
        if value is None and not True:
            raise ValueError("Attribute '" + snake_attr_name + "' is required and cannot be None")
        self._obj.routine_control = value
        return self


    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticRoutineControlBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticRoutineControlBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticRoutineControlBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticRoutineControlBuilder":
    ...
    def build(self) -> DiagnosticRoutineControl:
        """Build and return the DiagnosticRoutineControl instance with validation."""
