...
class DiagnosticComControlBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticComControlBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticComControlBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticComControlBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticComControlBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticComControlBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticComControlBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticComControlBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticComControlBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticComControlBuilder":
        """Set uuid attribute.
    ...
    def with_access(self, value: Optional[DiagnosticAccessPermission]) -> "DiagnosticComControlBuilder":
    ...
    def with_service_class(self, value: Optional[DiagnosticServiceClass]) -> "DiagnosticComControlBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticComControlBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticComControlBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticComControlBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticComControlBuilder":
