...
class DiagnosticTransferExitBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticTransferExitBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticTransferExitBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticTransferExitBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticTransferExitBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticTransferExitBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticTransferExitBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticTransferExitBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticTransferExitBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticTransferExitBuilder":
        """Set uuid attribute.
    ...
    def with_access(self, value: Optional[DiagnosticAccessPermission]) -> "DiagnosticTransferExitBuilder":
    ...
    def with_service_class(self, value: Optional[DiagnosticServiceClass]) -> "DiagnosticTransferExitBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticTransferExitBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticTransferExitBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticTransferExitBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticTransferExitBuilder":
