...
class DiagnosticRequestUploadBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticRequestUploadBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticRequestUploadBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticRequestUploadBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticRequestUploadBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticRequestUploadBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticRequestUploadBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticRequestUploadBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticRequestUploadBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticRequestUploadBuilder":
        """Set uuid attribute.
    ...
    def with_access(self, value: Optional[DiagnosticAccessPermission]) -> "DiagnosticRequestUploadBuilder":
    ...
    def with_service_class(self, value: Optional[DiagnosticServiceClass]) -> "DiagnosticRequestUploadBuilder":
    ...
    def with_memory_ranges(self, items: list[any (DiagnosticMemory)]) -> "DiagnosticRequestUploadBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticRequestUploadBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticRequestUploadBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticRequestUploadBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticRequestUploadBuilder":
    ...
    def add_memory_range(self, item: any (DiagnosticMemory)) -> "DiagnosticRequestUploadBuilder":
    ...
    def clear_memory_ranges(self) -> "DiagnosticRequestUploadBuilder":
