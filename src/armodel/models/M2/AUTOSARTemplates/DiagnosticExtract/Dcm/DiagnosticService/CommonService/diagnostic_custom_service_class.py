...
class DiagnosticCustomServiceClassBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticCustomServiceClassBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticCustomServiceClassBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticCustomServiceClassBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticCustomServiceClassBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticCustomServiceClassBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticCustomServiceClassBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticCustomServiceClassBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticCustomServiceClassBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticCustomServiceClassBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticCustomServiceClassBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticCustomServiceClassBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticCustomServiceClassBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticCustomServiceClassBuilder":
