...
class DiagnosticControlDTCSettingClass(DiagnosticServiceClass):
    ...
    _xml_members = [
        ("control_option", None, True, False, None),  # controlOption
    ]
    ...
    def deserialize(cls, element: ET.Element) -> "DiagnosticControlDTCSettingClass":
        ...
        # Cast to DiagnosticControlDTCSettingClass since parent returns ARObject
        return cast("DiagnosticControlDTCSettingClass", obj)
