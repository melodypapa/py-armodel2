...
class DiagnosticDynamicallyDefineDataIdentifierClassBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticDynamicallyDefineDataIdentifierClassBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticDynamicallyDefineDataIdentifierClassBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticDynamicallyDefineDataIdentifierClassBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticDynamicallyDefineDataIdentifierClassBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticDynamicallyDefineDataIdentifierClassBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticDynamicallyDefineDataIdentifierClassBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticDynamicallyDefineDataIdentifierClassBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticDynamicallyDefineDataIdentifierClassBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticDynamicallyDefineDataIdentifierClassBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticDynamicallyDefineDataIdentifierClassBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticDynamicallyDefineDataIdentifierClassBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticDynamicallyDefineDataIdentifierClassBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticDynamicallyDefineDataIdentifierClassBuilder":
