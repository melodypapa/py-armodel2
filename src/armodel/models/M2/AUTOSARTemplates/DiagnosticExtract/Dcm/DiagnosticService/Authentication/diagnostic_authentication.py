...
class DiagnosticAuthenticationBuilder(DiagnosticServiceInstanceBuilder):
    """Builder for DiagnosticAuthentication with fluent API."""
    ...
    def build(self) -> DiagnosticAuthentication:
        """Build and return the DiagnosticAuthentication instance (abstract)."""
