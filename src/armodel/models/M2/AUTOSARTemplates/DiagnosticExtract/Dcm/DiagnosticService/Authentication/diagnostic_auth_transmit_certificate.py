...
class DiagnosticAuthTransmitCertificate(DiagnosticAuthentication):
    ...
    def deserialize(cls, element: ET.Element) -> "DiagnosticAuthTransmitCertificate":
        ...
        obj.certificates = []
        container = SerializationHelper.find_child_element(element, "CERTIFICATES")
...
class DiagnosticAuthTransmitCertificateBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticAuthTransmitCertificateBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticAuthTransmitCertificateBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticAuthTransmitCertificateBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticAuthTransmitCertificateBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticAuthTransmitCertificateBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticAuthTransmitCertificateBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticAuthTransmitCertificateBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticAuthTransmitCertificateBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticAuthTransmitCertificateBuilder":
        """Set uuid attribute.
    ...
    def with_access(self, value: Optional[DiagnosticAccessPermission]) -> "DiagnosticAuthTransmitCertificateBuilder":
    ...
    def with_service_class(self, value: Optional[DiagnosticServiceClass]) -> "DiagnosticAuthTransmitCertificateBuilder":
    ...
    def with_authentication(self, value: Optional[any (Diagnostic)]) -> "DiagnosticAuthTransmitCertificateBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticAuthTransmitCertificateBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticAuthTransmitCertificateBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticAuthTransmitCertificateBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticAuthTransmitCertificateBuilder":
