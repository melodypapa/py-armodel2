...
class DiagnosticClearDiagnosticInformationBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticClearDiagnosticInformationBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticClearDiagnosticInformationBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticClearDiagnosticInformationBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticClearDiagnosticInformationBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticClearDiagnosticInformationBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticClearDiagnosticInformationBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticClearDiagnosticInformationBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticClearDiagnosticInformationBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticClearDiagnosticInformationBuilder":
        """Set uuid attribute.
    ...
    def with_access(self, value: Optional[DiagnosticAccessPermission]) -> "DiagnosticClearDiagnosticInformationBuilder":
    ...
    def with_service_class(self, value: Optional[DiagnosticServiceClass]) -> "DiagnosticClearDiagnosticInformationBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticClearDiagnosticInformationBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticClearDiagnosticInformationBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticClearDiagnosticInformationBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticClearDiagnosticInformationBuilder":
