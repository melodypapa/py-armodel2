...
class DiagnosticClearDiagnosticInformation(DiagnosticServiceInstance):
    ...
    _xml_members = [
        ("clear_diagnostic", None, False, False, any (DiagnosticClear)),  # clearDiagnostic
    ]
    ...
    def deserialize(cls, element: ET.Element) -> "DiagnosticClearDiagnosticInformation":
        ...
        # Cast to DiagnosticClearDiagnosticInformation since parent returns ARObject
        return cast("DiagnosticClearDiagnosticInformation", obj)
