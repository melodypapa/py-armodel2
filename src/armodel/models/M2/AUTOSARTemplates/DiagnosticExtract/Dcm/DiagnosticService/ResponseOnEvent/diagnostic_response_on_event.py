...
class DiagnosticResponseOnEventBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticResponseOnEventBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticResponseOnEventBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticResponseOnEventBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticResponseOnEventBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticResponseOnEventBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticResponseOnEventBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticResponseOnEventBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticResponseOnEventBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticResponseOnEventBuilder":
        """Set uuid attribute.
    ...
    def with_access(self, value: Optional[DiagnosticAccessPermission]) -> "DiagnosticResponseOnEventBuilder":
    ...
    def with_service_class(self, value: Optional[DiagnosticServiceClass]) -> "DiagnosticResponseOnEventBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticResponseOnEventBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticResponseOnEventBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticResponseOnEventBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticResponseOnEventBuilder":
