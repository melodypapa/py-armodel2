...
class DiagnosticControlDTCSettingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticControlDTCSettingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticControlDTCSettingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticControlDTCSettingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticControlDTCSettingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticControlDTCSettingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticControlDTCSettingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticControlDTCSettingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticControlDTCSettingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticControlDTCSettingBuilder":
        """Set uuid attribute.
    ...
    def with_access(self, value: Optional[DiagnosticAccessPermission]) -> "DiagnosticControlDTCSettingBuilder":
    ...
    def with_service_class(self, value: Optional[DiagnosticServiceClass]) -> "DiagnosticControlDTCSettingBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticControlDTCSettingBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticControlDTCSettingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticControlDTCSettingBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticControlDTCSettingBuilder":
