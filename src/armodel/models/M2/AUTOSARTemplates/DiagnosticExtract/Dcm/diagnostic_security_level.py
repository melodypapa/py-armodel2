...
class DiagnosticSecurityLevelBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticSecurityLevelBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticSecurityLevelBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticSecurityLevelBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticSecurityLevelBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticSecurityLevelBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticSecurityLevelBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticSecurityLevelBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticSecurityLevelBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticSecurityLevelBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticSecurityLevelBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticSecurityLevelBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticSecurityLevelBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticSecurityLevelBuilder":
