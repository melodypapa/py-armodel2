...
class DiagnosticEnvSwcModeElementBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticEnvSwcModeElementBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticEnvSwcModeElementBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticEnvSwcModeElementBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticEnvSwcModeElementBuilder":
