...
class DiagnosticEnvBswModeElementBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticEnvBswModeElementBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticEnvBswModeElementBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticEnvBswModeElementBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticEnvBswModeElementBuilder":
