...
class DiagnosticAuthRoleBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticAuthRoleBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticAuthRoleBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticAuthRoleBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticAuthRoleBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticAuthRoleBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticAuthRoleBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticAuthRoleBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticAuthRoleBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticAuthRoleBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticAuthRoleBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticAuthRoleBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticAuthRoleBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticAuthRoleBuilder":
