...
class DiagnosticRequestControlOfOnBoardDeviceBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticRequestControlOfOnBoardDeviceBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticRequestControlOfOnBoardDeviceBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticRequestControlOfOnBoardDeviceBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticRequestControlOfOnBoardDeviceBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticRequestControlOfOnBoardDeviceBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticRequestControlOfOnBoardDeviceBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticRequestControlOfOnBoardDeviceBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticRequestControlOfOnBoardDeviceBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticRequestControlOfOnBoardDeviceBuilder":
        """Set uuid attribute.
    ...
    def with_access(self, value: Optional[DiagnosticAccessPermission]) -> "DiagnosticRequestControlOfOnBoardDeviceBuilder":
    ...
    def with_service_class(self, value: Optional[DiagnosticServiceClass]) -> "DiagnosticRequestControlOfOnBoardDeviceBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticRequestControlOfOnBoardDeviceBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticRequestControlOfOnBoardDeviceBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticRequestControlOfOnBoardDeviceBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticRequestControlOfOnBoardDeviceBuilder":
