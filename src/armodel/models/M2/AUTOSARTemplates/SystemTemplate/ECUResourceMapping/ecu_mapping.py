...
class ECUMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ECUMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ECUMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ECUMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ECUMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ECUMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ECUMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ECUMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ECUMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ECUMappingBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ECUMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "ECUMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ECUMappingBuilder":
    ...
    def clear_annotations(self) -> "ECUMappingBuilder":
