...
class SenderRecRecordTypeMapping(SenderRecCompositeTypeMapping):
    ...
    _xml_members = [
        ("record_elements", None, False, True, any (SenderRecRecord)),  # recordElements
    ]
    ...
    def deserialize(cls, element: ET.Element) -> "SenderRecRecordTypeMapping":
        ...
        # Cast to SenderRecRecordTypeMapping since parent returns ARObject
        return cast("SenderRecRecordTypeMapping", obj)
