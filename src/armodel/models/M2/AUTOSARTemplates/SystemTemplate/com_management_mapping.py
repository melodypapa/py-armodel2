...
class ComManagementMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ComManagementMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ComManagementMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ComManagementMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ComManagementMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ComManagementMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ComManagementMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ComManagementMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ComManagementMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ComManagementMappingBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ComManagementMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "ComManagementMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ComManagementMappingBuilder":
    ...
    def clear_annotations(self) -> "ComManagementMappingBuilder":
