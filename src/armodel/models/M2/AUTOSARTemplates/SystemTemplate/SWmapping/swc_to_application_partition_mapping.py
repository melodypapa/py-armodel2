...
class SwcToApplicationPartitionMappingBuilder:
    """Builder for SwcToApplicationPartitionMapping with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "SwcToApplicationPartitionMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SwcToApplicationPartitionMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SwcToApplicationPartitionMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SwcToApplicationPartitionMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SwcToApplicationPartitionMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SwcToApplicationPartitionMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SwcToApplicationPartitionMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SwcToApplicationPartitionMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SwcToApplicationPartitionMappingBuilder":
        """Set uuid attribute.
    ...
    def with_application(self, value: Optional[ApplicationPartition]) -> "SwcToApplicationPartitionMappingBuilder":
    ...
    def with_sw_component_prototype(self, value: Optional[SwComponentPrototype]) -> "SwcToApplicationPartitionMappingBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SwcToApplicationPartitionMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "SwcToApplicationPartitionMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SwcToApplicationPartitionMappingBuilder":
    ...
    def clear_annotations(self) -> "SwcToApplicationPartitionMappingBuilder":
    ...
    def build(self) -> SwcToApplicationPartitionMapping:
        """Build and return the SwcToApplicationPartitionMapping instance with validation."""
