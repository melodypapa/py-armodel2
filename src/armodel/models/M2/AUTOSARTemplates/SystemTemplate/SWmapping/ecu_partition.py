...
class EcuPartitionBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "EcuPartitionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "EcuPartitionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "EcuPartitionBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "EcuPartitionBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "EcuPartitionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "EcuPartitionBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "EcuPartitionBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "EcuPartitionBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "EcuPartitionBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "EcuPartitionBuilder":
    ...
    def clear_short_name_fragments(self) -> "EcuPartitionBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "EcuPartitionBuilder":
    ...
    def clear_annotations(self) -> "EcuPartitionBuilder":
