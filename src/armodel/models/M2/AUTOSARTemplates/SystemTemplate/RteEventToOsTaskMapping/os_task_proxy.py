...
class OsTaskProxyBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "OsTaskProxyBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "OsTaskProxyBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "OsTaskProxyBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "OsTaskProxyBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "OsTaskProxyBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "OsTaskProxyBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "OsTaskProxyBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "OsTaskProxyBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "OsTaskProxyBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "OsTaskProxyBuilder":
    ...
    def clear_short_name_fragments(self) -> "OsTaskProxyBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "OsTaskProxyBuilder":
    ...
    def clear_annotations(self) -> "OsTaskProxyBuilder":
