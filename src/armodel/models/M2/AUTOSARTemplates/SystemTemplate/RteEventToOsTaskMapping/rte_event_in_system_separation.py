...
class RteEventInSystemSeparationBuilder:
    """Builder for RteEventInSystemSeparation with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "RteEventInSystemSeparationBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "RteEventInSystemSeparationBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "RteEventInSystemSeparationBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "RteEventInSystemSeparationBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "RteEventInSystemSeparationBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "RteEventInSystemSeparationBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "RteEventInSystemSeparationBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "RteEventInSystemSeparationBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "RteEventInSystemSeparationBuilder":
        """Set uuid attribute.
    ...
    def with_rte_event_instance_refs(self, items: list[RTEEvent]) -> "RteEventInSystemSeparationBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "RteEventInSystemSeparationBuilder":
    ...
    def clear_short_name_fragments(self) -> "RteEventInSystemSeparationBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "RteEventInSystemSeparationBuilder":
    ...
    def clear_annotations(self) -> "RteEventInSystemSeparationBuilder":
    ...
    def add_rte_event_instance_ref(self, item: RTEEvent) -> "RteEventInSystemSeparationBuilder":
    ...
    def clear_rte_event_instance_refs(self) -> "RteEventInSystemSeparationBuilder":
    ...
    def build(self) -> RteEventInSystemSeparation:
        """Build and return the RteEventInSystemSeparation instance with validation."""
