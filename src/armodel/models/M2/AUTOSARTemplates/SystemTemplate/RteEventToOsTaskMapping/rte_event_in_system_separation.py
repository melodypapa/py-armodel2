...
class RteEventInSystemSeparationBuilder(IdentifiableBuilder):
    ...
    def with_rte_event_instance_reves(self, items: list[RTEEvent]) -> "RteEventInSystemSeparationBuilder":
    ...
    def clear_rte_event_instance_reves(self) -> "RteEventInSystemSeparationBuilder":
