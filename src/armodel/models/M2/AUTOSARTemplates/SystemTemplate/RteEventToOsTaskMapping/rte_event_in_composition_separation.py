...
class RteEventInCompositionSeparationBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "RteEventInCompositionSeparationBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "RteEventInCompositionSeparationBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "RteEventInCompositionSeparationBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "RteEventInCompositionSeparationBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "RteEventInCompositionSeparationBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "RteEventInCompositionSeparationBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "RteEventInCompositionSeparationBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "RteEventInCompositionSeparationBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "RteEventInCompositionSeparationBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "RteEventInCompositionSeparationBuilder":
    ...
    def clear_short_name_fragments(self) -> "RteEventInCompositionSeparationBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "RteEventInCompositionSeparationBuilder":
    ...
    def clear_annotations(self) -> "RteEventInCompositionSeparationBuilder":
