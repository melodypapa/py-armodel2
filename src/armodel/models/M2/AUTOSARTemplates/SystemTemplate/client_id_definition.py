...
class ClientIdDefinitionBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ClientIdDefinitionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ClientIdDefinitionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ClientIdDefinitionBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ClientIdDefinitionBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ClientIdDefinitionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ClientIdDefinitionBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ClientIdDefinitionBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ClientIdDefinitionBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ClientIdDefinitionBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ClientIdDefinitionBuilder":
    ...
    def clear_short_name_fragments(self) -> "ClientIdDefinitionBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ClientIdDefinitionBuilder":
    ...
    def clear_annotations(self) -> "ClientIdDefinitionBuilder":
