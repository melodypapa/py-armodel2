...
class LinTpConfigBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "LinTpConfigBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "LinTpConfigBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "LinTpConfigBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "LinTpConfigBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "LinTpConfigBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "LinTpConfigBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "LinTpConfigBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "LinTpConfigBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "LinTpConfigBuilder":
        """Set uuid attribute.
    ...
    def with_communication_cluster(self, value: Optional[CommunicationCluster]) -> "LinTpConfigBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "LinTpConfigBuilder":
    ...
    def clear_short_name_fragments(self) -> "LinTpConfigBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "LinTpConfigBuilder":
    ...
    def clear_annotations(self) -> "LinTpConfigBuilder":
