...
class SomeipTpConfigBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SomeipTpConfigBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SomeipTpConfigBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SomeipTpConfigBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SomeipTpConfigBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SomeipTpConfigBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SomeipTpConfigBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SomeipTpConfigBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SomeipTpConfigBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SomeipTpConfigBuilder":
        """Set uuid attribute.
    ...
    def with_communication_cluster(self, value: Optional[CommunicationCluster]) -> "SomeipTpConfigBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SomeipTpConfigBuilder":
    ...
    def clear_short_name_fragments(self) -> "SomeipTpConfigBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SomeipTpConfigBuilder":
    ...
    def clear_annotations(self) -> "SomeipTpConfigBuilder":
