...
class FlexrayTpPduPoolBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "FlexrayTpPduPoolBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "FlexrayTpPduPoolBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "FlexrayTpPduPoolBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "FlexrayTpPduPoolBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "FlexrayTpPduPoolBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "FlexrayTpPduPoolBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "FlexrayTpPduPoolBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "FlexrayTpPduPoolBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "FlexrayTpPduPoolBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "FlexrayTpPduPoolBuilder":
    ...
    def clear_short_name_fragments(self) -> "FlexrayTpPduPoolBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "FlexrayTpPduPoolBuilder":
    ...
    def clear_annotations(self) -> "FlexrayTpPduPoolBuilder":
