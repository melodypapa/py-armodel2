...
class EthTpConfigBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "EthTpConfigBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "EthTpConfigBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "EthTpConfigBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "EthTpConfigBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "EthTpConfigBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "EthTpConfigBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "EthTpConfigBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "EthTpConfigBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "EthTpConfigBuilder":
        """Set uuid attribute.
    ...
    def with_communication_cluster(self, value: Optional[CommunicationCluster]) -> "EthTpConfigBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "EthTpConfigBuilder":
    ...
    def clear_short_name_fragments(self) -> "EthTpConfigBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "EthTpConfigBuilder":
    ...
    def clear_annotations(self) -> "EthTpConfigBuilder":
