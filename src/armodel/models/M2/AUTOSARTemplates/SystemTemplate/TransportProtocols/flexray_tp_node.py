...
class FlexrayTpNodeBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "FlexrayTpNodeBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "FlexrayTpNodeBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "FlexrayTpNodeBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "FlexrayTpNodeBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "FlexrayTpNodeBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "FlexrayTpNodeBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "FlexrayTpNodeBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "FlexrayTpNodeBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "FlexrayTpNodeBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "FlexrayTpNodeBuilder":
    ...
    def clear_short_name_fragments(self) -> "FlexrayTpNodeBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "FlexrayTpNodeBuilder":
    ...
    def clear_annotations(self) -> "FlexrayTpNodeBuilder":
