...
class TpAddressBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "TpAddressBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TpAddressBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "TpAddressBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "TpAddressBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "TpAddressBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "TpAddressBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "TpAddressBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "TpAddressBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "TpAddressBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TpAddressBuilder":
    ...
    def clear_short_name_fragments(self) -> "TpAddressBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "TpAddressBuilder":
    ...
    def clear_annotations(self) -> "TpAddressBuilder":
