...
class LinTpNodeBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "LinTpNodeBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "LinTpNodeBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "LinTpNodeBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "LinTpNodeBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "LinTpNodeBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "LinTpNodeBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "LinTpNodeBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "LinTpNodeBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "LinTpNodeBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "LinTpNodeBuilder":
    ...
    def clear_short_name_fragments(self) -> "LinTpNodeBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "LinTpNodeBuilder":
    ...
    def clear_annotations(self) -> "LinTpNodeBuilder":
