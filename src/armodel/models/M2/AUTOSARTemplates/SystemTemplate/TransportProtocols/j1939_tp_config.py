...
class J1939TpConfigBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "J1939TpConfigBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "J1939TpConfigBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "J1939TpConfigBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "J1939TpConfigBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "J1939TpConfigBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "J1939TpConfigBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "J1939TpConfigBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "J1939TpConfigBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "J1939TpConfigBuilder":
        """Set uuid attribute.
    ...
    def with_communication_cluster(self, value: Optional[CommunicationCluster]) -> "J1939TpConfigBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "J1939TpConfigBuilder":
    ...
    def clear_short_name_fragments(self) -> "J1939TpConfigBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "J1939TpConfigBuilder":
    ...
    def clear_annotations(self) -> "J1939TpConfigBuilder":
