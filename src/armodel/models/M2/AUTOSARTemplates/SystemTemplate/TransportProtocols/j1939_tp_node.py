...
class J1939TpNodeBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "J1939TpNodeBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "J1939TpNodeBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "J1939TpNodeBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "J1939TpNodeBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "J1939TpNodeBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "J1939TpNodeBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "J1939TpNodeBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "J1939TpNodeBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "J1939TpNodeBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "J1939TpNodeBuilder":
    ...
    def clear_short_name_fragments(self) -> "J1939TpNodeBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "J1939TpNodeBuilder":
    ...
    def clear_annotations(self) -> "J1939TpNodeBuilder":
