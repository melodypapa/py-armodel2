...
class DoIpLogicAddressBuilder:
    """Builder for DoIpLogicAddress with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "DoIpLogicAddressBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DoIpLogicAddressBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DoIpLogicAddressBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DoIpLogicAddressBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DoIpLogicAddressBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DoIpLogicAddressBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DoIpLogicAddressBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DoIpLogicAddressBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DoIpLogicAddressBuilder":
        """Set uuid attribute.
    ...
    def with_address(self, value: Optional[Integer]) -> "DoIpLogicAddressBuilder":
    ...
    def with_do_ip_logic(self, value: Optional[AbstractDoIpLogicAddressProps]) -> "DoIpLogicAddressBuilder":
        """Set do_ip_logic attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DoIpLogicAddressBuilder":
    ...
    def clear_short_name_fragments(self) -> "DoIpLogicAddressBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DoIpLogicAddressBuilder":
    ...
    def clear_annotations(self) -> "DoIpLogicAddressBuilder":
    ...
    def build(self) -> DoIpLogicAddress:
        """Build and return the DoIpLogicAddress instance with validation."""
