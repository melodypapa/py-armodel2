...
class SomeipTpChannelBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SomeipTpChannelBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SomeipTpChannelBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SomeipTpChannelBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SomeipTpChannelBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SomeipTpChannelBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SomeipTpChannelBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SomeipTpChannelBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SomeipTpChannelBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SomeipTpChannelBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SomeipTpChannelBuilder":
    ...
    def clear_short_name_fragments(self) -> "SomeipTpChannelBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SomeipTpChannelBuilder":
    ...
    def clear_annotations(self) -> "SomeipTpChannelBuilder":
