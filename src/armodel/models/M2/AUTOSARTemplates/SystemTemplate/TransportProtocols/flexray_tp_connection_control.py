...
class FlexrayTpConnectionControlBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "FlexrayTpConnectionControlBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "FlexrayTpConnectionControlBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "FlexrayTpConnectionControlBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "FlexrayTpConnectionControlBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "FlexrayTpConnectionControlBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "FlexrayTpConnectionControlBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "FlexrayTpConnectionControlBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "FlexrayTpConnectionControlBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "FlexrayTpConnectionControlBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "FlexrayTpConnectionControlBuilder":
    ...
    def clear_short_name_fragments(self) -> "FlexrayTpConnectionControlBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "FlexrayTpConnectionControlBuilder":
    ...
    def clear_annotations(self) -> "FlexrayTpConnectionControlBuilder":
