...
class IEEE1722TpAcfCanBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "IEEE1722TpAcfCanBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "IEEE1722TpAcfCanBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "IEEE1722TpAcfCanBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "IEEE1722TpAcfCanBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "IEEE1722TpAcfCanBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "IEEE1722TpAcfCanBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "IEEE1722TpAcfCanBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "IEEE1722TpAcfCanBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "IEEE1722TpAcfCanBuilder":
        """Set uuid attribute.
    ...
    def with_acf_parts(self, items: list[IEEE1722TpAcfBusPart]) -> "IEEE1722TpAcfCanBuilder":
    ...
    def with_bus_id(self, value: Optional[PositiveInteger]) -> "IEEE1722TpAcfCanBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "IEEE1722TpAcfCanBuilder":
    ...
    def clear_short_name_fragments(self) -> "IEEE1722TpAcfCanBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "IEEE1722TpAcfCanBuilder":
    ...
    def clear_annotations(self) -> "IEEE1722TpAcfCanBuilder":
    ...
    def add_acf_part(self, item: IEEE1722TpAcfBusPart) -> "IEEE1722TpAcfCanBuilder":
    ...
    def clear_acf_parts(self) -> "IEEE1722TpAcfCanBuilder":
