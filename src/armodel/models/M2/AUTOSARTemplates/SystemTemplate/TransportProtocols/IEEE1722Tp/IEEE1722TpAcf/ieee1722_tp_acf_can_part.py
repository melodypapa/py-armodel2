...
class IEEE1722TpAcfCanPartBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "IEEE1722TpAcfCanPartBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "IEEE1722TpAcfCanPartBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "IEEE1722TpAcfCanPartBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "IEEE1722TpAcfCanPartBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "IEEE1722TpAcfCanPartBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "IEEE1722TpAcfCanPartBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "IEEE1722TpAcfCanPartBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "IEEE1722TpAcfCanPartBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "IEEE1722TpAcfCanPartBuilder":
        """Set uuid attribute.
    ...
    def with_collection_trigger(self, value: Optional[PduCollectionTriggerEnum]) -> "IEEE1722TpAcfCanPartBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "IEEE1722TpAcfCanPartBuilder":
    ...
    def clear_short_name_fragments(self) -> "IEEE1722TpAcfCanPartBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "IEEE1722TpAcfCanPartBuilder":
    ...
    def clear_annotations(self) -> "IEEE1722TpAcfCanPartBuilder":
