...
class IEEE1722TpAcfLinPartBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "IEEE1722TpAcfLinPartBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "IEEE1722TpAcfLinPartBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "IEEE1722TpAcfLinPartBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "IEEE1722TpAcfLinPartBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "IEEE1722TpAcfLinPartBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "IEEE1722TpAcfLinPartBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "IEEE1722TpAcfLinPartBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "IEEE1722TpAcfLinPartBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "IEEE1722TpAcfLinPartBuilder":
        """Set uuid attribute.
    ...
    def with_collection_trigger(self, value: Optional[PduCollectionTriggerEnum]) -> "IEEE1722TpAcfLinPartBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "IEEE1722TpAcfLinPartBuilder":
    ...
    def clear_short_name_fragments(self) -> "IEEE1722TpAcfLinPartBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "IEEE1722TpAcfLinPartBuilder":
    ...
    def clear_annotations(self) -> "IEEE1722TpAcfLinPartBuilder":
