...
class IEEE1722TpRvfConnectionBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "IEEE1722TpRvfConnectionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "IEEE1722TpRvfConnectionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "IEEE1722TpRvfConnectionBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "IEEE1722TpRvfConnectionBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "IEEE1722TpRvfConnectionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "IEEE1722TpRvfConnectionBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "IEEE1722TpRvfConnectionBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "IEEE1722TpRvfConnectionBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "IEEE1722TpRvfConnectionBuilder":
        """Set uuid attribute.
    ...
    def with_destination_mac(self, value: Optional[MacAddressString]) -> "IEEE1722TpRvfConnectionBuilder":
    ...
    def with_mac_address_string(self, value: Optional[MacAddressString]) -> "IEEE1722TpRvfConnectionBuilder":
    ...
    def with_pdu(self, value: Optional[PduTriggering]) -> "IEEE1722TpRvfConnectionBuilder":
        """Set pdu attribute.
    ...
    def with_unique_stream_id(self, value: Optional[PositiveInteger]) -> "IEEE1722TpRvfConnectionBuilder":
    ...
    def with_version(self, value: Optional[PositiveInteger]) -> "IEEE1722TpRvfConnectionBuilder":
    ...
    def with_vlan_priority(self, value: Optional[PositiveInteger]) -> "IEEE1722TpRvfConnectionBuilder":
    ...
    def with_max_transit_time(self, value: Optional[TimeValue]) -> "IEEE1722TpRvfConnectionBuilder":
    ...
    def with_sdus(self, items: list[PduTriggering]) -> "IEEE1722TpRvfConnectionBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "IEEE1722TpRvfConnectionBuilder":
    ...
    def clear_short_name_fragments(self) -> "IEEE1722TpRvfConnectionBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "IEEE1722TpRvfConnectionBuilder":
    ...
    def clear_annotations(self) -> "IEEE1722TpRvfConnectionBuilder":
    ...
    def add_sdu(self, item: PduTriggering) -> "IEEE1722TpRvfConnectionBuilder":
    ...
    def clear_sdus(self) -> "IEEE1722TpRvfConnectionBuilder":
