...
class FlexrayArTpNodeBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "FlexrayArTpNodeBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "FlexrayArTpNodeBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "FlexrayArTpNodeBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "FlexrayArTpNodeBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "FlexrayArTpNodeBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "FlexrayArTpNodeBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "FlexrayArTpNodeBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "FlexrayArTpNodeBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "FlexrayArTpNodeBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "FlexrayArTpNodeBuilder":
    ...
    def clear_short_name_fragments(self) -> "FlexrayArTpNodeBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "FlexrayArTpNodeBuilder":
    ...
    def clear_annotations(self) -> "FlexrayArTpNodeBuilder":
