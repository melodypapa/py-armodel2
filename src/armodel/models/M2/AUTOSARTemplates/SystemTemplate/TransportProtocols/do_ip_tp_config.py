...
class DoIpTpConfigBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DoIpTpConfigBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DoIpTpConfigBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DoIpTpConfigBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DoIpTpConfigBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DoIpTpConfigBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DoIpTpConfigBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DoIpTpConfigBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DoIpTpConfigBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DoIpTpConfigBuilder":
        """Set uuid attribute.
    ...
    def with_communication_cluster(self, value: Optional[CommunicationCluster]) -> "DoIpTpConfigBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DoIpTpConfigBuilder":
    ...
    def clear_short_name_fragments(self) -> "DoIpTpConfigBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DoIpTpConfigBuilder":
    ...
    def clear_annotations(self) -> "DoIpTpConfigBuilder":
