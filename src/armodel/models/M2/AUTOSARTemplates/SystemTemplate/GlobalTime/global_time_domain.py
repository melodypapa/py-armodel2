...
class GlobalTimeDomainBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "GlobalTimeDomainBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "GlobalTimeDomainBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "GlobalTimeDomainBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "GlobalTimeDomainBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "GlobalTimeDomainBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "GlobalTimeDomainBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "GlobalTimeDomainBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "GlobalTimeDomainBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "GlobalTimeDomainBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "GlobalTimeDomainBuilder":
    ...
    def clear_short_name_fragments(self) -> "GlobalTimeDomainBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "GlobalTimeDomainBuilder":
    ...
    def clear_annotations(self) -> "GlobalTimeDomainBuilder":
