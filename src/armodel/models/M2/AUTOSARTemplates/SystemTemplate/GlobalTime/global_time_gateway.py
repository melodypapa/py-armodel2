...
class GlobalTimeGatewayBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "GlobalTimeGatewayBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "GlobalTimeGatewayBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "GlobalTimeGatewayBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "GlobalTimeGatewayBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "GlobalTimeGatewayBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "GlobalTimeGatewayBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "GlobalTimeGatewayBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "GlobalTimeGatewayBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "GlobalTimeGatewayBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "GlobalTimeGatewayBuilder":
    ...
    def clear_short_name_fragments(self) -> "GlobalTimeGatewayBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "GlobalTimeGatewayBuilder":
    ...
    def clear_annotations(self) -> "GlobalTimeGatewayBuilder":
