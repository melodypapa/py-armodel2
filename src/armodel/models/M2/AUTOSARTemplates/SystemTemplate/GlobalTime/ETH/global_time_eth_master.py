...
class GlobalTimeEthMasterBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "GlobalTimeEthMasterBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "GlobalTimeEthMasterBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "GlobalTimeEthMasterBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "GlobalTimeEthMasterBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "GlobalTimeEthMasterBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "GlobalTimeEthMasterBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "GlobalTimeEthMasterBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "GlobalTimeEthMasterBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "GlobalTimeEthMasterBuilder":
        """Set uuid attribute.
    ...
    def with_communication_connector(self, value: Optional[CommunicationConnector]) -> "GlobalTimeEthMasterBuilder":
    ...
    def with_icv_secured(self, value: Optional[GlobalTimeIcvSupportEnum]) -> "GlobalTimeEthMasterBuilder":
    ...
    def with_immediate(self, value: Optional[TimeValue]) -> "GlobalTimeEthMasterBuilder":
    ...
    def with_is_system_wide(self, value: Optional[Boolean]) -> "GlobalTimeEthMasterBuilder":
    ...
    def with_sync_period(self, value: Optional[TimeValue]) -> "GlobalTimeEthMasterBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "GlobalTimeEthMasterBuilder":
    ...
    def clear_short_name_fragments(self) -> "GlobalTimeEthMasterBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "GlobalTimeEthMasterBuilder":
    ...
    def clear_annotations(self) -> "GlobalTimeEthMasterBuilder":
