...
class GlobalTimeCanSlaveBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "GlobalTimeCanSlaveBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "GlobalTimeCanSlaveBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "GlobalTimeCanSlaveBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "GlobalTimeCanSlaveBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "GlobalTimeCanSlaveBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "GlobalTimeCanSlaveBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "GlobalTimeCanSlaveBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "GlobalTimeCanSlaveBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "GlobalTimeCanSlaveBuilder":
        """Set uuid attribute.
    ...
    def with_communication_connector(self, value: Optional[CommunicationConnector]) -> "GlobalTimeCanSlaveBuilder":
    ...
    def with_follow_up_timeout_value(self, value: Optional[TimeValue]) -> "GlobalTimeCanSlaveBuilder":
    ...
    def with_icv_verification(self, value: Optional[any (GlobalTimeIcv)]) -> "GlobalTimeCanSlaveBuilder":
    ...
    def with_time_leap_future(self, value: Optional[TimeValue]) -> "GlobalTimeCanSlaveBuilder":
    ...
    def with_time_leap(self, value: Optional[PositiveInteger]) -> "GlobalTimeCanSlaveBuilder":
    ...
    def with_time_leap_past(self, value: Optional[TimeValue]) -> "GlobalTimeCanSlaveBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "GlobalTimeCanSlaveBuilder":
    ...
    def clear_short_name_fragments(self) -> "GlobalTimeCanSlaveBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "GlobalTimeCanSlaveBuilder":
    ...
    def clear_annotations(self) -> "GlobalTimeCanSlaveBuilder":
