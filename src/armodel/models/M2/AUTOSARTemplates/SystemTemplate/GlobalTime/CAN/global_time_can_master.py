...
class GlobalTimeCanMasterBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "GlobalTimeCanMasterBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "GlobalTimeCanMasterBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "GlobalTimeCanMasterBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "GlobalTimeCanMasterBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "GlobalTimeCanMasterBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "GlobalTimeCanMasterBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "GlobalTimeCanMasterBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "GlobalTimeCanMasterBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "GlobalTimeCanMasterBuilder":
        """Set uuid attribute.
    ...
    def with_communication_connector(self, value: Optional[CommunicationConnector]) -> "GlobalTimeCanMasterBuilder":
    ...
    def with_icv_secured(self, value: Optional[GlobalTimeIcvSupportEnum]) -> "GlobalTimeCanMasterBuilder":
    ...
    def with_immediate(self, value: Optional[TimeValue]) -> "GlobalTimeCanMasterBuilder":
    ...
    def with_is_system_wide(self, value: Optional[Boolean]) -> "GlobalTimeCanMasterBuilder":
    ...
    def with_sync_period(self, value: Optional[TimeValue]) -> "GlobalTimeCanMasterBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "GlobalTimeCanMasterBuilder":
    ...
    def clear_short_name_fragments(self) -> "GlobalTimeCanMasterBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "GlobalTimeCanMasterBuilder":
    ...
    def clear_annotations(self) -> "GlobalTimeCanMasterBuilder":
