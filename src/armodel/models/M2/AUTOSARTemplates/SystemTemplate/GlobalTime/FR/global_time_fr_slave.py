...
class GlobalTimeFrSlaveBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "GlobalTimeFrSlaveBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "GlobalTimeFrSlaveBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "GlobalTimeFrSlaveBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "GlobalTimeFrSlaveBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "GlobalTimeFrSlaveBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "GlobalTimeFrSlaveBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "GlobalTimeFrSlaveBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "GlobalTimeFrSlaveBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "GlobalTimeFrSlaveBuilder":
        """Set uuid attribute.
    ...
    def with_communication_connector(self, value: Optional[CommunicationConnector]) -> "GlobalTimeFrSlaveBuilder":
    ...
    def with_follow_up_timeout_value(self, value: Optional[TimeValue]) -> "GlobalTimeFrSlaveBuilder":
    ...
    def with_icv_verification(self, value: Optional[any (GlobalTimeIcv)]) -> "GlobalTimeFrSlaveBuilder":
    ...
    def with_time_leap_future(self, value: Optional[TimeValue]) -> "GlobalTimeFrSlaveBuilder":
    ...
    def with_time_leap(self, value: Optional[PositiveInteger]) -> "GlobalTimeFrSlaveBuilder":
    ...
    def with_time_leap_past(self, value: Optional[TimeValue]) -> "GlobalTimeFrSlaveBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "GlobalTimeFrSlaveBuilder":
    ...
    def clear_short_name_fragments(self) -> "GlobalTimeFrSlaveBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "GlobalTimeFrSlaveBuilder":
    ...
    def clear_annotations(self) -> "GlobalTimeFrSlaveBuilder":
