...
class GlobalTimeFrMasterBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "GlobalTimeFrMasterBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "GlobalTimeFrMasterBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "GlobalTimeFrMasterBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "GlobalTimeFrMasterBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "GlobalTimeFrMasterBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "GlobalTimeFrMasterBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "GlobalTimeFrMasterBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "GlobalTimeFrMasterBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "GlobalTimeFrMasterBuilder":
        """Set uuid attribute.
    ...
    def with_communication_connector(self, value: Optional[CommunicationConnector]) -> "GlobalTimeFrMasterBuilder":
    ...
    def with_icv_secured(self, value: Optional[GlobalTimeIcvSupportEnum]) -> "GlobalTimeFrMasterBuilder":
    ...
    def with_immediate(self, value: Optional[TimeValue]) -> "GlobalTimeFrMasterBuilder":
    ...
    def with_is_system_wide(self, value: Optional[Boolean]) -> "GlobalTimeFrMasterBuilder":
    ...
    def with_sync_period(self, value: Optional[TimeValue]) -> "GlobalTimeFrMasterBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "GlobalTimeFrMasterBuilder":
    ...
    def clear_short_name_fragments(self) -> "GlobalTimeFrMasterBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "GlobalTimeFrMasterBuilder":
    ...
    def clear_annotations(self) -> "GlobalTimeFrMasterBuilder":
