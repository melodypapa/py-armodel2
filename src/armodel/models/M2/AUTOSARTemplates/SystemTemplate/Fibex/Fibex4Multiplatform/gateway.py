...
class GatewayBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "GatewayBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "GatewayBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "GatewayBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "GatewayBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "GatewayBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "GatewayBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "GatewayBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "GatewayBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "GatewayBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "GatewayBuilder":
    ...
    def clear_short_name_fragments(self) -> "GatewayBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "GatewayBuilder":
    ...
    def clear_annotations(self) -> "GatewayBuilder":
