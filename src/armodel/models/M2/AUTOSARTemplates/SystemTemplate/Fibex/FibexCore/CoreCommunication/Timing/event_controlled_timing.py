...
class EventControlledTimingBuilder:
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "EventControlledTimingBuilder":
    ...
    def with_category(self, value: Optional[CategoryString]) -> "EventControlledTimingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "EventControlledTimingBuilder":
        """Set desc attribute.
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "EventControlledTimingBuilder":
