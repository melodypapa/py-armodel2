...
class NmPduBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "NmPduBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "NmPduBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "NmPduBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "NmPduBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "NmPduBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "NmPduBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "NmPduBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "NmPduBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "NmPduBuilder":
        """Set uuid attribute.
    ...
    def with_has_dynamic(self, value: Optional[Boolean]) -> "NmPduBuilder":
    ...
    def with_length(self, value: Optional[UnlimitedInteger]) -> "NmPduBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "NmPduBuilder":
    ...
    def clear_short_name_fragments(self) -> "NmPduBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "NmPduBuilder":
    ...
    def clear_annotations(self) -> "NmPduBuilder":
