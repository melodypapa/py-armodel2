...
class SystemSignalBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SystemSignalBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SystemSignalBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SystemSignalBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SystemSignalBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SystemSignalBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SystemSignalBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SystemSignalBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SystemSignalBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SystemSignalBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SystemSignalBuilder":
    ...
    def clear_short_name_fragments(self) -> "SystemSignalBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SystemSignalBuilder":
    ...
    def clear_annotations(self) -> "SystemSignalBuilder":
