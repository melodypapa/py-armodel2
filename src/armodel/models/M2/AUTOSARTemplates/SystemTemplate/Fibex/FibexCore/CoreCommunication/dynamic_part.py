...
class DynamicPartBuilder:
    ...
    def with_segment_positions(self, items: list[SegmentPosition]) -> "DynamicPartBuilder":
    ...
    def add_segment_position(self, item: SegmentPosition) -> "DynamicPartBuilder":
    ...
    def clear_segment_positions(self) -> "DynamicPartBuilder":
