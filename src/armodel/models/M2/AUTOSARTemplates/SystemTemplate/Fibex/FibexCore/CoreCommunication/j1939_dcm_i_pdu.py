...
class J1939DcmIPduBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "J1939DcmIPduBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "J1939DcmIPduBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "J1939DcmIPduBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "J1939DcmIPduBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "J1939DcmIPduBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "J1939DcmIPduBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "J1939DcmIPduBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "J1939DcmIPduBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "J1939DcmIPduBuilder":
        """Set uuid attribute.
    ...
    def with_has_dynamic(self, value: Optional[Boolean]) -> "J1939DcmIPduBuilder":
    ...
    def with_length(self, value: Optional[UnlimitedInteger]) -> "J1939DcmIPduBuilder":
    ...
    def with_contained_i_pdu_props(self, value: Optional[ContainedIPduProps]) -> "J1939DcmIPduBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "J1939DcmIPduBuilder":
    ...
    def clear_short_name_fragments(self) -> "J1939DcmIPduBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "J1939DcmIPduBuilder":
    ...
    def clear_annotations(self) -> "J1939DcmIPduBuilder":
