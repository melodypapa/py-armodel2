...
class SecureCommunicationAuthenticationPropsBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SecureCommunicationAuthenticationPropsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SecureCommunicationAuthenticationPropsBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SecureCommunicationAuthenticationPropsBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SecureCommunicationAuthenticationPropsBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SecureCommunicationAuthenticationPropsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SecureCommunicationAuthenticationPropsBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SecureCommunicationAuthenticationPropsBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SecureCommunicationAuthenticationPropsBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SecureCommunicationAuthenticationPropsBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SecureCommunicationAuthenticationPropsBuilder":
    ...
    def clear_short_name_fragments(self) -> "SecureCommunicationAuthenticationPropsBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SecureCommunicationAuthenticationPropsBuilder":
    ...
    def clear_annotations(self) -> "SecureCommunicationAuthenticationPropsBuilder":
