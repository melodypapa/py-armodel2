...
class SystemSignalGroupBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SystemSignalGroupBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SystemSignalGroupBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SystemSignalGroupBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SystemSignalGroupBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SystemSignalGroupBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SystemSignalGroupBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SystemSignalGroupBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SystemSignalGroupBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SystemSignalGroupBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SystemSignalGroupBuilder":
    ...
    def clear_short_name_fragments(self) -> "SystemSignalGroupBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SystemSignalGroupBuilder":
    ...
    def clear_annotations(self) -> "SystemSignalGroupBuilder":
