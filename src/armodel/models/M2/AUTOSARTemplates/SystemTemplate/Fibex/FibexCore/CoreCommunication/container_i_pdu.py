...
class ContainerIPduBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ContainerIPduBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ContainerIPduBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ContainerIPduBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ContainerIPduBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ContainerIPduBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ContainerIPduBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ContainerIPduBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ContainerIPduBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ContainerIPduBuilder":
        """Set uuid attribute.
    ...
    def with_has_dynamic(self, value: Optional[Boolean]) -> "ContainerIPduBuilder":
    ...
    def with_length(self, value: Optional[UnlimitedInteger]) -> "ContainerIPduBuilder":
    ...
    def with_contained_i_pdu_props(self, value: Optional[ContainedIPduProps]) -> "ContainerIPduBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ContainerIPduBuilder":
    ...
    def clear_short_name_fragments(self) -> "ContainerIPduBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ContainerIPduBuilder":
    ...
    def clear_annotations(self) -> "ContainerIPduBuilder":
