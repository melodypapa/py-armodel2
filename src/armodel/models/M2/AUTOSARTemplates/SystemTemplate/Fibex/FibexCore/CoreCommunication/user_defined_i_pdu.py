...
class UserDefinedIPduBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "UserDefinedIPduBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "UserDefinedIPduBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "UserDefinedIPduBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "UserDefinedIPduBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "UserDefinedIPduBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "UserDefinedIPduBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "UserDefinedIPduBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "UserDefinedIPduBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "UserDefinedIPduBuilder":
        """Set uuid attribute.
    ...
    def with_has_dynamic(self, value: Optional[Boolean]) -> "UserDefinedIPduBuilder":
    ...
    def with_length(self, value: Optional[UnlimitedInteger]) -> "UserDefinedIPduBuilder":
    ...
    def with_contained_i_pdu_props(self, value: Optional[ContainedIPduProps]) -> "UserDefinedIPduBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "UserDefinedIPduBuilder":
    ...
    def clear_short_name_fragments(self) -> "UserDefinedIPduBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "UserDefinedIPduBuilder":
    ...
    def clear_annotations(self) -> "UserDefinedIPduBuilder":
