...
class CyclicTimingBuilder:
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "CyclicTimingBuilder":
    ...
    def with_category(self, value: Optional[CategoryString]) -> "CyclicTimingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "CyclicTimingBuilder":
        """Set desc attribute.
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "CyclicTimingBuilder":
