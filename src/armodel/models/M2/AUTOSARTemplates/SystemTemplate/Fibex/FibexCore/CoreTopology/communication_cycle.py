...
class CommunicationCycleBuilder(BuilderBase, ABC):
    """Builder for CommunicationCycle with fluent API."""
    ...
    def build(self) -> CommunicationCycle:
        """Build and return the CommunicationCycle instance (abstract)."""
