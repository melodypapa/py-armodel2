...
class ISignalGroupBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ISignalGroupBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ISignalGroupBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ISignalGroupBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ISignalGroupBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ISignalGroupBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ISignalGroupBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ISignalGroupBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ISignalGroupBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ISignalGroupBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ISignalGroupBuilder":
    ...
    def clear_short_name_fragments(self) -> "ISignalGroupBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ISignalGroupBuilder":
    ...
    def clear_annotations(self) -> "ISignalGroupBuilder":
