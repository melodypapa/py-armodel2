...
class UserDefinedPduBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "UserDefinedPduBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "UserDefinedPduBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "UserDefinedPduBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "UserDefinedPduBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "UserDefinedPduBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "UserDefinedPduBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "UserDefinedPduBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "UserDefinedPduBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "UserDefinedPduBuilder":
        """Set uuid attribute.
    ...
    def with_has_dynamic(self, value: Optional[Boolean]) -> "UserDefinedPduBuilder":
    ...
    def with_length(self, value: Optional[UnlimitedInteger]) -> "UserDefinedPduBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "UserDefinedPduBuilder":
    ...
    def clear_short_name_fragments(self) -> "UserDefinedPduBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "UserDefinedPduBuilder":
    ...
    def clear_annotations(self) -> "UserDefinedPduBuilder":
