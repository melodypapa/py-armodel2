...
class ISignalIPduBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ISignalIPduBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ISignalIPduBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ISignalIPduBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ISignalIPduBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ISignalIPduBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ISignalIPduBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ISignalIPduBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ISignalIPduBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ISignalIPduBuilder":
        """Set uuid attribute.
    ...
    def with_has_dynamic(self, value: Optional[Boolean]) -> "ISignalIPduBuilder":
    ...
    def with_length(self, value: Optional[UnlimitedInteger]) -> "ISignalIPduBuilder":
    ...
    def with_contained_i_pdu_props(self, value: Optional[ContainedIPduProps]) -> "ISignalIPduBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ISignalIPduBuilder":
    ...
    def clear_short_name_fragments(self) -> "ISignalIPduBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ISignalIPduBuilder":
    ...
    def clear_annotations(self) -> "ISignalIPduBuilder":
