...
class IPduPortBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "IPduPortBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "IPduPortBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "IPduPortBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "IPduPortBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "IPduPortBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "IPduPortBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "IPduPortBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "IPduPortBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "IPduPortBuilder":
        """Set uuid attribute.
    ...
    def with_communication(self, value: Optional[any (Communication)]) -> "IPduPortBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "IPduPortBuilder":
    ...
    def clear_short_name_fragments(self) -> "IPduPortBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "IPduPortBuilder":
    ...
    def clear_annotations(self) -> "IPduPortBuilder":
