...
class IPduTimingBuilder:
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "IPduTimingBuilder":
    ...
    def with_category(self, value: Optional[CategoryString]) -> "IPduTimingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "IPduTimingBuilder":
        """Set desc attribute.
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "IPduTimingBuilder":
