...
class SecureCommunicationPropsSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SecureCommunicationPropsSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SecureCommunicationPropsSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SecureCommunicationPropsSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SecureCommunicationPropsSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SecureCommunicationPropsSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SecureCommunicationPropsSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SecureCommunicationPropsSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SecureCommunicationPropsSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SecureCommunicationPropsSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SecureCommunicationPropsSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "SecureCommunicationPropsSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SecureCommunicationPropsSetBuilder":
    ...
    def clear_annotations(self) -> "SecureCommunicationPropsSetBuilder":
