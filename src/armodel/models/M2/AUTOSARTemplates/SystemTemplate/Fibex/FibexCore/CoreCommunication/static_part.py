...
class StaticPartBuilder:
    """Builder for StaticPart with fluent API."""
    ...
    def with_segment_positions(self, items: list[SegmentPosition]) -> "StaticPartBuilder":
    ...
    def with_i_pdu(self, value: Optional[ISignalIPdu]) -> "StaticPartBuilder":
        """Set i_pdu attribute.
    ...
    def add_segment_position(self, item: SegmentPosition) -> "StaticPartBuilder":
    ...
    def clear_segment_positions(self) -> "StaticPartBuilder":
    ...
    def build(self) -> StaticPart:
        """Build and return the StaticPart instance with validation."""
