...
from armodel.models.M2.AUTOSARTemplates.SystemTemplate.Fibex.FibexCore.CoreCommunication.multiplexed_part import MultiplexedPartBuilder
...
class StaticPartBuilder(MultiplexedPartBuilder):
