...
class ISignalTriggeringBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ISignalTriggeringBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ISignalTriggeringBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ISignalTriggeringBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ISignalTriggeringBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ISignalTriggeringBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ISignalTriggeringBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ISignalTriggeringBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ISignalTriggeringBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ISignalTriggeringBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ISignalTriggeringBuilder":
    ...
    def clear_short_name_fragments(self) -> "ISignalTriggeringBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ISignalTriggeringBuilder":
    ...
    def clear_annotations(self) -> "ISignalTriggeringBuilder":
