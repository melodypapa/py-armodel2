...
class PdurIPduGroupBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "PdurIPduGroupBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "PdurIPduGroupBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "PdurIPduGroupBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "PdurIPduGroupBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "PdurIPduGroupBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "PdurIPduGroupBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "PdurIPduGroupBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "PdurIPduGroupBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "PdurIPduGroupBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "PdurIPduGroupBuilder":
    ...
    def clear_short_name_fragments(self) -> "PdurIPduGroupBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "PdurIPduGroupBuilder":
    ...
    def clear_annotations(self) -> "PdurIPduGroupBuilder":
