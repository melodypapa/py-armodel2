...
class MultiplexedIPduBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "MultiplexedIPduBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "MultiplexedIPduBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "MultiplexedIPduBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "MultiplexedIPduBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "MultiplexedIPduBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "MultiplexedIPduBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "MultiplexedIPduBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "MultiplexedIPduBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "MultiplexedIPduBuilder":
        """Set uuid attribute.
    ...
    def with_has_dynamic(self, value: Optional[Boolean]) -> "MultiplexedIPduBuilder":
    ...
    def with_length(self, value: Optional[UnlimitedInteger]) -> "MultiplexedIPduBuilder":
    ...
    def with_contained_i_pdu_props(self, value: Optional[ContainedIPduProps]) -> "MultiplexedIPduBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "MultiplexedIPduBuilder":
    ...
    def clear_short_name_fragments(self) -> "MultiplexedIPduBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "MultiplexedIPduBuilder":
    ...
    def clear_annotations(self) -> "MultiplexedIPduBuilder":
