...
class FlexrayFrameBuilder:
    """Builder for FlexrayFrame with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "FlexrayFrameBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "FlexrayFrameBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "FlexrayFrameBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "FlexrayFrameBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "FlexrayFrameBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "FlexrayFrameBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "FlexrayFrameBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "FlexrayFrameBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "FlexrayFrameBuilder":
        """Set uuid attribute.
    ...
    def with_frame_length(self, value: Optional[Integer]) -> "FlexrayFrameBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "FlexrayFrameBuilder":
    ...
    def clear_short_name_fragments(self) -> "FlexrayFrameBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "FlexrayFrameBuilder":
    ...
    def clear_annotations(self) -> "FlexrayFrameBuilder":
    ...
    def build(self) -> FlexrayFrame:
        """Build and return the FlexrayFrame instance with validation."""
