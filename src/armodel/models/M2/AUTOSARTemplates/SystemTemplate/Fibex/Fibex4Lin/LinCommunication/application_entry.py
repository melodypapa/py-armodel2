...
class ApplicationEntryBuilder:
    ...
    def with_delay(self, value: Optional[TimeValue]) -> "ApplicationEntryBuilder":
        """Set delay attribute.
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ApplicationEntryBuilder":
    ...
    def with_position_in_table(self, value: Optional[Integer]) -> "ApplicationEntryBuilder":
