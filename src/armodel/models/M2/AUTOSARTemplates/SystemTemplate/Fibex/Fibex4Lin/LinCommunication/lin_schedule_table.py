...
class LinScheduleTableBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "LinScheduleTableBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "LinScheduleTableBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "LinScheduleTableBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "LinScheduleTableBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "LinScheduleTableBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "LinScheduleTableBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "LinScheduleTableBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "LinScheduleTableBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "LinScheduleTableBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "LinScheduleTableBuilder":
    ...
    def clear_short_name_fragments(self) -> "LinScheduleTableBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "LinScheduleTableBuilder":
    ...
    def clear_annotations(self) -> "LinScheduleTableBuilder":
