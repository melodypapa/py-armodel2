...
class AssignNadBuilder:
    ...
    def with_delay(self, value: Optional[TimeValue]) -> "AssignNadBuilder":
        """Set delay attribute.
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "AssignNadBuilder":
    ...
    def with_position_in_table(self, value: Optional[Integer]) -> "AssignNadBuilder":
    ...
    def with_assigned(self, value: Optional[LinSlave]) -> "AssignNadBuilder":
    ...
    def with_assigned_lin(self, value: Optional[LinSlaveConfigIdent]) -> "AssignNadBuilder":
