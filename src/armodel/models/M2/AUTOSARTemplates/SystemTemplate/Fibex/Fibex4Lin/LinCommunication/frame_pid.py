...
class FramePidBuilder(BuilderBase):
    """Builder for FramePid with fluent API."""
    ...
    def with_index(self, value: Optional[Integer]) -> "FramePidBuilder":
        """Set index attribute.
    ...
    def with_pid(self, value: Optional[PositiveInteger]) -> "FramePidBuilder":
        """Set pid attribute.
    ...
    def build(self) -> FramePid:
        """Build and return the FramePid instance with validation."""
