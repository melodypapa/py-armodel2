...
from armodel.models.M2.AUTOSARTemplates.SystemTemplate.Fibex.FibexCore.CoreCommunication.frame import FrameBuilder
from abc import ABC, abstractmethod
from armodel.models.M2.AUTOSARTemplates.GenericStructure.GeneralTemplateClasses.ArObject.ar_object import ARObject
from armodel.serialization import SerializationHelper
...
class LinFrame(Frame, ABC):
    ...
    def serialize(self) -> ET.Element:
        """Serialize LinFrame to XML element.
        ...
        parent_elem = super(LinFrame, self).serialize()
...
class LinFrameBuilder(FrameBuilder):
    """Builder for LinFrame with fluent API."""
    ...
    def build(self) -> LinFrame:
        """Build and return the LinFrame instance (abstract)."""
