...
class FreeFormatBuilder:
    ...
    def with_delay(self, value: Optional[TimeValue]) -> "FreeFormatBuilder":
        """Set delay attribute.
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "FreeFormatBuilder":
    ...
    def with_position_in_table(self, value: Optional[Integer]) -> "FreeFormatBuilder":
