...
class DataDumpEntryBuilder:
    ...
    def with_delay(self, value: Optional[TimeValue]) -> "DataDumpEntryBuilder":
        """Set delay attribute.
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DataDumpEntryBuilder":
    ...
    def with_position_in_table(self, value: Optional[Integer]) -> "DataDumpEntryBuilder":
    ...
    def with_assigned(self, value: Optional[LinSlave]) -> "DataDumpEntryBuilder":
    ...
    def with_assigned_lin(self, value: Optional[LinSlaveConfigIdent]) -> "DataDumpEntryBuilder":
