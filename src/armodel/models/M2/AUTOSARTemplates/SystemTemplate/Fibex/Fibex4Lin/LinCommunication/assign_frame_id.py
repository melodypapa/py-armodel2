...
class AssignFrameId(LinConfigurationEntry):
    ...
    def serialize(self) -> ET.Element:
        ...
        if self.assigned_frame_ref is not None:
            serialized = SerializationHelper.serialize_item(self.assigned_frame_ref, "LinFrameTriggering")
    ...
    def deserialize(cls, element: ET.Element) -> "AssignFrameId":
        ...
        child = SerializationHelper.find_child_element(element, "ASSIGNED-FRAME-REF")
...
class AssignFrameIdBuilder:
    """Builder for AssignFrameId with fluent API."""
    ...
    def with_delay(self, value: Optional[TimeValue]) -> "AssignFrameIdBuilder":
        """Set delay attribute.
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "AssignFrameIdBuilder":
    ...
    def with_position_in_table(self, value: Optional[Integer]) -> "AssignFrameIdBuilder":
    ...
    def with_assigned(self, value: Optional[LinSlave]) -> "AssignFrameIdBuilder":
    ...
    def with_assigned_lin(self, value: Optional[LinSlaveConfigIdent]) -> "AssignFrameIdBuilder":
    ...
    def with_assigned_frame(self, value: Optional[LinFrameTriggering]) -> "AssignFrameIdBuilder":
        """Set assigned_frame attribute.
    ...
    def build(self) -> AssignFrameId:
        """Build and return the AssignFrameId instance with validation."""
