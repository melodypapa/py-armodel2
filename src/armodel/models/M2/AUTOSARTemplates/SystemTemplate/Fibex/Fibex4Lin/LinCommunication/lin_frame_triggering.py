...
class LinFrameTriggeringBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "LinFrameTriggeringBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "LinFrameTriggeringBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "LinFrameTriggeringBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "LinFrameTriggeringBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "LinFrameTriggeringBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "LinFrameTriggeringBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "LinFrameTriggeringBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "LinFrameTriggeringBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "LinFrameTriggeringBuilder":
        """Set uuid attribute.
    ...
    def with_frame(self, value: Optional[Frame]) -> "LinFrameTriggeringBuilder":
        """Set frame attribute.
    ...
    def with_frame_ports(self, items: list[FramePort]) -> "LinFrameTriggeringBuilder":
    ...
    def with_pdu_triggerings(self, items: list[PduTriggering]) -> "LinFrameTriggeringBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "LinFrameTriggeringBuilder":
    ...
    def clear_short_name_fragments(self) -> "LinFrameTriggeringBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "LinFrameTriggeringBuilder":
    ...
    def clear_annotations(self) -> "LinFrameTriggeringBuilder":
    ...
    def add_frame_port(self, item: FramePort) -> "LinFrameTriggeringBuilder":
    ...
    def clear_frame_ports(self) -> "LinFrameTriggeringBuilder":
    ...
    def add_pdu_triggering(self, item: PduTriggering) -> "LinFrameTriggeringBuilder":
    ...
    def clear_pdu_triggerings(self) -> "LinFrameTriggeringBuilder":
