...
class SaveConfigurationEntryBuilder:
    """Builder for SaveConfigurationEntry with fluent API."""
    ...
    def with_delay(self, value: Optional[TimeValue]) -> "SaveConfigurationEntryBuilder":
        """Set delay attribute.
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SaveConfigurationEntryBuilder":
    ...
    def with_position_in_table(self, value: Optional[Integer]) -> "SaveConfigurationEntryBuilder":
    ...
    def with_assigned(self, value: Optional[LinSlave]) -> "SaveConfigurationEntryBuilder":
    ...
    def with_assigned_lin(self, value: Optional[LinSlaveConfigIdent]) -> "SaveConfigurationEntryBuilder":
    ...
    def build(self) -> SaveConfigurationEntry:
        """Build and return the SaveConfigurationEntry instance with validation."""
