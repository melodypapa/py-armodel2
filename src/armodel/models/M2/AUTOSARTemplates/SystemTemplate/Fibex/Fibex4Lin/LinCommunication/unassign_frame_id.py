...
class UnassignFrameIdBuilder:
    ...
    def with_delay(self, value: Optional[TimeValue]) -> "UnassignFrameIdBuilder":
        """Set delay attribute.
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "UnassignFrameIdBuilder":
    ...
    def with_position_in_table(self, value: Optional[Integer]) -> "UnassignFrameIdBuilder":
    ...
    def with_assigned(self, value: Optional[LinSlave]) -> "UnassignFrameIdBuilder":
    ...
    def with_assigned_lin(self, value: Optional[LinSlaveConfigIdent]) -> "UnassignFrameIdBuilder":
