...
from armodel.models.M2.AUTOSARTemplates.SystemTemplate.Fibex.Fibex4Lin.LinCommunication.lin_frame import LinFrameBuilder
...
class LinUnconditionalFrameBuilder(LinFrameBuilder):
