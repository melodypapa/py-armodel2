...
class LinUnconditionalFrameBuilder:
    """Builder for LinUnconditionalFrame with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "LinUnconditionalFrameBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "LinUnconditionalFrameBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "LinUnconditionalFrameBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "LinUnconditionalFrameBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "LinUnconditionalFrameBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "LinUnconditionalFrameBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "LinUnconditionalFrameBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "LinUnconditionalFrameBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "LinUnconditionalFrameBuilder":
        """Set uuid attribute.
    ...
    def with_frame_length(self, value: Optional[Integer]) -> "LinUnconditionalFrameBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "LinUnconditionalFrameBuilder":
    ...
    def clear_short_name_fragments(self) -> "LinUnconditionalFrameBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "LinUnconditionalFrameBuilder":
    ...
    def clear_annotations(self) -> "LinUnconditionalFrameBuilder":
    ...
    def build(self) -> LinUnconditionalFrame:
        """Build and return the LinUnconditionalFrame instance with validation."""
