...
class LinSporadicFrameBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "LinSporadicFrameBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "LinSporadicFrameBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "LinSporadicFrameBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "LinSporadicFrameBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "LinSporadicFrameBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "LinSporadicFrameBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "LinSporadicFrameBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "LinSporadicFrameBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "LinSporadicFrameBuilder":
        """Set uuid attribute.
    ...
    def with_frame_length(self, value: Optional[Integer]) -> "LinSporadicFrameBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "LinSporadicFrameBuilder":
    ...
    def clear_short_name_fragments(self) -> "LinSporadicFrameBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "LinSporadicFrameBuilder":
    ...
    def clear_annotations(self) -> "LinSporadicFrameBuilder":
