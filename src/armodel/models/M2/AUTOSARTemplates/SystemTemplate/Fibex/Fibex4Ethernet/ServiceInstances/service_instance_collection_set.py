...
class ServiceInstanceCollectionSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ServiceInstanceCollectionSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ServiceInstanceCollectionSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ServiceInstanceCollectionSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ServiceInstanceCollectionSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ServiceInstanceCollectionSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ServiceInstanceCollectionSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ServiceInstanceCollectionSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ServiceInstanceCollectionSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ServiceInstanceCollectionSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ServiceInstanceCollectionSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "ServiceInstanceCollectionSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ServiceInstanceCollectionSetBuilder":
    ...
    def clear_annotations(self) -> "ServiceInstanceCollectionSetBuilder":
