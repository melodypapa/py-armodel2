...
class SwitchStreamFilterEntryBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SwitchStreamFilterEntryBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SwitchStreamFilterEntryBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SwitchStreamFilterEntryBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SwitchStreamFilterEntryBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SwitchStreamFilterEntryBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SwitchStreamFilterEntryBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SwitchStreamFilterEntryBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SwitchStreamFilterEntryBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SwitchStreamFilterEntryBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SwitchStreamFilterEntryBuilder":
    ...
    def clear_short_name_fragments(self) -> "SwitchStreamFilterEntryBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SwitchStreamFilterEntryBuilder":
    ...
    def clear_annotations(self) -> "SwitchStreamFilterEntryBuilder":
