...
class EthernetWakeupSleepOnDatalineConfigBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "EthernetWakeupSleepOnDatalineConfigBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "EthernetWakeupSleepOnDatalineConfigBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "EthernetWakeupSleepOnDatalineConfigBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "EthernetWakeupSleepOnDatalineConfigBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "EthernetWakeupSleepOnDatalineConfigBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "EthernetWakeupSleepOnDatalineConfigBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "EthernetWakeupSleepOnDatalineConfigBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "EthernetWakeupSleepOnDatalineConfigBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "EthernetWakeupSleepOnDatalineConfigBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "EthernetWakeupSleepOnDatalineConfigBuilder":
    ...
    def clear_short_name_fragments(self) -> "EthernetWakeupSleepOnDatalineConfigBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "EthernetWakeupSleepOnDatalineConfigBuilder":
    ...
    def clear_annotations(self) -> "EthernetWakeupSleepOnDatalineConfigBuilder":
