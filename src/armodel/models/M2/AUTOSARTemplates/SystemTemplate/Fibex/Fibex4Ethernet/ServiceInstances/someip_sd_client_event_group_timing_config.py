...
class SomeipSdClientEventGroupTimingConfigBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SomeipSdClientEventGroupTimingConfigBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SomeipSdClientEventGroupTimingConfigBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SomeipSdClientEventGroupTimingConfigBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SomeipSdClientEventGroupTimingConfigBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SomeipSdClientEventGroupTimingConfigBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SomeipSdClientEventGroupTimingConfigBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SomeipSdClientEventGroupTimingConfigBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SomeipSdClientEventGroupTimingConfigBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SomeipSdClientEventGroupTimingConfigBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SomeipSdClientEventGroupTimingConfigBuilder":
    ...
    def clear_short_name_fragments(self) -> "SomeipSdClientEventGroupTimingConfigBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SomeipSdClientEventGroupTimingConfigBuilder":
    ...
    def clear_annotations(self) -> "SomeipSdClientEventGroupTimingConfigBuilder":
