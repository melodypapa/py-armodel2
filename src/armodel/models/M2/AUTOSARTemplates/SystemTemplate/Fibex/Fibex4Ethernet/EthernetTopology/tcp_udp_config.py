...
class TcpUdpConfigBuilder(TransportProtocolConfigurationBuilder):
    """Builder for TcpUdpConfig with fluent API."""
    ...
    def build(self) -> TcpUdpConfig:
        """Build and return the TcpUdpConfig instance (abstract)."""
