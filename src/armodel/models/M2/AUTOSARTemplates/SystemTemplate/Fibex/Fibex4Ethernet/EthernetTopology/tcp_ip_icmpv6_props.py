...
class TcpIpIcmpv6PropsBuilder(BuilderBase):
    """Builder for TcpIpIcmpv6Props with fluent API."""
    ...
    def with_tcp_ip_icmp(self, value: Optional[Boolean]) -> "TcpIpIcmpv6PropsBuilder":
    ...
    def build(self) -> TcpIpIcmpv6Props:
        """Build and return the TcpIpIcmpv6Props instance with validation."""
