...
from armodel.models.M2.AUTOSARTemplates.SystemTemplate.Fibex.Fibex4Ethernet.EthernetTopology.network_endpoint_address import NetworkEndpointAddressBuilder
...
class MacMulticastConfigurationBuilder(NetworkEndpointAddressBuilder):
    """Builder for MacMulticastConfiguration with fluent API."""
    ...
    def with_mac_multicast_group_group(self, value: Optional[MacMulticastGroup]) -> "MacMulticastConfigurationBuilder":
        """Set mac_multicast_group_group attribute.
    ...
    def build(self) -> MacMulticastConfiguration:
        """Build and return the MacMulticastConfiguration instance with validation."""
