...
from armodel.models.M2.AUTOSARTemplates.SystemTemplate.Fibex.Fibex4Ethernet.EthernetTopology.tcp_udp_config import TcpUdpConfigBuilder
...
class UdpTpBuilder(TcpUdpConfigBuilder):
    """Builder for UdpTp with fluent API."""
    ...
    def with_udp_tp_port(self, value: Optional[TpPort]) -> "UdpTpBuilder":
        """Set udp_tp_port attribute.
    ...
    def build(self) -> UdpTp:
        """Build and return the UdpTp instance with validation."""
