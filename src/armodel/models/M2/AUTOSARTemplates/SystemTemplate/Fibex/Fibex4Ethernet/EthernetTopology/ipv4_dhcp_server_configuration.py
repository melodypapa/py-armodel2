...
class Ipv4DhcpServerConfigurationBuilder:
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "Ipv4DhcpServerConfigurationBuilder":
    ...
    def with_category(self, value: Optional[CategoryString]) -> "Ipv4DhcpServerConfigurationBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "Ipv4DhcpServerConfigurationBuilder":
        """Set desc attribute.
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "Ipv4DhcpServerConfigurationBuilder":
