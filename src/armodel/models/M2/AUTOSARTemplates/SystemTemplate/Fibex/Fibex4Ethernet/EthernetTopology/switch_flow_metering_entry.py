...
class SwitchFlowMeteringEntryBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SwitchFlowMeteringEntryBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SwitchFlowMeteringEntryBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SwitchFlowMeteringEntryBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SwitchFlowMeteringEntryBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SwitchFlowMeteringEntryBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SwitchFlowMeteringEntryBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SwitchFlowMeteringEntryBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SwitchFlowMeteringEntryBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SwitchFlowMeteringEntryBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SwitchFlowMeteringEntryBuilder":
    ...
    def clear_short_name_fragments(self) -> "SwitchFlowMeteringEntryBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SwitchFlowMeteringEntryBuilder":
    ...
    def clear_annotations(self) -> "SwitchFlowMeteringEntryBuilder":
