...
class VlanConfigBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "VlanConfigBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "VlanConfigBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "VlanConfigBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "VlanConfigBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "VlanConfigBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "VlanConfigBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "VlanConfigBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "VlanConfigBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "VlanConfigBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "VlanConfigBuilder":
    ...
    def clear_short_name_fragments(self) -> "VlanConfigBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "VlanConfigBuilder":
    ...
    def clear_annotations(self) -> "VlanConfigBuilder":
