...
class CouplingPortStructuralElementBuilder(IdentifiableBuilder):
    """Builder for CouplingPortStructuralElement with fluent API."""
    ...
    def build(self) -> CouplingPortStructuralElement:
        """Build and return the CouplingPortStructuralElement instance (abstract)."""
