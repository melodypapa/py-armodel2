...
class EthTcpIpPropsBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "EthTcpIpPropsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "EthTcpIpPropsBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "EthTcpIpPropsBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "EthTcpIpPropsBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "EthTcpIpPropsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "EthTcpIpPropsBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "EthTcpIpPropsBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "EthTcpIpPropsBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "EthTcpIpPropsBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "EthTcpIpPropsBuilder":
    ...
    def clear_short_name_fragments(self) -> "EthTcpIpPropsBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "EthTcpIpPropsBuilder":
    ...
    def clear_annotations(self) -> "EthTcpIpPropsBuilder":
