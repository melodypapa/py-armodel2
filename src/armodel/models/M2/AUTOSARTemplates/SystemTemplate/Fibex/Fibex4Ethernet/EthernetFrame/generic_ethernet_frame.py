...
class GenericEthernetFrame(AbstractEthernetFrame):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(GenericEthernetFrame, self).serialize()
...
class GenericEthernetFrameBuilder:
    """Builder for GenericEthernetFrame with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "GenericEthernetFrameBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "GenericEthernetFrameBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "GenericEthernetFrameBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "GenericEthernetFrameBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "GenericEthernetFrameBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "GenericEthernetFrameBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "GenericEthernetFrameBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "GenericEthernetFrameBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "GenericEthernetFrameBuilder":
        """Set uuid attribute.
    ...
    def with_frame_length(self, value: Optional[Integer]) -> "GenericEthernetFrameBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "GenericEthernetFrameBuilder":
    ...
    def clear_short_name_fragments(self) -> "GenericEthernetFrameBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "GenericEthernetFrameBuilder":
    ...
    def clear_annotations(self) -> "GenericEthernetFrameBuilder":
    ...
    def build(self) -> GenericEthernetFrame:
        """Build and return the GenericEthernetFrame instance with validation."""
