...
class TransportProtocolConfigurationBuilder(BuilderBase, ABC):
    """Builder for TransportProtocolConfiguration with fluent API."""
    ...
    def build(self) -> TransportProtocolConfiguration:
        """Build and return the TransportProtocolConfiguration instance (abstract)."""
