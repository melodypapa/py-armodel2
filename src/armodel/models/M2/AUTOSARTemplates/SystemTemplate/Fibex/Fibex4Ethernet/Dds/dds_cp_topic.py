...
class DdsCpTopicBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DdsCpTopicBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DdsCpTopicBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DdsCpTopicBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DdsCpTopicBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DdsCpTopicBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DdsCpTopicBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DdsCpTopicBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DdsCpTopicBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DdsCpTopicBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DdsCpTopicBuilder":
    ...
    def clear_short_name_fragments(self) -> "DdsCpTopicBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DdsCpTopicBuilder":
    ...
    def clear_annotations(self) -> "DdsCpTopicBuilder":
