...
class MacMulticastGroupBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "MacMulticastGroupBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "MacMulticastGroupBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "MacMulticastGroupBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "MacMulticastGroupBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "MacMulticastGroupBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "MacMulticastGroupBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "MacMulticastGroupBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "MacMulticastGroupBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "MacMulticastGroupBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "MacMulticastGroupBuilder":
    ...
    def clear_short_name_fragments(self) -> "MacMulticastGroupBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "MacMulticastGroupBuilder":
    ...
    def clear_annotations(self) -> "MacMulticastGroupBuilder":
