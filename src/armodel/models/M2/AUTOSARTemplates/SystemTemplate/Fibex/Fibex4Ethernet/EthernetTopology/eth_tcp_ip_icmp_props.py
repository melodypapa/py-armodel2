...
class EthTcpIpIcmpPropsBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "EthTcpIpIcmpPropsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "EthTcpIpIcmpPropsBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "EthTcpIpIcmpPropsBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "EthTcpIpIcmpPropsBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "EthTcpIpIcmpPropsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "EthTcpIpIcmpPropsBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "EthTcpIpIcmpPropsBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "EthTcpIpIcmpPropsBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "EthTcpIpIcmpPropsBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "EthTcpIpIcmpPropsBuilder":
    ...
    def clear_short_name_fragments(self) -> "EthTcpIpIcmpPropsBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "EthTcpIpIcmpPropsBuilder":
    ...
    def clear_annotations(self) -> "EthTcpIpIcmpPropsBuilder":
