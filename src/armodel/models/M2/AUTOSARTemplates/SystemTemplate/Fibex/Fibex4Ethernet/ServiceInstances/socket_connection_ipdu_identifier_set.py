...
class SocketConnectionIpduIdentifierSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SocketConnectionIpduIdentifierSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SocketConnectionIpduIdentifierSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SocketConnectionIpduIdentifierSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SocketConnectionIpduIdentifierSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SocketConnectionIpduIdentifierSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SocketConnectionIpduIdentifierSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SocketConnectionIpduIdentifierSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SocketConnectionIpduIdentifierSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SocketConnectionIpduIdentifierSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SocketConnectionIpduIdentifierSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "SocketConnectionIpduIdentifierSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SocketConnectionIpduIdentifierSetBuilder":
    ...
    def clear_annotations(self) -> "SocketConnectionIpduIdentifierSetBuilder":
