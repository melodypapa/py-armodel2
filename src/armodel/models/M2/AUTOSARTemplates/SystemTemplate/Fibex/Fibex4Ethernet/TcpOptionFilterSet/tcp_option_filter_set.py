...
class TcpOptionFilterSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "TcpOptionFilterSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TcpOptionFilterSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "TcpOptionFilterSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "TcpOptionFilterSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "TcpOptionFilterSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "TcpOptionFilterSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "TcpOptionFilterSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "TcpOptionFilterSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "TcpOptionFilterSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TcpOptionFilterSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "TcpOptionFilterSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "TcpOptionFilterSetBuilder":
    ...
    def clear_annotations(self) -> "TcpOptionFilterSetBuilder":
