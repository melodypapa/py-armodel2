...
class CouplingPortBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "CouplingPortBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "CouplingPortBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "CouplingPortBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "CouplingPortBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "CouplingPortBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "CouplingPortBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "CouplingPortBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "CouplingPortBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "CouplingPortBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "CouplingPortBuilder":
    ...
    def clear_short_name_fragments(self) -> "CouplingPortBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "CouplingPortBuilder":
    ...
    def clear_annotations(self) -> "CouplingPortBuilder":
