...
class DdsDestinationOrderBuilder(BuilderBase):
    """Builder for DdsDestinationOrder with fluent API."""
    ...
    def with_destination(self, value: Optional[DdsDestinationOrder]) -> "DdsDestinationOrderBuilder":
    ...
    def build(self) -> DdsDestinationOrder:
        """Build and return the DdsDestinationOrder instance with validation."""
