...
class CouplingPortTrafficClassAssignmentBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "CouplingPortTrafficClassAssignmentBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "CouplingPortTrafficClassAssignmentBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "CouplingPortTrafficClassAssignmentBuilder":
    ...
    def clear_short_name_fragments(self) -> "CouplingPortTrafficClassAssignmentBuilder":
