...
class SwitchStreamFilterActionDestPortModificationBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SwitchStreamFilterActionDestPortModificationBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SwitchStreamFilterActionDestPortModificationBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SwitchStreamFilterActionDestPortModificationBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SwitchStreamFilterActionDestPortModificationBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SwitchStreamFilterActionDestPortModificationBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SwitchStreamFilterActionDestPortModificationBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SwitchStreamFilterActionDestPortModificationBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SwitchStreamFilterActionDestPortModificationBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SwitchStreamFilterActionDestPortModificationBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SwitchStreamFilterActionDestPortModificationBuilder":
    ...
    def clear_short_name_fragments(self) -> "SwitchStreamFilterActionDestPortModificationBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SwitchStreamFilterActionDestPortModificationBuilder":
    ...
    def clear_annotations(self) -> "SwitchStreamFilterActionDestPortModificationBuilder":
