...
class CouplingElementAbstractDetails(Identifiable, ABC):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(CouplingElementAbstractDetails, self).serialize()
...
class CouplingElementAbstractDetailsBuilder(IdentifiableBuilder):
    """Builder for CouplingElementAbstractDetails with fluent API."""
    ...
    def build(self) -> CouplingElementAbstractDetails:
        """Build and return the CouplingElementAbstractDetails instance (abstract)."""
