...
class UserDefinedEthernetFrameBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "UserDefinedEthernetFrameBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "UserDefinedEthernetFrameBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "UserDefinedEthernetFrameBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "UserDefinedEthernetFrameBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "UserDefinedEthernetFrameBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "UserDefinedEthernetFrameBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "UserDefinedEthernetFrameBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "UserDefinedEthernetFrameBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "UserDefinedEthernetFrameBuilder":
        """Set uuid attribute.
    ...
    def with_frame_length(self, value: Optional[Integer]) -> "UserDefinedEthernetFrameBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "UserDefinedEthernetFrameBuilder":
    ...
    def clear_short_name_fragments(self) -> "UserDefinedEthernetFrameBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "UserDefinedEthernetFrameBuilder":
    ...
    def clear_annotations(self) -> "UserDefinedEthernetFrameBuilder":
