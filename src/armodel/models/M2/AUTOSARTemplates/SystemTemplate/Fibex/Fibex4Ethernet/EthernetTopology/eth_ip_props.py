...
class EthIpPropsBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "EthIpPropsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "EthIpPropsBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "EthIpPropsBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "EthIpPropsBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "EthIpPropsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "EthIpPropsBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "EthIpPropsBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "EthIpPropsBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "EthIpPropsBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "EthIpPropsBuilder":
    ...
    def clear_short_name_fragments(self) -> "EthIpPropsBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "EthIpPropsBuilder":
    ...
    def clear_annotations(self) -> "EthIpPropsBuilder":
