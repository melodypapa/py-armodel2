...
class EthernetWakeupSleepOnDatalineConfigSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "EthernetWakeupSleepOnDatalineConfigSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "EthernetWakeupSleepOnDatalineConfigSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "EthernetWakeupSleepOnDatalineConfigSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "EthernetWakeupSleepOnDatalineConfigSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "EthernetWakeupSleepOnDatalineConfigSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "EthernetWakeupSleepOnDatalineConfigSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "EthernetWakeupSleepOnDatalineConfigSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "EthernetWakeupSleepOnDatalineConfigSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "EthernetWakeupSleepOnDatalineConfigSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "EthernetWakeupSleepOnDatalineConfigSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "EthernetWakeupSleepOnDatalineConfigSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "EthernetWakeupSleepOnDatalineConfigSetBuilder":
    ...
    def clear_annotations(self) -> "EthernetWakeupSleepOnDatalineConfigSetBuilder":
