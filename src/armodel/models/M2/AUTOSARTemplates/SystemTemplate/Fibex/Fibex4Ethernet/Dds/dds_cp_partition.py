...
class DdsCpPartitionBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DdsCpPartitionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DdsCpPartitionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DdsCpPartitionBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DdsCpPartitionBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DdsCpPartitionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DdsCpPartitionBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DdsCpPartitionBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DdsCpPartitionBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DdsCpPartitionBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DdsCpPartitionBuilder":
    ...
    def clear_short_name_fragments(self) -> "DdsCpPartitionBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DdsCpPartitionBuilder":
    ...
    def clear_annotations(self) -> "DdsCpPartitionBuilder":
