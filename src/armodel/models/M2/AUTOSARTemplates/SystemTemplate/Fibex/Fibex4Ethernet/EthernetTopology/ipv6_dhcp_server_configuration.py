...
class Ipv6DhcpServerConfigurationBuilder:
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "Ipv6DhcpServerConfigurationBuilder":
    ...
    def with_category(self, value: Optional[CategoryString]) -> "Ipv6DhcpServerConfigurationBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "Ipv6DhcpServerConfigurationBuilder":
        """Set desc attribute.
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "Ipv6DhcpServerConfigurationBuilder":
