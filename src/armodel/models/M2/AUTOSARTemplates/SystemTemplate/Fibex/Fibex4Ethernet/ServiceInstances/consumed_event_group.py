...
class ConsumedEventGroupBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ConsumedEventGroupBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ConsumedEventGroupBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ConsumedEventGroupBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ConsumedEventGroupBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ConsumedEventGroupBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ConsumedEventGroupBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ConsumedEventGroupBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ConsumedEventGroupBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ConsumedEventGroupBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ConsumedEventGroupBuilder":
    ...
    def clear_short_name_fragments(self) -> "ConsumedEventGroupBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ConsumedEventGroupBuilder":
    ...
    def clear_annotations(self) -> "ConsumedEventGroupBuilder":
