...
class SoAdRoutingGroupBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SoAdRoutingGroupBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SoAdRoutingGroupBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SoAdRoutingGroupBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SoAdRoutingGroupBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SoAdRoutingGroupBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SoAdRoutingGroupBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SoAdRoutingGroupBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SoAdRoutingGroupBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SoAdRoutingGroupBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SoAdRoutingGroupBuilder":
    ...
    def clear_short_name_fragments(self) -> "SoAdRoutingGroupBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SoAdRoutingGroupBuilder":
    ...
    def clear_annotations(self) -> "SoAdRoutingGroupBuilder":
