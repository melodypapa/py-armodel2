...
class SwitchStreamFilterRuleBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SwitchStreamFilterRuleBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SwitchStreamFilterRuleBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SwitchStreamFilterRuleBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SwitchStreamFilterRuleBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SwitchStreamFilterRuleBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SwitchStreamFilterRuleBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SwitchStreamFilterRuleBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SwitchStreamFilterRuleBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SwitchStreamFilterRuleBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SwitchStreamFilterRuleBuilder":
    ...
    def clear_short_name_fragments(self) -> "SwitchStreamFilterRuleBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SwitchStreamFilterRuleBuilder":
    ...
    def clear_annotations(self) -> "SwitchStreamFilterRuleBuilder":
