...
class CouplingPortShaperBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "CouplingPortShaperBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "CouplingPortShaperBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "CouplingPortShaperBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "CouplingPortShaperBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "CouplingPortShaperBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "CouplingPortShaperBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "CouplingPortShaperBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "CouplingPortShaperBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "CouplingPortShaperBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "CouplingPortShaperBuilder":
    ...
    def clear_short_name_fragments(self) -> "CouplingPortShaperBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "CouplingPortShaperBuilder":
    ...
    def clear_annotations(self) -> "CouplingPortShaperBuilder":
