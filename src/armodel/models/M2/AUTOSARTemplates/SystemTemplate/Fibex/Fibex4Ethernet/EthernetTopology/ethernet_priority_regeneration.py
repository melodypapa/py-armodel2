...
class EthernetPriorityRegenerationBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "EthernetPriorityRegenerationBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "EthernetPriorityRegenerationBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "EthernetPriorityRegenerationBuilder":
    ...
    def clear_short_name_fragments(self) -> "EthernetPriorityRegenerationBuilder":
