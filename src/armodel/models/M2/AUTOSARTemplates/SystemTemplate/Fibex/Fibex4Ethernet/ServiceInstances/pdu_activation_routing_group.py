...
class PduActivationRoutingGroupBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "PduActivationRoutingGroupBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "PduActivationRoutingGroupBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "PduActivationRoutingGroupBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "PduActivationRoutingGroupBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "PduActivationRoutingGroupBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "PduActivationRoutingGroupBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "PduActivationRoutingGroupBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "PduActivationRoutingGroupBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "PduActivationRoutingGroupBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "PduActivationRoutingGroupBuilder":
    ...
    def clear_short_name_fragments(self) -> "PduActivationRoutingGroupBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "PduActivationRoutingGroupBuilder":
    ...
    def clear_annotations(self) -> "PduActivationRoutingGroupBuilder":
