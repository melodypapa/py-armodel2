...
class SwitchStreamGateEntryBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SwitchStreamGateEntryBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SwitchStreamGateEntryBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SwitchStreamGateEntryBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SwitchStreamGateEntryBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SwitchStreamGateEntryBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SwitchStreamGateEntryBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SwitchStreamGateEntryBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SwitchStreamGateEntryBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SwitchStreamGateEntryBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SwitchStreamGateEntryBuilder":
    ...
    def clear_short_name_fragments(self) -> "SwitchStreamGateEntryBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SwitchStreamGateEntryBuilder":
    ...
    def clear_annotations(self) -> "SwitchStreamGateEntryBuilder":
