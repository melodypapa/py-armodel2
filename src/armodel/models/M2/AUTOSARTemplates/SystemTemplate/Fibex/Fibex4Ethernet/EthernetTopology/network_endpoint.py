...
class NetworkEndpointBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "NetworkEndpointBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "NetworkEndpointBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "NetworkEndpointBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "NetworkEndpointBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "NetworkEndpointBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "NetworkEndpointBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "NetworkEndpointBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "NetworkEndpointBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "NetworkEndpointBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "NetworkEndpointBuilder":
    ...
    def clear_short_name_fragments(self) -> "NetworkEndpointBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "NetworkEndpointBuilder":
    ...
    def clear_annotations(self) -> "NetworkEndpointBuilder":
