...
class UserDefinedCluster(ARObject):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(UserDefinedCluster, self).serialize()
    ...
    def deserialize(cls, element: ET.Element) -> "UserDefinedCluster":
        ...
        obj = super(UserDefinedCluster, cls).deserialize(element)
...
class UserDefinedClusterBuilder(BuilderBase):
    """Builder for UserDefinedCluster with fluent API."""
    ...
    def build(self) -> UserDefinedCluster:
        """Build and return the UserDefinedCluster instance with validation."""
