...
class CanControllerConfigurationRequirementsBuilder:
    ...
    def with_can_controller_fd(self, value: Optional[any (CanControllerFd)]) -> "CanControllerConfigurationRequirementsBuilder":
    ...
    def with_can_controller_xl(self, value: Optional[any (CanControllerXl)]) -> "CanControllerConfigurationRequirementsBuilder":
