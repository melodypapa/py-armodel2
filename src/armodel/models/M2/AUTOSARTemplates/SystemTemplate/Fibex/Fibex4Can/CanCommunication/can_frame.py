...
class CanFrameBuilder:
    """Builder for CanFrame with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "CanFrameBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "CanFrameBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "CanFrameBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "CanFrameBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "CanFrameBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "CanFrameBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "CanFrameBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "CanFrameBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "CanFrameBuilder":
        """Set uuid attribute.
    ...
    def with_frame_length(self, value: Optional[Integer]) -> "CanFrameBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "CanFrameBuilder":
    ...
    def clear_short_name_fragments(self) -> "CanFrameBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "CanFrameBuilder":
    ...
    def clear_annotations(self) -> "CanFrameBuilder":
    ...
    def build(self) -> CanFrame:
        """Build and return the CanFrame instance with validation."""
