...
class AbstractCanPhysicalChannelBuilder(PhysicalChannelBuilder):
    """Builder for AbstractCanPhysicalChannel with fluent API."""
    ...
    def build(self) -> AbstractCanPhysicalChannel:
        """Build and return the AbstractCanPhysicalChannel instance (abstract)."""
