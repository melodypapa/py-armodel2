...
class SOMEIPTransformationPropsBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SOMEIPTransformationPropsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SOMEIPTransformationPropsBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SOMEIPTransformationPropsBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SOMEIPTransformationPropsBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SOMEIPTransformationPropsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SOMEIPTransformationPropsBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SOMEIPTransformationPropsBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SOMEIPTransformationPropsBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SOMEIPTransformationPropsBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SOMEIPTransformationPropsBuilder":
    ...
    def clear_short_name_fragments(self) -> "SOMEIPTransformationPropsBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SOMEIPTransformationPropsBuilder":
    ...
    def clear_annotations(self) -> "SOMEIPTransformationPropsBuilder":
