...
class DataTransformationBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DataTransformationBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DataTransformationBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DataTransformationBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DataTransformationBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DataTransformationBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DataTransformationBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DataTransformationBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DataTransformationBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DataTransformationBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DataTransformationBuilder":
    ...
    def clear_short_name_fragments(self) -> "DataTransformationBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DataTransformationBuilder":
    ...
    def clear_annotations(self) -> "DataTransformationBuilder":
