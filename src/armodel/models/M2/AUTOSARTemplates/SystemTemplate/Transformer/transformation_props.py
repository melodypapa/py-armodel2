...
class TransformationPropsBuilder(IdentifiableBuilder):
    """Builder for TransformationProps with fluent API."""
    ...
    def build(self) -> TransformationProps:
        """Build and return the TransformationProps instance (abstract)."""
