...
class EndToEndTransformationDescriptionBuilder:
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "EndToEndTransformationDescriptionBuilder":
    ...
    def with_category(self, value: Optional[CategoryString]) -> "EndToEndTransformationDescriptionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "EndToEndTransformationDescriptionBuilder":
        """Set desc attribute.
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "EndToEndTransformationDescriptionBuilder":
