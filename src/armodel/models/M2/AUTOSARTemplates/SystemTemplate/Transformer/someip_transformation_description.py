...
class SOMEIPTransformationDescriptionBuilder:
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SOMEIPTransformationDescriptionBuilder":
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SOMEIPTransformationDescriptionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SOMEIPTransformationDescriptionBuilder":
        """Set desc attribute.
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SOMEIPTransformationDescriptionBuilder":
