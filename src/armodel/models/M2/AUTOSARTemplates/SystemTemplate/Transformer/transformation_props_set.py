...
class TransformationPropsSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "TransformationPropsSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TransformationPropsSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "TransformationPropsSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "TransformationPropsSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "TransformationPropsSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "TransformationPropsSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "TransformationPropsSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "TransformationPropsSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "TransformationPropsSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TransformationPropsSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "TransformationPropsSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "TransformationPropsSetBuilder":
    ...
    def clear_annotations(self) -> "TransformationPropsSetBuilder":
