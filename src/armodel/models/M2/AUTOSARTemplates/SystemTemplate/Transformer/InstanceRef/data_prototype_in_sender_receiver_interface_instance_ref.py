...
class DataPrototypeInSenderReceiverInterfaceInstanceRef(DataPrototypeInPortInterfaceInstanceRef):
    ...
    def deserialize(cls, element: ET.Element) -> "DataPrototypeInSenderReceiverInterfaceInstanceRef":
        ...
        child = SerializationHelper.find_child_element(element, "BASE-INTERFACE-REF")
        ...
        child = SerializationHelper.find_child_element(element, "ROOT-DATA-PROTOTYPE-IN-SR-REF")
        if child is not None:
        ...
        child = SerializationHelper.find_child_element(element, "TARGET-DATA-PROTOTYPE-IN-SR-REF")
        if child is not None:
...
class DataPrototypeInSenderReceiverInterfaceInstanceRefBuilder:
    ...
    def with_abstract_base(self, value: Optional[PortInterface]) -> "DataPrototypeInSenderReceiverInterfaceInstanceRefBuilder":
    ...
    def with_root_data(self, value: Optional[AutosarDataPrototype]) -> "DataPrototypeInSenderReceiverInterfaceInstanceRefBuilder":
    ...
    def with_target_data(self, value: DataPrototype) -> "DataPrototypeInSenderReceiverInterfaceInstanceRefBuilder":
