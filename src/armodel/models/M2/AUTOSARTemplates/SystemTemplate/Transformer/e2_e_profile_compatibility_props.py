...
class E2EProfileCompatibilityPropsBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "E2EProfileCompatibilityPropsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "E2EProfileCompatibilityPropsBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "E2EProfileCompatibilityPropsBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "E2EProfileCompatibilityPropsBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "E2EProfileCompatibilityPropsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "E2EProfileCompatibilityPropsBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "E2EProfileCompatibilityPropsBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "E2EProfileCompatibilityPropsBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "E2EProfileCompatibilityPropsBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "E2EProfileCompatibilityPropsBuilder":
    ...
    def clear_short_name_fragments(self) -> "E2EProfileCompatibilityPropsBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "E2EProfileCompatibilityPropsBuilder":
    ...
    def clear_annotations(self) -> "E2EProfileCompatibilityPropsBuilder":
