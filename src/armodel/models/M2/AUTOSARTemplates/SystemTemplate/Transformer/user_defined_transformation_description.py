...
class UserDefinedTransformationDescriptionBuilder:
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "UserDefinedTransformationDescriptionBuilder":
    ...
    def with_category(self, value: Optional[CategoryString]) -> "UserDefinedTransformationDescriptionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "UserDefinedTransformationDescriptionBuilder":
        """Set desc attribute.
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "UserDefinedTransformationDescriptionBuilder":
