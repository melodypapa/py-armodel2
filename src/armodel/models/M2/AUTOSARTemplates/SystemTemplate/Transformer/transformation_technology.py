...
class TransformationTechnologyBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "TransformationTechnologyBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TransformationTechnologyBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "TransformationTechnologyBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "TransformationTechnologyBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "TransformationTechnologyBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "TransformationTechnologyBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "TransformationTechnologyBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "TransformationTechnologyBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "TransformationTechnologyBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TransformationTechnologyBuilder":
    ...
    def clear_short_name_fragments(self) -> "TransformationTechnologyBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "TransformationTechnologyBuilder":
    ...
    def clear_annotations(self) -> "TransformationTechnologyBuilder":
