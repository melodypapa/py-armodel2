...
class EndToEndTransformationComSpecPropsBuilder:
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "EndToEndTransformationComSpecPropsBuilder":
    ...
    def with_category(self, value: Optional[CategoryString]) -> "EndToEndTransformationComSpecPropsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "EndToEndTransformationComSpecPropsBuilder":
        """Set desc attribute.
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "EndToEndTransformationComSpecPropsBuilder":
