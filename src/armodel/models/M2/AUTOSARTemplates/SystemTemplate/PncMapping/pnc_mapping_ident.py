...
class PncMappingIdentBuilder:
    """Builder for PncMappingIdent with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "PncMappingIdentBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "PncMappingIdentBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "PncMappingIdentBuilder":
    ...
    def clear_short_name_fragments(self) -> "PncMappingIdentBuilder":
    ...
    def build(self) -> PncMappingIdent:
        """Build and return the PncMappingIdent instance with validation."""
