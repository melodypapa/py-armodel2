...
class ClientIdDefinitionSet(ARElement):
    ...
    def deserialize(cls, element: ET.Element) -> "ClientIdDefinitionSet":
        ...
        obj.client_ids = []
        container = SerializationHelper.find_child_element(element, "CLIENT-IDS")
...
class ClientIdDefinitionSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ClientIdDefinitionSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ClientIdDefinitionSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ClientIdDefinitionSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ClientIdDefinitionSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ClientIdDefinitionSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ClientIdDefinitionSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ClientIdDefinitionSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ClientIdDefinitionSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ClientIdDefinitionSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ClientIdDefinitionSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "ClientIdDefinitionSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ClientIdDefinitionSetBuilder":
    ...
    def clear_annotations(self) -> "ClientIdDefinitionSetBuilder":
