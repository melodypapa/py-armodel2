...
class GeneralPurposeConnectionBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "GeneralPurposeConnectionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "GeneralPurposeConnectionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "GeneralPurposeConnectionBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "GeneralPurposeConnectionBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "GeneralPurposeConnectionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "GeneralPurposeConnectionBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "GeneralPurposeConnectionBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "GeneralPurposeConnectionBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "GeneralPurposeConnectionBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "GeneralPurposeConnectionBuilder":
    ...
    def clear_short_name_fragments(self) -> "GeneralPurposeConnectionBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "GeneralPurposeConnectionBuilder":
    ...
    def clear_annotations(self) -> "GeneralPurposeConnectionBuilder":
