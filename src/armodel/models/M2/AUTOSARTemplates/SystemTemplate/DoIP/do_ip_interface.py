...
class DoIpInterfaceBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DoIpInterfaceBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DoIpInterfaceBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DoIpInterfaceBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DoIpInterfaceBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DoIpInterfaceBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DoIpInterfaceBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DoIpInterfaceBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DoIpInterfaceBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DoIpInterfaceBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DoIpInterfaceBuilder":
    ...
    def clear_short_name_fragments(self) -> "DoIpInterfaceBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DoIpInterfaceBuilder":
    ...
    def clear_annotations(self) -> "DoIpInterfaceBuilder":
