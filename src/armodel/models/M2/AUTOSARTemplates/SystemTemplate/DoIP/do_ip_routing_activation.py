...
class DoIpRoutingActivationBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DoIpRoutingActivationBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DoIpRoutingActivationBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DoIpRoutingActivationBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DoIpRoutingActivationBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DoIpRoutingActivationBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DoIpRoutingActivationBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DoIpRoutingActivationBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DoIpRoutingActivationBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DoIpRoutingActivationBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DoIpRoutingActivationBuilder":
    ...
    def clear_short_name_fragments(self) -> "DoIpRoutingActivationBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DoIpRoutingActivationBuilder":
    ...
    def clear_annotations(self) -> "DoIpRoutingActivationBuilder":
