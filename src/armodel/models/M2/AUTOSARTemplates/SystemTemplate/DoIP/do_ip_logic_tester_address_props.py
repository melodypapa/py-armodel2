...
class DoIpLogicTesterAddressPropsBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DoIpLogicTesterAddressPropsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DoIpLogicTesterAddressPropsBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DoIpLogicTesterAddressPropsBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DoIpLogicTesterAddressPropsBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DoIpLogicTesterAddressPropsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DoIpLogicTesterAddressPropsBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DoIpLogicTesterAddressPropsBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DoIpLogicTesterAddressPropsBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DoIpLogicTesterAddressPropsBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DoIpLogicTesterAddressPropsBuilder":
    ...
    def clear_short_name_fragments(self) -> "DoIpLogicTesterAddressPropsBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DoIpLogicTesterAddressPropsBuilder":
    ...
    def clear_annotations(self) -> "DoIpLogicTesterAddressPropsBuilder":
