...
class TpConnectionIdent(Referrable):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(TpConnectionIdent, self).serialize()
...
class TpConnectionIdentBuilder:
    """Builder for TpConnectionIdent with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "TpConnectionIdentBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TpConnectionIdentBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TpConnectionIdentBuilder":
    ...
    def clear_short_name_fragments(self) -> "TpConnectionIdentBuilder":
    ...
    def build(self) -> TpConnectionIdent:
        """Build and return the TpConnectionIdent instance with validation."""
