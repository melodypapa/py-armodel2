...
class J1939NmNodeBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "J1939NmNodeBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "J1939NmNodeBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "J1939NmNodeBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "J1939NmNodeBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "J1939NmNodeBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "J1939NmNodeBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "J1939NmNodeBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "J1939NmNodeBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "J1939NmNodeBuilder":
        """Set uuid attribute.
    ...
    def with_controller(self, value: Optional[any (Communication)]) -> "J1939NmNodeBuilder":
    ...
    def with_nm_coord_cluster(self, value: Optional[PositiveInteger]) -> "J1939NmNodeBuilder":
    ...
    def with_nm_coordinator_role(self, value: Optional[NmCoordinatorRoleEnum]) -> "J1939NmNodeBuilder":
    ...
    def with_nm_if_ecu(self, value: Optional[NmEcu]) -> "J1939NmNodeBuilder":
    ...
    def with_nm_node_id(self, value: Optional[Integer]) -> "J1939NmNodeBuilder":
    ...
    def with_nm_passive(self, value: Optional[Boolean]) -> "J1939NmNodeBuilder":
    ...
    def with_rx_nm_pdus(self, items: list[NmPdu]) -> "J1939NmNodeBuilder":
    ...
    def with_tx_nm_pdus(self, items: list[NmPdu]) -> "J1939NmNodeBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "J1939NmNodeBuilder":
    ...
    def clear_short_name_fragments(self) -> "J1939NmNodeBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "J1939NmNodeBuilder":
    ...
    def clear_annotations(self) -> "J1939NmNodeBuilder":
    ...
    def add_rx_nm_pdu(self, item: NmPdu) -> "J1939NmNodeBuilder":
    ...
    def clear_rx_nm_pdus(self) -> "J1939NmNodeBuilder":
    ...
    def add_tx_nm_pdu(self, item: NmPdu) -> "J1939NmNodeBuilder":
    ...
    def clear_tx_nm_pdus(self) -> "J1939NmNodeBuilder":
