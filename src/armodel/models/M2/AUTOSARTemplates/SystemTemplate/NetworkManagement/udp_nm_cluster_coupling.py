...
from armodel.models.M2.AUTOSARTemplates.SystemTemplate.NetworkManagement.nm_cluster_coupling import NmClusterCouplingBuilder
...
class UdpNmClusterCouplingBuilder(NmClusterCouplingBuilder):
    """Builder for UdpNmClusterCoupling with fluent API."""
    ...
    def with_coupled_clusters(self, items: list[UdpNmCluster]) -> "UdpNmClusterCouplingBuilder":
    ...
    def with_nm_immediate(self, value: Optional[Boolean]) -> "UdpNmClusterCouplingBuilder":
    ...
    def add_coupled_cluster(self, item: UdpNmCluster) -> "UdpNmClusterCouplingBuilder":
    ...
    def clear_coupled_clusters(self) -> "UdpNmClusterCouplingBuilder":
    ...
    def build(self) -> UdpNmClusterCoupling:
        """Build and return the UdpNmClusterCoupling instance with validation."""
