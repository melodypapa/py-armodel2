...
class NmEcuBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "NmEcuBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "NmEcuBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "NmEcuBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "NmEcuBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "NmEcuBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "NmEcuBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "NmEcuBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "NmEcuBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "NmEcuBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "NmEcuBuilder":
    ...
    def clear_short_name_fragments(self) -> "NmEcuBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "NmEcuBuilder":
    ...
    def clear_annotations(self) -> "NmEcuBuilder":
