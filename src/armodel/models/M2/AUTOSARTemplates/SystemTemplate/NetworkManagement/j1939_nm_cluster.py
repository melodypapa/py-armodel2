...
class J1939NmClusterBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "J1939NmClusterBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "J1939NmClusterBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "J1939NmClusterBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "J1939NmClusterBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "J1939NmClusterBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "J1939NmClusterBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "J1939NmClusterBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "J1939NmClusterBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "J1939NmClusterBuilder":
        """Set uuid attribute.
    ...
    def with_communication_cluster(self, value: Optional[CommunicationCluster]) -> "J1939NmClusterBuilder":
    ...
    def with_nm_channel(self, value: Optional[Boolean]) -> "J1939NmClusterBuilder":
    ...
    def with_nm_node(self, value: Optional[Boolean]) -> "J1939NmClusterBuilder":
    ...
    def with_nm_node_id_enabled(self, value: Optional[Boolean]) -> "J1939NmClusterBuilder":
    ...
    def with_nm_pnc(self, value: Optional[Boolean]) -> "J1939NmClusterBuilder":
    ...
    def with_nm_repeat_msg_ind_enabled(self, value: Optional[Boolean]) -> "J1939NmClusterBuilder":
    ...
    def with_nm(self, value: Optional[Boolean]) -> "J1939NmClusterBuilder":
        """Set nm attribute.
    ...
    def with_pnc_cluster(self, value: Optional[PositiveInteger]) -> "J1939NmClusterBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "J1939NmClusterBuilder":
    ...
    def clear_short_name_fragments(self) -> "J1939NmClusterBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "J1939NmClusterBuilder":
    ...
    def clear_annotations(self) -> "J1939NmClusterBuilder":
