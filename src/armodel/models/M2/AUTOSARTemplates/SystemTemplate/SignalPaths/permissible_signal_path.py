...
class PermissibleSignalPathBuilder:
    """Builder for PermissibleSignalPath with fluent API."""
    ...
    def with_introduction(self, value: DocumentationBlock) -> "PermissibleSignalPathBuilder":
    ...
    def with_physical_channels(self, items: list[PhysicalChannel]) -> "PermissibleSignalPathBuilder":
    ...
    def with_signals(self, items: list[SwcToSwcSignal]) -> "PermissibleSignalPathBuilder":
    ...
    def clear_operations(self) -> "PermissibleSignalPathBuilder":
    ...
    def add_physical_channel(self, item: PhysicalChannel) -> "PermissibleSignalPathBuilder":
    ...
    def clear_physical_channels(self) -> "PermissibleSignalPathBuilder":
    ...
    def add_signal(self, item: SwcToSwcSignal) -> "PermissibleSignalPathBuilder":
    ...
    def clear_signals(self) -> "PermissibleSignalPathBuilder":
    ...
    def build(self) -> PermissibleSignalPath:
        """Build and return the PermissibleSignalPath instance with validation."""
