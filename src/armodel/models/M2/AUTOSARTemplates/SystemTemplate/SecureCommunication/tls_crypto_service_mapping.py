...
class TlsCryptoServiceMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "TlsCryptoServiceMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TlsCryptoServiceMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "TlsCryptoServiceMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "TlsCryptoServiceMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "TlsCryptoServiceMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "TlsCryptoServiceMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "TlsCryptoServiceMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "TlsCryptoServiceMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "TlsCryptoServiceMappingBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TlsCryptoServiceMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "TlsCryptoServiceMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "TlsCryptoServiceMappingBuilder":
    ...
    def clear_annotations(self) -> "TlsCryptoServiceMappingBuilder":
