...
class CryptoEllipticCurvePropsBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "CryptoEllipticCurvePropsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "CryptoEllipticCurvePropsBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "CryptoEllipticCurvePropsBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "CryptoEllipticCurvePropsBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "CryptoEllipticCurvePropsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "CryptoEllipticCurvePropsBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "CryptoEllipticCurvePropsBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "CryptoEllipticCurvePropsBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "CryptoEllipticCurvePropsBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "CryptoEllipticCurvePropsBuilder":
    ...
    def clear_short_name_fragments(self) -> "CryptoEllipticCurvePropsBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "CryptoEllipticCurvePropsBuilder":
    ...
    def clear_annotations(self) -> "CryptoEllipticCurvePropsBuilder":
