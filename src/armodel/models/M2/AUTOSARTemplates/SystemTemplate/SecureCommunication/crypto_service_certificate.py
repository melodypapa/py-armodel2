...
class CryptoServiceCertificateBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "CryptoServiceCertificateBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "CryptoServiceCertificateBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "CryptoServiceCertificateBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "CryptoServiceCertificateBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "CryptoServiceCertificateBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "CryptoServiceCertificateBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "CryptoServiceCertificateBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "CryptoServiceCertificateBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "CryptoServiceCertificateBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "CryptoServiceCertificateBuilder":
    ...
    def clear_short_name_fragments(self) -> "CryptoServiceCertificateBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "CryptoServiceCertificateBuilder":
    ...
    def clear_annotations(self) -> "CryptoServiceCertificateBuilder":
