...
class IPSecRuleBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "IPSecRuleBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "IPSecRuleBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "IPSecRuleBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "IPSecRuleBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "IPSecRuleBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "IPSecRuleBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "IPSecRuleBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "IPSecRuleBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "IPSecRuleBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "IPSecRuleBuilder":
    ...
    def clear_short_name_fragments(self) -> "IPSecRuleBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "IPSecRuleBuilder":
    ...
    def clear_annotations(self) -> "IPSecRuleBuilder":
