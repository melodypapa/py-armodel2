...
class IPSecConfig(ARObject):
    ...
    _xml_members = [
        ("ip_sec_config", None, False, False, IPSecConfigProps),  # ipSecConfig
        ("ip_sec_rules", None, False, True, IPSecRule),  # ipSecRules
    ]
    ...
    def deserialize(cls, element: ET.Element) -> "IPSecConfig":
        ...
        # Cast to IPSecConfig since parent returns ARObject
        return cast("IPSecConfig", obj)
