...
class IPSecConfigPropsBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "IPSecConfigPropsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "IPSecConfigPropsBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "IPSecConfigPropsBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "IPSecConfigPropsBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "IPSecConfigPropsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "IPSecConfigPropsBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "IPSecConfigPropsBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "IPSecConfigPropsBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "IPSecConfigPropsBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "IPSecConfigPropsBuilder":
    ...
    def clear_short_name_fragments(self) -> "IPSecConfigPropsBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "IPSecConfigPropsBuilder":
    ...
    def clear_annotations(self) -> "IPSecConfigPropsBuilder":
