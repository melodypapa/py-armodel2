...
class MacSecGlobalKayPropsBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "MacSecGlobalKayPropsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "MacSecGlobalKayPropsBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "MacSecGlobalKayPropsBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "MacSecGlobalKayPropsBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "MacSecGlobalKayPropsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "MacSecGlobalKayPropsBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "MacSecGlobalKayPropsBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "MacSecGlobalKayPropsBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "MacSecGlobalKayPropsBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "MacSecGlobalKayPropsBuilder":
    ...
    def clear_short_name_fragments(self) -> "MacSecGlobalKayPropsBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "MacSecGlobalKayPropsBuilder":
    ...
    def clear_annotations(self) -> "MacSecGlobalKayPropsBuilder":
