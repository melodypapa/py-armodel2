...
class MacSecKayParticipantBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "MacSecKayParticipantBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "MacSecKayParticipantBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "MacSecKayParticipantBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "MacSecKayParticipantBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "MacSecKayParticipantBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "MacSecKayParticipantBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "MacSecKayParticipantBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "MacSecKayParticipantBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "MacSecKayParticipantBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "MacSecKayParticipantBuilder":
    ...
    def clear_short_name_fragments(self) -> "MacSecKayParticipantBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "MacSecKayParticipantBuilder":
    ...
    def clear_annotations(self) -> "MacSecKayParticipantBuilder":
