...
class TlsCryptoCipherSuiteBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "TlsCryptoCipherSuiteBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TlsCryptoCipherSuiteBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "TlsCryptoCipherSuiteBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "TlsCryptoCipherSuiteBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "TlsCryptoCipherSuiteBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "TlsCryptoCipherSuiteBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "TlsCryptoCipherSuiteBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "TlsCryptoCipherSuiteBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "TlsCryptoCipherSuiteBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TlsCryptoCipherSuiteBuilder":
    ...
    def clear_short_name_fragments(self) -> "TlsCryptoCipherSuiteBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "TlsCryptoCipherSuiteBuilder":
    ...
    def clear_annotations(self) -> "TlsCryptoCipherSuiteBuilder":
