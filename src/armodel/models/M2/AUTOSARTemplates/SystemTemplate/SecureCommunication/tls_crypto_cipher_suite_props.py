...
class TlsCryptoCipherSuitePropsBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "TlsCryptoCipherSuitePropsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TlsCryptoCipherSuitePropsBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "TlsCryptoCipherSuitePropsBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "TlsCryptoCipherSuitePropsBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "TlsCryptoCipherSuitePropsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "TlsCryptoCipherSuitePropsBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "TlsCryptoCipherSuitePropsBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "TlsCryptoCipherSuitePropsBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "TlsCryptoCipherSuitePropsBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TlsCryptoCipherSuitePropsBuilder":
    ...
    def clear_short_name_fragments(self) -> "TlsCryptoCipherSuitePropsBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "TlsCryptoCipherSuitePropsBuilder":
    ...
    def clear_annotations(self) -> "TlsCryptoCipherSuitePropsBuilder":
