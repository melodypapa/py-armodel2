...
class MacSecParticipantSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "MacSecParticipantSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "MacSecParticipantSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "MacSecParticipantSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "MacSecParticipantSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "MacSecParticipantSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "MacSecParticipantSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "MacSecParticipantSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "MacSecParticipantSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "MacSecParticipantSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "MacSecParticipantSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "MacSecParticipantSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "MacSecParticipantSetBuilder":
    ...
    def clear_annotations(self) -> "MacSecParticipantSetBuilder":
