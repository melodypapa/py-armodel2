...
class CpSoftwareClusterCommunicationResourceProps(ARObject, ABC):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(CpSoftwareClusterCommunicationResourceProps, self).serialize()
    ...
    def deserialize(cls, element: ET.Element) -> "CpSoftwareClusterCommunicationResourceProps":
        ...
        return super(CpSoftwareClusterCommunicationResourceProps, cls).deserialize(element)



class CpSoftwareClusterCommunicationResourcePropsBuilder(BuilderBase, ABC):
    """Builder for CpSoftwareClusterCommunicationResourceProps with fluent API."""
    ...
    def build(self) -> CpSoftwareClusterCommunicationResourceProps:
        """Build and return the CpSoftwareClusterCommunicationResourceProps instance (abstract)."""
