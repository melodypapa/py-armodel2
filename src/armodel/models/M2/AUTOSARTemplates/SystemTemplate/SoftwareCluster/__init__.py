...
from armodel.models.M2.AUTOSARTemplates.SystemTemplate.SoftwareCluster.data_consistency_policy_enum import (
    DataConsistencyPolicyEnum,
)
from armodel.models.M2.AUTOSARTemplates.SystemTemplate.SoftwareCluster.send_indication_enum import (
    SendIndicationEnum,
)
