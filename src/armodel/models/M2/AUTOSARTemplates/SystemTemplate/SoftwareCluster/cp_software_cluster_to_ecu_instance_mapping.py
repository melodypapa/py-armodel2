...
class CpSoftwareClusterToEcuInstanceMapping(Identifiable):
    ...
    def deserialize(cls, element: ET.Element) -> "CpSoftwareClusterToEcuInstanceMapping":
        ...
        # Parse machine_id
        child = SerializationHelper.find_child_element(element, "MACHINE-ID")
        if child is not None:
...
class CpSoftwareClusterToEcuInstanceMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "CpSoftwareClusterToEcuInstanceMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "CpSoftwareClusterToEcuInstanceMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "CpSoftwareClusterToEcuInstanceMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "CpSoftwareClusterToEcuInstanceMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "CpSoftwareClusterToEcuInstanceMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "CpSoftwareClusterToEcuInstanceMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "CpSoftwareClusterToEcuInstanceMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "CpSoftwareClusterToEcuInstanceMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "CpSoftwareClusterToEcuInstanceMappingBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "CpSoftwareClusterToEcuInstanceMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "CpSoftwareClusterToEcuInstanceMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "CpSoftwareClusterToEcuInstanceMappingBuilder":
    ...
    def clear_annotations(self) -> "CpSoftwareClusterToEcuInstanceMappingBuilder":
