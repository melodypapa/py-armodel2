...
class CpSoftwareClusterResourcePoolBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "CpSoftwareClusterResourcePoolBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "CpSoftwareClusterResourcePoolBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "CpSoftwareClusterResourcePoolBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "CpSoftwareClusterResourcePoolBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "CpSoftwareClusterResourcePoolBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "CpSoftwareClusterResourcePoolBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "CpSoftwareClusterResourcePoolBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "CpSoftwareClusterResourcePoolBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "CpSoftwareClusterResourcePoolBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "CpSoftwareClusterResourcePoolBuilder":
    ...
    def clear_short_name_fragments(self) -> "CpSoftwareClusterResourcePoolBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "CpSoftwareClusterResourcePoolBuilder":
    ...
    def clear_annotations(self) -> "CpSoftwareClusterResourcePoolBuilder":
