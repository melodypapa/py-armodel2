...
class CpSoftwareClusterBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "CpSoftwareClusterBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "CpSoftwareClusterBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "CpSoftwareClusterBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "CpSoftwareClusterBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "CpSoftwareClusterBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "CpSoftwareClusterBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "CpSoftwareClusterBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "CpSoftwareClusterBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "CpSoftwareClusterBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "CpSoftwareClusterBuilder":
    ...
    def clear_short_name_fragments(self) -> "CpSoftwareClusterBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "CpSoftwareClusterBuilder":
    ...
    def clear_annotations(self) -> "CpSoftwareClusterBuilder":
