...
class CpSoftwareClusterToApplicationPartitionMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "CpSoftwareClusterToApplicationPartitionMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "CpSoftwareClusterToApplicationPartitionMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "CpSoftwareClusterToApplicationPartitionMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "CpSoftwareClusterToApplicationPartitionMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "CpSoftwareClusterToApplicationPartitionMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "CpSoftwareClusterToApplicationPartitionMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "CpSoftwareClusterToApplicationPartitionMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "CpSoftwareClusterToApplicationPartitionMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "CpSoftwareClusterToApplicationPartitionMappingBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "CpSoftwareClusterToApplicationPartitionMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "CpSoftwareClusterToApplicationPartitionMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "CpSoftwareClusterToApplicationPartitionMappingBuilder":
    ...
    def clear_annotations(self) -> "CpSoftwareClusterToApplicationPartitionMappingBuilder":
