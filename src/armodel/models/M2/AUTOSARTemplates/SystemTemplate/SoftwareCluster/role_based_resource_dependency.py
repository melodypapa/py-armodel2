...
class RoleBasedResourceDependencyBuilder(BuilderBase):
    """Builder for RoleBasedResourceDependency with fluent API."""
    ...
    def with_resource(self, value: Optional[CpSoftwareCluster]) -> "RoleBasedResourceDependencyBuilder":
    ...
    def with_role(self, value: Optional[Identifier]) -> "RoleBasedResourceDependencyBuilder":
        """Set role attribute.
    ...
    def build(self) -> RoleBasedResourceDependency:
        """Build and return the RoleBasedResourceDependency instance with validation."""
