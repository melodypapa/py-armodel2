...
class SwComponentPrototypeAssignment(ARObject):
    ...
    _xml_members = [
        ("sw_component", None, False, False, any (SwComponent)),  # swComponent
    ]
    ...
    def deserialize(cls, element: ET.Element) -> "SwComponentPrototypeAssignment":
        ...
        # Cast to SwComponentPrototypeAssignment since parent returns ARObject
        return cast("SwComponentPrototypeAssignment", obj)
