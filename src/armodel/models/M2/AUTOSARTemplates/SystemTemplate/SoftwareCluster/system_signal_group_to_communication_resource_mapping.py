...
class SystemSignalGroupToCommunicationResourceMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SystemSignalGroupToCommunicationResourceMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SystemSignalGroupToCommunicationResourceMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SystemSignalGroupToCommunicationResourceMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SystemSignalGroupToCommunicationResourceMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SystemSignalGroupToCommunicationResourceMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SystemSignalGroupToCommunicationResourceMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SystemSignalGroupToCommunicationResourceMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SystemSignalGroupToCommunicationResourceMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SystemSignalGroupToCommunicationResourceMappingBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SystemSignalGroupToCommunicationResourceMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "SystemSignalGroupToCommunicationResourceMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SystemSignalGroupToCommunicationResourceMappingBuilder":
    ...
    def clear_annotations(self) -> "SystemSignalGroupToCommunicationResourceMappingBuilder":
