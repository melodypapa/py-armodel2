...
class BinaryManifestResourceDefinitionBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "BinaryManifestResourceDefinitionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "BinaryManifestResourceDefinitionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "BinaryManifestResourceDefinitionBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "BinaryManifestResourceDefinitionBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "BinaryManifestResourceDefinitionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "BinaryManifestResourceDefinitionBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "BinaryManifestResourceDefinitionBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "BinaryManifestResourceDefinitionBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "BinaryManifestResourceDefinitionBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "BinaryManifestResourceDefinitionBuilder":
    ...
    def clear_short_name_fragments(self) -> "BinaryManifestResourceDefinitionBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "BinaryManifestResourceDefinitionBuilder":
    ...
    def clear_annotations(self) -> "BinaryManifestResourceDefinitionBuilder":
