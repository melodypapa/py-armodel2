...
class BinaryManifestItemBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "BinaryManifestItemBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "BinaryManifestItemBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "BinaryManifestItemBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "BinaryManifestItemBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "BinaryManifestItemBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "BinaryManifestItemBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "BinaryManifestItemBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "BinaryManifestItemBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "BinaryManifestItemBuilder":
        """Set uuid attribute.
    ...
    def with_address(self, value: Optional[Address]) -> "BinaryManifestItemBuilder":
    ...
    def with_symbol(self, value: Optional[SymbolString]) -> "BinaryManifestItemBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "BinaryManifestItemBuilder":
    ...
    def clear_short_name_fragments(self) -> "BinaryManifestItemBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "BinaryManifestItemBuilder":
    ...
    def clear_annotations(self) -> "BinaryManifestItemBuilder":
