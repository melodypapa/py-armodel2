...
class BinaryManifestItemValueBuilder(BuilderBase, ABC):
    """Builder for BinaryManifestItemValue with fluent API."""
    ...
    def build(self) -> BinaryManifestItemValue:
        """Build and return the BinaryManifestItemValue instance (abstract)."""
