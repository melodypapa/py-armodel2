...
class BinaryManifestItemDefinitionBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "BinaryManifestItemDefinitionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "BinaryManifestItemDefinitionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "BinaryManifestItemDefinitionBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "BinaryManifestItemDefinitionBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "BinaryManifestItemDefinitionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "BinaryManifestItemDefinitionBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "BinaryManifestItemDefinitionBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "BinaryManifestItemDefinitionBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "BinaryManifestItemDefinitionBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "BinaryManifestItemDefinitionBuilder":
    ...
    def clear_short_name_fragments(self) -> "BinaryManifestItemDefinitionBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "BinaryManifestItemDefinitionBuilder":
    ...
    def clear_annotations(self) -> "BinaryManifestItemDefinitionBuilder":
