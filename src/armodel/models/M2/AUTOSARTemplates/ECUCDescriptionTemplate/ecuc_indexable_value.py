...
class EcucIndexableValue(ARObject, ABC):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(EcucIndexableValue, self).serialize()
...
class EcucIndexableValueBuilder(BuilderBase, ABC):
    """Builder for EcucIndexableValue with fluent API."""
    ...
    def with_index(self, value: Optional[PositiveInteger]) -> "EcucIndexableValueBuilder":
        """Set index attribute.
    ...
    def build(self) -> EcucIndexableValue:
        """Build and return the EcucIndexableValue instance (abstract)."""
