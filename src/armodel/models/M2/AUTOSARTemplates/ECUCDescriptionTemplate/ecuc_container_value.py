...
class EcucContainerValueBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "EcucContainerValueBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "EcucContainerValueBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "EcucContainerValueBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "EcucContainerValueBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "EcucContainerValueBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "EcucContainerValueBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "EcucContainerValueBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "EcucContainerValueBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "EcucContainerValueBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "EcucContainerValueBuilder":
    ...
    def clear_short_name_fragments(self) -> "EcucContainerValueBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "EcucContainerValueBuilder":
    ...
    def clear_annotations(self) -> "EcucContainerValueBuilder":
