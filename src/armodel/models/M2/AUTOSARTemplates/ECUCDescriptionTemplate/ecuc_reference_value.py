...
class EcucReferenceValueBuilder:
    ...
    def with_index(self, value: Optional[PositiveInteger]) -> "EcucReferenceValueBuilder":
        """Set index attribute.
    ...
    def with_annotations(self, items: list[Annotation]) -> "EcucReferenceValueBuilder":
    ...
    def with_definition(self, value: Optional[any (EcucAbstractReference)]) -> "EcucReferenceValueBuilder":
    ...
    def with_is_auto_value(self, value: Optional[Boolean]) -> "EcucReferenceValueBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "EcucReferenceValueBuilder":
    ...
    def clear_annotations(self) -> "EcucReferenceValueBuilder":
