...
class EcucValueCollectionBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "EcucValueCollectionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "EcucValueCollectionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "EcucValueCollectionBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "EcucValueCollectionBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "EcucValueCollectionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "EcucValueCollectionBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "EcucValueCollectionBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "EcucValueCollectionBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "EcucValueCollectionBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "EcucValueCollectionBuilder":
    ...
    def clear_short_name_fragments(self) -> "EcucValueCollectionBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "EcucValueCollectionBuilder":
    ...
    def clear_annotations(self) -> "EcucValueCollectionBuilder":
