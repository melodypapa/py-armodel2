...
class EcucNumericalParamValueBuilder:
    """Builder for EcucNumericalParamValue with fluent API."""
    ...
    def with_index(self, value: Optional[PositiveInteger]) -> "EcucNumericalParamValueBuilder":
        """Set index attribute.
    ...
    def with_annotations(self, items: list[Annotation]) -> "EcucNumericalParamValueBuilder":
    ...
    def with_definition(self, value: Optional[EcucParameterDef]) -> "EcucNumericalParamValueBuilder":
    ...
    def with_is_auto_value(self, value: Optional[Boolean]) -> "EcucNumericalParamValueBuilder":
    ...
    def with_value(self, value: Optional[Numerical]) -> "EcucNumericalParamValueBuilder":
        """Set value attribute.
    ...
    def add_annotation(self, item: Annotation) -> "EcucNumericalParamValueBuilder":
    ...
    def clear_annotations(self) -> "EcucNumericalParamValueBuilder":
    ...
    def build(self) -> EcucNumericalParamValue:
        """Build and return the EcucNumericalParamValue instance with validation."""
