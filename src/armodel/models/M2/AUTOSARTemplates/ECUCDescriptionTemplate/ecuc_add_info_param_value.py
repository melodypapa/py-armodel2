...
from armodel.models.M2.AUTOSARTemplates.ECUCDescriptionTemplate.ecuc_parameter_value import EcucParameterValueBuilder
...
class EcucAddInfoParamValueBuilder(EcucParameterValueBuilder):
