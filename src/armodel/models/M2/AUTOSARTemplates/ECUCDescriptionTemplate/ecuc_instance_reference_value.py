...
class EcucInstanceReferenceValueBuilder:
    ...
    def with_index(self, value: Optional[PositiveInteger]) -> "EcucInstanceReferenceValueBuilder":
        """Set index attribute.
    ...
    def with_annotations(self, items: list[Annotation]) -> "EcucInstanceReferenceValueBuilder":
    ...
    def with_definition(self, value: Optional[any (EcucAbstractReference)]) -> "EcucInstanceReferenceValueBuilder":
    ...
    def with_is_auto_value(self, value: Optional[Boolean]) -> "EcucInstanceReferenceValueBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "EcucInstanceReferenceValueBuilder":
    ...
    def clear_annotations(self) -> "EcucInstanceReferenceValueBuilder":
