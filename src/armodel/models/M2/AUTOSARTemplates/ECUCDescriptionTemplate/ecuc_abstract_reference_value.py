...
from armodel.models.M2.AUTOSARTemplates.ECUCDescriptionTemplate.ecuc_indexable_value import EcucIndexableValueBuilder
...
class EcucAbstractReferenceValue(EcucIndexableValue, ABC):
    ...
    def serialize(self) -> ET.Element:
        ...
        if self.definition_ref is not None:
            serialized = SerializationHelper.serialize_item(self.definition_ref, "Any")
            if serialized is not None:
...
class EcucAbstractReferenceValueBuilder(EcucIndexableValueBuilder):
    """Builder for EcucAbstractReferenceValue with fluent API."""
    ...
    def with_annotations(self, items: list[Annotation]) -> "EcucAbstractReferenceValueBuilder":
    ...
    def with_is_auto_value(self, value: Optional[Boolean]) -> "EcucAbstractReferenceValueBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "EcucAbstractReferenceValueBuilder":
    ...
    def clear_annotations(self) -> "EcucAbstractReferenceValueBuilder":
    ...
    def build(self) -> EcucAbstractReferenceValue:
        """Build and return the EcucAbstractReferenceValue instance (abstract)."""
