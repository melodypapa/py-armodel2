...
class EcucTextualParamValueBuilder:
    ...
    def with_index(self, value: Optional[PositiveInteger]) -> "EcucTextualParamValueBuilder":
        """Set index attribute.
    ...
    def with_annotations(self, items: list[Annotation]) -> "EcucTextualParamValueBuilder":
    ...
    def with_definition(self, value: Optional[EcucParameterDef]) -> "EcucTextualParamValueBuilder":
    ...
    def with_is_auto_value(self, value: Optional[Boolean]) -> "EcucTextualParamValueBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "EcucTextualParamValueBuilder":
    ...
    def clear_annotations(self) -> "EcucTextualParamValueBuilder":
