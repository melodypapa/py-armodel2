...
class AtpType(Identifiable, ABC):
    ...
    def serialize(self) -> ET.Element:
        """Serialize AtpType to XML element.
        ...
        parent_elem = super(AtpType, self).serialize()
...
class AtpTypeBuilder(IdentifiableBuilder):
    """Builder for AtpType with fluent API."""
    ...
    def build(self) -> AtpType:
        """Build and return the AtpType instance (abstract)."""
