...
class PredefinedVariantBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "PredefinedVariantBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "PredefinedVariantBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "PredefinedVariantBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "PredefinedVariantBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "PredefinedVariantBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "PredefinedVariantBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "PredefinedVariantBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "PredefinedVariantBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "PredefinedVariantBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "PredefinedVariantBuilder":
    ...
    def clear_short_name_fragments(self) -> "PredefinedVariantBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "PredefinedVariantBuilder":
    ...
    def clear_annotations(self) -> "PredefinedVariantBuilder":
