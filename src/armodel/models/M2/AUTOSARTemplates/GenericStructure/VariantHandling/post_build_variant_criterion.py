...
class PostBuildVariantCriterionBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "PostBuildVariantCriterionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "PostBuildVariantCriterionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "PostBuildVariantCriterionBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "PostBuildVariantCriterionBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "PostBuildVariantCriterionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "PostBuildVariantCriterionBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "PostBuildVariantCriterionBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "PostBuildVariantCriterionBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "PostBuildVariantCriterionBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "PostBuildVariantCriterionBuilder":
    ...
    def clear_short_name_fragments(self) -> "PostBuildVariantCriterionBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "PostBuildVariantCriterionBuilder":
    ...
    def clear_annotations(self) -> "PostBuildVariantCriterionBuilder":
