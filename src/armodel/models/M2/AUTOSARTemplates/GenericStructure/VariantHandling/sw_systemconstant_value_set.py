...
class SwSystemconstantValueSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SwSystemconstantValueSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SwSystemconstantValueSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SwSystemconstantValueSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SwSystemconstantValueSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SwSystemconstantValueSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SwSystemconstantValueSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SwSystemconstantValueSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SwSystemconstantValueSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SwSystemconstantValueSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SwSystemconstantValueSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "SwSystemconstantValueSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SwSystemconstantValueSetBuilder":
    ...
    def clear_annotations(self) -> "SwSystemconstantValueSetBuilder":
