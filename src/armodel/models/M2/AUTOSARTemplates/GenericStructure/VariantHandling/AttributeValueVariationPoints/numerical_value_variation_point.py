...
class NumericalValueVariationPointBuilder(BuilderBase):
    """Builder for NumericalValueVariationPoint with fluent API."""
    ...
    def build(self) -> NumericalValueVariationPoint:
        """Build and return the NumericalValueVariationPoint instance with validation."""
