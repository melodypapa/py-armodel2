...
class EnumerationMappingTableBuilder:
    """Builder for EnumerationMappingTable with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "EnumerationMappingTableBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "EnumerationMappingTableBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "EnumerationMappingTableBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "EnumerationMappingTableBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "EnumerationMappingTableBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "EnumerationMappingTableBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "EnumerationMappingTableBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "EnumerationMappingTableBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "EnumerationMappingTableBuilder":
        """Set uuid attribute.
    ...
    def with_entries(self, items: list[any (EnumerationMapping)]) -> "EnumerationMappingTableBuilder":
        ...
        Returns:
            self for method chaining
        """
        self._obj.entries = list(items) if items else []
        return self


    def add_short_name_fragment(self, item: ShortNameFragment) -> "EnumerationMappingTableBuilder":
    ...
    def clear_short_name_fragments(self) -> "EnumerationMappingTableBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "EnumerationMappingTableBuilder":
    ...
    def clear_annotations(self) -> "EnumerationMappingTableBuilder":
    ...
    def add_entrie(self, item: any (EnumerationMapping)) -> "EnumerationMappingTableBuilder":
        ...
        Returns:
            self for method chaining
        """
        self._obj.entries.append(item)
        return self

    def clear_entries(self) -> "EnumerationMappingTableBuilder":
        """Clear all items from entries list.
    ...
    def build(self) -> EnumerationMappingTable:
        """Build and return the EnumerationMappingTable instance with validation."""
