...
class ConditionByFormulaBuilder(BuilderBase):
    """Builder for ConditionByFormula with fluent API."""
    ...
    def with_binding_time_enum(self, value: BindingTimeEnum) -> "ConditionByFormulaBuilder":
    ...
    def build(self) -> ConditionByFormula:
        """Build and return the ConditionByFormula instance with validation."""
