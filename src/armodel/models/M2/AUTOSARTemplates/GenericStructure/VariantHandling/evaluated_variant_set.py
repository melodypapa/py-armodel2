...
class EvaluatedVariantSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "EvaluatedVariantSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "EvaluatedVariantSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "EvaluatedVariantSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "EvaluatedVariantSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "EvaluatedVariantSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "EvaluatedVariantSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "EvaluatedVariantSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "EvaluatedVariantSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "EvaluatedVariantSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "EvaluatedVariantSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "EvaluatedVariantSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "EvaluatedVariantSetBuilder":
    ...
    def clear_annotations(self) -> "EvaluatedVariantSetBuilder":
