...
class DocumentationContextBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DocumentationContextBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DocumentationContextBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DocumentationContextBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DocumentationContextBuilder":
    ...
    def clear_short_name_fragments(self) -> "DocumentationContextBuilder":
