...
class ViewMapSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ViewMapSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ViewMapSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ViewMapSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ViewMapSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ViewMapSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ViewMapSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ViewMapSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ViewMapSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ViewMapSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ViewMapSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "ViewMapSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ViewMapSetBuilder":
    ...
    def clear_annotations(self) -> "ViewMapSetBuilder":
