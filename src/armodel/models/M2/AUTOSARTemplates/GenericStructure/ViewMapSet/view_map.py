...
class ViewMap(Identifiable):
    ...
    _xml_members = [
        ("first_elements", None, False, True, AtpFeature),  # firstElements
        ("role", None, True, False, None),  # role
        ("second_elements", None, False, True, AtpFeature),  # secondElements
    ]
    ...
    def deserialize(cls, element: ET.Element) -> "ViewMap":
        ...
        # Cast to ViewMap since parent returns ARObject
        return cast("ViewMap", obj)
