...
class SingleLanguageReferrable(Referrable):
    ...
    _xml_members = [
        ("long_name1", None, False, False, SingleLanguageLongName),  # longName1
    ]
    ...
    def deserialize(cls, element: ET.Element) -> "SingleLanguageReferrable":
        ...
        # Cast to SingleLanguageReferrable since parent returns ARObject
        return cast("SingleLanguageReferrable", obj)
