...
class SdgForeignReferenceWithVariationBuilder:
    ...
    def with_gid(self, value: Optional[NameToken]) -> "SdgForeignReferenceWithVariationBuilder":
        """Set gid attribute.
    ...
    def with_dest_meta_class(self, value: Optional[MetaClassName]) -> "SdgForeignReferenceWithVariationBuilder":
