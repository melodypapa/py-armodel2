...
class SdgAggregationWithVariation(SdgElementWithGid):
    ...
    def serialize(self) -> ET.Element:
        ...
        if self.sub_sdg_ref is not None:
            serialized = SerializationHelper.serialize_item(self.sub_sdg_ref, "SdgClass")
...
class SdgAggregationWithVariationBuilder:
    """Builder for SdgAggregationWithVariation with fluent API."""
    ...
    def with_gid(self, value: Optional[NameToken]) -> "SdgAggregationWithVariationBuilder":
        """Set gid attribute.
    ...
    def with_sub_sdg(self, value: Optional[SdgClass]) -> "SdgAggregationWithVariationBuilder":
        """Set sub_sdg attribute.
    ...
    def build(self) -> SdgAggregationWithVariation:
        """Build and return the SdgAggregationWithVariation instance with validation."""
