...
class SdgReferenceBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SdgReferenceBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SdgReferenceBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SdgReferenceBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SdgReferenceBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SdgReferenceBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SdgReferenceBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SdgReferenceBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SdgReferenceBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SdgReferenceBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SdgReferenceBuilder":
    ...
    def clear_short_name_fragments(self) -> "SdgReferenceBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SdgReferenceBuilder":
    ...
    def clear_annotations(self) -> "SdgReferenceBuilder":
