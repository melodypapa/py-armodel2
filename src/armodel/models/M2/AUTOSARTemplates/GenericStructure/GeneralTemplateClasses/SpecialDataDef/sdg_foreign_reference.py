...
class SdgForeignReferenceBuilder:
    ...
    def with_gid(self, value: Optional[NameToken]) -> "SdgForeignReferenceBuilder":
        """Set gid attribute.
    ...
    def with_dest_meta_class(self, value: Optional[MetaClassName]) -> "SdgForeignReferenceBuilder":
