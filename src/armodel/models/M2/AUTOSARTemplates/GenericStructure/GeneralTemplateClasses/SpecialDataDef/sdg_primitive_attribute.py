...
from armodel.models.M2.AUTOSARTemplates.GenericStructure.GeneralTemplateClasses.SpecialDataDef.sdg_abstract_primitive_attribute import SdgAbstractPrimitiveAttributeBuilder
...
class SdgPrimitiveAttributeBuilder(SdgAbstractPrimitiveAttributeBuilder):
    """Builder for SdgPrimitiveAttribute with fluent API."""
    ...
    def build(self) -> SdgPrimitiveAttribute:
        """Build and return the SdgPrimitiveAttribute instance with validation."""
