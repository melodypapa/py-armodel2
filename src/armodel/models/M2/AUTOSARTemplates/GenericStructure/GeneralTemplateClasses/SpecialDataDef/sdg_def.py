...
class SdgDefBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SdgDefBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SdgDefBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SdgDefBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SdgDefBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SdgDefBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SdgDefBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SdgDefBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SdgDefBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SdgDefBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SdgDefBuilder":
    ...
    def clear_short_name_fragments(self) -> "SdgDefBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SdgDefBuilder":
    ...
    def clear_annotations(self) -> "SdgDefBuilder":
