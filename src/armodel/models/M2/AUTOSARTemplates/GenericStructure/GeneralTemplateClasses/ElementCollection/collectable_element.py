...
class CollectableElementBuilder(IdentifiableBuilder):
    """Builder for CollectableElement with fluent API."""
    ...
    def build(self) -> CollectableElement:
        """Build and return the CollectableElement instance (abstract)."""
