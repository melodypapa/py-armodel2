...
class CollectionBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "CollectionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "CollectionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "CollectionBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "CollectionBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "CollectionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "CollectionBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "CollectionBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "CollectionBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "CollectionBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "CollectionBuilder":
    ...
    def clear_short_name_fragments(self) -> "CollectionBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "CollectionBuilder":
    ...
    def clear_annotations(self) -> "CollectionBuilder":
