...
class BuildActionManifestBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "BuildActionManifestBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "BuildActionManifestBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "BuildActionManifestBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "BuildActionManifestBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "BuildActionManifestBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "BuildActionManifestBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "BuildActionManifestBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "BuildActionManifestBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "BuildActionManifestBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "BuildActionManifestBuilder":
    ...
    def clear_short_name_fragments(self) -> "BuildActionManifestBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "BuildActionManifestBuilder":
    ...
    def clear_annotations(self) -> "BuildActionManifestBuilder":
