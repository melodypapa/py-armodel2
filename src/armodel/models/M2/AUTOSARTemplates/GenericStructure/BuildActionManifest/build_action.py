...
class BuildActionBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "BuildActionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "BuildActionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "BuildActionBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "BuildActionBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "BuildActionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "BuildActionBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "BuildActionBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "BuildActionBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "BuildActionBuilder":
        """Set uuid attribute.
    ...
    def with_delivery_artifacts(self, items: list[AutosarEngineeringObject]) -> "BuildActionBuilder":
    ...
    def with_invocation(self, value: Optional[BuildActionInvocator]) -> "BuildActionBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "BuildActionBuilder":
    ...
    def clear_short_name_fragments(self) -> "BuildActionBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "BuildActionBuilder":
    ...
    def clear_annotations(self) -> "BuildActionBuilder":
    ...
    def add_delivery_artifact(self, item: AutosarEngineeringObject) -> "BuildActionBuilder":
    ...
    def clear_delivery_artifacts(self) -> "BuildActionBuilder":
