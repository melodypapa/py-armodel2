...
class AclOperationBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "AclOperationBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "AclOperationBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "AclOperationBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "AclOperationBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "AclOperationBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "AclOperationBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "AclOperationBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "AclOperationBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "AclOperationBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "AclOperationBuilder":
    ...
    def clear_short_name_fragments(self) -> "AclOperationBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "AclOperationBuilder":
    ...
    def clear_annotations(self) -> "AclOperationBuilder":
