...
class AclRoleBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "AclRoleBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "AclRoleBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "AclRoleBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "AclRoleBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "AclRoleBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "AclRoleBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "AclRoleBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "AclRoleBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "AclRoleBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "AclRoleBuilder":
    ...
    def clear_short_name_fragments(self) -> "AclRoleBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "AclRoleBuilder":
    ...
    def clear_annotations(self) -> "AclRoleBuilder":
