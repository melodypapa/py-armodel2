...
class SignalServiceTranslationPropsSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SignalServiceTranslationPropsSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SignalServiceTranslationPropsSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SignalServiceTranslationPropsSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SignalServiceTranslationPropsSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SignalServiceTranslationPropsSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SignalServiceTranslationPropsSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SignalServiceTranslationPropsSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SignalServiceTranslationPropsSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SignalServiceTranslationPropsSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SignalServiceTranslationPropsSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "SignalServiceTranslationPropsSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SignalServiceTranslationPropsSetBuilder":
    ...
    def clear_annotations(self) -> "SignalServiceTranslationPropsSetBuilder":
    ...
    def add_signal_service_propse(self, item: any (SignalService)) -> "SignalServiceTranslationPropsSetBuilder":
