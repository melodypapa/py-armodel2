...
class ConsistencyNeedsBlueprintSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ConsistencyNeedsBlueprintSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ConsistencyNeedsBlueprintSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ConsistencyNeedsBlueprintSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ConsistencyNeedsBlueprintSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ConsistencyNeedsBlueprintSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ConsistencyNeedsBlueprintSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ConsistencyNeedsBlueprintSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ConsistencyNeedsBlueprintSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ConsistencyNeedsBlueprintSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ConsistencyNeedsBlueprintSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "ConsistencyNeedsBlueprintSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ConsistencyNeedsBlueprintSetBuilder":
    ...
    def clear_annotations(self) -> "ConsistencyNeedsBlueprintSetBuilder":
