...
class PortPrototypeBlueprintInitValue(ARObject):
    ...
    _xml_members = [
        ("data_prototype", None, False, False, AutosarDataPrototype),  # dataPrototype
    ...
    def deserialize(cls, element: ET.Element) -> "PortPrototypeBlueprintInitValue":
        ...
        # Cast to PortPrototypeBlueprintInitValue since parent returns ARObject
        return cast("PortPrototypeBlueprintInitValue", obj)
