...
class KeywordSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "KeywordSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "KeywordSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "KeywordSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "KeywordSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "KeywordSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "KeywordSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "KeywordSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "KeywordSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "KeywordSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "KeywordSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "KeywordSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "KeywordSetBuilder":
    ...
    def clear_annotations(self) -> "KeywordSetBuilder":
