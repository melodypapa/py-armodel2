...
class BlueprintMappingSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "BlueprintMappingSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "BlueprintMappingSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "BlueprintMappingSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "BlueprintMappingSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "BlueprintMappingSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "BlueprintMappingSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "BlueprintMappingSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "BlueprintMappingSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "BlueprintMappingSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "BlueprintMappingSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "BlueprintMappingSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "BlueprintMappingSetBuilder":
    ...
    def clear_annotations(self) -> "BlueprintMappingSetBuilder":
