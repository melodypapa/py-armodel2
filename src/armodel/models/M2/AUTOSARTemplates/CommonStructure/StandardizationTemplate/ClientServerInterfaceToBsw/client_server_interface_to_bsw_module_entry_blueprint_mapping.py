...
class ClientServerInterfaceToBswModuleEntryBlueprintMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ClientServerInterfaceToBswModuleEntryBlueprintMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ClientServerInterfaceToBswModuleEntryBlueprintMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ClientServerInterfaceToBswModuleEntryBlueprintMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ClientServerInterfaceToBswModuleEntryBlueprintMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ClientServerInterfaceToBswModuleEntryBlueprintMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ClientServerInterfaceToBswModuleEntryBlueprintMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ClientServerInterfaceToBswModuleEntryBlueprintMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ClientServerInterfaceToBswModuleEntryBlueprintMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ClientServerInterfaceToBswModuleEntryBlueprintMappingBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ClientServerInterfaceToBswModuleEntryBlueprintMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "ClientServerInterfaceToBswModuleEntryBlueprintMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ClientServerInterfaceToBswModuleEntryBlueprintMappingBuilder":
    ...
    def clear_annotations(self) -> "ClientServerInterfaceToBswModuleEntryBlueprintMappingBuilder":
