...
class BlueprintPolicySingleBuilder(BlueprintPolicyBuilder):
    """Builder for BlueprintPolicySingle with fluent API."""
    ...
    def build(self) -> BlueprintPolicySingle:
        """Build and return the BlueprintPolicySingle instance with validation."""
