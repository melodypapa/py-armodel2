...
from armodel.models.M2.AUTOSARTemplates.CommonStructure.StandardizationTemplate.AbstractBlueprintStructure.blueprint_policy import BlueprintPolicyBuilder
from armodel.models.M2.AUTOSARTemplates.GenericStructure.GeneralTemplateClasses.ArObject.ar_object import ARObject
from armodel.serialization import SerializationHelper
...
class BlueprintPolicyNotModifiable(BlueprintPolicy):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(BlueprintPolicyNotModifiable, self).serialize()
...
class BlueprintPolicyNotModifiableBuilder(BlueprintPolicyBuilder):
    """Builder for BlueprintPolicyNotModifiable with fluent API."""
    ...
    def build(self) -> BlueprintPolicyNotModifiable:
        """Build and return the BlueprintPolicyNotModifiable instance with validation."""
