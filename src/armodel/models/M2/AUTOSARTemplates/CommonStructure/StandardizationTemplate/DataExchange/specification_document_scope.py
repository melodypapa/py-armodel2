...
class SpecificationDocumentScopeBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SpecificationDocumentScopeBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SpecificationDocumentScopeBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SpecificationDocumentScopeBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SpecificationDocumentScopeBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SpecificationDocumentScopeBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SpecificationDocumentScopeBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SpecificationDocumentScopeBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SpecificationDocumentScopeBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SpecificationDocumentScopeBuilder":
        """Set uuid attribute.
    ...
    def with_alternative(self, value: Optional[String]) -> "SpecificationDocumentScopeBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SpecificationDocumentScopeBuilder":
    ...
    def clear_short_name_fragments(self) -> "SpecificationDocumentScopeBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SpecificationDocumentScopeBuilder":
    ...
    def clear_annotations(self) -> "SpecificationDocumentScopeBuilder":
