...
class DocumentElementScopeBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DocumentElementScopeBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DocumentElementScopeBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DocumentElementScopeBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DocumentElementScopeBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DocumentElementScopeBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DocumentElementScopeBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DocumentElementScopeBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DocumentElementScopeBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DocumentElementScopeBuilder":
        """Set uuid attribute.
    ...
    def with_alternative(self, value: Optional[String]) -> "DocumentElementScopeBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DocumentElementScopeBuilder":
    ...
    def clear_short_name_fragments(self) -> "DocumentElementScopeBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DocumentElementScopeBuilder":
    ...
    def clear_annotations(self) -> "DocumentElementScopeBuilder":
