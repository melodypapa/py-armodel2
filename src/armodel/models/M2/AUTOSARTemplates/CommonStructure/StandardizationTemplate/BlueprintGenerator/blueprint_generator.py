...
class BlueprintGeneratorBuilder(BuilderBase):
    """Builder for BlueprintGenerator with fluent API."""
    ...
    def with_expression(self, value: Optional[VerbatimString]) -> "BlueprintGeneratorBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "BlueprintGeneratorBuilder":
    ...
    def build(self) -> BlueprintGenerator:
        """Build and return the BlueprintGenerator instance with validation."""
