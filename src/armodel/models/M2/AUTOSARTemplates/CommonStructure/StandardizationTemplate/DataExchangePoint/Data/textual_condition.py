...
from armodel.models.M2.AUTOSARTemplates.CommonStructure.StandardizationTemplate.DataExchangePoint.Data.abstract_condition import AbstractConditionBuilder
...
class TextualConditionBuilder(AbstractConditionBuilder):
    """Builder for TextualCondition with fluent API."""
    ...
    def with_text(self, value: String) -> "TextualConditionBuilder":
        """Set text attribute.
    ...
    def build(self) -> TextualCondition:
        """Build and return the TextualCondition instance with validation."""
