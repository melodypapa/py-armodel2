...
class DataExchangePointBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DataExchangePointBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DataExchangePointBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DataExchangePointBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DataExchangePointBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DataExchangePointBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DataExchangePointBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DataExchangePointBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DataExchangePointBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DataExchangePointBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DataExchangePointBuilder":
    ...
    def clear_short_name_fragments(self) -> "DataExchangePointBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DataExchangePointBuilder":
    ...
    def clear_annotations(self) -> "DataExchangePointBuilder":
