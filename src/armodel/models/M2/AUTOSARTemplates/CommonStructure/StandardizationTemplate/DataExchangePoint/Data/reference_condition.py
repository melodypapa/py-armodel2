...
class ReferenceConditionBuilder:
    ...
    def with_lower_multiplicity(self, value: Optional[PositiveInteger]) -> "ReferenceConditionBuilder":
    ...
    def with_upper_multiplicity(self, value: Optional[Boolean]) -> "ReferenceConditionBuilder":
