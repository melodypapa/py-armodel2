...
class ConcreteClassTailoringBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ConcreteClassTailoringBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ConcreteClassTailoringBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ConcreteClassTailoringBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ConcreteClassTailoringBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ConcreteClassTailoringBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ConcreteClassTailoringBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ConcreteClassTailoringBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ConcreteClassTailoringBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ConcreteClassTailoringBuilder":
        """Set uuid attribute.
    ...
    def with_alternative(self, value: Optional[String]) -> "ConcreteClassTailoringBuilder":
    ...
    def with_in_scope(self, value: Optional[Boolean]) -> "ConcreteClassTailoringBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ConcreteClassTailoringBuilder":
    ...
    def clear_short_name_fragments(self) -> "ConcreteClassTailoringBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ConcreteClassTailoringBuilder":
    ...
    def clear_annotations(self) -> "ConcreteClassTailoringBuilder":
