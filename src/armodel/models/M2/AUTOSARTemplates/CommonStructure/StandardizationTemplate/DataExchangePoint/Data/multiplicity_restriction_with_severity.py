...
from armodel.models.M2.AUTOSARTemplates.CommonStructure.StandardizationTemplate.DataExchangePoint.Common.restriction_with_severity import RestrictionWithSeverityBuilder
...
class MultiplicityRestrictionWithSeverityBuilder(RestrictionWithSeverityBuilder):
    """Builder for MultiplicityRestrictionWithSeverity with fluent API."""
    ...
    def build(self) -> MultiplicityRestrictionWithSeverity:
        """Build and return the MultiplicityRestrictionWithSeverity instance with validation."""
