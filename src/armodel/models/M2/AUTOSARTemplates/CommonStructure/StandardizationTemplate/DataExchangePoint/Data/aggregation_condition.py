...
class AggregationCondition(AttributeCondition):
    ...
    _xml_members = [
        ("aggregation", None, False, False, AggregationTailoring),  # aggregation
    ]
    ...
    def deserialize(cls, element: ET.Element) -> "AggregationCondition":
        ...
        # Cast to AggregationCondition since parent returns ARObject
        return cast("AggregationCondition", obj)
