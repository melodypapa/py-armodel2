...
class AggregationCondition(AttributeCondition):
    ...
    def deserialize(cls, element: ET.Element) -> "AggregationCondition":
        ...
        child = SerializationHelper.find_child_element(element, "AGGREGATION-REF")
...
class AggregationConditionBuilder:
    ...
    def with_lower_multiplicity(self, value: Optional[PositiveInteger]) -> "AggregationConditionBuilder":
    ...
    def with_upper_multiplicity(self, value: Optional[Boolean]) -> "AggregationConditionBuilder":
