...
class ReferenceTailoringBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ReferenceTailoringBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ReferenceTailoringBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ReferenceTailoringBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ReferenceTailoringBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ReferenceTailoringBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ReferenceTailoringBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ReferenceTailoringBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ReferenceTailoringBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ReferenceTailoringBuilder":
        """Set uuid attribute.
    ...
    def with_alternative(self, value: Optional[String]) -> "ReferenceTailoringBuilder":
    ...
    def with_in_scope(self, value: Optional[Boolean]) -> "ReferenceTailoringBuilder":
    ...
    def with_multiplicity(self, value: Optional[any (MultiplicityRestriction)]) -> "ReferenceTailoringBuilder":
    ...
    def with_variation(self, value: Optional[VariationRestrictionWithSeverity]) -> "ReferenceTailoringBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ReferenceTailoringBuilder":
    ...
    def clear_short_name_fragments(self) -> "ReferenceTailoringBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ReferenceTailoringBuilder":
    ...
    def clear_annotations(self) -> "ReferenceTailoringBuilder":
