...
class DataFormatTailoring(ARObject):
    ...
    _xml_members = [
        ("class_tailorings", None, False, True, ClassTailoring),  # classTailorings
    ...
    def deserialize(cls, element: ET.Element) -> "DataFormatTailoring":
        ...
        # Cast to DataFormatTailoring since parent returns ARObject
        return cast("DataFormatTailoring", obj)
