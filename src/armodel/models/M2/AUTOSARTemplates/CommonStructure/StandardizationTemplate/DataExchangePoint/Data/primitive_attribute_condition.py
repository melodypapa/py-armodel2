...
class PrimitiveAttributeCondition(AttributeCondition):
    ...
    _xml_members = [
        ("attribute", None, False, False, any (PrimitiveAttribute)),  # attribute
    ]
    ...
    def deserialize(cls, element: ET.Element) -> "PrimitiveAttributeCondition":
        ...
        # Cast to PrimitiveAttributeCondition since parent returns ARObject
        return cast("PrimitiveAttributeCondition", obj)
