...
class PrimitiveAttributeConditionBuilder:
    ...
    def with_lower_multiplicity(self, value: Optional[PositiveInteger]) -> "PrimitiveAttributeConditionBuilder":
    ...
    def with_upper_multiplicity(self, value: Optional[Boolean]) -> "PrimitiveAttributeConditionBuilder":
