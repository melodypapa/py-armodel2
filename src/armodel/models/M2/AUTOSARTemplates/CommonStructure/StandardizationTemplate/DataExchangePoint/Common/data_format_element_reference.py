...
class DataFormatElementReferenceBuilder(SpecElementReferenceBuilder):
    """Builder for DataFormatElementReference with fluent API."""
    ...
    def build(self) -> DataFormatElementReference:
        """Build and return the DataFormatElementReference instance (abstract)."""
