...
class FlatInstanceDescriptorBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "FlatInstanceDescriptorBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "FlatInstanceDescriptorBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "FlatInstanceDescriptorBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "FlatInstanceDescriptorBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "FlatInstanceDescriptorBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "FlatInstanceDescriptorBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "FlatInstanceDescriptorBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "FlatInstanceDescriptorBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "FlatInstanceDescriptorBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "FlatInstanceDescriptorBuilder":
    ...
    def clear_short_name_fragments(self) -> "FlatInstanceDescriptorBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "FlatInstanceDescriptorBuilder":
    ...
    def clear_annotations(self) -> "FlatInstanceDescriptorBuilder":
