...
class FlatMapBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "FlatMapBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "FlatMapBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "FlatMapBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "FlatMapBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "FlatMapBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "FlatMapBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "FlatMapBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "FlatMapBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "FlatMapBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "FlatMapBuilder":
    ...
    def clear_short_name_fragments(self) -> "FlatMapBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "FlatMapBuilder":
    ...
    def clear_annotations(self) -> "FlatMapBuilder":
