...
class AliasNameSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "AliasNameSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "AliasNameSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "AliasNameSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "AliasNameSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "AliasNameSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "AliasNameSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "AliasNameSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "AliasNameSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "AliasNameSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "AliasNameSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "AliasNameSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "AliasNameSetBuilder":
    ...
    def clear_annotations(self) -> "AliasNameSetBuilder":
