...
class AbstractImplementationDataTypeElementBuilder(IdentifiableBuilder):
    """Builder for AbstractImplementationDataTypeElement with fluent API."""
    ...
    def build(self) -> AbstractImplementationDataTypeElement:
        """Build and return the AbstractImplementationDataTypeElement instance (abstract)."""
