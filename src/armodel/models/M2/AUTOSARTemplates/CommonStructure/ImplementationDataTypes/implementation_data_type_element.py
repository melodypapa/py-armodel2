...
class ImplementationDataTypeElementBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ImplementationDataTypeElementBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ImplementationDataTypeElementBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ImplementationDataTypeElementBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ImplementationDataTypeElementBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ImplementationDataTypeElementBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ImplementationDataTypeElementBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ImplementationDataTypeElementBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ImplementationDataTypeElementBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ImplementationDataTypeElementBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ImplementationDataTypeElementBuilder":
    ...
    def clear_short_name_fragments(self) -> "ImplementationDataTypeElementBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ImplementationDataTypeElementBuilder":
    ...
    def clear_annotations(self) -> "ImplementationDataTypeElementBuilder":
