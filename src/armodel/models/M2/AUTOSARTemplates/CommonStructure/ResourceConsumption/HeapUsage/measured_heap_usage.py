...
class MeasuredHeapUsageBuilder:
    """Builder for MeasuredHeapUsage with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "MeasuredHeapUsageBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "MeasuredHeapUsageBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "MeasuredHeapUsageBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "MeasuredHeapUsageBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "MeasuredHeapUsageBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "MeasuredHeapUsageBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "MeasuredHeapUsageBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "MeasuredHeapUsageBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "MeasuredHeapUsageBuilder":
        """Set uuid attribute.
    ...
    def with_hardware(self, value: Optional[HardwareConfiguration]) -> "MeasuredHeapUsageBuilder":
    ...
    def with_hw_element(self, value: Optional[HwElement]) -> "MeasuredHeapUsageBuilder":
    ...
    def with_software_context(self, value: Optional[SoftwareContext]) -> "MeasuredHeapUsageBuilder":
    ...
    def with_average_memory_consumption(self, value: Optional[PositiveInteger]) -> "MeasuredHeapUsageBuilder":
    ...
    def with_maximum_memory_consumption(self, value: Optional[PositiveInteger]) -> "MeasuredHeapUsageBuilder":
    ...
    def with_minimum_memory_consumption(self, value: Optional[PositiveInteger]) -> "MeasuredHeapUsageBuilder":
    ...
    def with_test_pattern(self, value: Optional[String]) -> "MeasuredHeapUsageBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "MeasuredHeapUsageBuilder":
    ...
    def clear_short_name_fragments(self) -> "MeasuredHeapUsageBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "MeasuredHeapUsageBuilder":
    ...
    def clear_annotations(self) -> "MeasuredHeapUsageBuilder":
    ...
    def build(self) -> MeasuredHeapUsage:
        """Build and return the MeasuredHeapUsage instance with validation."""
