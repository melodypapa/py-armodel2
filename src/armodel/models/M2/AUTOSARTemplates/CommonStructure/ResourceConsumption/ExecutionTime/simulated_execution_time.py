...
from armodel.models.M2.AUTOSARTemplates.CommonStructure.ResourceConsumption.ExecutionTime.execution_time import ExecutionTimeBuilder
...
class SimulatedExecutionTimeBuilder(ExecutionTimeBuilder):
