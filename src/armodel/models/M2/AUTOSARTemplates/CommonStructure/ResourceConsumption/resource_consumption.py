...
class ResourceConsumptionBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ResourceConsumptionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ResourceConsumptionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ResourceConsumptionBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ResourceConsumptionBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ResourceConsumptionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ResourceConsumptionBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ResourceConsumptionBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ResourceConsumptionBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ResourceConsumptionBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ResourceConsumptionBuilder":
    ...
    def clear_short_name_fragments(self) -> "ResourceConsumptionBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ResourceConsumptionBuilder":
    ...
    def clear_annotations(self) -> "ResourceConsumptionBuilder":
