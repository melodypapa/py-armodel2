...
class SectionNamePrefixBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SectionNamePrefixBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SectionNamePrefixBuilder":
    ...
    def with_symbol(self, value: Optional[CIdentifier]) -> "SectionNamePrefixBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SectionNamePrefixBuilder":
    ...
    def clear_short_name_fragments(self) -> "SectionNamePrefixBuilder":
