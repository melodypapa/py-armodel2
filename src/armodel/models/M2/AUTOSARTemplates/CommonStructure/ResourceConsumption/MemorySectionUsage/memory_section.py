...
class MemorySectionBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "MemorySectionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "MemorySectionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "MemorySectionBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "MemorySectionBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "MemorySectionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "MemorySectionBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "MemorySectionBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "MemorySectionBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "MemorySectionBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "MemorySectionBuilder":
    ...
    def clear_short_name_fragments(self) -> "MemorySectionBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "MemorySectionBuilder":
    ...
    def clear_annotations(self) -> "MemorySectionBuilder":
