...
from armodel.models.M2.AUTOSARTemplates.CommonStructure.ResourceConsumption.StackUsage.stack_usage import StackUsageBuilder
...
class WorstCaseStackUsageBuilder(StackUsageBuilder):
