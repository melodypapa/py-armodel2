...
class MeasuredStackUsageBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "MeasuredStackUsageBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "MeasuredStackUsageBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "MeasuredStackUsageBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "MeasuredStackUsageBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "MeasuredStackUsageBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "MeasuredStackUsageBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "MeasuredStackUsageBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "MeasuredStackUsageBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "MeasuredStackUsageBuilder":
        """Set uuid attribute.
    ...
    def with_executable_entity(self, value: Optional[ExecutableEntity]) -> "MeasuredStackUsageBuilder":
    ...
    def with_hardware(self, value: Optional[HardwareConfiguration]) -> "MeasuredStackUsageBuilder":
    ...
    def with_hw_element(self, value: Optional[HwElement]) -> "MeasuredStackUsageBuilder":
    ...
    def with_software_context(self, value: Optional[SoftwareContext]) -> "MeasuredStackUsageBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "MeasuredStackUsageBuilder":
    ...
    def clear_short_name_fragments(self) -> "MeasuredStackUsageBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "MeasuredStackUsageBuilder":
    ...
    def clear_annotations(self) -> "MeasuredStackUsageBuilder":
