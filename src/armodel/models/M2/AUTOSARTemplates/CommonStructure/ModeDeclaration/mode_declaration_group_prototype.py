...
class ModeDeclarationGroupPrototypeBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ModeDeclarationGroupPrototypeBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ModeDeclarationGroupPrototypeBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ModeDeclarationGroupPrototypeBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ModeDeclarationGroupPrototypeBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ModeDeclarationGroupPrototypeBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ModeDeclarationGroupPrototypeBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ModeDeclarationGroupPrototypeBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ModeDeclarationGroupPrototypeBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ModeDeclarationGroupPrototypeBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ModeDeclarationGroupPrototypeBuilder":
    ...
    def clear_short_name_fragments(self) -> "ModeDeclarationGroupPrototypeBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ModeDeclarationGroupPrototypeBuilder":
    ...
    def clear_annotations(self) -> "ModeDeclarationGroupPrototypeBuilder":
