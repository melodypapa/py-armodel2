...
class ModeTransitionBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ModeTransitionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ModeTransitionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ModeTransitionBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ModeTransitionBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ModeTransitionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ModeTransitionBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ModeTransitionBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ModeTransitionBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ModeTransitionBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ModeTransitionBuilder":
    ...
    def clear_short_name_fragments(self) -> "ModeTransitionBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ModeTransitionBuilder":
    ...
    def clear_annotations(self) -> "ModeTransitionBuilder":
