...
class ModeDeclarationGroupBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ModeDeclarationGroupBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ModeDeclarationGroupBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ModeDeclarationGroupBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ModeDeclarationGroupBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ModeDeclarationGroupBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ModeDeclarationGroupBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ModeDeclarationGroupBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ModeDeclarationGroupBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ModeDeclarationGroupBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ModeDeclarationGroupBuilder":
    ...
    def clear_short_name_fragments(self) -> "ModeDeclarationGroupBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ModeDeclarationGroupBuilder":
    ...
    def clear_annotations(self) -> "ModeDeclarationGroupBuilder":
