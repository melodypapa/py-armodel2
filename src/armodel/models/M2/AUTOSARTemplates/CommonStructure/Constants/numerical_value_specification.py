...
class NumericalValueSpecificationBuilder:
    """Builder for NumericalValueSpecification with fluent API."""
    ...
    def with_short_label(self, value: Optional[Identifier]) -> "NumericalValueSpecificationBuilder":
    ...
    def with_value(self, value: Optional[Numerical]) -> "NumericalValueSpecificationBuilder":
        """Set value attribute.
    ...
    def build(self) -> NumericalValueSpecification:
        """Build and return the NumericalValueSpecification instance with validation."""
