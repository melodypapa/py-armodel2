...
class ConstantSpecificationMappingSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ConstantSpecificationMappingSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ConstantSpecificationMappingSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ConstantSpecificationMappingSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ConstantSpecificationMappingSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ConstantSpecificationMappingSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ConstantSpecificationMappingSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ConstantSpecificationMappingSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ConstantSpecificationMappingSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ConstantSpecificationMappingSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ConstantSpecificationMappingSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "ConstantSpecificationMappingSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ConstantSpecificationMappingSetBuilder":
    ...
    def clear_annotations(self) -> "ConstantSpecificationMappingSetBuilder":
