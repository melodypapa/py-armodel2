...
class ConstantSpecificationBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ConstantSpecificationBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ConstantSpecificationBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ConstantSpecificationBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ConstantSpecificationBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ConstantSpecificationBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ConstantSpecificationBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ConstantSpecificationBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ConstantSpecificationBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ConstantSpecificationBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ConstantSpecificationBuilder":
    ...
    def clear_short_name_fragments(self) -> "ConstantSpecificationBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ConstantSpecificationBuilder":
    ...
    def clear_annotations(self) -> "ConstantSpecificationBuilder":
