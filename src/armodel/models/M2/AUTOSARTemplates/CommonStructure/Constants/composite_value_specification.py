...
class CompositeValueSpecification(ValueSpecification, ABC):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(CompositeValueSpecification, self).serialize()
    ...
    def deserialize(cls, element: ET.Element) -> "CompositeValueSpecification":
        ...
        return super(CompositeValueSpecification, cls).deserialize(element)



class CompositeValueSpecificationBuilder(ValueSpecificationBuilder):
    """Builder for CompositeValueSpecification with fluent API."""
    ...
    def build(self) -> CompositeValueSpecification:
        """Build and return the CompositeValueSpecification instance (abstract)."""
