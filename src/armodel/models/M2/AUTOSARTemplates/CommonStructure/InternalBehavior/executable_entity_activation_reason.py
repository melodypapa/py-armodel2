...
class ExecutableEntityActivationReasonBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ExecutableEntityActivationReasonBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ExecutableEntityActivationReasonBuilder":
    ...
    def with_symbol(self, value: Optional[CIdentifier]) -> "ExecutableEntityActivationReasonBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ExecutableEntityActivationReasonBuilder":
    ...
    def clear_short_name_fragments(self) -> "ExecutableEntityActivationReasonBuilder":
