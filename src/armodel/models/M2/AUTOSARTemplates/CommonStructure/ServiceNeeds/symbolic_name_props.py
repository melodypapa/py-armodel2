...
class SymbolicNameProps(ImplementationProps):
    ...
    def serialize(self) -> ET.Element:
        ...
        parent_elem = super(SymbolicNameProps, self).serialize()
...
class SymbolicNamePropsBuilder:
    """Builder for SymbolicNameProps with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "SymbolicNamePropsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SymbolicNamePropsBuilder":
    ...
    def with_symbol(self, value: Optional[CIdentifier]) -> "SymbolicNamePropsBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SymbolicNamePropsBuilder":
    ...
    def clear_short_name_fragments(self) -> "SymbolicNamePropsBuilder":
    ...
    def build(self) -> SymbolicNameProps:
        """Build and return the SymbolicNameProps instance with validation."""
