...
class DiagEventDebounceTimeBasedBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagEventDebounceTimeBasedBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagEventDebounceTimeBasedBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagEventDebounceTimeBasedBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagEventDebounceTimeBasedBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagEventDebounceTimeBasedBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagEventDebounceTimeBasedBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagEventDebounceTimeBasedBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagEventDebounceTimeBasedBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagEventDebounceTimeBasedBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagEventDebounceTimeBasedBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagEventDebounceTimeBasedBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagEventDebounceTimeBasedBuilder":
    ...
    def clear_annotations(self) -> "DiagEventDebounceTimeBasedBuilder":
