...
class ObdRatioServiceNeedsBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ObdRatioServiceNeedsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ObdRatioServiceNeedsBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ObdRatioServiceNeedsBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ObdRatioServiceNeedsBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ObdRatioServiceNeedsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ObdRatioServiceNeedsBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ObdRatioServiceNeedsBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ObdRatioServiceNeedsBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ObdRatioServiceNeedsBuilder":
        """Set uuid attribute.
    ...
    def with_audiences(self, items: list[DiagnosticAudienceEnum]) -> "ObdRatioServiceNeedsBuilder":
    ...
    def with_diag(self, value: Optional[DiagRequirementIdString]) -> "ObdRatioServiceNeedsBuilder":
        """Set diag attribute.
    ...
    def with_security_access(self, value: Optional[PositiveInteger]) -> "ObdRatioServiceNeedsBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ObdRatioServiceNeedsBuilder":
    ...
    def clear_short_name_fragments(self) -> "ObdRatioServiceNeedsBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ObdRatioServiceNeedsBuilder":
    ...
    def clear_annotations(self) -> "ObdRatioServiceNeedsBuilder":
    ...
    def add_audience(self, item: DiagnosticAudienceEnum) -> "ObdRatioServiceNeedsBuilder":
    ...
    def clear_audiences(self) -> "ObdRatioServiceNeedsBuilder":
