...
class DiagnosticEventInfoNeedsBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticEventInfoNeedsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticEventInfoNeedsBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticEventInfoNeedsBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticEventInfoNeedsBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticEventInfoNeedsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticEventInfoNeedsBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticEventInfoNeedsBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticEventInfoNeedsBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticEventInfoNeedsBuilder":
        """Set uuid attribute.
    ...
    def with_audiences(self, items: list[DiagnosticAudienceEnum]) -> "DiagnosticEventInfoNeedsBuilder":
    ...
    def with_diag(self, value: Optional[DiagRequirementIdString]) -> "DiagnosticEventInfoNeedsBuilder":
        """Set diag attribute.
    ...
    def with_security_access(self, value: Optional[PositiveInteger]) -> "DiagnosticEventInfoNeedsBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticEventInfoNeedsBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticEventInfoNeedsBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticEventInfoNeedsBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticEventInfoNeedsBuilder":
    ...
    def add_audience(self, item: DiagnosticAudienceEnum) -> "DiagnosticEventInfoNeedsBuilder":
    ...
    def clear_audiences(self) -> "DiagnosticEventInfoNeedsBuilder":
