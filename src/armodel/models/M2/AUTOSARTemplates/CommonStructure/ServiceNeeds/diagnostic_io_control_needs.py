...
class DiagnosticIoControlNeedsBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DiagnosticIoControlNeedsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DiagnosticIoControlNeedsBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DiagnosticIoControlNeedsBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DiagnosticIoControlNeedsBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DiagnosticIoControlNeedsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DiagnosticIoControlNeedsBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DiagnosticIoControlNeedsBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DiagnosticIoControlNeedsBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DiagnosticIoControlNeedsBuilder":
        """Set uuid attribute.
    ...
    def with_audiences(self, items: list[DiagnosticAudienceEnum]) -> "DiagnosticIoControlNeedsBuilder":
    ...
    def with_diag(self, value: Optional[DiagRequirementIdString]) -> "DiagnosticIoControlNeedsBuilder":
        """Set diag attribute.
    ...
    def with_security_access(self, value: Optional[PositiveInteger]) -> "DiagnosticIoControlNeedsBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DiagnosticIoControlNeedsBuilder":
    ...
    def clear_short_name_fragments(self) -> "DiagnosticIoControlNeedsBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DiagnosticIoControlNeedsBuilder":
    ...
    def clear_annotations(self) -> "DiagnosticIoControlNeedsBuilder":
    ...
    def add_audience(self, item: DiagnosticAudienceEnum) -> "DiagnosticIoControlNeedsBuilder":
    ...
    def clear_audiences(self) -> "DiagnosticIoControlNeedsBuilder":
