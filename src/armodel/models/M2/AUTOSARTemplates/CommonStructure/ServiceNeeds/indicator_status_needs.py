...
class IndicatorStatusNeedsBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "IndicatorStatusNeedsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "IndicatorStatusNeedsBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "IndicatorStatusNeedsBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "IndicatorStatusNeedsBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "IndicatorStatusNeedsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "IndicatorStatusNeedsBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "IndicatorStatusNeedsBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "IndicatorStatusNeedsBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "IndicatorStatusNeedsBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "IndicatorStatusNeedsBuilder":
    ...
    def clear_short_name_fragments(self) -> "IndicatorStatusNeedsBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "IndicatorStatusNeedsBuilder":
    ...
    def clear_annotations(self) -> "IndicatorStatusNeedsBuilder":
