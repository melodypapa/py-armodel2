...
class IdsMgrNeedsBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "IdsMgrNeedsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "IdsMgrNeedsBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "IdsMgrNeedsBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "IdsMgrNeedsBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "IdsMgrNeedsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "IdsMgrNeedsBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "IdsMgrNeedsBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "IdsMgrNeedsBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "IdsMgrNeedsBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "IdsMgrNeedsBuilder":
    ...
    def clear_short_name_fragments(self) -> "IdsMgrNeedsBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "IdsMgrNeedsBuilder":
    ...
    def clear_annotations(self) -> "IdsMgrNeedsBuilder":
