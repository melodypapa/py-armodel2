...
class ObdRatioDenominatorNeedsBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "ObdRatioDenominatorNeedsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "ObdRatioDenominatorNeedsBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "ObdRatioDenominatorNeedsBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "ObdRatioDenominatorNeedsBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "ObdRatioDenominatorNeedsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "ObdRatioDenominatorNeedsBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "ObdRatioDenominatorNeedsBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "ObdRatioDenominatorNeedsBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "ObdRatioDenominatorNeedsBuilder":
        """Set uuid attribute.
    ...
    def with_audiences(self, items: list[DiagnosticAudienceEnum]) -> "ObdRatioDenominatorNeedsBuilder":
    ...
    def with_diag(self, value: Optional[DiagRequirementIdString]) -> "ObdRatioDenominatorNeedsBuilder":
        """Set diag attribute.
    ...
    def with_security_access(self, value: Optional[PositiveInteger]) -> "ObdRatioDenominatorNeedsBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "ObdRatioDenominatorNeedsBuilder":
    ...
    def clear_short_name_fragments(self) -> "ObdRatioDenominatorNeedsBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "ObdRatioDenominatorNeedsBuilder":
    ...
    def clear_annotations(self) -> "ObdRatioDenominatorNeedsBuilder":
    ...
    def add_audience(self, item: DiagnosticAudienceEnum) -> "ObdRatioDenominatorNeedsBuilder":
    ...
    def clear_audiences(self) -> "ObdRatioDenominatorNeedsBuilder":
