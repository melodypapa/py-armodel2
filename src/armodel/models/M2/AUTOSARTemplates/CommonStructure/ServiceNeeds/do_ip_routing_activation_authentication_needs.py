...
from armodel.models.M2.AUTOSARTemplates.CommonStructure.ServiceNeeds.do_ip_service_needs import DoIpServiceNeedsBuilder
...
class DoIpRoutingActivationAuthenticationNeedsBuilder(DoIpServiceNeedsBuilder):
