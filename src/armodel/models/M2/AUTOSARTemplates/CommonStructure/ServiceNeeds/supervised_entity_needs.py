...
class SupervisedEntityNeedsBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "SupervisedEntityNeedsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "SupervisedEntityNeedsBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "SupervisedEntityNeedsBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "SupervisedEntityNeedsBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "SupervisedEntityNeedsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "SupervisedEntityNeedsBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "SupervisedEntityNeedsBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "SupervisedEntityNeedsBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "SupervisedEntityNeedsBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "SupervisedEntityNeedsBuilder":
    ...
    def clear_short_name_fragments(self) -> "SupervisedEntityNeedsBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "SupervisedEntityNeedsBuilder":
    ...
    def clear_annotations(self) -> "SupervisedEntityNeedsBuilder":
