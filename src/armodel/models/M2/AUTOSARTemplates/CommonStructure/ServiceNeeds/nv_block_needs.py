...
class NvBlockNeedsBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "NvBlockNeedsBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "NvBlockNeedsBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "NvBlockNeedsBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "NvBlockNeedsBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "NvBlockNeedsBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "NvBlockNeedsBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "NvBlockNeedsBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "NvBlockNeedsBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "NvBlockNeedsBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "NvBlockNeedsBuilder":
    ...
    def clear_short_name_fragments(self) -> "NvBlockNeedsBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "NvBlockNeedsBuilder":
    ...
    def clear_annotations(self) -> "NvBlockNeedsBuilder":
