...
class CodeBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "CodeBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "CodeBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "CodeBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "CodeBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "CodeBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "CodeBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "CodeBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "CodeBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "CodeBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "CodeBuilder":
    ...
    def clear_short_name_fragments(self) -> "CodeBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "CodeBuilder":
    ...
    def clear_annotations(self) -> "CodeBuilder":
