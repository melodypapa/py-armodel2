...
class CompilerBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "CompilerBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "CompilerBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "CompilerBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "CompilerBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "CompilerBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "CompilerBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "CompilerBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "CompilerBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "CompilerBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "CompilerBuilder":
    ...
    def clear_short_name_fragments(self) -> "CompilerBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "CompilerBuilder":
    ...
    def clear_annotations(self) -> "CompilerBuilder":
