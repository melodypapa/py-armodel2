...
class DependencyOnArtifactBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DependencyOnArtifactBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DependencyOnArtifactBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DependencyOnArtifactBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DependencyOnArtifactBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DependencyOnArtifactBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DependencyOnArtifactBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DependencyOnArtifactBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DependencyOnArtifactBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DependencyOnArtifactBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DependencyOnArtifactBuilder":
    ...
    def clear_short_name_fragments(self) -> "DependencyOnArtifactBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DependencyOnArtifactBuilder":
    ...
    def clear_annotations(self) -> "DependencyOnArtifactBuilder":
