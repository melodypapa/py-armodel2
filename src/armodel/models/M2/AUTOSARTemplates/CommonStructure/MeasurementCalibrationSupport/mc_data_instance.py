...
class McDataInstanceBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "McDataInstanceBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "McDataInstanceBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "McDataInstanceBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "McDataInstanceBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "McDataInstanceBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "McDataInstanceBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "McDataInstanceBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "McDataInstanceBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "McDataInstanceBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "McDataInstanceBuilder":
    ...
    def clear_short_name_fragments(self) -> "McDataInstanceBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "McDataInstanceBuilder":
    ...
    def clear_annotations(self) -> "McDataInstanceBuilder":
