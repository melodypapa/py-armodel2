...
class RptComponentBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "RptComponentBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "RptComponentBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "RptComponentBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "RptComponentBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "RptComponentBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "RptComponentBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "RptComponentBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "RptComponentBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "RptComponentBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "RptComponentBuilder":
    ...
    def clear_short_name_fragments(self) -> "RptComponentBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "RptComponentBuilder":
    ...
    def clear_annotations(self) -> "RptComponentBuilder":
