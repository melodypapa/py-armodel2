...
class RptServicePointBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "RptServicePointBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "RptServicePointBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "RptServicePointBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "RptServicePointBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "RptServicePointBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "RptServicePointBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "RptServicePointBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "RptServicePointBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "RptServicePointBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "RptServicePointBuilder":
    ...
    def clear_short_name_fragments(self) -> "RptServicePointBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "RptServicePointBuilder":
    ...
    def clear_annotations(self) -> "RptServicePointBuilder":
