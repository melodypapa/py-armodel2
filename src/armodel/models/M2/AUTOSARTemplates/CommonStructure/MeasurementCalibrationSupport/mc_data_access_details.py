...
class McDataAccessDetails(ARObject):
    ...
    _xml_members = [
        ("rte_event_refs", None, False, True, RTEEvent),  # rteEventRefs
        ("variable_accesses", None, False, True, VariableAccess),  # variableAccesses
    ]
    ...
    def deserialize(cls, element: ET.Element) -> "McDataAccessDetails":
        ...
        # Cast to McDataAccessDetails since parent returns ARObject
        return cast("McDataAccessDetails", obj)
