...
class AutosarVariableInstanceBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "AutosarVariableInstanceBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "AutosarVariableInstanceBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "AutosarVariableInstanceBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "AutosarVariableInstanceBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "AutosarVariableInstanceBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "AutosarVariableInstanceBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "AutosarVariableInstanceBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "AutosarVariableInstanceBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "AutosarVariableInstanceBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "AutosarVariableInstanceBuilder":
    ...
    def clear_short_name_fragments(self) -> "AutosarVariableInstanceBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "AutosarVariableInstanceBuilder":
    ...
    def clear_annotations(self) -> "AutosarVariableInstanceBuilder":
