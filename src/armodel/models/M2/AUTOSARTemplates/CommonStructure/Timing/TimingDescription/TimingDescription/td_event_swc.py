...
from armodel.models.M2.AUTOSARTemplates.CommonStructure.Timing.TimingDescription.timing_description_event import TimingDescriptionEventBuilder
...
class TDEventSwcBuilder(TimingDescriptionEventBuilder):
    """Builder for TDEventSwc with fluent API."""
    ...
    def with_component(self, value: Optional[any (SwComponent)]) -> "TDEventSwcBuilder":
    ...
    def build(self) -> TDEventSwc:
        """Build and return the TDEventSwc instance (abstract)."""
