...
from armodel.models.M2.AUTOSARTemplates.CommonStructure.Timing.TimingDescription.timing_description import TimingDescriptionBuilder
...
class TimingDescriptionEvent(TimingDescription, ABC):
    ...
    def serialize(self) -> ET.Element:
        ...
        if self.clock_reference_ref is not None:
            serialized = SerializationHelper.serialize_item(self.clock_reference_ref, "TimingClock")
        ...
        if self.occurrence is not None:
            serialized = SerializationHelper.serialize_item(self.occurrence, "Any")
            if serialized is not None:
                # Wrap with correct tag
...
class TimingDescriptionEventBuilder(TimingDescriptionBuilder):
    """Builder for TimingDescriptionEvent with fluent API."""
    ...
    def with_clock_reference(self, value: Optional[TimingClock]) -> "TimingDescriptionEventBuilder":
    ...
    def build(self) -> TimingDescriptionEvent:
        """Build and return the TimingDescriptionEvent instance (abstract)."""
