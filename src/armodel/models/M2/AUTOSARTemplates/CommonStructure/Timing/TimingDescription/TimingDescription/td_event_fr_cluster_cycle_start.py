...
class TDEventFrClusterCycleStartBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "TDEventFrClusterCycleStartBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TDEventFrClusterCycleStartBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "TDEventFrClusterCycleStartBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "TDEventFrClusterCycleStartBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "TDEventFrClusterCycleStartBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "TDEventFrClusterCycleStartBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "TDEventFrClusterCycleStartBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "TDEventFrClusterCycleStartBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "TDEventFrClusterCycleStartBuilder":
        """Set uuid attribute.
    ...
    def with_clock_reference(self, value: Optional[TimingClock]) -> "TDEventFrClusterCycleStartBuilder":
    ...
    def with_occurrence(self, value: Optional[any (TDEventOccurrence)]) -> "TDEventFrClusterCycleStartBuilder":
    ...
    def with_ecu_instance(self, value: Optional[EcuInstance]) -> "TDEventFrClusterCycleStartBuilder":
    ...
    def with_cycle_repetition(self, value: Optional[Integer]) -> "TDEventFrClusterCycleStartBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TDEventFrClusterCycleStartBuilder":
    ...
    def clear_short_name_fragments(self) -> "TDEventFrClusterCycleStartBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "TDEventFrClusterCycleStartBuilder":
    ...
    def clear_annotations(self) -> "TDEventFrClusterCycleStartBuilder":
