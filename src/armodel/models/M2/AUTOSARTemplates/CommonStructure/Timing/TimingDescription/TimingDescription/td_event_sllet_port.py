...
class TDEventSLLETPortBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "TDEventSLLETPortBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TDEventSLLETPortBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "TDEventSLLETPortBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "TDEventSLLETPortBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "TDEventSLLETPortBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "TDEventSLLETPortBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "TDEventSLLETPortBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "TDEventSLLETPortBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "TDEventSLLETPortBuilder":
        """Set uuid attribute.
    ...
    def with_clock_reference(self, value: Optional[TimingClock]) -> "TDEventSLLETPortBuilder":
    ...
    def with_occurrence(self, value: Optional[any (TDEventOccurrence)]) -> "TDEventSLLETPortBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TDEventSLLETPortBuilder":
    ...
    def clear_short_name_fragments(self) -> "TDEventSLLETPortBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "TDEventSLLETPortBuilder":
    ...
    def clear_annotations(self) -> "TDEventSLLETPortBuilder":
