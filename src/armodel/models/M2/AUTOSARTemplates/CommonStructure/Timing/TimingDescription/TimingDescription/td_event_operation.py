...
class TDEventOperation(TDEventVfbPort):
    ...
    def deserialize(cls, element: ET.Element) -> "TDEventOperation":
        ...
        # Parse td_event
        child = SerializationHelper.find_child_element(element, "TD-EVENT")
        if child is not None:
...
class TDEventOperationBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "TDEventOperationBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TDEventOperationBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "TDEventOperationBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "TDEventOperationBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "TDEventOperationBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "TDEventOperationBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "TDEventOperationBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "TDEventOperationBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "TDEventOperationBuilder":
        """Set uuid attribute.
    ...
    def with_clock_reference(self, value: Optional[TimingClock]) -> "TDEventOperationBuilder":
    ...
    def with_occurrence(self, value: Optional[any (TDEventOccurrence)]) -> "TDEventOperationBuilder":
    ...
    def with_component(self, value: Optional[any (SwComponent)]) -> "TDEventOperationBuilder":
    ...
    def with_is_external(self, value: Optional[Boolean]) -> "TDEventOperationBuilder":
    ...
    def with_port(self, value: Optional[PortPrototype]) -> "TDEventOperationBuilder":
        """Set port attribute.
    ...
    def with_port_prototype(self, value: Optional[PortPrototypeBlueprint]) -> "TDEventOperationBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TDEventOperationBuilder":
    ...
    def clear_short_name_fragments(self) -> "TDEventOperationBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "TDEventOperationBuilder":
    ...
    def clear_annotations(self) -> "TDEventOperationBuilder":
