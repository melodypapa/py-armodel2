...
class TDEventSwcInternalBehaviorReferenceBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "TDEventSwcInternalBehaviorReferenceBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TDEventSwcInternalBehaviorReferenceBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "TDEventSwcInternalBehaviorReferenceBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "TDEventSwcInternalBehaviorReferenceBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "TDEventSwcInternalBehaviorReferenceBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "TDEventSwcInternalBehaviorReferenceBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "TDEventSwcInternalBehaviorReferenceBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "TDEventSwcInternalBehaviorReferenceBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "TDEventSwcInternalBehaviorReferenceBuilder":
        """Set uuid attribute.
    ...
    def with_clock_reference(self, value: Optional[TimingClock]) -> "TDEventSwcInternalBehaviorReferenceBuilder":
    ...
    def with_occurrence(self, value: Optional[any (TDEventOccurrence)]) -> "TDEventSwcInternalBehaviorReferenceBuilder":
    ...
    def with_component(self, value: Optional[any (SwComponent)]) -> "TDEventSwcInternalBehaviorReferenceBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TDEventSwcInternalBehaviorReferenceBuilder":
    ...
    def clear_short_name_fragments(self) -> "TDEventSwcInternalBehaviorReferenceBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "TDEventSwcInternalBehaviorReferenceBuilder":
    ...
    def clear_annotations(self) -> "TDEventSwcInternalBehaviorReferenceBuilder":
