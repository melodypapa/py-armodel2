...
class TDEventISignalBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "TDEventISignalBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TDEventISignalBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "TDEventISignalBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "TDEventISignalBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "TDEventISignalBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "TDEventISignalBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "TDEventISignalBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "TDEventISignalBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "TDEventISignalBuilder":
        """Set uuid attribute.
    ...
    def with_clock_reference(self, value: Optional[TimingClock]) -> "TDEventISignalBuilder":
    ...
    def with_occurrence(self, value: Optional[any (TDEventOccurrence)]) -> "TDEventISignalBuilder":
    ...
    def with_ecu_instance(self, value: Optional[EcuInstance]) -> "TDEventISignalBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TDEventISignalBuilder":
    ...
    def clear_short_name_fragments(self) -> "TDEventISignalBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "TDEventISignalBuilder":
    ...
    def clear_annotations(self) -> "TDEventISignalBuilder":
