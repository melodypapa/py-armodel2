...
from armodel.models.M2.AUTOSARTemplates.CommonStructure.Timing.TimingDescription.TimingDescription.td_event_cycle_start import TDEventCycleStartBuilder
...
class TDEventTTCanCycleStartBuilder(TDEventCycleStartBuilder):
