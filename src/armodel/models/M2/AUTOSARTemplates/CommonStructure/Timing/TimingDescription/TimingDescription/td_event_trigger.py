...
class TDEventTrigger(TDEventVfbPort):
    ...
    def serialize(self) -> ET.Element:
        ...
        if self.td_event_trigger_ref is not None:
            serialized = SerializationHelper.serialize_item(self.td_event_trigger_ref, "TDEventTriggerTypeEnum")
...
class TDEventTriggerBuilder:
    """Builder for TDEventTrigger with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "TDEventTriggerBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TDEventTriggerBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "TDEventTriggerBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "TDEventTriggerBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "TDEventTriggerBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "TDEventTriggerBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "TDEventTriggerBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "TDEventTriggerBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "TDEventTriggerBuilder":
        """Set uuid attribute.
    ...
    def with_clock_reference(self, value: Optional[TimingClock]) -> "TDEventTriggerBuilder":
    ...
    def with_occurrence(self, value: Optional[any (TDEventOccurrence)]) -> "TDEventTriggerBuilder":
    ...
    def with_component(self, value: Optional[any (SwComponent)]) -> "TDEventTriggerBuilder":
    ...
    def with_is_external(self, value: Optional[Boolean]) -> "TDEventTriggerBuilder":
    ...
    def with_port(self, value: Optional[PortPrototype]) -> "TDEventTriggerBuilder":
        """Set port attribute.
    ...
    def with_port_prototype(self, value: Optional[PortPrototypeBlueprint]) -> "TDEventTriggerBuilder":
    ...
    def with_td_event_trigger(self, value: Optional[TDEventTriggerTypeEnum]) -> "TDEventTriggerBuilder":
        """Set td_event_trigger attribute.
    ...
    def with_trigger(self, value: Optional[Trigger]) -> "TDEventTriggerBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TDEventTriggerBuilder":
    ...
    def clear_short_name_fragments(self) -> "TDEventTriggerBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "TDEventTriggerBuilder":
    ...
    def clear_annotations(self) -> "TDEventTriggerBuilder":
    ...
    def build(self) -> TDEventTrigger:
        """Build and return the TDEventTrigger instance with validation."""
