...
class TimingModeInstanceBuilder:
    """Builder for TimingModeInstance with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "TimingModeInstanceBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TimingModeInstanceBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "TimingModeInstanceBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "TimingModeInstanceBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "TimingModeInstanceBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "TimingModeInstanceBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "TimingModeInstanceBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "TimingModeInstanceBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "TimingModeInstanceBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TimingModeInstanceBuilder":
    ...
    def clear_short_name_fragments(self) -> "TimingModeInstanceBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "TimingModeInstanceBuilder":
    ...
    def clear_annotations(self) -> "TimingModeInstanceBuilder":
    ...
    def build(self) -> TimingModeInstance:
        """Build and return the TimingModeInstance instance with validation."""
