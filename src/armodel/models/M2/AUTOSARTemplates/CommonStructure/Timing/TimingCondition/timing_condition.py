...
class TimingConditionBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "TimingConditionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TimingConditionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "TimingConditionBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "TimingConditionBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "TimingConditionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "TimingConditionBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "TimingConditionBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "TimingConditionBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "TimingConditionBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TimingConditionBuilder":
    ...
    def clear_short_name_fragments(self) -> "TimingConditionBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "TimingConditionBuilder":
    ...
    def clear_annotations(self) -> "TimingConditionBuilder":
