...
class PeriodicEventTriggeringBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "PeriodicEventTriggeringBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "PeriodicEventTriggeringBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "PeriodicEventTriggeringBuilder":
    ...
    def with_traces(self, items: list[Traceable]) -> "PeriodicEventTriggeringBuilder":
    ...
    def with_timing_condition(self, value: Optional[TimingCondition]) -> "PeriodicEventTriggeringBuilder":
    ...
    def with_event(self, value: Optional[TimingDescriptionEvent]) -> "PeriodicEventTriggeringBuilder":
        """Set event attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "PeriodicEventTriggeringBuilder":
    ...
    def clear_short_name_fragments(self) -> "PeriodicEventTriggeringBuilder":
    ...
    def add_trace(self, item: Traceable) -> "PeriodicEventTriggeringBuilder":
    ...
    def clear_traces(self) -> "PeriodicEventTriggeringBuilder":
