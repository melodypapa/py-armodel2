...
class EventTriggeringConstraintBuilder(TimingConstraintBuilder):
    """Builder for EventTriggeringConstraint with fluent API."""
    ...
    def with_event(self, value: Optional[TimingDescriptionEvent]) -> "EventTriggeringConstraintBuilder":
        """Set event attribute.
    ...
    def build(self) -> EventTriggeringConstraint:
        """Build and return the EventTriggeringConstraint instance (abstract)."""
