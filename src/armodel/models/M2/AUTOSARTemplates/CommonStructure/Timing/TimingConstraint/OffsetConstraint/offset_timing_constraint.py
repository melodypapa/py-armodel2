...
class OffsetTimingConstraintBuilder:
    """Builder for OffsetTimingConstraint with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "OffsetTimingConstraintBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "OffsetTimingConstraintBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "OffsetTimingConstraintBuilder":
    ...
    def with_traces(self, items: list[Traceable]) -> "OffsetTimingConstraintBuilder":
    ...
    def with_timing_condition(self, value: Optional[TimingCondition]) -> "OffsetTimingConstraintBuilder":
    ...
    def with_maximum(self, value: Optional[MultidimensionalTime]) -> "OffsetTimingConstraintBuilder":
    ...
    def with_minimum(self, value: Optional[MultidimensionalTime]) -> "OffsetTimingConstraintBuilder":
    ...
    def with_source(self, value: Optional[TimingDescriptionEvent]) -> "OffsetTimingConstraintBuilder":
    ...
    def with_target(self, value: Optional[TimingDescriptionEvent]) -> "OffsetTimingConstraintBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "OffsetTimingConstraintBuilder":
    ...
    def clear_short_name_fragments(self) -> "OffsetTimingConstraintBuilder":
    ...
    def add_trace(self, item: Traceable) -> "OffsetTimingConstraintBuilder":
    ...
    def clear_traces(self) -> "OffsetTimingConstraintBuilder":
    ...
    def build(self) -> OffsetTimingConstraint:
        """Build and return the OffsetTimingConstraint instance with validation."""
