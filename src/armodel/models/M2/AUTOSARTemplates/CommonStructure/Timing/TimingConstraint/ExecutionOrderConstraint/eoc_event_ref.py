...
class EOCEventRefBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "EOCEventRefBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "EOCEventRefBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "EOCEventRefBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "EOCEventRefBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "EOCEventRefBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "EOCEventRefBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "EOCEventRefBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "EOCEventRefBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "EOCEventRefBuilder":
        """Set uuid attribute.
    ...
    def with_direct_successors(self, items: list[any (EOCExecutableEntity)]) -> "EOCEventRefBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "EOCEventRefBuilder":
    ...
    def clear_short_name_fragments(self) -> "EOCEventRefBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "EOCEventRefBuilder":
    ...
    def clear_annotations(self) -> "EOCEventRefBuilder":
    ...
    def add_direct_successor(self, item: any (EOCExecutableEntity)) -> "EOCEventRefBuilder":
    ...
    def clear_direct_successors(self) -> "EOCEventRefBuilder":
