...
class AgeConstraintBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "AgeConstraintBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "AgeConstraintBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "AgeConstraintBuilder":
    ...
    def with_traces(self, items: list[Traceable]) -> "AgeConstraintBuilder":
    ...
    def with_timing_condition(self, value: Optional[TimingCondition]) -> "AgeConstraintBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "AgeConstraintBuilder":
    ...
    def clear_short_name_fragments(self) -> "AgeConstraintBuilder":
    ...
    def add_trace(self, item: Traceable) -> "AgeConstraintBuilder":
    ...
    def clear_traces(self) -> "AgeConstraintBuilder":
