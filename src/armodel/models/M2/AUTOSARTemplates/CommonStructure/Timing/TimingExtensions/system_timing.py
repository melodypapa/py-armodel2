...
from armodel.models.M2.AUTOSARTemplates.CommonStructure.Timing.TimingExtensions.timing_extension import TimingExtensionBuilder
...
class SystemTimingBuilder(TimingExtensionBuilder):
