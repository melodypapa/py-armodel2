...
class TDCpSoftwareClusterMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "TDCpSoftwareClusterMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TDCpSoftwareClusterMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "TDCpSoftwareClusterMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "TDCpSoftwareClusterMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "TDCpSoftwareClusterMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "TDCpSoftwareClusterMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "TDCpSoftwareClusterMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "TDCpSoftwareClusterMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "TDCpSoftwareClusterMappingBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TDCpSoftwareClusterMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "TDCpSoftwareClusterMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "TDCpSoftwareClusterMappingBuilder":
    ...
    def clear_annotations(self) -> "TDCpSoftwareClusterMappingBuilder":
