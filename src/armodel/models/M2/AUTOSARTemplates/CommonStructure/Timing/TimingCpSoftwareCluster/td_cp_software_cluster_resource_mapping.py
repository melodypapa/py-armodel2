...
class TDCpSoftwareClusterResourceMappingBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "TDCpSoftwareClusterResourceMappingBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TDCpSoftwareClusterResourceMappingBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "TDCpSoftwareClusterResourceMappingBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "TDCpSoftwareClusterResourceMappingBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "TDCpSoftwareClusterResourceMappingBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "TDCpSoftwareClusterResourceMappingBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "TDCpSoftwareClusterResourceMappingBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "TDCpSoftwareClusterResourceMappingBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "TDCpSoftwareClusterResourceMappingBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TDCpSoftwareClusterResourceMappingBuilder":
    ...
    def clear_short_name_fragments(self) -> "TDCpSoftwareClusterResourceMappingBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "TDCpSoftwareClusterResourceMappingBuilder":
    ...
    def clear_annotations(self) -> "TDCpSoftwareClusterResourceMappingBuilder":
