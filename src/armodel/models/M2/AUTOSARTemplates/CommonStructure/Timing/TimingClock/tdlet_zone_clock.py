...
class TDLETZoneClockBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "TDLETZoneClockBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TDLETZoneClockBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "TDLETZoneClockBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "TDLETZoneClockBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "TDLETZoneClockBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "TDLETZoneClockBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "TDLETZoneClockBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "TDLETZoneClockBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "TDLETZoneClockBuilder":
        """Set uuid attribute.
    ...
    def with_platform_time(self, value: Optional[GlobalTimeDomain]) -> "TDLETZoneClockBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TDLETZoneClockBuilder":
    ...
    def clear_short_name_fragments(self) -> "TDLETZoneClockBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "TDLETZoneClockBuilder":
    ...
    def clear_annotations(self) -> "TDLETZoneClockBuilder":
