...
class TimingClockSyncAccuracyBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "TimingClockSyncAccuracyBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "TimingClockSyncAccuracyBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "TimingClockSyncAccuracyBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "TimingClockSyncAccuracyBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "TimingClockSyncAccuracyBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "TimingClockSyncAccuracyBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "TimingClockSyncAccuracyBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "TimingClockSyncAccuracyBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "TimingClockSyncAccuracyBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "TimingClockSyncAccuracyBuilder":
    ...
    def clear_short_name_fragments(self) -> "TimingClockSyncAccuracyBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "TimingClockSyncAccuracyBuilder":
    ...
    def clear_annotations(self) -> "TimingClockSyncAccuracyBuilder":
