...
class HwPinGroupBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "HwPinGroupBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "HwPinGroupBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "HwPinGroupBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "HwPinGroupBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "HwPinGroupBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "HwPinGroupBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "HwPinGroupBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "HwPinGroupBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "HwPinGroupBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "HwPinGroupBuilder":
    ...
    def clear_short_name_fragments(self) -> "HwPinGroupBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "HwPinGroupBuilder":
    ...
    def clear_annotations(self) -> "HwPinGroupBuilder":
