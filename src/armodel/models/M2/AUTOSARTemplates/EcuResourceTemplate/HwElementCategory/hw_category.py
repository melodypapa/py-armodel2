...
class HwCategoryBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "HwCategoryBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "HwCategoryBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "HwCategoryBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "HwCategoryBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "HwCategoryBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "HwCategoryBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "HwCategoryBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "HwCategoryBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "HwCategoryBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "HwCategoryBuilder":
    ...
    def clear_short_name_fragments(self) -> "HwCategoryBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "HwCategoryBuilder":
    ...
    def clear_annotations(self) -> "HwCategoryBuilder":
