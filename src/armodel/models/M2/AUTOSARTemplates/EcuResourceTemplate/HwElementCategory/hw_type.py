...
class HwTypeBuilder:
    """Builder for HwType with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "HwTypeBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "HwTypeBuilder":
    ...
    def with_hw_attributes(self, items: list[HwAttributeValue]) -> "HwTypeBuilder":
    ...
    def with_hw_categories(self, items: list[HwCategory]) -> "HwTypeBuilder":
    ...
    def with_hw_type(self, value: Optional[HwType]) -> "HwTypeBuilder":
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "HwTypeBuilder":
    ...
    def clear_short_name_fragments(self) -> "HwTypeBuilder":
    ...
    def add_hw_attribute(self, item: HwAttributeValue) -> "HwTypeBuilder":
    ...
    def clear_hw_attributes(self) -> "HwTypeBuilder":
    ...
    def add_hw_categorie(self, item: HwCategory) -> "HwTypeBuilder":
    ...
    def clear_hw_categories(self) -> "HwTypeBuilder":
    ...
    def build(self) -> HwType:
        """Build and return the HwType instance with validation."""
