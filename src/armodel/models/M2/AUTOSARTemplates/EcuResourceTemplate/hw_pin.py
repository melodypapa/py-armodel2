...
class HwPinBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "HwPinBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "HwPinBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "HwPinBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "HwPinBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "HwPinBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "HwPinBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "HwPinBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "HwPinBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "HwPinBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "HwPinBuilder":
    ...
    def clear_short_name_fragments(self) -> "HwPinBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "HwPinBuilder":
    ...
    def clear_annotations(self) -> "HwPinBuilder":
