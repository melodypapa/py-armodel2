        ...
        if container is not None:
            for child in container:
                ...
                if child_value is not None:
                    obj.hw_pin_refs.append(child_value)
...
class HwPinConnectorBuilder:
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "HwPinConnectorBuilder":
    ...
    def with_category(self, value: Optional[CategoryString]) -> "HwPinConnectorBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "HwPinConnectorBuilder":
        """Set desc attribute.
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "HwPinConnectorBuilder":
