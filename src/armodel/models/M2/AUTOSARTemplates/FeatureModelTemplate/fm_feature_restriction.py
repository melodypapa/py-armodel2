...
class FMFeatureRestrictionBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "FMFeatureRestrictionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "FMFeatureRestrictionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "FMFeatureRestrictionBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "FMFeatureRestrictionBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "FMFeatureRestrictionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "FMFeatureRestrictionBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "FMFeatureRestrictionBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "FMFeatureRestrictionBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "FMFeatureRestrictionBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "FMFeatureRestrictionBuilder":
    ...
    def clear_short_name_fragments(self) -> "FMFeatureRestrictionBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "FMFeatureRestrictionBuilder":
    ...
    def clear_annotations(self) -> "FMFeatureRestrictionBuilder":
