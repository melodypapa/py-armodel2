...
class FMFeatureMapBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "FMFeatureMapBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "FMFeatureMapBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "FMFeatureMapBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "FMFeatureMapBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "FMFeatureMapBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "FMFeatureMapBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "FMFeatureMapBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "FMFeatureMapBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "FMFeatureMapBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "FMFeatureMapBuilder":
    ...
    def clear_short_name_fragments(self) -> "FMFeatureMapBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "FMFeatureMapBuilder":
    ...
    def clear_annotations(self) -> "FMFeatureMapBuilder":
