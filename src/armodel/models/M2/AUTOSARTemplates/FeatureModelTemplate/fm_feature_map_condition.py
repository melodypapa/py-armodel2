...
class FMFeatureMapConditionBuilder:
    """Builder for FMFeatureMapCondition with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "FMFeatureMapConditionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "FMFeatureMapConditionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "FMFeatureMapConditionBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "FMFeatureMapConditionBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "FMFeatureMapConditionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "FMFeatureMapConditionBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "FMFeatureMapConditionBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "FMFeatureMapConditionBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "FMFeatureMapConditionBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "FMFeatureMapConditionBuilder":
    ...
    def clear_short_name_fragments(self) -> "FMFeatureMapConditionBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "FMFeatureMapConditionBuilder":
    ...
    def clear_annotations(self) -> "FMFeatureMapConditionBuilder":
    ...
    def build(self) -> FMFeatureMapCondition:
        """Build and return the FMFeatureMapCondition instance with validation."""
