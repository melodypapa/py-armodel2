...
class FMFeatureModel(ARElement):
    ...
    def __init__(self) -> None:
        ...
        self.root_ref: Optional[ARRef] = None
...
class FMFeatureModelBuilder:
    """Builder for FMFeatureModel with fluent API."""
    ...
    def with_short_name(self, value: Identifier) -> "FMFeatureModelBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "FMFeatureModelBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "FMFeatureModelBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "FMFeatureModelBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "FMFeatureModelBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "FMFeatureModelBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "FMFeatureModelBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "FMFeatureModelBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "FMFeatureModelBuilder":
        """Set uuid attribute.
    ...
    def with_features(self, items: list[FMFeature]) -> "FMFeatureModelBuilder":
    ...
    def with_root(self, value: Optional[FMFeature]) -> "FMFeatureModelBuilder":
        """Set root attribute.
        ...
        if value is None and not True:
            raise ValueError("Attribute '" + snake_attr_name + "' is required and cannot be None")
        self._obj.root = value
        return self


    def add_short_name_fragment(self, item: ShortNameFragment) -> "FMFeatureModelBuilder":
    ...
    def clear_short_name_fragments(self) -> "FMFeatureModelBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "FMFeatureModelBuilder":
    ...
    def clear_annotations(self) -> "FMFeatureModelBuilder":
    ...
    def add_feature(self, item: FMFeature) -> "FMFeatureModelBuilder":
    ...
    def clear_features(self) -> "FMFeatureModelBuilder":
    ...
    def build(self) -> FMFeatureModel:
        """Build and return the FMFeatureModel instance with validation."""
