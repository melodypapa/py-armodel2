...
class FMFeatureMapElementBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "FMFeatureMapElementBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "FMFeatureMapElementBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "FMFeatureMapElementBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "FMFeatureMapElementBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "FMFeatureMapElementBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "FMFeatureMapElementBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "FMFeatureMapElementBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "FMFeatureMapElementBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "FMFeatureMapElementBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "FMFeatureMapElementBuilder":
    ...
    def clear_short_name_fragments(self) -> "FMFeatureMapElementBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "FMFeatureMapElementBuilder":
    ...
    def clear_annotations(self) -> "FMFeatureMapElementBuilder":
