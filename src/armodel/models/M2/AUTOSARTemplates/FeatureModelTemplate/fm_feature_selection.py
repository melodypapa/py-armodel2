...
class FMFeatureSelectionBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "FMFeatureSelectionBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "FMFeatureSelectionBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "FMFeatureSelectionBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "FMFeatureSelectionBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "FMFeatureSelectionBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "FMFeatureSelectionBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "FMFeatureSelectionBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "FMFeatureSelectionBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "FMFeatureSelectionBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "FMFeatureSelectionBuilder":
    ...
    def clear_short_name_fragments(self) -> "FMFeatureSelectionBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "FMFeatureSelectionBuilder":
    ...
    def clear_annotations(self) -> "FMFeatureSelectionBuilder":
