...
class FMFeatureRelationBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "FMFeatureRelationBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "FMFeatureRelationBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "FMFeatureRelationBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "FMFeatureRelationBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "FMFeatureRelationBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "FMFeatureRelationBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "FMFeatureRelationBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "FMFeatureRelationBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "FMFeatureRelationBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "FMFeatureRelationBuilder":
    ...
    def clear_short_name_fragments(self) -> "FMFeatureRelationBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "FMFeatureRelationBuilder":
    ...
    def clear_annotations(self) -> "FMFeatureRelationBuilder":
