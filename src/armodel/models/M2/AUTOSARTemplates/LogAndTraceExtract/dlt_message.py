...
class DltMessageBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DltMessageBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DltMessageBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DltMessageBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DltMessageBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DltMessageBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DltMessageBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DltMessageBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DltMessageBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DltMessageBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DltMessageBuilder":
    ...
    def clear_short_name_fragments(self) -> "DltMessageBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DltMessageBuilder":
    ...
    def clear_annotations(self) -> "DltMessageBuilder":
