...
class DltContextBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DltContextBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DltContextBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DltContextBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DltContextBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DltContextBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DltContextBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DltContextBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DltContextBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DltContextBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DltContextBuilder":
    ...
    def clear_short_name_fragments(self) -> "DltContextBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DltContextBuilder":
    ...
    def clear_annotations(self) -> "DltContextBuilder":
