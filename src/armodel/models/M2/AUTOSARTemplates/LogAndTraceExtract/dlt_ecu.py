...
class DltEcuBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DltEcuBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DltEcuBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DltEcuBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DltEcuBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DltEcuBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DltEcuBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DltEcuBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DltEcuBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DltEcuBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DltEcuBuilder":
    ...
    def clear_short_name_fragments(self) -> "DltEcuBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DltEcuBuilder":
    ...
    def clear_annotations(self) -> "DltEcuBuilder":
