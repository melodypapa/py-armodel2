...
class DltArgumentBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DltArgumentBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DltArgumentBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DltArgumentBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DltArgumentBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DltArgumentBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DltArgumentBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DltArgumentBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DltArgumentBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DltArgumentBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DltArgumentBuilder":
    ...
    def clear_short_name_fragments(self) -> "DltArgumentBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DltArgumentBuilder":
    ...
    def clear_annotations(self) -> "DltArgumentBuilder":
