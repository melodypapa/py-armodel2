...
class DltApplicationBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "DltApplicationBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "DltApplicationBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "DltApplicationBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "DltApplicationBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "DltApplicationBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "DltApplicationBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "DltApplicationBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "DltApplicationBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "DltApplicationBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "DltApplicationBuilder":
    ...
    def clear_short_name_fragments(self) -> "DltApplicationBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "DltApplicationBuilder":
    ...
    def clear_annotations(self) -> "DltApplicationBuilder":
