...
class LogAndTraceMessageCollectionSetBuilder:
    ...
    def with_short_name(self, value: Identifier) -> "LogAndTraceMessageCollectionSetBuilder":
    ...
    def with_short_name_fragments(self, items: list[ShortNameFragment]) -> "LogAndTraceMessageCollectionSetBuilder":
    ...
    def with_long_name(self, value: Optional[MultilanguageLongName]) -> "LogAndTraceMessageCollectionSetBuilder":
    ...
    def with_admin_data(self, value: Optional[AdminData]) -> "LogAndTraceMessageCollectionSetBuilder":
    ...
    def with_annotations(self, items: list[Annotation]) -> "LogAndTraceMessageCollectionSetBuilder":
    ...
    def with_desc(self, value: Optional[MultiLanguageOverviewParagraph]) -> "LogAndTraceMessageCollectionSetBuilder":
        """Set desc attribute.
    ...
    def with_category(self, value: Optional[CategoryString]) -> "LogAndTraceMessageCollectionSetBuilder":
    ...
    def with_introduction(self, value: Optional[DocumentationBlock]) -> "LogAndTraceMessageCollectionSetBuilder":
    ...
    def with_uuid(self, value: Optional[String]) -> "LogAndTraceMessageCollectionSetBuilder":
        """Set uuid attribute.
    ...
    def add_short_name_fragment(self, item: ShortNameFragment) -> "LogAndTraceMessageCollectionSetBuilder":
    ...
    def clear_short_name_fragments(self) -> "LogAndTraceMessageCollectionSetBuilder":
    ...
    def add_annotation(self, item: Annotation) -> "LogAndTraceMessageCollectionSetBuilder":
    ...
    def clear_annotations(self) -> "LogAndTraceMessageCollectionSetBuilder":
